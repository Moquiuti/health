...
<!--
	...
	Ultima revisión: ET 5abr23 15:00 AdminTecnica2022_050423.js
+-->
...
<head>
	...
	<script type="text/javascript" src="http://www.newco.dev.br/Gestion/AdminTecnica/AdminTecnica2022_050423.js"></script>
</head>
...
<xsl:otherwise>
	...
	<input type="hidden" name="PARAMETROS" value="{/Administracion/INICIO/PARAMETROS}"/>
		...
		<tbody>
			<tr class="sinLinea">
				<td>&nbsp;</td>
				<td class="labelRight">1.- Consultas de tablas de CONTROL y LOG</td>
				<td class="textLeft">
					<xsl:call-template name="desplegable">
			...
			<tr class="sinLinea">
				<td class="uno">&nbsp;</td>
				<td class="labelRight trenta">2.- Diferencia horaria:</td>
				<td class="veinte textLeft" colspan="3">
					Brasil:&nbsp;
					<xsl:call-template name="desplegable">
						<xsl:with-param name="path" select="/Administracion/INICIO/DIF_HOR_BRASIL/field"></xsl:with-param>
						<xsl:with-param name="claSel">w70px</xsl:with-param>
					</xsl:call-template>
					&nbsp;&nbsp;&nbsp;Colombia:&nbsp;
					<xsl:call-template name="desplegable">
						<xsl:with-param name="path" select="/Administracion/INICIO/DIF_HOR_COLOMBIA/field"></xsl:with-param>
						<xsl:with-param name="claSel">w70px</xsl:with-param>
					</xsl:call-template>
				</td>
				<td class="textLeft" colspan="2"><a class="btnDestacado" href="javascript:DiferenciaHoraria();">Guardar</a></td>
			</tr>
			<!--	DESACTIVADO
			<tr class="sinLinea">
				<td class="uno">&nbsp;</td>
				<td class="labelRight trenta">3.- Asociar empresa a catálogo:</td>
				<td class="veinte textLeft" colspan="3">
					<xsl:call-template name="desplegable">
			...
			<tr class="sinLinea">
				<td>&nbsp;</td>
				<td class="labelRight">4.- Desbloquear proveedor:</td>
			...
			<tr class="sinLinea">
				<td>&nbsp;</td>
				<td class="labelRight">5.- Bloquear proveedor:</td>
				<td class="textLeft" colspan="3">
					<xsl:call-template name="desplegable">
			...
			<tr class="sinLinea">
				<td>&nbsp;</td>
				<td class="labelRight">3.- Copiar derechos generales:</td>
				<td class="textLeft" colspan="3">
			...
			<tr class="sinLinea">
				<td>&nbsp;</td>
				<td class="labelRight">4.- Copiar derechos menus:</td>
				<td class="textLeft" colspan="3">
			...
			<tr class="sinLinea">
				<td>&nbsp;</td>
				<td class="labelRight">5.- Copiar derechos carpetas y plantillas:</td>
				<td class="textLeft" colspan="3">
			...
			<tr class="sinLinea">
				<td>&nbsp;</td>
				<td class="labelRight">6.- Ocultar productos no comprados en empresa:</td>
				<td class="textLeft" colspan="3">
					<xsl:call-template name="desplegable">
			...
			<tr class="sinLinea">
				<td>&nbsp;</td>
				<td class="labelRight">7.- Derechos productos en plantillas del usuario:</td>
				<td class="textLeft" colspan="3">
					<input type="text" size="5" class="campopesquisa" name="IDUSUARIOOCULTAR"/>
				</td>
				<td class="textLeft" colspan="2">
					<a class="btnDestacado" href="javascript:DerechosProductosUsuario('OCULTARNOCOMPRADOS');">Ocultar NO COMPRADOS</a>&nbsp;
			...
			<tr class="sinLinea">
				<td>&nbsp;</td>
				<td class="labelRight">8.- Comprobar programas:</td>
				<td class="textLeft" colspan="3">
				</td>
				<td class="textLeft" colspan="2">
...
<!--
			<tr class="sinLinea">
				<td>&nbsp;</td>
				<td class="labelRight">11.- Otras acciones:</td>
			...
			<tr class="sinLinea">
				<td>&nbsp;</td>
				<td class="labelRight">12.- Consultar situación ficheros integración :</td>
				<td class="textLeft" colspan="5">
