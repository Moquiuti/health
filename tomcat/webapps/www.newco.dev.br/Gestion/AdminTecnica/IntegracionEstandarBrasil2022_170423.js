...
function ProcesarSolicitudXMLEstandarBrasil(fileName, fileContent)
{
	...
	var ficRequisicao, ficTituloPdc, ficDataVencimento, ficHoraVencimento, ficMoeda, ficObservacao, ficUrgencia='N', licAvisosCarga='', ficControlErrores='', ficContacto=''; 
	...
	try
	{
		...
		ficContacto=tree.Pedido.Cabecalho.Contato;
		//	Campos extra a nivel de licitacion
		//	ficUrgencia=tree.Pedido.Cabecalho.Campo_Extra.Nome;
		
		if (ficContacto!='')	//	17abr23 Concatenamos el contacto a las observaciones
			ficObservacao+=' '+str_Contacto+':'+ficContacto;
