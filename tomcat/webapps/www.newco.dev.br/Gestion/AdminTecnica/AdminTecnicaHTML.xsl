		...
		<tbody>
			...
			<tr class="sinLinea">
				...
				<td class="textLeft" colspan="2">
					...
					<a href="javascript:DerechosProductosUsuario('SEGUNCENTRO');">Según derechos centro</a>
				</td>
			</tr>
			...
			<tr>
				...
				<td colspan="5">
					<a href="javascript:Accion('AVISOS_CAMBIOSCATALOGOASISA');">Cambios catálogo ASISA</a>&nbsp;|&nbsp;
			...
			<tr class="sinLinea">
				...
				<td class="textLeft">
					...
					<!--<select name="TIPOLOG">
						...
						<option value="DEBUG">Log de depuración</option>
						<option value="ADMIN">Log de administración</option>
					</select>-->
				</td>
				<td class="textLeft">
					<xsl:call-template name="desplegable">
					...
					<!--<select name="PLAZO">
						<option value="1DIA" selected="yes">1 día</option>
