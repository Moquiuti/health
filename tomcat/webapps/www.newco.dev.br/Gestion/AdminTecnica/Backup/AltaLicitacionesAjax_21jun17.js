...
function EnviarTodosProductos(licNumProductosEnviados)
{
	...
	var texto	='['+ficProductos[licNumProductosEnviados].Codigo+'] '+ficProductos[licNumProductosEnviados].Descripcion+': '+ficProductos[licNumProductosEnviados].Cantidad;
...
function ProcesarCadenaTXT()
{
	...
	for (i=0;i<=numRefs;++i)
	{
		...
		//solodebug
		console.log('Leyendo Centro:'+items['Centro']+' > producto: ('+items['Codigo']+') '+items['Descripcion']+'. Cant:'+items['Cantidad']);
