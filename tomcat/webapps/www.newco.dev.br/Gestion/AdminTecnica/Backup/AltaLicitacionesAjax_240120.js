...
//	ultima revision ET 23ene20 09:22 AltaLicitacionesAjax_240120.js
...
function prepararEnvio(nombreFichero, ficRequisicao, ficTituloPdc, ficDataVencimento, ficHoraVencimento, ficMoeda, ficObservacao, ficUrgencia)
{
	...
	//if (ficObservacao!='') ficObservacao=ScapeHTMLString(ficObservacao.replace(/\r\n/g, '<br/>'));	//	24ene20
	
	var datosFichero='Titulo_Pdc:::'+ScapeHTMLString(ficTituloPdc)+'|'				
				+'Data_Vencimento:::'+ficDataVencimento+'|'
				+'Hora_Vencimento:::'+ficHoraVencimento+'|'
				+'Moeda:::'+ficMoeda+'|'
				+'Observacao:::'+ficObservacao+'|'	//	24ene20
