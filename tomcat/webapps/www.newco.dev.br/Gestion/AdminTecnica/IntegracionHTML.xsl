...
<head>
	...
	<script type="text/javascript" src="http://www.newco.dev.br/Gestion/AdminTecnica/AltaLicitacionesAjax_250221.js"></script>
	...
	<xsl:if test="/Administracion/INICIO/ACCION='INT_CONSULTA' or /Administracion/INICIO/ACCION='INT_EJECUTAR' or /Administracion/INICIO/ACCION='INT_OKMANUAL'">
			...
			<thead>
				<tr class="subTituloTabla">
					<th align="center"> <!--colspan="4"-->
						<xsl:attribute name="colspan">
							<xsl:choose>
							<xsl:when test="/Administracion/INICIO/ADMIN_MVM">13</xsl:when>
				...
				<tr>
					...
					<th align="left"><xsl:value-of select="document($doc)/translation/texts/item[@name='fichero']/node()"/></th>
					...
					<th align="center" style="width:140px;"><xsl:value-of select="document($doc)/translation/texts/item[@name='boton_descargarOC']/node()"/></th>
					<th align="center" style="width:180px;"><xsl:value-of select="document($doc)/translation/texts/item[@name='fecha_descarga']/node()"/></th>
					<th align="center"><xsl:value-of select="document($doc)/translation/texts/item[@name='estado_descarga']/node()"/></th>
				</tr>
			</thead>
			...
			<xsl:for-each select="/Administracion/INICIO/INTEGRACION/FICHERO">
				<tr>
					...
					<td align="left">&nbsp;<xsl:value-of select="CLIENTE/NOMBRE"/></td>
					...
					<td align="center">&nbsp;<xsl:value-of select="FECHA_DESCARGA"/></td>
					<td align="center">&nbsp;<xsl:value-of select="ESTADO_DESCARGA"/></td>
				</tr>
			</xsl:for-each>
...
<!--   
	...
	6feb20 Hemos quitado las acciones, no se requiere leyenda
