...
//	Ultima revisión ET 31may22 14:15 EISConsultas_310522.js
...
function globalEvents(){
	...
	if ((jQuery("#NOTICIAS_DESTACADAS").val()=='S')&&(Noticias.length>0)) AlertNoticias();
}

//30may22 Presenta un alert con las noticias (guardadas en campos hidden). 31may22 Abre tambien el documento correspondiente
