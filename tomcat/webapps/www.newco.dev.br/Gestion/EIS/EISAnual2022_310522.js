...
//	Ultima revision ET 2jun22 14:16 EISAnual2022_310522.js
		...
		if(Piece(key,'|',0) == 'COLUMNA'){
			...
			if(IDGrupoActual!='99999Total'){
				...
				for(var k=1;k<=NumColumnas;k++){
					Valores[count*NumColumnas+k-1]=desformateaDivisa(ResultadosTabla['COLUMNA|'+IDGrupoActual+'|'+k]);
				}
			}
		}
	});
...
//	2jun22 Incluimos head y body, th en los titulos, etc
...
function generarTabla(){
	...
	//2jun22 var cadenaHtml='<tr class="titleTablaEIS">';
	...
	//2jun22 cadenaHtml=cadenaHtml+ '<span style="float:left;padding-top:5px;">&nbsp;&nbsp;&nbsp;<a href="javascript:OrdenarPorColumna(-1);">' + txtConcepto + '</a>&nbsp;&nbsp;&nbsp;&nbsp;</span>';
	//2jun22 cadenaHtml=cadenaHtml+BotonArribaHTML(txtTodos, 'Seleccionar', 'javascript:Seleccionar();', 50)+BotonArribaHTML(txtResultados, 'Dejar todos los seleccionados', 'javascript:Activar(true);', 50)+BotonArribaHTML(txtVolver, 'Ver todas las lineas de datos', 'javascript:TodasLineasActivas();', 50) + cellEnd;
	...
	for(i=0;i<=NumLineas;i++){
		...
		if(LineaActiva[ColumnaOrdenada[i]]=='S'){
			...
			console.log('generarTabla ['+k+'].');
			
			if(ColumnaActiva[k-1] == 'S'){
			
				console.log('generarTabla ['+k+']. Activa.');
				
				Totales[k]=Totales[k]+Valores[ColumnaOrdenada[i]*NumColumnas+k-1];

				console.log('generarTabla ['+k+']. Activa. Total col:'+Totales[k]);
				...
				cadenaHtml=cadenaHtml+cellStart+Enlace+AdjustNumber(Valores[ColumnaOrdenada[i]*NumColumnas+k-1])+'</a>'+cellEnd;
				console.log('generarTabla ['+k+']. Activa. Incluyendo Col:'+Valores[ColumnaOrdenada[i]*NumColumnas+k-1]);
	...
	//2jun22	cadenaHtml=cadenaHtml+'<tr class="subTituloTabla"><td colspan="' + (NumColumnas + 1) + '" align="left">'+BotonArribaHTML(txtTodos, 'Seleccionar', 'javascript:Seleccionar();', 50)+BotonArribaHTML(txtResultados, 'Dejar todos los seleccionados', 'javascript:Activar(true);', 50)+BotonArribaHTML(txtVolver, 'Ver todas las lineas de datos', 'javascript:TodasLineasActivas();', 50)+'</td></tr>';
