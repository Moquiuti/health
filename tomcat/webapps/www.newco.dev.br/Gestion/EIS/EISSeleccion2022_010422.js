...
//	Ultima revisión: ET 03may22 10:00 EISSeleccion2022_010422.js
...
function CambioClasificacion()
{
	...
	{
		jQuery("#CHK_AUTORIZADOS").prop('checked',true);			//1jul22 attr
	...
	{
		jQuery("#CHK_AUTORIZADOS").removeProp("disabled");
		jQuery("#CHK_EXCLUIDOS").removeProp("disabled");			//1jul22 removeAttr
	}
}
...
function DescargarExcel()
{
	...
	/*//	Recorremos el array de registros seleccionados
    jQuery("#REGISTRO_SEL").each(function(){
      	 cadenaCSV+=jQuery(this).attr('value')+sepCSV+jQuery(this).text()+saltoLineaCSV;
    });*/
