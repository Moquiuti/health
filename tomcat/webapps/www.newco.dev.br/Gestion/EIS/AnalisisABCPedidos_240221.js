...
//	ultima revisión: ET 30jul19 10:45
...
function AplicarFiltro(){
	...
	form.action='AnalisisABCPedidos.xsql';
...
function DescargarExcel(){
    ...
    var form=document.forms[0];
	var IDEmpresa, IDCentro, IDProveedor, IDFamilia, fechaInicio, fechaFinal, IDCentroConsumo,GrupoDeStock,Oncologico,PorcA,PorcB;
