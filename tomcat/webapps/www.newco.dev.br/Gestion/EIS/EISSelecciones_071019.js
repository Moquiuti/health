...
//	Ultima revisión: ET 07oct19 10:15
...
{
	//	Por defecto será de proveedores
...
function QuitarEmpresaSel()
{
    ...
    for (var i=0; i<obj.options.length;i++){
        ...
        if (obj.options[i].selected == true)
		{
			...
			--i; 							//	Al quitar un elemento, el siguiente pasará a la posición de este
       }
    }
...
/*
	//	Versión anterior, limpiaba la lista pero no corregía la cadenas concatenada de IDs
