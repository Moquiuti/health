...
<!--
	...
	Ultima revision: ET 1jun22 11:55 EISDatos2022_140322.js
-->
...
<head>
	...
	<title><xsl:value-of select="document($doc)/translation/texts/item[@name='eis']/node()"/>:&nbsp;<xsl:value-of select="document($doc)/translation/texts/item[@name='totales_mensuales']/node()"/></title>
	...
	<script type="text/javascript" src="http://www.newco.dev.br/Gestion/EIS/EISDatos2022_140322.js"/>
	<!--
	...
	<xsl:otherwise>
		...
		<div class="ZonaTituloPagina">
			...
			<p class="TituloPagina">
				...
				<span class="fuentePeq">(<xsl:value-of select="document($doc)/translation/texts/item[@name='actualizado']/node()"/>: <xsl:value-of select="/EIS_XML/EISANALISIS/ACTUALIZACION"/>)</span>
...
-->
	...
	<tr class="sinLinea">
		...
		<td class="datosLeft quince"><select id="IDCENTRO2" name="IDCENTRO2" class="w300px" disabled="disabled"/></td>
		<td class="cinco">&nbsp;</td>
	</tr>
	...
	<tr class="sinLinea">
		...
		<td class="datosLeft">
			<input type="text" name="CODIGO" id="CODIGO" class="campopesquisa w300px">
		...
		<td class="datosLeft">
			<input type="text" name="REFERENCIA" id="REFERENCIA" class="campopesquisa w300px">
	...
	<tr class="sinLinea">
		...
		<td colspan="4">&nbsp;</td>
		<td>
			<a class="btnDestacado btn150px textCenter" id="MostrarCuadro" href="javascript:TablaEISAjax();"><xsl:value-of select="document($doc)/translation/texts/item[@name='mostrar']/node()"/></a>
		...
		<xsl:if test="/EIS_XML/EISANALISIS/FILTROS/field/@name='IDCENTRO'">
			...
			<td class="datosLeft">
				<xsl:call-template name="desplegable">
					...
					<xsl:with-param name="claSel">seleccion w300px</xsl:with-param>
				</xsl:call-template>
			</td>
			<td>&nbsp;</td>
		</xsl:if>
	...
	<tr class="sinLinea">
		...
		<xsl:when test="/EIS_XML/EISANALISIS/FILTROS/field/@name='IDCATEGORIA' and /EIS_XML/EISANALISIS/FILTROS/field/@name='IDSUBFAMILIA'">
			...
			<td class="datosLeft">
				...
				<!--<span id="borrarSEL_IDSUBFAMILIA" style="display:none;">&nbsp;<a href="javascript:borrarSeleccion('IDSUBFAMILIA');"><img src="http://www.newco.dev.br/images/2022/icones/del.svg"/></a></span>-->
			</td>
			<td>&nbsp;</td>
		</xsl:when>
	...
	<tr class="sinLinea">
		...
		<xsl:when test="/EIS_XML/EISANALISIS/FILTROS/field/@name='IDCATEGORIA' and /EIS_XML/EISANALISIS/FILTROS/field/@name='IDGRUPO'">
			...
			<td class="datosLeft">
				...
				<!--<span id="borrarSEL_IDGRUPO" style="display:none;">&nbsp;<a href="javascript:borrarSeleccion('IDGRUPO');"><img src="http://www.newco.dev.br/images/2022/icones/del.svg"/></a></span>-->
			</td>
			<td>&nbsp;</td>
		</xsl:when>
		<xsl:otherwise>
...
<table class="buscador">
	<tr class="sinLinea">
		...
		<xsl:if test="/EIS_XML/EISANALISIS/FILTROS/field/@name='IDCATEGORIA'">
			...
			<td class="datosLeft quince">
				...
				<span id="borrarSEL_IDCATEGORIA" style="display:none;">&nbsp;<a href="javascript:borrarSeleccion('IDCATEGORIA');"><img src="http://www.newco.dev.br/images/2022/icones/del.svg"/></a></span>
			</td>
			<td class="cinco">&nbsp;</td>
		</xsl:if>
	</tr>
	...
	<tr class="sinLinea">
		...
		<xsl:if test="/EIS_XML/EISANALISIS/FILTROS/field/@name='IDEMPRESA'">
			...
			<td class="datosLeft">
				...
				<span id="borrarSEL_IDEMPRESA" style="display:none;">&nbsp;<a href="javascript:borrarSeleccion('IDEMPRESA');"><img src="http://www.newco.dev.br/images/2022/icones/del.svg"/></a></span>
			</td>
			<td>&nbsp;</td>
		</xsl:if>
		...
		<xsl:if test="/EIS_XML/EISANALISIS/FILTROS/field/@name='IDEMPRESA2'">
			...
			<td class="datosLeft">
				...
				<span id="borrarSEL_IDEMPRESA2" style="display:none;">&nbsp;<a href="javascript:borrarSeleccion('IDEMPRESA2');"><img src="http://www.newco.dev.br/images/2022/icones/del.svg"/></a></span>
			</td>
			<td>&nbsp;</td>
		</xsl:if>
		...
		<xsl:if test="/EIS_XML/EISANALISIS/FILTROS/field/@name='IDFAMILIA'">
			...
			<td class="datosLeft">
				...
				<span id="borrarSEL_IDFAMILIA" style="display:none;">&nbsp;<a href="javascript:borrarSeleccion('IDFAMILIA');"><img src="http://www.newco.dev.br/images/2022/icones/del.svg"/></a></span>
			</td>
			<td>&nbsp;</td>
		</xsl:if>
	</tr>
	...
	<tr class="sinLinea">
		...
		<td class="datosLeft">
			<select id="IDCENTRO" name="IDCENTRO" disabled="disabled" class="w300px"/>
			<span id="borrarSEL_IDCENTRO" style="display:none;">&nbsp;<a href="javascript:borrarSeleccion('IDCENTRO');"><img src="http://www.newco.dev.br/images/2022/icones/del.svg"/></a></span>
		</td>
		<td>&nbsp;</td>
		...
		<td class="datosLeft">
			<select id="IDCENTRO2" name="IDCENTRO2" disabled="disabled" class="w300px seleccion"/>
			<span id="borrarSEL_IDCENTRO2" style="display:none;">&nbsp;<a href="javascript:borrarSeleccion('IDCENTRO2');"><img src="http://www.newco.dev.br/images/2022/icones/del.svg"/></a></span>
		</td>
		<td>&nbsp;</td>
