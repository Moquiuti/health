	...
	jQuery.ajax({
		...
		success:function(data){
			...
			for(var i=0; i<doc.Empresas.length; i++){
				var mediaMes = doc.Empresas[i].datosEmpresa.pedCompras12 / 12;
				var mediaDia = doc.Empresas[i].datosEmpresa.pedMesAnt / 30;
				...
				//catCatal
				if(doc.Empresas[i].datosEmpresa.catCatal > (doc.Empresas[i].datosEmpresa.empPotCatalogo * toleranciaCat)){
				...
				//catAdj
				if(doc.Empresas[i].datosEmpresa.catAdj > (doc.Empresas[i].datosEmpresa.catCatal * toleranciaCat)){
				...
				//catComprados12
				if(doc.Empresas[i].datosEmpresa.catComprados12 > (doc.Empresas[i].datosEmpresa.catAdj * toleranciaCat)){
				...
				//pedCompras12
				if(doc.Empresas[i].datosEmpresa.pedCompras12 > (doc.Empresas[i].datosEmpresa.empPotComprasMens * 12 * toleranciaCat)){
				...
				//pedMesAnt
				if(doc.Empresas[i].datosEmpresa.pedMesAnt > mediaMes){
				...
				//ped30Dias
				if(doc.Empresas[i].datosEmpresa.ped30Dias > mediaMes){
				...
				//pedUltimosDias
				if(doc.Empresas[i].datosEmpresa.pedUltimoDia > mediaMes){
