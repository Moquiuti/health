...
function NuevaSeleccion()
{
	...
	if (document.forms['Selecciones'].elements['ADMINMVM'].value=='S'){
    	if (document.forms['Selecciones'].elements['CHK_PUBLICO'].checked == false){
	...
	alert(Estado);
	console.log('NuevaSeleccion. '+Estado);
...
function ModificaSeleccion(){
    ...
    if (document.forms['Selecciones'].elements['CHK_PUBLICO_MOD'].checked == false){
        document.forms['Selecciones'].elements['IDEMPRESA'].value = '';
    }
...
function AutorizadosYExcluidos(control)
{
	...
	if ((Activado === true) && (document.forms['Selecciones'].elements['CHK_PUBLICO'+isMod].checked === false))
	{
		document.forms['Selecciones'].elements['CHK_PUBLICO'+isMod].checked = true;
	}
...
function chkPublico(control)
{
    ...
    if (document.forms['Selecciones'].elements[control].checked === false)
	{
		if (control==='TODOS_ADMIN_MOD')
		{
