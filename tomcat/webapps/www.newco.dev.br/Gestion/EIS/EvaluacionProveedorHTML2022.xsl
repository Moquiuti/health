...
<!--
	...
	Ultima revisión: ET 15mar22 17:20 EvaluacionProveedor2022_150322.js
-->
...
<!--	<script type="text/javascript" src="http://www.newco.dev.br/General/jquery-1.8.3.min.js"></script>
		...
		<script type="text/javascript" src="http://www.newco.dev.br/Gestion/EIS/EvaluacionProveedor2022_150322.js"></script>
	...
	<body onload="javascript:inicio();">	
      ...
      <!--idioma fin-->
        ...
        <div class="divLeft marginLeft200" id="Cabecera">
        ...
        <div class="divLeft marginLeft200">
			<form name="frmFiltro" id="frmFiltro" method="post" action="http://www.newco.dev.br/Gestion/EIS/EvaluacionProveedor2022.xsql">        
				...
				<th>
					...
					<xsl:when test="not (/EvaluacionProveedor/INDICADORES/SIN_CABECERA='S')">
						...
						<xsl:if test="/EvaluacionProveedor/INDICADORES/IDPROVEEDOR!=-1">
							<a class="btnNormal" href="javascript:FichaEmpresa({/EvaluacionProveedor/INDICADORES/IDPROVEEDOR});"><xsl:value-of select="document($doc)/translation/texts/item[@name='ver']/node()"/></a>
						</xsl:if>
						&nbsp;&nbsp;&nbsp;
					</xsl:when>
					<xsl:otherwise>
					...
					<label><xsl:value-of select="document($doc)/translation/texts/item[@name='periodo']/node()"/>:</label>&nbsp;
					<xsl:call-template name="desplegable">
        ...
        <div class="divLeft marginLeft200" id="TablaPedidos">
			<br/>
			<br/>
			<br/>
			<br/>
			<table class="w500px" cellspacing="2px" cellpadding="2px">
			<tr ><td class="textLeft"  colspan="2"><strong><xsl:value-of select="document($doc)/translation/texts/item[@name='Nota_final']/node()"/>:&nbsp;<xsl:value-of select="/EvaluacionProveedor/INDICADORES/NOTAS/NOTA_FINAL" />/100</strong></td></tr>
			<tr ><td class="labelLeft w250px"><xsl:value-of select="document($doc)/translation/texts/item[@name='Nota_Pedidos']/node()"/></td><td class="textRight" ><xsl:value-of select="/EvaluacionProveedor/INDICADORES/NOTAS/NOTA_PEDIDOS" />/<xsl:value-of select="/EvaluacionProveedor/INDICADORES/NOTAS/PORC_PEDIDOS" /></td></tr>
			<tr ><td class="labelLeft" ><xsl:value-of select="document($doc)/translation/texts/item[@name='Nota_Retrasos']/node()"/></td><td class="textRight" ><xsl:value-of select="/EvaluacionProveedor/INDICADORES/NOTAS/NOTA_RETRASOS" />/<xsl:value-of select="/EvaluacionProveedor/INDICADORES/NOTAS/PORC_RETRASOS" /></td></tr>
			<tr ><td class="labelLeft" ><xsl:value-of select="document($doc)/translation/texts/item[@name='Nota_Incidencias']/node()"/></td><td class="textRight" ><xsl:value-of select="/EvaluacionProveedor/INDICADORES/NOTAS/NOTA_INCIDENCIAS" />/<xsl:value-of select="/EvaluacionProveedor/INDICADORES/NOTAS/PORC_INCIDENCIAS" /></td></tr>
			<tr ><td class="labelLeft" ><xsl:value-of select="document($doc)/translation/texts/item[@name='Nota_Roturas']/node()"/></td><td class="textRight" ><xsl:value-of select="/EvaluacionProveedor/INDICADORES/NOTAS/NOTA_ROTURAS" />/<xsl:value-of select="/EvaluacionProveedor/INDICADORES/NOTAS/PORC_ROTURAS" /></td></tr>
			<tr ><td class="labelLeft" ><xsl:value-of select="document($doc)/translation/texts/item[@name='Nota_Licitaciones']/node()"/></td><td class="textRight" ><xsl:value-of select="/EvaluacionProveedor/INDICADORES/NOTAS/NOTA_LICITACIONES" />/<xsl:value-of select="/EvaluacionProveedor/INDICADORES/NOTAS/PORC_LICITACIONES" /></td></tr>
			</table>
			<br/>
			<br/>
        </div>
        ...
        <div class="divLeft marginLeft200" id="TablaPedidos">
			<table class="w500px" cellspacing="2px" cellpadding="2px">
			<tr ><td class="textLeft"  colspan="2"><strong><xsl:value-of select="document($doc)/translation/texts/item[@name='Resumen']/node()"/></strong></td></tr>
			<tr ><td class="labelLeft w250px"><xsl:value-of select="document($doc)/translation/texts/item[@name='eis_importe_pedidos']/node()"/></td><td class="textRight" style="font-size:15px;width=150px;"><xsl:value-of select="/EvaluacionProveedor/INDICADORES/PEDIDOS/IMPORTE_FORMATO" /></td></tr>
			<tr ><td class="labelLeft" ><xsl:value-of select="document($doc)/translation/texts/item[@name='eis_numero_pedidos']/node()"/></td><td class="textRight" ><xsl:value-of select="/EvaluacionProveedor/INDICADORES/PEDIDOS/TOTAL" /></td></tr>
			<tr ><td class="labelLeft" ><xsl:value-of select="document($doc)/translation/texts/item[@name='Pedidos_puntuales']/node()"/></td><td class="textRight" ><xsl:value-of select="/EvaluacionProveedor/INDICADORES/PEDIDOS/PUNTUALES" /></td><td class="textRight" ><xsl:value-of select="/EvaluacionProveedor/INDICADORES/PEDIDOS/PUNTUALES_PORC" />%</td></tr>
			<tr ><td class="labelLeft" ><xsl:value-of select="document($doc)/translation/texts/item[@name='Pedidos_retrasados']/node()"/></td><td class="textRight" ><xsl:value-of select="/EvaluacionProveedor/INDICADORES/PEDIDOS/RETRASADOS" /></td><td class="textRight" ><xsl:value-of select="/EvaluacionProveedor/INDICADORES/PEDIDOS/RETRASADOS_PORC" />%</td></tr>
			<tr ><td class="labelLeft" ><xsl:value-of select="document($doc)/translation/texts/item[@name='Pedidos_parciales']/node()"/></td><td class="textRight" ><xsl:value-of select="/EvaluacionProveedor/INDICADORES/PEDIDOS/PARCIALES" /></td><td class="textRight" ><xsl:value-of select="/EvaluacionProveedor/INDICADORES/PEDIDOS/PARCIALES_PORC" />%</td></tr>
			<tr ><td class="labelLeft" ><xsl:value-of select="document($doc)/translation/texts/item[@name='reclamaciones']/node()"/></td><td class="textRight" ><xsl:value-of select="/EvaluacionProveedor/INDICADORES/PEDIDOS/RECLAMACIONES" /></td><td class="textRight" ><xsl:value-of select="/EvaluacionProveedor/INDICADORES/PEDIDOS/RECLAMACIONES_PORC" />%</td></tr>
			<tr ><td class="labelLeft" ><xsl:value-of select="document($doc)/translation/texts/item[@name='Pedidos_urgentes']/node()"/></td><td class="textRight" ><xsl:value-of select="/EvaluacionProveedor/INDICADORES/PEDIDOS/URGENTES" /></td><td class="textRight" ><xsl:value-of select="/EvaluacionProveedor/INDICADORES/PEDIDOS/URGENTES_PORC" />%</td></tr>
			</table>
			<br/>
			<br/>
        </div>
		
        <div class="divLeft marginLeft200" id="TablaTiempos">
			<table class="w500px" cellspacing="2px" cellpadding="2px">
			<tr ><td class="textLeft"  colspan="2"><strong><xsl:value-of select="document($doc)/translation/texts/item[@name='Proceso_completo_pedido']/node()"/></strong></td></tr>
			<tr ><td class="labelLeft w250px"><xsl:value-of select="document($doc)/translation/texts/item[@name='Aceptacion']/node()"/></td><td class="textRight" ><xsl:value-of select="/EvaluacionProveedor/INDICADORES/PEDIDOS/TM_ACEPTACION_FORMATO" /></td></tr>
			<tr ><td class="labelLeft" ><xsl:value-of select="document($doc)/translation/texts/item[@name='Preparacion']/node()"/></td><td class="textRight" ><xsl:value-of select="/EvaluacionProveedor/INDICADORES/PEDIDOS/TM_PREPARACION_FORMATO" /></td></tr>
			<tr ><td class="labelLeft" ><xsl:value-of select="document($doc)/translation/texts/item[@name='Transporte']/node()"/></td><td class="textRight" ><xsl:value-of select="/EvaluacionProveedor/INDICADORES/PEDIDOS/TM_TRANSPORTE_FORMATO" /></td></tr>
			<tr ><td class="labelLeft" ><xsl:value-of select="document($doc)/translation/texts/item[@name='retraso']/node()"/></td><td class="textRight" ><xsl:value-of select="/EvaluacionProveedor/INDICADORES/PEDIDOS/TM_RETRASO_FORMATO" /></td></tr>
			</table>
			<br/>
			<br/>
        </div>

        <div class="divLeft marginLeft200" id="TablaRetrasos">
			<table class="w500px" cellspacing="2px" cellpadding="2px">
			<tr ><td class="textLeft"  colspan="2"><strong><xsl:value-of select="document($doc)/translation/texts/item[@name='Analisis_retraso_pedidos']/node()"/></strong></td></tr>
			<tr ><td class="labelLeft w250px"><xsl:value-of select="document($doc)/translation/texts/item[@name='Pedidos_retrasados_1dia']/node()"/></td><td class="textRight" ><xsl:value-of select="/EvaluacionProveedor/INDICADORES/PEDIDOS/RETRASADOS1DIA" /></td></tr>
			<tr ><td class="labelLeft" ><xsl:value-of select="document($doc)/translation/texts/item[@name='Pedidos_retrasados_2dias']/node()"/></td><td class="textRight" ><xsl:value-of select="/EvaluacionProveedor/INDICADORES/PEDIDOS/RETRASADOS2DIAS" /></td></tr>
			<tr ><td class="labelLeft" ><xsl:value-of select="document($doc)/translation/texts/item[@name='Pedidos_retrasados_3dias']/node()"/></td><td class="textRight" ><xsl:value-of select="/EvaluacionProveedor/INDICADORES/PEDIDOS/RETRASADOS3DIAS" /></td></tr>
			<tr ><td class="labelLeft" ><xsl:value-of select="document($doc)/translation/texts/item[@name='Pedidos_retrasados_4dias']/node()"/></td><td class="textRight" ><xsl:value-of select="/EvaluacionProveedor/INDICADORES/PEDIDOS/RETRASADOS4DIAS" /></td></tr>
			<tr ><td class="labelLeft" ><xsl:value-of select="document($doc)/translation/texts/item[@name='Pedidos_retrasados_5dias_omas']/node()"/></td><td class="textRight" ><xsl:value-of select="/EvaluacionProveedor/INDICADORES/PEDIDOS/RETRASADOS5DIASOMAS" /></td></tr>
			</table>
			<br/>
			<br/>
        </div>
        ...
        <div class="divLeft marginLeft200" id="TablaRetrasos">
			<table class="w500px" cellspacing="2px" cellpadding="2px">
			<tr ><td class="textLeft"  colspan="2"><strong><xsl:value-of select="document($doc)/translation/texts/item[@name='licitaciones']/node()"/></strong></td></tr>
			<tr ><td class="labelLeft w250px"><xsl:value-of select="document($doc)/translation/texts/item[@name='Licitaciones_informadas']/node()"/></td><td class="textRight" ><xsl:value-of select="/EvaluacionProveedor/INDICADORES/LICITACIONES/INFORMADAS" /></td></tr>
			<tr ><td class="labelLeft" ><xsl:value-of select="document($doc)/translation/texts/item[@name='Licitaciones_no_informadas']/node()"/></td><td class="textRight" ><xsl:value-of select="/EvaluacionProveedor/INDICADORES/LICITACIONES/NOOFERTADAS" /></td></tr>
			<tr ><td class="labelLeft" ><xsl:value-of select="document($doc)/translation/texts/item[@name='Licitaciones_adjudicadas']/node()"/></td><td class="textRight" ><xsl:value-of select="/EvaluacionProveedor/INDICADORES/LICITACIONES/ADJUDICADAS" /></td></tr>
			</table>
			<br/>
			<br/>
        </div>
		...
		<span class="tituloTabla"><xsl:value-of select="document($doc)/translation/texts/item[@name='Pedidos']/node()"/>&nbsp;&nbsp;&nbsp;
			<a id="btnOcultarPedidos" href="javascript:OcultarPedidos();" class="btnNormal"><xsl:value-of select="document($doc)/translation/texts/item[@name='ocultar']/node()"/></a>
			<a id="btnMostrarPedidos" href="javascript:MostrarPedidos();" class="btnNormal oculto"><xsl:value-of select="document($doc)/translation/texts/item[@name='mostrar']/node()"/></a>
		</span>
		<br/>
		<br/>
        </div>

        <div id="divTodosPedidos" class="tabela tabela_redonda">
		<table cellspacing="6px" cellpadding="6px">
		<thead class="cabecalho_tabela">
			<tr class="subTituloTabla" >
				<th class="w1px">&nbsp;</th>
				<th class="w50px"><xsl:value-of select="document($doc)/translation/texts/item[@name='Codigo']/node()"/></th>
				...
				<th class="w50px"><xsl:value-of select="document($doc)/translation/texts/item[@name='fecha_pedido']/node()"/></th>
				<th class="w50px"><xsl:value-of select="document($doc)/translation/texts/item[@name='Fecha_acep']/node()"/></th>
				<th class="w50px"><xsl:value-of select="document($doc)/translation/texts/item[@name='Fecha_envio']/node()"/></th>
				<th class="w50px"><xsl:value-of select="document($doc)/translation/texts/item[@name='fecha_entrega_prevista']/node()"/></th>
				<th class="w50px"><xsl:value-of select="document($doc)/translation/texts/item[@name='fecha_entrega_real']/node()"/></th>
				<th class="w50px"><xsl:value-of select="document($doc)/translation/texts/item[@name='urgente']/node()"/></th>
				<th class="w50px"><xsl:value-of select="document($doc)/translation/texts/item[@name='retrasado']/node()"/></th>
				<th class="w50px"><xsl:value-of select="document($doc)/translation/texts/item[@name='parcial']/node()"/></th>
				<th class="w50px"><xsl:value-of select="document($doc)/translation/texts/item[@name='reclamaciones']/node()"/></th>
				<th class="w50px"><xsl:value-of select="document($doc)/translation/texts/item[@name='importe']/node()"/></th>
				<th class="w1px">&nbsp;</th>
			</tr>
		</thead>
		<!--	Cuerpo de la tabla	-->
