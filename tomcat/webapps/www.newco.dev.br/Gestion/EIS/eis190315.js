...
function globalEvents(){
	...
	// Si se cambia la seleccion del desplegable de Anno => Recargamos la página haciendo peticion a EISCambioAnyo.xsql (sin pasar valor de los desplegbales)
