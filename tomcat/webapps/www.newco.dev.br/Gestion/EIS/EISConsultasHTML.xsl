...
<!--
	...
	Ultima revision: 31ene22 14:15 EISConsultas_310522.js
+-->
...
<style>
	...
	<script type="text/javascript" src="http://www.newco.dev.br/Gestion/EIS/EISConsultas_310522.js"></script>
	...
	<xsl:param name="doc"/>
		...
		<div id="pestanas">
			<ul class="Pestannas">
				...
				<!--	3feb20 Quitamos este bloque, se utilizaba poco y consumía mucho
		...
		<td>
			<div class="divLeft" style="margin-top:20px">
				<div class="btnNormal btnAnchoMedio"><!--	Estos "div" son necesarios para fijar el ancho del botón	-->
				<a href="javascript:MostrarPagPersonalizada('http://www.newco.dev.br/Gestion/EIS/EISBasico.xsql?IDCONSULTA=COPedidosPorEmpEur','Análisis',100,80,0,-50);">
				...
				<xsl:when test="/EIS_CONSULTAS/CUADROPRINCIPALEIS/MVM or /EIS_CONSULTAS/CUADROPRINCIPALEIS/MVMB or /EIS_CONSULTAS/CUADROPRINCIPALEIS/EMPRESA">
					...
					<br/>
					<div class="btnNormal btnAnchoMedio">
					<!--<a href="javascript:MostrarPagPersonalizada('http://www.newco.dev.br/Gestion/EIS/ClasificacionProveedoresEIS.xsql','Clasificación proveedores',100,80,0,-50);">-->
					<a href="javascript:MostrarPagPersonalizada('http://www.newco.dev.br/Gestion/EIS/IndicadoresProveedoresEIS.xsql','Indicadores proveedores',100,80,0,-50);">
					...
					<xsl:if test="/EIS_CONSULTAS/CUADROPRINCIPALEIS/TIENE_HISTORICOS_POR_CENTRO">
						<div class="btnNormal btnAnchoMedio">
						<a href="javascript:MostrarPagPersonalizada('http://www.newco.dev.br/ProcesosCdC/CatalogoPrivado/HistoricosPorCentro.xsql?IDEMPRESA={/EIS_CONSULTAS/CUADROPRINCIPALEIS/IDEMPRESA}','Clasificación proveedores',100,80,0,-50);">
		...
		<td style="width:1200px">
        	<div id="actividadMensualBox" class="eisBox" style="float:left;width:100%;">
				<label><xsl:value-of select="document($doc)/translation/texts/item[@name='indicador']/node()"/>:</label>&nbsp;<select style="height:25px;font-size:18px;width:300px;" id="IDINDICADORMENSUAL" name="IDINDICADORMENSUAL" onchange="javascript:CambioIndicador('MENSUAL');"/><br/>
				<canvas id="actMensual" width="1200" height="600"></canvas>
        	</div><!--fin de actividadMensualBox-->
			
        	<div id="actividadDiariaBox" class="eisBox" style="float:left;width:100%;display:none;">
				<label><xsl:value-of select="document($doc)/translation/texts/item[@name='indicador']/node()"/>:</label>&nbsp;<select style="height:25px;font-size:18px;width:300px;" id="IDINDICADORDIARIO" name="IDINDICADORDIARIO" onchange="javascript:CambioIndicador('DIARIO');"/><br/>
				<canvas id="actDiaria" width="1200" height="600"></canvas>
		...
		<td class="textoResaltado">
			...
			&nbsp;&nbsp;&nbsp;*&nbsp;<a class="enlaceResaltado" href="http://www.newco.dev.br/Gestion/EIS/AnalisisABCPedidos.xsql" target="_blank"><xsl:value-of select="document($doc)/translation/texts/item[@name='Analisis_pedidos_ABC']/node()"/></a><br/>
			&nbsp;&nbsp;&nbsp;*&nbsp;<a class="enlaceResaltado" href="http://www.newco.dev.br/Personal/BandejaTrabajo/PedidosPorProveedor.xsql" target="_blank"><xsl:value-of select="document($doc)/translation/texts/item[@name='Pedidos_por_proveedor_y_centro']/node()"/></a><br/>
			&nbsp;&nbsp;&nbsp;*&nbsp;<a class="enlaceResaltado" href="http://www.newco.dev.br/Gestion/EIS/ResumenPedidosPorProveedor.xsql" target="_blank"><xsl:value-of select="document($doc)/translation/texts/item[@name='Resumen_pedidos_por_proveedor']/node()"/></a><br/>
			&nbsp;&nbsp;&nbsp;*&nbsp;<a class="enlaceResaltado" href="http://www.newco.dev.br/Gestion/EIS/PedidosPorProducto.xsql" target="_blank"><xsl:value-of select="document($doc)/translation/texts/item[@name='Pedidos_por_producto']/node()"/></a><br/>
	...
	<div class="divLeft margin25">
		...
		<div class="divLeft30nopa">
			...
			<tr class="sinLinea">
					<td><p><img src="http://www.newco.dev.br/images/listNaranja.gif"/></p></td>
					<td colspan="4">
							<p><strong><a style="text-decoration:none;" href="javascript:MostrarPagPersonalizada('http://www.newco.dev.br/Gestion/EIS/ClasificacionProveedoresEIS.xsql','Clasificación proveedores',100,80,0,-50);">
...
<xsl:template match="NOTICIAS">
	...
	<input type="hidden" name="NOTICIAS_DESTACADAS" id="NOTICIAS_DESTACADAS" value="{$destacar}"/>
	...
	<table>
		...
		<xsl:for-each select="NOTICIA">
			<input type="hidden" name="TITNOTICIA_{ID}" id="TITNOTICIA_{ID}" value="TITULO"/>
			<input type="hidden" name="CUERPONOTICIA_{ID}" id="CUERPONOTICIA_{ID}" value="CUERPO"/>
			<tr class="conhover">
				<td>
