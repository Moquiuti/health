...
//	Ultima revisión ET 8jun23 10:00 LicitacionV2_2022_080623.js
...
function AbrirProducto(Pos, Foco)
{
	...
	else 
	{
		...
		if (arrProductos[Pos].Entregas!='')
		{
			linDatosProd=linDatosProd.replace('[PROG_ENTREGAS]','<p><a href="javascript:EntregasProducto('+Pos+');"><img src="http://www.newco.dev.br/images/2022/icones/calendar-clock.png" class="valignM" title="'+str_ProgEntregas+': '+arrProductos[Pos].Entregas.replaceAll('#',', ').replaceAll('|',':')+'"/></a>&nbsp;</p>');
		}
		else
