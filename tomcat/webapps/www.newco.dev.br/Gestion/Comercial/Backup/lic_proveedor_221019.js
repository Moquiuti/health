...
//	Ultima revisión ET 22oct10 11:20
...
function PreparaLineaProducto(numProd, contLinea)
{
	...
	//				thisCell += '<img src="" class="static"/>';
		...
		{
			//	en caso de forzar caja, recordamos la unidad por lote para el precio
			thisMacro = '1 '+arrProductos[ColumnaOrdenadaProds[numProd]].UdBasica;
