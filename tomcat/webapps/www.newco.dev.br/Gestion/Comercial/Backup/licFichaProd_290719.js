...
//	Ultima revision ET 29jul19 17:30
...
function SeleccionadaOferta (ID)
{
	...
	//solodebug 
console.log('SeleccionadaOferta: ID'+ID+' MostrarMotivo:'+MostrarMotivoSeleccion+' PrecioOfertaActual:'+gl_PrecioOfertaActual+' MejorPrecio:'+gl_MejorPrecio+' CantidadPendiente:'+CantidadPendiente+ ' #ADJUD_'+ID+' checked:'+jQuery("#ADJUD_"+ID).prop("checked"));
