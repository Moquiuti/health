			...
			success: function(objeto){
				...
				if(data.ProductosLicitacion.ListaProductosOfertas.length > 0){
					jQuery.each(data.ProductosLicitacion.ListaProductosOfertas, function(key, producto){
						...
						if ((arrProductos[fila].Ofertas[PosProvActual/*columna*/].UdsXLote=='0')&&(producto.PrecioOfe=='0,0000'))
...
function NoIniciarLicitacion(IDEstado){
	...
	if (provsInformados == 'S' /*&& prodsInformados == 'S' 13set16 FALLA CON PIONIER, REVISAR */ && (isLicAgregada == 'N' || NumCentrosEnLicitacion>0)){		//	2set16	Comprueba también que tenga centros
