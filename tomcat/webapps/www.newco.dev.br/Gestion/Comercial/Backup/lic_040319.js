...
function MostrarFloatingBox(){
	...
	jQuery.each(arrConsumoProvs, function(key, consumoProv){
		console.log('MostrarFloatingBox.Control proveedores seleccionados. Prov:('+consumoProv.IDProvLic+')'+consumoProv.NombreCorto+'. ofertasAdj:'+consumoProv.OfertasAdj+'->0');	//21jul18
