...
function NoIniciarLicitacion(IDEstado){
	...
	//	Para licitaciones agregadas quitamos este control
	if(isLicAgregada == 'N')
	{
		for (j=0;((j<arrProductos.length) && (prodsInformados=='S'));++j)
		{
			...
			console.log('NoIniciarLicitacion. Comprobando producto:'+j+' Ud.Basica:'+arrProductos[j].UdBasica+' Cant:'+arrProductos[j].Cantidad);
