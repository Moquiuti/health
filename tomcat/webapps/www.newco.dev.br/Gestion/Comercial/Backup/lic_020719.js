...
//	Ultima revisión ET 21jun19 09:00
...
function dibujaTablaProveedoresADJ(){
	...
	if(totalProvs > 0){
		for(var i=0; i<totalProvs; i++)
		{
			if ((arrProveedores[ColumnaOrdenadaProvs[i]].IDEstadoProv=='INF')||(arrProveedores[ColumnaOrdenadaProvs[i]].IDEstadoProv=='CONT')||(SoloProvInformados=='N'))
			{
