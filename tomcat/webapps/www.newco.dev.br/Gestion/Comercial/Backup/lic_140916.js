//	22/2/16 ET Prueba problemas adjudicacion, eliminadas del código
...
//	29/8/16	ET Incluir info documentación proveedor
//	31/8/16 ET Reducir columnas en pestaña proveedores, incluir linea de separación, varios cambios menores
...
//	9/9/16	ET Mostrar únicamente los proveedores con ofertas en la pestaña de productos
//	ultima revision: 12/9/16 11:43
...
function onloadEvents(){
	...
	//	14set16	Cargamos los datos de ofertas de los proveedores informados
	cargaDatosOfertas();
	...
	jQuery("#pes_lDatosGenerales").click(function(){
		...
		if(chk){
			if(lang == 'spanish'){
				jQuery("#pes_lDatosGenerales > img").attr('src',"/images/botonDatosGenerales1.gif");
				if(jQuery("#pes_lInfoPedido").length)	jQuery("#pes_lInfoPedido > img").attr('src',"/images/botonInfoPedido.gif");
				jQuery("#pes_lProductos > img").attr('src',"/images/botonProductos.gif");
				jQuery("#pes_lProductosCompacta > img").attr('src',"/images/botonAnalisis.gif");
				jQuery("#pes_lProveedores > img").attr('src',"/images/botonProveedores.gif");
				jQuery("#pes_lUsuarios > img").attr('src',"/images/botonUsuarios.gif");
				if(jQuery("#pes_lCentros").length)	jQuery("#pes_lCentros > img").attr('src',"/images/botonCentros.gif");
				jQuery("#pes_lInforme > img").attr('src',"/images/botonInforme.gif");
			}else{
				jQuery("#pes_lDatosGenerales > img").attr('src',"/images/botonDatosGenerales1-BR.gif");
				if(jQuery("#pes_lInfoPedido").length)	jQuery("#pes_lInfoPedido > img").attr('src',"/images/botonInfoPedido-BR.gif");
				jQuery("#pes_lProductos > img").attr('src',"/images/botonProductos-BR.gif");
				jQuery("#pes_lProductosCompacta > img").attr('src',"/images/botonAnalisis-BR.gif");
				jQuery("#pes_lProveedores > img").attr('src',"/images/botonProveedores-BR.gif");
				jQuery("#pes_lUsuarios > img").attr('src',"/images/botonUsuarios-BR.gif");
				if(jQuery("#pes_lCentros").length)	jQuery("#pes_lCentros > img").attr('src',"/images/botonCentros.gif");
				jQuery("#pes_lInforme > img").attr('src',"/images/botonInforme-BR.gif");
			}
	...
	jQuery("#pes_lInfoPedido").click(function(){
		...
		if(chk){
			if(lang == 'spanish'){
				jQuery("#pes_lDatosGenerales > img").attr('src',"/images/botonDatosGenerales.gif");
				jQuery("#pes_lInfoPedido > img").attr('src',"/images/botonInfoPedido1.gif");
				jQuery("#pes_lProductos > img").attr('src',"/images/botonProductos.gif");
				jQuery("#pes_lProductosCompacta > img").attr('src',"/images/botonAnalisis.gif");
				jQuery("#pes_lProveedores > img").attr('src',"/images/botonProveedores.gif");
				jQuery("#pes_lUsuarios > img").attr('src',"/images/botonUsuarios.gif");
				...
				jQuery("#pes_lDatosGenerales > img").attr('src',"/images/botonDatosGenerales-BR.gif");
				jQuery("#pes_lInfoPedido > img").attr('src',"/images/botonInfoPedido1-BR.gif");
				jQuery("#pes_lProductos > img").attr('src',"/images/botonProductos-BR.gif");
				jQuery("#pes_lProductosCompacta > img").attr('src',"/images/botonAnalisis-BR.gif");
				jQuery("#pes_lProveedores > img").attr('src',"/images/botonProveedores-BR.gif");
				jQuery("#pes_lUsuarios > img").attr('src',"/images/botonUsuarios-BR.gif");
	...
	jQuery("#pes_lProductos").click(function(){
		if(lang == 'spanish'){
			jQuery("#pes_lDatosGenerales > img").attr('src',"/images/botonDatosGenerales.gif");
			if(jQuery("#pes_lInfoPedido").length)	jQuery("#pes_lInfoPedido > img").attr('src',"/images/botonInfoPedido.gif");
			jQuery("#pes_lProductos > img").attr('src',"/images/botonProductos1.gif");
			jQuery("#pes_lProductosCompacta > img").attr('src',"/images/botonAnalisis.gif");
			jQuery("#pes_lProveedores > img").attr('src',"/images/botonProveedores.gif");
			jQuery("#pes_lUsuarios > img").attr('src',"/images/botonUsuarios.gif");
			if(jQuery("#pes_lCentros").length)	jQuery("#pes_lCentros > img").attr('src',"/images/botonCentros.gif");
			...
			jQuery("#pes_lDatosGenerales > img").attr('src',"/images/botonDatosGenerales-BR.gif");
			if(jQuery("#pes_lInfoPedido").length)	jQuery("#pes_lInfoPedido > img").attr('src',"/images/botonInfoPedido-BR.gif");
			jQuery("#pes_lProductos > img").attr('src',"/images/botonProductos1-BR.gif");
			jQuery("#pes_lProductosCompacta > img").attr('src',"/images/botonAnalisis-BR.gif");
			jQuery("#pes_lProveedores > img").attr('src',"/images/botonProveedores-BR.gif");
			jQuery("#pes_lUsuarios > img").attr('src',"/images/botonUsuarios-BR.gif");
			if(jQuery("#pes_lCentros").length)	jQuery("#pes_lCentros > img").attr('src',"/images/botonCentros.gif");
	...
	jQuery("#pes_lProductosCompacta").click(function(){
		...
		if(chk){
			if(lang == 'spanish'){
				...
				if(jQuery("#pes_lInfoPedido").length)	jQuery("#pes_lInfoPedido > img").attr('src',"/images/botonInfoPedido.gif");
				jQuery("#pes_lProductos > img").attr('src',"/images/botonProductos.gif");
				jQuery("#pes_lProductosCompacta > img").attr('src',"/images/botonAnalisis1.gif");
				jQuery("#pes_lProveedores > img").attr('src',"/images/botonProveedores.gif");
				jQuery("#pes_lUsuarios > img").attr('src',"/images/botonUsuarios.gif");
				jQuery("#pes_lInforme > img").attr('src',"/images/botonInforme.gif");
			}else{
				...
				if(jQuery("#pes_lInfoPedido").length)	jQuery("#pes_lInfoPedido > img").attr('src',"/images/botonInfoPedido-BR.gif");
				jQuery("#pes_lProductos > img").attr('src',"/images/botonProductos-BR.gif");
				jQuery("#pes_lProductosCompacta > img").attr('src',"/images/botonAnalisis1-BR.gif");
				jQuery("#pes_lProveedores > img").attr('src',"/images/botonProveedores-BR.gif");
				jQuery("#pes_lUsuarios > img").attr('src',"/images/botonUsuarios-BR.gif");
				jQuery("#pes_lInforme > img").attr('src',"/images/botonInforme-BR.gif");
			}
	...
	jQuery("#pes_lProveedores").click(function(){
		...
		if(chk){
			if(lang == 'spanish'){
				...
				jQuery("#pes_lProductos > img").attr('src',"/images/botonProductos.gif");
				jQuery("#pes_lProductosCompacta > img").attr('src',"/images/botonAnalisis.gif");
				jQuery("#pes_lProveedores > img").attr('src',"/images/botonProveedores1.gif");
				jQuery("#pes_lUsuarios > img").attr('src',"/images/botonUsuarios.gif");
				if(jQuery("#pes_lCentros").length)	jQuery("#pes_lCentros > img").attr('src',"/images/botonCentros.gif");
				jQuery("#pes_lInforme > img").attr('src',"/images/botonInforme.gif");
			}else{
				...
				jQuery("#pes_lProductos > img").attr('src',"/images/botonProductos-BR.gif");
				jQuery("#pes_lProductosCompacta > img").attr('src',"/images/botonAnalisis-BR.gif");
				jQuery("#pes_lProveedores > img").attr('src',"/images/botonProveedores1-BR.gif");
				jQuery("#pes_lUsuarios > img").attr('src',"/images/botonUsuarios-BR.gif");
				if(jQuery("#pes_lCentros").length)	jQuery("#pes_lCentros > img").attr('src',"/images/botonCentros.gif");
				jQuery("#pes_lInforme > img").attr('src',"/images/botonInforme-BR.gif");
			}
	...
	jQuery("#pes_lUsuarios").click(function(){
		...
		if(chk){
			if(lang == 'spanish'){
				...
				jQuery("#pes_lProductosCompacta > img").attr('src',"/images/botonAnalisis.gif");
				jQuery("#pes_lProveedores > img").attr('src',"/images/botonProveedores.gif");
				jQuery("#pes_lUsuarios > img").attr('src',"/images/botonUsuarios1.gif");
				if(jQuery("#pes_lCentros").length)	jQuery("#pes_lCentros > img").attr('src',"/images/botonCentros.gif");
				jQuery("#pes_lInforme > img").attr('src',"/images/botonInforme.gif");
			}else{
				jQuery("#pes_lDatosGenerales > img").attr('src',"/images/botonDatosGenerales-BR.gif");
				...
				jQuery("#pes_lProductosCompacta > img").attr('src',"/images/botonAnalisis-BR.gif");
				jQuery("#pes_lProveedores > img").attr('src',"/images/botonProveedores-BR.gif");
				jQuery("#pes_lUsuarios > img").attr('src',"/images/botonUsuarios1-BR.gif");
				if(jQuery("#pes_lCentros").length)	jQuery("#pes_lCentros > img").attr('src',"/images/botonCentros.gif");
				jQuery("#pes_lInforme > img").attr('src',"/images/botonInforme-BR.gif");
			}
	...
	jQuery("#pes_lCentros").click(function(){
		...
		if(chk){
			if(lang == 'spanish'){
				...
				jQuery("#pes_lProveedores > img").attr('src',"/images/botonProveedores.gif");
				jQuery("#pes_lUsuarios > img").attr('src',"/images/botonUsuarios.gif");
				jQuery("#pes_lCentros > img").attr('src',"/images/botonCentros1.gif");
				jQuery("#pes_lInforme > img").attr('src',"/images/botonInforme.gif");
			}else{
				jQuery("#pes_lDatosGenerales > img").attr('src',"/images/botonDatosGenerales-BR.gif");
				if(jQuery("#pes_lInfoPedido").length)	jQuery("#pes_lInfoPedido > img").attr('src',"/images/botonInfoPedido-BR.gif");
	...
	jQuery("#pes_lInforme").click(function(){
		...
		if(chk){
			if(lang == 'spanish'){
				...
				jQuery("#pes_lUsuarios > img").attr('src',"/images/botonUsuarios.gif");
				if(jQuery("#pes_lCentros").length)	jQuery("#pes_lCentros > img").attr('src',"/images/botonCentros.gif");
				jQuery("#pes_lInforme > img").attr('src',"/images/botonInforme1.gif");
			}else{
				jQuery("#pes_lDatosGenerales > img").attr('src',"/images/botonDatosGenerales-BR.gif");
				if(jQuery("#pes_lInfoPedido").length)	jQuery("#pes_lInfoPedido > img").attr('src',"/images/botonInfoPedido-BR.gif");
				jQuery("#pes_lProductos > img").attr('src',"/images/botonProductos-BR.gif");
				...
				jQuery("#pes_lUsuarios > img").attr('src',"/images/botonUsuarios-BR.gif");
				if(jQuery("#pes_lCentros").length)	jQuery("#pes_lCentros > img").attr('src',"/images/botonCentros.gif");
				jQuery("#pes_lInforme > img").attr('src',"/images/botonInforme1-BR.gif");
			}
...
function cargaDatosOfertas()
{
	...
	var mensajeActual=jQuery('#idEstadoLic').html();
		
	//	Recuperamos los datos correctos para los proveedores informados
	for(var i=0; i < arrProveedores.length; i++){

		if (arrProveedores[i].TieneOfertas=='S'){
		
			//lProveedoresConOfertas+=arrProveedores[i].NombreCorto+'('+arrProveedores[i].IDProvLic+') ';
			//if (i<2) alert('cargaDatosOfertasProveedor '+arrProveedores[i].IDProvLic+':'+arrProductos[0].Ofertas[i].IDProvLic);

			jQuery('#idEstadoLic').html(arrProveedores[i].NombreCorto);
			jQuery('#idEstadoLic').show();
			//jQuery('#idEstadoLic').offsetHeight;//show(); el show no parece ser suficiente en desarrollo, según funcone en internet lo mantendremos o no
			cargaDatosOfertasProveedor(arrProveedores[i].IDProvLic);
			
		}
		//else{
		//	lProveedoresSinOfertas+=arrProveedores[i].NombreCorto+' ';
		//}
	}

	jQuery('#idEstadoLic').html(mensajeActual);
	jQuery('#idEstadoLic').show();
	...
	//	for(var i=0; i < arrProveedores.length; i++){
	//
	//		texto+=arrProductos[j].Ofertas[i].IDOferta+' ';
	//	}
	//}
		
	//alert('Proveedores con ofertas:'+lProveedoresConOfertas+'\n\r'+'Proveedores sin ofertas:'+lProveedoresSinOfertas+'\n\rIDs:'+texto);

	//solodebug	
	//alert('arrProductos.length:'+arrProductos.length+' arrProveedores.length:'+arrProveedores.length+' arrConsumoProvs.length:'+ arrConsumoProvs.length);
	//
	//var texto='';
	//
	//for(var i=0; i < arrConsumoProvs.length; i++)
	//{
	//	texto+=i+' '+arrConsumoProvs[i].NombreCorto+' ('+arrConsumoProvs[i].IDProvLic+','+arrConsumoProvs[i].TieneOfertas+') //';
	//}
	//alert('Proveedores cargados. arrConsumoProvs:'+arrConsumoProvs.length+' : '+texto);

	//solodebug	
	//MuestraMatrizOfertas();
}
...
function MuestraMatrizOfertas(){
	...
	for (i=0; i<arrProveedores.length; ++i){
		texto+=arrProveedores[i].NombreCorto+'|';
	}
	texto+='\n\r';
	
	for (j=0; j<arrProductos.length; ++j){
		texto+=arrProductos[j].Nombre+'|';
		for (i=0; i<arrProveedores.length; ++i){
...
function ValidarFormulario(oForm, nombre, flag){
	...
	if(nombre == 'provPublicarOferta'){
		...
		if(ofertaProvInformada != 'S'){
			...
			alert(alrt_faltaInformarOfertas);
		}

		if(!errores && pedidoMinimoInform != 'S'){
			errores++;
			jQuery('#pes_lProductos' ).click();
...
// Peticion ajax que inserta nuevos productos en la tabla lic_productos (por referencia mediante cadena separada por '|')
function AnadirProductos(oForm){
	...
	jQuery.ajax({
		...
		type:	"GET",
		data:	"LIC_ID="+IDLicitacion+"&LISTA_REFERENCIAS="+Referencias+"&TIPOIVA="+TipoIVA+"&_="+d.getTime(),
...
function modificaProducto(idProdLic,idProd,refProd,descProd,unBaProd,cantProd,precioProd,precioObj,ivaProd,estado){
	...
	if (Ejecutar){
		jQuery.ajax({
			cache:	false,
			url:	'ModificaEstadoProducto.xsql',
			type:	"GET",
...
function ActualizarProductos(eliminarOfertas){
	var listaProductos= '', sendProductos, IDTablaProds, thisRowID, thisPosArr;
	var d = new Date();
	...
	for(var loop = 1; loop <= loops; loop++){
		...
		jQuery(IDTablaProds + " tbody tr").each(function(index, element){
			...
			if(index >= lenAuxIni && index < lenAuxFin){
				...
				listaProductos += IDLicProd + '|' +				//p_IDProductoEstandar
		...
		jQuery.ajax({
			...
			success: function(objeto){
				...
				if(data.ProductosActualizados.estado == 'OK'){
					...
					// Recuperamos los datos de los productos via ajax
					if(estadoLicitacion == 'EST' && loop == loops){
						recuperaDatosProductos(1);
...
function cargaDatosOfertasProveedor(LicProvID){
	...
	//if (LicProvID==5085) alert ('Proveedor 5085 en columna '+columna);
	
	jQuery.ajax({
		cache:	false,
		url:	'RecuperaOfertaProductos.xsql',
		type:	"GET",
		...
		success: function(objeto){
			...
			if(data.ProductosLicitacion.ListaProductosOfertas.length > 0){
				jQuery.each(data.ProductosLicitacion.ListaProductosOfertas, function(key, producto){
					...
					arrProductos[fila].Ofertas[columna].NoInformada	= producto.NoInformada;
...
function recuperaDatosCompraPorCentro(){
	...
	jQuery.ajax({
		cache:	false,
		url:	'RecuperaDatosCompraPorCentro.xsql',
		type:	"GET",
...
function AnadirSeleccionProveedor(oForm){
	...
	jQuery.ajax({
		cache:	false,
		url:	'NuevaSeleccionProveedor.xsql',
		type:	"GET",
...
function modificaUsuario(idUsEliminar,Estado){
	...
	jQuery.ajax({
		cache:	false,
		url:	'ModificaEstadoUsuario.xsql',
		type:	"GET",
...
function publicarPedidoMinimo(oForm){
	...
	jQuery.ajax({
		cache:	false,
		url:	'PedidoMinimoProveedor.xsql',
		type:	"GET",
...
function publicarOferta(oForm){
	...
	jQuery.ajax({
		cache:	false,
		url:	'CambiarEstadoProveedor.xsql',
		type:	"GET",
...
function validarBotonPublicarOferta(){
	if(ofertaProvInformada == 'S' && pedidoMinimoInform == 'S'){
		jQuery('#botonPublicarOferta a').removeClass("grey");
...
function CambioEstadoLicitacion(IDEstado){
	...
	if (enviarCambio){
		jQuery.ajax({
			cache:	false,
			url:	'CambiarEstadoLicitacion.xsql',
			type:	"GET",
...
function dibujaTablaProductosCENTRO(){
	...
	if(totalProductos > 0){
		for(var i=0; i<totalProductos; i++){
			...
			thisMacro = thisMacro.replace('#CLASS#', 'cantidad');
			...
			thisMacro	= macroImagen3.replace('#SRC#', 'http://www.newco.dev.br/images/guardar.gif');
...
//				thisCell += '<img src="" class="static"/>';
			...
			thisCell = cellStart;
			if(IDPais != '55'){
				thisMacro = macroInputText.replace('#NAME#', 'RefProv_' + (arrProductos[ColumnaOrdenadaProds[i]].linea - 1));
			...
			// Celda/Columna Descripcion
			thisCell = cellStart;
			thisMacro = macroInputText.replace('#NAME#', 'Desc_' + (arrProductos[ColumnaOrdenadaProds[i]].linea - 1));
			...
			// Celda/Columna Marca
			thisCell = cellStart;
			thisMacro = macroInputText.replace('#NAME#', 'Marca_' + (arrProductos[ColumnaOrdenadaProds[i]].linea - 1));
			...
			// Celda/Columna UdsXLote
			thisCell = cellStart;
			thisMacro = macroInputText.replace('#NAME#', 'UdsLote_' + (arrProductos[ColumnaOrdenadaProds[i]].linea - 1));
			thisMacro = thisMacro.replace('#ID#', 'UdsLote_' + (arrProductos[ColumnaOrdenadaProds[i]].linea - 1));
			thisMacro = thisMacro.replace('#CLASS#', 'unidades');
			...
			thisCell = cellStart;
			thisMacro = macroInputText.replace('#NAME#', 'Precio_' + (arrProductos[ColumnaOrdenadaProds[i]].linea - 1));
			thisMacro = thisMacro.replace('#ID#', 'Precio_' + (arrProductos[ColumnaOrdenadaProds[i]].linea - 1));
			thisMacro = thisMacro.replace('#CLASS#', 'precio');
			thisMacro = thisMacro.replace('#SIZE#', '8');
			thisMacro = thisMacro.replace('#MAXLENGTH#', '8');
			if(isLicPorProducto == 'S'){
...
//				thisCell += '<img src="" class="static"/>';
			...
			if(isAutor == 'S' && estadoLicitacion != 'CONT'){
				...
				thisMacro	= thisMacro.replace('#CLASS#', 'udbasica');
			...
			if(mostrarPrecioIVA == 'S'){
				if(isAutor == 'S' && estadoLicitacion != 'CONT'){
					...
					thisMacro	=	thisMacro.replace('#CLASS#', 'preciorefiva');
					thisMacro	=	thisMacro.replace('#SIZE#', '8');
					...
					thisMacro	=	thisMacro.replace('#CLASS#', 'precioref');
					thisCell	+=	thisMacro;
				}else{
			...
			if(mostrarPrecioIVA == 'S'){
				if(isAutor == 'S' && estadoLicitacion != 'CONT'){
					...
					thisMacro	=	thisMacro.replace('#CLASS#', 'precioobjiva');
					thisMacro	=	thisMacro.replace('#SIZE#', '8');
					thisMacro	=	thisMacro.replace('#MAXLENGTH#', '10');
					thisCell	+=	thisMacro;
					...
					thisMacro	=	thisMacro.replace('#CLASS#', 'precioobj');
					thisCell	+=	thisMacro;
				}else{
			...
			for(var j=0; j<arrProductos[ColumnaOrdenadaProds[i]].Ofertas.length; j++){
				...
				//solodebug	if (j=81) alert(j+' '+arrProductos[ColumnaOrdenadaProds[i]].IDProdLic+' '+arrProductos[ColumnaOrdenadaProds[i]].Ofertas[j].IDProvLic+' '+arrProductos[ColumnaOrdenadaProds[i]].Ofertas[j].IDOferta);
				...
				if (arrConsumoProvs[j].TieneOfertas=='S'){	//	COmprueba proveedor con ofertas /Mantenimiento/LICITACION/PRODUCTOSLICITACION/PROVEEDORESLICITACION/PROVEEDOR/TIENE_OFERTAS
					...
					//solodebug	
					//alert(arrConsumoProvs[j].NombreCorto+' ofertas:'+arrConsumoProvs[j].TieneOfertas);
					...
					// Si el proveedor ha informado de algunas ofertas, pero esta esta vacia
						...
						if((estadoLicitacion=='CURS' || estadoLicitacion=='INF') && isLicPorProducto=='S' && isAutor=='S'){
							...
							thisMacro = thisMacro.replace('#CLASS#', 'RADIO_' + (arrProductos[ColumnaOrdenadaProds[i]].linea - 1));
							thisMacro = thisMacro.replace('#VALUE#', arrProductos[ColumnaOrdenadaProds[i]].Ofertas[j].IDOferta);
							if(arrProductos[ColumnaOrdenadaProds[i]].Ofertas[j].OfertaAdjud == 'S'){
								...
								items['OfertaID']	= (arrProductos[ColumnaOrdenadaProds[i]].Ofertas[j].IDOferta);
							...
							thisMacro = macroInputHidden.replace('#NAME#', 'Prov_' + arrProductos[ColumnaOrdenadaProds[i]].Ofertas[j].IDOferta);
							thisMacro = thisMacro.replace('#ID#', 'Prov_' + arrProductos[ColumnaOrdenadaProds[i]].Ofertas[j].IDOferta);
	...
	*/
							...
							if(arrProductos[ColumnaOrdenadaProds[i]].Ofertas[j].PrecioColor == 'Naranja'){
								thisCell += spanStartClass.replace('#CLASS#', 'oferta orange');
...
//			console.log(producto.Ofertas[posArr].IDOferta + ': yes, key: ' + key);
			MejorOfertaID = producto.Ofertas[posArr].IDOferta;
...
function dibujarFilaConsumoProdEST(){
	...
	if(isAutor == 'S'){
		htmlTFOOT += rowStartID.replace('#ID#', 'botonRow');
...
function dibujaTablaProveedores(){
	if(estadoLicitacion == 'EST' || estadoLicitacion == 'CURS' || estadoLicitacion == 'INF'){
...
*/
			...
			if(isAutor == 'S'){
				if(estadoLicitacion == 'EST'){
					...
					// Si el prov ha informado oferta, se puede volver atras para pedir otra oferta
...
function comentarioInterno(){
	MostrarPagPersonalizada('ConversacionLicitacion.xsql?IDLICITACION='+IDLicitacion+'&IDUSUARIOCLIENTE='+IDUsuario,'Conversacion Licitacion',70,70,0,0);
}

// Funcion para abrir la ficha de un producto de la licitacion en un pop-up
function FichaProductoLic(IDProdLic){
	MostrarPagPersonalizada('FichaProductoLicitacion.xsql?LIC_PROD_ID='+IDProdLic+'&LIC_ID='+IDLicitacion,'Ficha Producto Licitacion',100,100,0,0);
}

// Funcion para abrir la ficha de una empresa en un pop-up
function FichaEmpresa(IDEmpresa){
	MostrarPagPersonalizada('http://www.newco.dev.br/Administracion/Mantenimiento/Empresas/EMPDetalle.xsql?EMP_ID='+IDEmpresa+'&ESTADO=CABECERA','Detalle Empresa',100,80,0,0);
}

// Funcion para abrir las ofertas de un proveedor en pop-up para imprimir
function imprimirOferta(IDProvLic){
	MostrarPagPersonalizada('ImprimirOferta.xsql?LIC_ID='+IDLicitacion+'&LIC_PROV_ID='+IDProvLic,'',100,100,0,0);
}
...
function conversacionProveedor(ProvID, UsuID, UsuProvID, NombreProv){
	MostrarPagPersonalizada('ConversacionLicitacion.xsql?IDLICITACION='+IDLicitacion+'&IDPROVEEDOR='+ProvID+'&IDUSUARIOCLIENTE='+UsuID+'&IDUSUARIOPROV='+UsuProvID+'&NOMBREPROV='+NombreProv,'',70,70,0,0);
}
...
function conversacionProveedor2(posArr){
	...
	jQuery.ajax({
		cache:	false,
		url:	'ConversacionLicitacionAJAX.xsql',
		type:	"GET",
...
function guardarConversProv(){
	...
	if(!errores){
		jQuery.ajax({
			cache:	false,
			url:	'ConversacionLicitacionSaveAJAX.xsql',
			type:	"POST",
...
function modificaEstadoProveedor(IDProve, IDEstado){
	...
	jQuery.ajax({
		cache:	false,
		url:	'ModificaEstadoProveedor.xsql',
		type:	"GET",
...
function ActualizarFechaDecision(){
	...
	if(!errores){
		jQuery.ajax({
			cache:	false,
			url:	'ModificarFechaDecision.xsql',
			type:	"GET",
...
function ActualizarFechasReales(){
	...
	jQuery.ajax({
		cache:	false,
		url:	'ModificarFechasReales.xsql',
		type:	"GET",
...
function SeleccionarMejoresPrecios(){
	...
	jQuery.each(arrProductos, function(key, producto){
		...
		if(MejorColumna != -1){
			MejorOfertaID = arrProductos[key].Ofertas[MejorColumna].IDOferta;
...
function recalcularFloatingBox(obj, flagPedMin){
	var thisPosArr, thisOfertaID, PrecioHist, Cantidad, wasChecked, isChecked, oldPrecioOferta = 0, newPrecioOferta = 0, oldOfertaID = null;
	var thisPosArrProv, oldPosArrProv = null;
	var oldConsumoPot = 0, newConsumoPot, oldConsumoPrev = 0, newConsumoPrev, oldAhorro = 0, newAhorro, oldNumOfertas = 0, newNumOfertas, oldNumProvsAdj = 0, newNumProvsAdj = 0;
	var chckPedMinimo = false, valAux;
	...
	thisPosArr	= jQuery(obj).attr('class').replace('RADIO_', '');
	...
	for(var j=0; j<arrProductos[thisPosArr].Ofertas.length; j++){
		if(arrProductos[thisPosArr].Ofertas[j].IDOferta == thisOfertaID){
	...
	if(isChecked){
		...
		arrRadios[(i-firstProduct)].OfertaID = arrProductos[thisPosArr].Ofertas[j].IDOferta;
...
function ActualizarCantidades(string){
	...
	jQuery.ajax({
		cache:	false,
		url:	'ActualizarCantidadesAJAX.xsql',
		type:	"POST",
		async:	false,
...
function validarPedidosMinimosAgr(){
	...
	jQuery.ajax({
		cache:	false,
		url:	'licComprobarPedidoMinimoAJAX.xsql',
		type:	"POST",
		async:	false,
		data:	"LIC_ID="+IDLicitacion+"&_="+d.getTime(),
		error: function(objeto, quepaso, otroobj){
...
function ComprobarCatalogoProveedor(){
	...
	jQuery.ajax({
		cache:	false,
		url:	'ComprobarCatalogoProveedor.xsql',
		type:	"GET",
		data:	"LIC_ID="+IDLicitacion+"&_="+d.getTime(),
		contentType: "application/xhtml+xml",
		beforeSend: function(){
...
function InsertarEnCatalogoProveedor(){
	...
	jQuery.ajax({
		cache:	false,
		url:	'InsertarEnCatalogoProveedor.xsql',
		type:	"GET",
		data:	"LIC_ID="+IDLicitacion+"&_="+d.getTime(),
		contentType: "application/xhtml+xml",
		error: function(objeto, quepaso, otroobj){
...
function ComprobarCatalogoCliente(){
	...
	jQuery.ajax({
		cache:	false,
		url:	'ComprobarCatalogoCliente.xsql',
		type:	"GET",
		data:	"LIC_ID="+IDLicitacion+"&_="+d.getTime(),
		contentType: "application/xhtml+xml",
		beforeSend: function(){
...
function CrearLicitacionHija(){
	...
	jQuery.ajax({
		cache:	false,
		url:	'CrearLicitacionHijaAJAX.xsql',
		type:	"GET",
		data:	"LIC_ID="+IDLicitacion+"&_="+d.getTime(),
		contentType: "application/xhtml+xml",
		beforeSend: function(){
...
function guardarDatosInforme(){
	...
	jQuery.ajax({
		cache:	false,
		url:	'GuardarDatosInformeAJAX.xsql',
		type:	"GET",
	...
	jQuery.each(arrProductos, function(key, producto){
		if(producto.IDProdLic == IDProdLic){
			...
			jQuery.each(producto.Ofertas, function(key, oferta){
				if(oferta.IDOferta == IDOfertaLic){
...
function guardarCamposAvanzadosProd(){
	...
	if(infoAmpliada != '' || anotaciones != '' || IDDoc != ''){
		jQuery.ajax({
			cache:	false,
			url:	'CamposAvanzadosProdAJAX.xsql',
			type:	"POST",
			async:	false,
...
function guardarContrato(){
  ...
  var d					= new Date();
	...
	jQuery.ajax({
		cache:  false,
    url:    'InformarNuevoContratoAJAX.xsql',
    type:   "GET",
...
function guardarNuevoUsuProv(){
	...
	jQuery.ajax({
		cache:	false,
		url:	'GuardarUsuarioProveedorAJAX.xsql',
		type:	"GET",
...
*/
	...
	if(enviarOferta){
		...
		jQuery.ajax({
			...
			error: function(objeto, quepaso, otroobj){
				jQuery('tr#posArr_' + thisPosArr + ' .resultado').html('<img src="http://www.newco.dev.br/images/error.gif"/>');
				alert('error'+quepaso+' '+otroobj+' '+objeto);
			},
			success: function(objeto){
				var data = eval("(" + objeto + ")");
				...
				if(data.OfertaActualizada.IDOferta > 0){
					jQuery('tr#posArr_' + thisPosArr + ' .resultado').html('<img src="http://www.newco.dev.br/images/recibido.gif"/>');
...
function PublicarDatosCompra()
{
	...
	jQuery.ajax({
		cache:	false,
		url:	'PublicarComprasCentroAJAX.xsql',
		type:	"GET",
...
function verInfoCentros(thisPosArr){
	...
	jQuery.ajax({
		cache:	false,
		url:	'InfoHistoricaCentrosAJAX.xsql',
		type:	"GET",
