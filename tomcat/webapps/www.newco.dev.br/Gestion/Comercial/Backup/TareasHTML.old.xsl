...
<head>
	...
	<xsl:variable name="lang">
		<xsl:choose>
			<xsl:when test="/Tareas/LANG != ''"><xsl:value-of select="/Tareas/LANG"/></xsl:when>
			<xsl:when test="/Tareas/LANGTESTI != ''"><xsl:value-of select="/Tareas/LANGTESTI"/></xsl:when>
...
<body onload="TareasRecientes();">
	...
	<xsl:choose>
        ...
        <form name="Admin" method="post" action="Tareas.xsql">
            ...
            <xsl:if test="/Tareas/INICIO/COMERCIAL or /Tareas/INICIO/MVM or /Tareas/INICIO/MVMB"></xsl:if>
		<table class="infoTable" style="margin-bottom:10px;">
			<tr style="background:#C3D2E9;border-bottom:0px solid #3B5998;">
				<td>
					<p style="font-weight:bold;">
                                            <xsl:call-template name="desplegable">
						<xsl:with-param name="path" select="/Tareas/INICIO/EMPRESAS/field"/>
						<xsl:with-param name="onChange">javascript:CambiarEmpresa();</xsl:with-param>
                                            ...
                                            &nbsp;&nbsp;
                                            <input type="hidden" name="IDPAIS" value="{/Tareas/INICIO/GESTIONCOMERCIAL/IDPAIS}" />
                                            <input type="hidden" name="IDEMPRESAUSUARIO" value="{/Tareas/INICIO/IDEMPRESAUSUARIO}" />
                                            <input type="hidden" name="IDEMPRESA" id="IDEMPRESA">
                                                <xsl:attribute name="value">
                                                    <xsl:choose>
                                                        <xsl:when test="/Tareas/INICIO/EMPRESAS/field/@current != ''"><xsl:value-of select="/Tareas/INICIO/EMPRESAS/field/@current" /></xsl:when>
                                                        <xsl:otherwise><xsl:value-of select="/Tareas/IDEMPRESA" /></xsl:otherwise>
                                                    </xsl:choose>
                                                </xsl:attribute>
                                            </input>
	...
	<div style="background:#fff;float:left;">
			...
			<a href="http://www.newco.dev.br/Administracion/Mantenimiento/Empresas/EMPDetalle.xsql?EMP_ID={/Tareas/INICIO/IDEMPRESA}&amp;ESTADO=CABECERA" style="text-decoration:none;">
				<xsl:choose>
					<xsl:when test="/Tareas/LANG = 'spanish'">
					...
					<xsl:otherwise>
                        ...
                        <xsl:if test="/Tareas/INICIO/IDEMPRESA != '' and (/Tareas/INICIO/COMERCIAL or /Tareas/INICIO/MVM or /Tareas/INICIO/MVMB or /Tareas/INICIO/USUARIO_CDC)">
                                <a href="http://www.newco.dev.br/Administracion/Mantenimiento/Empresas/EMPDetalle.xsql?EMP_ID={/Tareas/INICIO/IDEMPRESA}&amp;ESTADO=CABECERA&amp;ZONA=COND_COMERC_PROV" style="text-decoration:none;">
                                <xsl:choose>
                                <xsl:when test="/Tareas/LANG = 'spanish'">
                        ...
                        <xsl:if test="/Tareas/INICIO/COMERCIAL or /Tareas/INICIO/MVM or /Tareas/INICIO/MVMB">
			<a href="http://www.newco.dev.br/Gestion/Comercial/Seguimiento.xsql?FIDEMPRESA={/Tareas/INICIO/IDEMPRESA}" style="text-decoration:none;">
				<xsl:choose>
					<xsl:when test="/Tareas/LANG = 'spanish'">
			...
			&nbsp;
			<a href="http://www.newco.dev.br/Gestion/Comercial/Tareas.xsql?FIDEMPRESA={/Tareas/INICIO/IDEMPRESA}&amp;FIDRESPONSABLE=-1" style="text-decoration:none;">
				<xsl:choose>
					<xsl:when test="/Tareas/LANG = 'spanish'">
			...
			&nbsp;
                        <xsl:if test="/Tareas/INICIO/IDEMPRESA != '' and (/Tareas/INICIO/MVM or /Tareas/INICIO/MVMB)">
			<a href="http://www.newco.dev.br/Gestion/Comercial/Meddicc.xsql?FIDEMPRESA={/Tareas/INICIO/IDEMPRESA}"  style="text-decoration:none;">
				<xsl:choose>
					<xsl:when test="/Tareas/LANG = 'spanish'">
					...
					<xsl:otherwise>
                        ...
                        &nbsp;
                        <xsl:if test="/Tareas/INICIO/IDEMPRESA != '' and (/Tareas/INICIO/MVM or /Tareas/INICIO/MVMB)">
                                <a href="http://www.newco.dev.br/Administracion/Mantenimiento/Empresas/EMPDetalle.xsql?EMP_ID={/Tareas/INICIO/IDEMPRESA}&amp;ESTADO=CABECERA&amp;ZONA=DOCS" style="text-decoration:none;">
...
<div class="divLeft">
			...
			<xsl:choose>
				<xsl:when test="/Tareas/INICIO/RESULTADO">
					<xsl:value-of select="document($doc)/translation/texts/item[@name='gestion_tareas']/node()"/>:&nbsp;
                                        <xsl:value-of select="substring(/Tareas/INICIO/RESULTADO,0,48)"/>

				</xsl:when>
				<xsl:otherwise>
					<xsl:value-of select="document($doc)/translation/texts/item[@name='gestion_tareas']/node()"/>&nbsp;
                                        <xsl:if test="/Tareas/INICIO/EMPRESAS/field/dropDownList/listElem[ID = ../../../../IDEMPRESA]/listItem != 'Todas'">[ <xsl:value-of select="/Tareas/INICIO/EMPRESAS/field/dropDownList/listElem[ID = ../../../../IDEMPRESA]/listItem"/> ]</xsl:if>
				</xsl:otherwise>
			</xsl:choose>
                        <xsl:text>&nbsp;&nbsp;&nbsp;</xsl:text>
            ...
            <h1 class="titlePage" style="float:left;width:20%;">
                <xsl:if test="(/Tareas/INICIO/MVM or /Tareas/INICIO/MVMB or /Tareas/INICIO/ADMIN) and /Tareas/INICIO/IDEMPRESA != ''"><span style="float:right; padding:5px;" class="amarillo">EMP_ID: <xsl:value-of select="/Tareas/INICIO/EMPRESAS/field/@current"/></span></xsl:if>
            </h1>
				...
				<table class="infoTable" border="0">
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="/Tareas/INICIO/GESTIONCOMERCIAL/GESTION">

					<!--buscador-->
					<tr class="subTituloTablaNoB">
						<td>
							<!--<a href="javascript:VerTareas();" style="text-decoration:none;">
								<img src="http://www.newco.dev.br/images/anadir.gif" style="vertical-align:middle; margin-top:0px;"/>
							</a>-->
						</td>
						<td><xsl:value-of select="document($doc)/translation/texts/item[@name='fecha']/node()"/></td>
						<!--<td class="datosLeft"><xsl:value-of select="document($doc)/translation/texts/item[@name='autor']/node()"/></td>-->
						<td class="datosLeft">
						...
						<td class="datosLeft">
							<xsl:value-of select="document($doc)/translation/texts/item[@name='empresa']/node()"/>
                                                ...
                                                <td class="datosLeft">
							<span class="centroBox"><xsl:value-of select="document($doc)/translation/texts/item[@name='centro']/node()"/></span>
						</td>
                                                <td class="datosLeft">
							<xsl:value-of select="document($doc)/translation/texts/item[@name='tipo']/node()"/>
                                                ...
                                                <td>&nbsp;<!--semaforo si caduca--></td>
						<td class="datosLeft">
							<xsl:value-of select="document($doc)/translation/texts/item[@name='descripcion_tarea']/node()"/>
						</td>
                                                <td>&nbsp;</td>
						<td class="datosLeft">
						...
						<td class="datosLeft">
							<xsl:value-of select="document($doc)/translation/texts/item[@name='prioridad']/node()"/>
						</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					</tr>
					...
					<tr class="subTituloTablaNoB">
						...
						<!--<td class="doce">
							<xsl:call-template name="desplegable">
								<xsl:with-param name="path" select="/Tareas/INICIO/GESTIONCOMERCIAL/FIDAUTOR/field"></xsl:with-param>
							</xsl:call-template>
						</td>-->
						<td class="doce datosLeft">
							<!--responsable-->
							<xsl:call-template name="desplegable">
								<xsl:with-param name="path" select="/Tareas/INICIO/GESTIONCOMERCIAL/FIDRESPONSABLE/field"></xsl:with-param>
                                                                <xsl:with-param name="claSel">select140</xsl:with-param>
							</xsl:call-template>
						</td>
						<td class="dies datosLeft">
							<!--empresa-->
                                                        <!--<xsl:value-of select="/Tareas/INICIO/EMPRESAS/field/dropDownList/listElem[ID = ../../@current]/listItem"/>
                                                        <xsl:value-of select="/Tareas/INICIO/GESTIONCOMERCIAL/FIDEMPRESA/field/dropDownList/listElem[ID = ../../@current]/listItem"/>
							<xsl:call-template name="desplegable">
								<xsl:with-param name="path" select="/Tareas/INICIO/GESTIONCOMERCIAL/FIDEMPRESA/field"></xsl:with-param>
                                                ...
                                                <td class="datosLeft doce">
                                                    <xsl:if test="/Tareas/INICIO/EMPRESAS/field/@current != ''">
							...
							<!--tipo <xsl:value-of select="/Tareas/INICIO/TIPO/field/dropDownList/listElem[ID = ../../@current]/listItem"/>-->
							<xsl:call-template name="desplegable">
								<xsl:with-param name="path" select="/Tareas/INICIO/TIPO/field[@name= 'FIDTIPO']"></xsl:with-param>
						...
						<td class="datosLeft">
							<!--descripcion-->
							<input type="text" name="FTEXTO" size="40" value="{/Tareas/INICIO/GESTIONCOMERCIAL/FTEXTO}"/>
						</td>
                                                <td class="uno">&nbsp;</td>
						<td class="seis datosLeft">&nbsp;</td>
						<td class="cinco datosLeft"><!--estado-->
							<xsl:call-template name="desplegable">
								<xsl:with-param name="path" select="/Tareas/INICIO/GESTIONCOMERCIAL/FESTADO/field"></xsl:with-param>
                                                                <xsl:with-param name="defecto" select="/Tareas/INICIO/GESTIONCOMERCIAL/FESTADO/field/@current"></xsl:with-param>
                                                                <xsl:with-param name="claSel">select80</xsl:with-param>
							</xsl:call-template>
						...
						<td class="cinco datosLeft"><!--prioridad-->
							<xsl:call-template name="desplegable">
								<xsl:with-param name="path" select="/Tareas/INICIO/GESTIONCOMERCIAL/FPRIORIDAD/field"></xsl:with-param>
                                                                <xsl:with-param name="claSel">select80</xsl:with-param>
							</xsl:call-template>
						</td>
						<td class="siete" align="center">
							<div class="botonLargo">
								<strong>
									<a href="javascript:EnviarTareas();">
					...
					<xsl:for-each select="/Tareas/INICIO/GESTIONCOMERCIAL/GESTION">
						<tr>
                                                        <xsl:choose>
							...
							<xsl:attribute name="class">
								<xsl:choose>
									<xsl:when test="IDPADRE=ID">tareaLine noOculto</xsl:when>
									<xsl:when test="IDPADRE!=ID and RECIENTE">subTareasTot subtarea_<xsl:value-of select="IDPADRE"/> noOculto</xsl:when>
									<xsl:when test="IDPADRE!=ID and not(RECIENTE)">subTareasTot subtarea_<xsl:value-of select="IDPADRE"/> oculto</xsl:when>
								</xsl:choose>
							</xsl:attribute>-->
							...
							<td>
								<xsl:attribute name="class">
									<xsl:choose><xsl:when test="IDPADRE=ID and HIJOS != ''">dos<!--borderBottom--></xsl:when></xsl:choose>
									<xsl:choose><xsl:when test="IDPADRE!=ID">dos<!--borderRight--></xsl:when></xsl:choose>
								</xsl:attribute>

								<!--pongo + si es padre para abrir tareas hijo
								<xsl:choose>
									<xsl:when test="IDPADRE=ID and HIJOS != ''">
										<a href="javascript:AbrirSubTareas('{IDPADRE}');" style="text-decoration:none;">
											<img src="http://www.newco.dev.br/images/anadir.gif" style="margin-top:2px;"/>
										</a>
									</xsl:when>
								</xsl:choose>-->
							</td>
							...
							<!--<td class="borderTop datosLeft"><xsl:value-of select="AUTOR"/></td>-->
							...
							<td class="datosLeft borderTop"><!--si no hay marca comercial desabilito-->
                                                        ...
                                                        <td class="datosLeft borderTop">
                                                           ...
                                                           <xsl:when test="/Tareas/INICIO/GESTIONCOMERCIAL/USUARIOCONECTADO/US_ID=IDAUTOR or /Tareas/INICIO/SUPERUSUARIO"><!--si autor puede cambiar-->
                                                                <xsl:call-template name="desplegable">
									<xsl:with-param name="path" select="/Tareas/INICIO/GESTIONCOMERCIAL/GESTION/TIPO[@id=$id]/field"></xsl:with-param>
                                                                        <xsl:with-param name="claSel">select80</xsl:with-param>
								</xsl:call-template>
                                                            </xsl:when>
                                                            <xsl:otherwise>
							...
							<td class="datosLeft borderTop" style="padding:3px 0 3px 5px;">
                                                            <!--<xsl:choose>
                                                            <xsl:when test="/Seguimiento/ENTRADAS_SEGUIMIENTO/COMERCIAL or /Tareas/INICIO/GESTIONCOMERCIAL/USUARIOCONECTADO/US_ID=IDAUTOR or /Tareas/INICIO/GESTIONCOMERCIAL/USUARIOCONECTADO/US_ID=IDRESPONSABLE">
                                                                 <input type="text" name="TEXTO_{ID}" size="40" value="{TEXTO}"/>
                                                             </xsl:when>
                                                            </xsl:choose>-->
							...
							<td class="datosLeft borderTop">
                                                            ...
                                                            <xsl:when test="/Tareas/INICIO/GESTIONCOMERCIAL/USUARIOCONECTADO/US_ID=IDAUTOR or /Tareas/INICIO/GESTIONCOMERCIAL/USUARIOCONECTADO/US_ID=IDRESPONSABLE or /Tareas/INICIO/SUPERUSUARIO"><!--si autor o responsable puede cambiar-->
                                                                <xsl:call-template name="desplegable">
									<xsl:with-param name="path" select="/Tareas/INICIO/GESTIONCOMERCIAL/GESTION/ESTADO[@id=$id]/field"></xsl:with-param>
									<xsl:with-param name="claSel">select80</xsl:with-param>
								</xsl:call-template>
                                                            </xsl:when>
                                                            <xsl:otherwise>
							...
							<td class="datosLeft borderTop">
                                                            ...
                                                            <xsl:when test="/Tareas/INICIO/GESTIONCOMERCIAL/USUARIOCONECTADO/US_ID=IDAUTOR or /Tareas/INICIO/SUPERUSUARIO"><!--si autor puede cambiar-->
								<xsl:call-template name="desplegable">
									<xsl:with-param name="path" select="/Tareas/INICIO/GESTIONCOMERCIAL/GESTION/PRIORIDAD[@id=$id]/field"></xsl:with-param>
									<xsl:with-param name="claSel">select80</xsl:with-param>
								</xsl:call-template>
                                                            </xsl:when>
                                                            <xsl:otherwise>
							...
							<td class="datosLeft borderTop">
                                                                    ...
                                                                    &nbsp;
                                                                       <!-- <a href="javascript:Subtarea('{ID}');" style="text-decoration:none;">
                                                                        ...
                                                                        <xsl:choose>
                                                                                <xsl:when test="/Tareas/INICIO/GESTIONCOMERCIAL/USUARIOCONECTADO/US_ID=IDAUTOR or /Tareas/INICIO/GESTIONCOMERCIAL/USUARIOCONECTADO/US_ID=IDRESPONSABLE or /Tareas/INICIO/SUPERUSUARIO">
                                                                                        ...
                                                                                        <xsl:if test="../../EMPRESAS/field/@current != ''"></xsl:if>
                    ...
                    <xsl:if test="/Tareas/INICIO/COMERCIAL and /Tareas/INICIO/IDEMPRESA != ''">
                    ...
                    <table class="infoTable incidencias" border="0" cellspacing="5" style="border-top:2px solid #D7D8D7;border-bottom:2px solid #D7D8D7;">
                      <tr>
                          <td colspan="4" class="grisMed" style="font-weight:bold;">
                            ...
                            <xsl:value-of select="/Tareas/INICIO/GESTIONCOMERCIAL/USUARIOCONECTADO/NOMBRE"/>&nbsp;
                            ...
                            <xsl:value-of select="/Tareas/INICIO/GESTIONCOMERCIAL/FECHA"/>
                      ...
                      <tr>
                        ...
                        <td class="datosLeft quince">
                        	<xsl:call-template name="desplegable">
								<xsl:with-param name="path" select="/Tareas/INICIO/GESTIONCOMERCIAL/ESTADO/field"></xsl:with-param>
                      ...
                      <tr>
                        ...
                        <td class="datosLeft">
                            <xsl:call-template name="desplegable">
				<xsl:with-param name="path" select="/Tareas/INICIO/GESTIONCOMERCIAL/IDRESPONSABLE/field"></xsl:with-param>
                                <xsl:with-param name="claSel">select250</xsl:with-param>
                            </xsl:call-template>
                        </td>
                        ...
                        <td class="datosLeft">
                        	<xsl:call-template name="desplegable">
                                    <xsl:with-param name="path" select="/Tareas/INICIO/GESTIONCOMERCIAL/PRIORIDAD/field"></xsl:with-param>
                                    <xsl:with-param name="claSel">select250</xsl:with-param>
				</xsl:call-template>
                        </td>
                     </tr>
                     <tr>
                        ...
                        <td class="datosLeft">
                                <xsl:call-template name="desplegable">
                                    <xsl:with-param name="path" select="/Tareas/INICIO/TIPO/field[@name= 'IDTIPO']"></xsl:with-param>
                                    <xsl:with-param name="claSel">select250</xsl:with-param>
                                </xsl:call-template>
                        </td>
				...
				<div class="botonCenter">
                                    <strong>
					<a href="javascript:NuevaGestion();">
