...
function globalEvents(){
  // Codigo javascript para mostrar/ocultar tablas cuando se clica en la pestanya 'Alta Producto'
    ...
    if(lang == 'spanish'){
      jQuery("#pes_lAltaProducto > img").attr('src',"/images/");
      jQuery("#pes_lAltaFichero > img").attr('src',"/images/");
    }else{
      jQuery("#pes_lAltaProducto > img").attr('src',"/images/");
      jQuery("#pes_lAltaFichero > img").attr('src',"/images/");
    }
...
function ValidarFormulario(oForm,IDEstado){
    ...
    if(oForm.elements['SC_PRODUCTO'] && oForm.elements['SC_PRODUCTO'].value === ''){
      ...
      var precio = oForm.elements['SC_PRECIO'].value.replace(',', '.');
      if(isNaN(precio)){
        ...
        oForm.elements['SC_PRECIO'].value = precio.replace('.', ',');
      }
		}
...
function anadirFilasProductos(oForm){
  ...
  var arrProd, nombreProd, refCliente, refProv, nombreProv, precio, cantidad;
