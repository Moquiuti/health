...
<!-- 
	Template para la pestaña de PROVEEDORES de la licitación. Disenno 2022
	ultima revision: ET 2feb22 15:17
-->
...
<div id="lProveedores" class="marginTop80" style="display:none;">
	...
	<table id="lProveedores_EST" cellspacing="6px" cellpadding="6px">
		...
		<tr class="subTituloTabla">
			...
			<th class="tres"><xsl:copy-of select="document($doc)/translation/texts/item[@name='comentarios_cdc_abbr']/node()"/></th>
			<th class="tres"><xsl:copy-of select="document($doc)/translation/texts/item[@name='comentarios_prov_abbr']/node()"/></th>
			-->
			<th class="w50px">
				<!-- Permitimos ordenacion -->
