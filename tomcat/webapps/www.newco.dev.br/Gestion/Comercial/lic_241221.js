...
//	Ultima revisión ET 21dic21 11:50 lic_241221.js 
			...
			success: function(objeto)
			{
				...
				if(data.ProductosLicitacion.ListaProductosOfertas.length > 0)
				{
					...
					jQuery.each(data.ProductosLicitacion.ListaProductosOfertas, function(key, producto)
					{
						...
						//solodebug 
						debug('Proveedor:'+arrProveedores[PosProvActual].NombreCorto+' fila:'+fila+' PosProvActual:'+PosProvActual+' FichaTecnica:'+arrProductos[fila].Ofertas[PosProvActual].FichaTecnica.ID);
						...
						//solodebug 
						debug('Proveedor:'+arrProveedores[PosProvActual].NombreCorto+' fila:'+fila+' PosProvActual:'+PosProvActual+' RegSanitario:'+arrProductos[fila].Ofertas[PosProvActual].RegSanitario.ID);
						...
						//solodebug 
						debug('Proveedor:'+arrProveedores[PosProvActual].NombreCorto+' fila:'+fila+' PosProvActual:'+PosProvActual+' CertExperiencia:'+arrProductos[fila].Ofertas[PosProvActual].CertExperiencia.ID);
...
//			thisRow = rowStartIDStyle.replace('#ID#', arrProductos[ColumnaOrdenadaProds[i]].IDProdLic);
			...
			thisCell += '<span style="padding:2px;display:table-cell;"><strong>' + NombreProductoConEstilo(i) + '</strong>&nbsp;';

			if ((arrProductos[ColumnaOrdenadaProds[i]].Marcas!='')||(arrProductos[ColumnaOrdenadaProds[i]].PrincActivo!=''))
				thisCell += '<img src="http://www.newco.dev.br/images/2017/info.png" title="Marcas: '+arrProductos[ColumnaOrdenadaProds[i]].Marcas+'&#13;'+strPrincActivo+': '+arrProductos[ColumnaOrdenadaProds[i]].PrincActivo+'" class="static"/>'
...
function PermitirDescarga()
{
	...
	{
		document.forms['infoPedido'].action="http://www.newco.dev.br/Gestion/Comercial/MantLicitacionAcciones.xsql?ACCION=PERMITIRDESCARGA&LIC_ID="+IDLicitacion;
