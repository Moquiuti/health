...
<!-- 
	...
	ultima revision: ET 24dic21 10:00
-->
...
<!--<form class="formEstandar" id="form1" name="form1" action="http://www.newco.dev.br/Gestion/Comercial/MantLicitacionSave.xsql" method="post">-->
    ...
    <div>
        <ul style="width:1400px;">
            ...
            <li>
				...
				<input type="text" name="LIC_TITULO" size="50" maxlength="100" class="largo" value="{/Mantenimiento/NUEVALICITACION/LIC_TITULO}"/>
            </li>
            <li>
				...
				<input type="text" name="LIC_FECHADECISION" size="15" maxlength="10" class="corto"/>
				...
				&nbsp;<xsl:value-of select="document($doc)/translation/texts/item[@name='formato_fecha_hora']/node()"/>
            </li>
			<xsl:choose>
			...
			<xsl:when test="/Mantenimiento/NUEVALICITACION/IDPAIS = 55">
				<!--	Para Brasil no infromamos no presentamos esta campo	-->
			</xsl:when>
			<xsl:otherwise>
            	<li>
					...
					<input type="text" name="LIC_FECHAADJUDICACION" id="LIC_FECHAADJUDICACION" size="15" maxlength="10"/>
            ...
            <li class="campoPedidoPuntual" style="display:none;">
				...
				<select name="LIC_IDUSUARIOPEDIDO" id="LIC_IDUSUARIOPEDIDO" style="width:560px;">
            ...
            <li class="campoPedidoPuntual" style="display:none;">
				...
				<select name="LIC_IDLUGARENTREGA" id="LIC_IDLUGARENTREGA" class="grande">
					<option value=""><xsl:value-of select="document($doc)/translation/texts/item[@name='selecciona']/node()"/></option>
        ...
        <ul style="width:100%;">
            <li class="sinSeparador">
				...
				<xsl:when test="/Mantenimiento/LICITACION/AUTOR">
					<input class="largo" type="text" name="LIC_TITULO" value="{Mantenimiento/LICITACION/LIC_TITULO}" size="50" maxlength="100"/>
				</xsl:when>
				<xsl:otherwise>
					<input class="largo" type="text" name="LIC_TITULO" value="{Mantenimiento/LICITACION/LIC_TITULO}" size="50" maxlength="100" disabled="disabled"/>
				</xsl:otherwise>
				</xsl:choose>
				<!--	Fecha decisión	-->
				<label style="margin-left:200px;"><xsl:value-of select="document($doc)/translation/texts/item[@name='fecha_decision']/node()"/>:</label>
				<xsl:choose>
				<xsl:when test="/Mantenimiento/LICITACION/AUTOR">
					<input class="corto" type="text" name="LIC_FECHADECISION" value="{Mantenimiento/LICITACION/LIC_FECHADECISIONPREVISTA}" size="10" maxlength="10"/>
					<xsl:call-template name="desplegable">
				...
				<xsl:otherwise>
					<input class="corto" type="text" name="LIC_FECHADECISION" value="{Mantenimiento/LICITACION/LIC_FECHADECISIONPREVISTA}" size="10" maxlength="10" disabled="disabled"/>
					<xsl:call-template name="desplegable">
						<xsl:with-param name="path" select="/Mantenimiento/LICITACION/LIC_HORADECISION/field"/>
			...
			<xsl:if test="/Mantenimiento/LICITACION/AUTOR">
				...
				<xsl:if test="/Mantenimiento/LICITACION/IDPAIS = 55">
            		<li class="sinSeparador campoPedidoPuntual_Inv">
						...
						<input type="text" name="LIC_FECHAADJUDICACION" id="LIC_FECHAADJUDICACION" value="{Mantenimiento/LICITACION/LIC_FECHAADJUDICACION}" size="15" maxlength="10"/>
						&nbsp;<xsl:value-of select="document($doc)/translation/texts/item[@name='formato_fecha']/node()"/>
            		</li>
				</xsl:if>
            	...
            	<li class="sinSeparador campoPedidoPuntual" style="display:none;">
					<label><xsl:value-of select="document($doc)/translation/texts/item[@name='fecha_entrega_programada']/node()"/>:</label>
					<input type="text" id="LIC_FECHAENTREGAPEDIDO" name="LIC_FECHAENTREGAPEDIDO" value="{/Mantenimiento/LICITACION/LIC_FECHAENTREGAPEDIDO}"/>
					&nbsp;<xsl:value-of select="document($doc)/translation/texts/item[@name='fecha_entrega_expli']/node()"/>
            	</li>
...
<ul style="width:100%;">
    ...
    <li class="sinSeparador">
		...
		<xsl:choose>
		<xsl:when test="/Mantenimiento/LICITACION/AUTOR">
			<input class="corto" type="text" id="LIC_FECHADECISION" name="LIC_FECHADECISION" value="{Mantenimiento/LICITACION/LIC_FECHADECISIONPREVISTA}" size="8" maxlength="8"/>
	...
	<xsl:if test="/Mantenimiento/LICITACION/LIC_IDESTADO = 'ADJ' or /Mantenimiento/LICITACION/LIC_IDESTADO = 'FIRM' or /Mantenimiento/LICITACION/LIC_IDESTADO = 'CONT'">
    	<li class="sinSeparador">
			...
			<xsl:choose>
			<xsl:when test="/Mantenimiento/LICITACION/AUTOR">
				<input class="corto" type="text" id="LIC_FECHAREALADJUDICACION" name="LIC_FECHAREALADJUDICACION" value="{Mantenimiento/LICITACION/LIC_FECHAREALADJUDICACION}" size="8" maxlength="8"/>
			...
			<div style="width:200px;display:inline-block;margin-left:50px;"><label><xsl:value-of select="document($doc)/translation/texts/item[@name='fecha_real_cad']/node()"/>:</label></div>
			<xsl:choose>
			<xsl:when test="/Mantenimiento/LICITACION/AUTOR">
				<input class="corto" type="text" id="LIC_FECHAREALCADUCIDAD" name="LIC_FECHAREALCADUCIDAD" value="{Mantenimiento/LICITACION/LIC_FECHAREALCADUCIDAD}" size="8" maxlength="8"/>
				&nbsp;<a href="javascript:ActualizarFechasReales();" style="text-decoration:none;">
					<img src="http://www.newco.dev.br/images/modificar.gif">
						<xsl:attribute name="alt"><xsl:value-of select="document($doc)/translation/texts/item[@name='actualizar_fecha']/node()"/></xsl:attribute>
						<xsl:attribute name="title"><xsl:value-of select="document($doc)/translation/texts/item[@name='actualizar_fecha']/node()"/></xsl:attribute>
...
<!--<form id="form1" name="form1" action="http://www.newco.dev.br/Gestion/Comercial/MantLicitacionSave.xsql" method="post">-->
<form id="form1" name="form1" action="http://www.newco.dev.br/Gestion/Comercial/MantLicitacion.xsql" method="post">
	...
	<input type="hidden" name="LIC_MULTIOPCION" id="LIC_MULTIOPCION" value="{/Mantenimiento/LICITACION/LIC_MULTIOPCION}"/>
        ...
        <ul style="width:100%;">
            <li class="sinSeparador">
				<!--	Titulo	-->
				<div style="width:140px;display:inline-block;margin-left:50px;"><label><xsl:value-of select="document($doc)/translation/texts/item[@name='titulo']/node()"/>:</label></div>
				<input class="largo" type="text" name="LIC_TITULO" value="{Mantenimiento/LICITACION/LIC_TITULO}" size="50" maxlength="100"/>
				<!--	Fecha decisión	-->
				<div style="width:160px;display:inline-block;margin-left:50px;"><label><xsl:value-of select="document($doc)/translation/texts/item[@name='fecha_decision']/node()"/>:</label></div>
				<input class="corto" type="text" name="LIC_FECHADECISION" value="{Mantenimiento/LICITACION/LIC_FECHADECISIONPREVISTA}" size="10" maxlength="10"/>
				<xsl:call-template name="desplegable">
					<xsl:with-param name="path" select="/Mantenimiento/LICITACION/LIC_HORADECISION/field"/>
					<xsl:with-param name="style">width:auto</xsl:with-param>
            ...
            <li class="sinSeparador">
				<div style="width:140px;display:inline-block;margin-left:50px;"><label><xsl:value-of select="document($doc)/translation/texts/item[@name='fecha_alta']/node()"/>:</label></div>
				<strong><xsl:value-of select="Mantenimiento/LICITACION/LIC_FECHAALTA"/></strong>
				<div style="width:100px;display:inline-block;margin-left:205px;"><label><xsl:value-of select="document($doc)/translation/texts/item[@name='estado']/node()"/>:</label></div>
