...
<!--nueva solicitud de catalogacion	-->
...
<xsl:otherwise>
	...
	<div class="ZonaTituloPagina">
		<p class="Path"><xsl:value-of select="document($doc)/translation/texts/item[@name='Inicio']/node()"/>&nbsp;/&nbsp;<span class="FinPath"><xsl:value-of select="document($doc)/translation/texts/item[@name='nueva_solicitud_catalogacion']/node()"/></span></p>
		<p class="TituloPagina">
           <xsl:value-of select="document($doc)/translation/texts/item[@name='solicitud_catalogacion_guardada_exito']/node()"/>:
			...
			<span class="CompletarTitulo">
				<a class="btnDestacado" href="javascript:anadirProducto(document.forms['SolicitudCatalogacion']);">
        ...
        <div class="divLeft60nopa">
           ...
           <table class="infoTable incidencias" cellspacing="5" cellpadding="5" style="border-bottom:2px solid #D7D8D7;">
				<tr>
					...
					<td style="text-transform:uppercase;text-align:left;background-color:#D3D3D3;padding-left:10px;">
						<strong>
							<xsl:value-of select="document($doc)/translation/texts/item[@name='solicitud']/node()"/>
							<span style="float:right;padding-right:30px;">
								<xsl:value-of select="document($doc)/translation/texts/item[@name='fecha']/node()"/>:&nbsp;<xsl:value-of select="/NuevaSolicitud/SOLICITUD/SC_FECHA"/>
							</span>
						</strong>
                	</td>
				</tr>
				<tr>
					...
					<td class="datosLeft"><xsl:value-of select="/NuevaSolicitud/SOLICITUD/USUARIO"/></td>
				</tr>
                <tr>
    ...
    <div>
        <ul style="width:1000px;">
            ...
            <li>
				...
				<input type="text" name="SC_TITULO" id="SC_TITULO" maxlength="200" size="62"/>
	...
	- - >
		<form name="SolicitudCatalogacion" id="SolicitudCatalogacion" method="post">
        	...
        	<table class="infoTable incidencias" cellspacing="5" style="border-bottom:2px solid #D7D8D7;">
				...
				<tr>
					<td>&nbsp;</td>
					<td class="title" colspan="2"><strong><xsl:value-of select="document($doc)/translation/texts/item[@name='datos_generales']/node()"/></strong></td>
				</tr>
				<!- -Solictud Catalogacion - ->
				<tr>
					...
					<td class="datosLeft"><input type="text" name="SC_TITULO" id="SC_TITULO" maxlength="200" size="62"/></td>
					<td class="datosLeft" style="padding-left:5px;"><xsl:value-of select="document($doc)/translation/texts/item[@name='titulo_explicacion_sol_cat']/node()"/></td>
				</tr>
				<tr>
					<td class="labelRight grisMed">
						<xsl:value-of select="document($doc)/translation/texts/item[@name='descripcion']/node()"/>:&nbsp;
					...
					<td class="datosLeft"><textarea name="SC_DESCRIPCION" id="SC_DESCRIPCION" rows="4" cols="60" maxlength="3000"></textarea></td>
					...
					<td class="datosLeft" colspan="2"><input type="text" name="SC_PRODUCTO" id="SC_PRODUCTO" maxlength="200" size="62"/></td>
				</tr>
				<tr>
					<td class="labelRight grisMed">
						<xsl:value-of select="document($doc)/translation/texts/item[@name='ref_cliente']/node()"/>:
					</td>
					<td class="datosLeft" colspan="2"><input type="text" name="SC_REFCLIENTE" id="SC_REFCLIENTE" maxlength="100"/></td>
				</tr>
				<tr>
					<td class="labelRight grisMed">
						<xsl:value-of select="document($doc)/translation/texts/item[@name='ref_proveedor']/node()"/>:
					</td>
					<td class="datosLeft" colspan="2"><input type="text" name="SC_REFPROVEEDOR" id="SC_REFPROVEEDOR" maxlength="100"/></td>
				</tr>
				<tr>
					<td class="labelRight grisMed">
						<xsl:value-of select="document($doc)/translation/texts/item[@name='proveedor']/node()"/>:
					</td>
					<td class="datosLeft" colspan="2"><input type="text" name="SC_PROVEEDOR" id="SC_PROVEEDOR" maxlength="100"/></td>
				</tr>
                                <tr>
					<td class="labelRight grisMed">
						<xsl:value-of select="document($doc)/translation/texts/item[@name='precio']/node()"/>:&nbsp;
					</td>
					<td class="datosLeft"><input name="SC_PRECIO" id="SC_PRECIO" size="" maxlength="10"/></td>
				...
				<tr>
					<td class="labelRight grisMed">
						<xsl:value-of select="document($doc)/translation/texts/item[@name='cantidad_anual']/node()"/>:
					</td>
					<td class="datosLeft" colspan="2"><input type="text" name="SC_CANTIDAD" id="SC_CANTIDAD" maxlength="10"/>&nbsp;<xsl:value-of select="document($doc)/translation/texts/item[@name='cantidad_explicacion_sol_cat']/node()"/></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="datosLeft">
						<div class="boton" id="BotonSubmit">
							<a href="javascript:ValidarFormulario(document.forms['SolicitudCatalogacion'],'NUEVA');">
								<xsl:value-of select="document($doc)/translation/texts/item[@name='enviar']/node()"/>
							</a>
						</div>
					</td>
