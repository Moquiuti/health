...
<!--
	...
	Ultima revisión: ET 30jun22 10:00 EISSeleccion2022_010422.js
-->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="/">
    ...
    <script type="text/javascript" src="http://www.newco.dev.br/Gestion/EIS/EISSeleccion2022_010422.js"></script>
		...
		<form class="formEstrecho" action="http://www.newco.dev.br/Gestion/EIS/EISSeleccion2022.xsql" name="Seleccion" method="POST">
			...
			<div class="ZonaTituloPagina">
				<p class="TituloPagina">
					...
					<span class="CompletarTitulo400px">
