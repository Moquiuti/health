...
//	Ultima revision ET 21abr23 10:45 licOfertasSeleccionadas2022_010623.js

//	1jul21 fin da carga de la pagina: ocultar boton de "Ajustar Cantidades" si ya estan OK.
function onLoad()
{
	console.log('onLoad 1jun23 10:50');
	...
	if (IDProdLicActivo!='')
	{
		console.log('#IDPRODLIC_'+IDProdLicActivo+' '+jQuery('#IDPRODLIC_'+IDProdLicActivo).position().top);
		var offset = jQuery('#IDPRODLIC_'+IDProdLicActivo).offset();
		scroll(0,offset.top);
	}
...
function DescargarExcel()
{
	...
	for (i=0; i<arrProveedores.length; i++)
	{
		...
		{
			// 	Ref.Cliente 	REFCENTRO (6oct21)	Item 	Marca 	Unidade básica 	Preço 	Embalagem 	Quantidade 	Consumo 	Preço Ref 	Economia
...
//	21abr23 abre el informe en pop-up
