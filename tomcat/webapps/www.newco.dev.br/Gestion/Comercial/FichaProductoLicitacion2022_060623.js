...
//	Ultima revision ET 6jun23 09:40 FichaProductoLicitacion2022_060623.js
...
function EntregasProducto(Pos)
{
	...
	jQuery("#progEntrTitulo").html('<label>'+str_ProgEntregas+'</label>:&nbsp('+RefCliente+')&nbsp'+nombreProducto);
