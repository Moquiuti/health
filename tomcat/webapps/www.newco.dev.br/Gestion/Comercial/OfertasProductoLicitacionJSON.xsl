...
<!--
	...
	Ultima revision: ET 1feb23 12:22
+-->
...
<xsl:template match="/OfertasProductoLic">
	<xsl:text>{"OfertasProductoLic":</xsl:text>
		...
		<xsl:value-of select="PRODUCTOLICITACION/CP_PRO_CURVAABC"/>
		<xsl:text>","UltCompra":{"FECHA":"</xsl:text>
		<xsl:value-of select="PRODUCTOLICITACION/ULTIMACOMPRA/FECHA"/>
		<xsl:text>","MO_ID":"</xsl:text>
		<xsl:value-of select="PRODUCTOLICITACION/ULTIMACOMPRA/MO_ID"/>
		<xsl:text>","IDPROVEEDOR":"</xsl:text>
		<xsl:value-of select="PRODUCTOLICITACION/ULTIMACOMPRA/IDPROVEEDOR"/>
		<xsl:text>","PROVEEDOR":"</xsl:text>
		<xsl:value-of select="PRODUCTOLICITACION/ULTIMACOMPRA/PROVEEDOR"/>
		<xsl:text>","MARCA":"</xsl:text>
		<xsl:value-of select="PRODUCTOLICITACION/ULTIMACOMPRA/MARCA"/>
		<xsl:text>","PRECIO":"</xsl:text>
		<xsl:value-of select="PRODUCTOLICITACION/ULTIMACOMPRA/PRECIO"/>
		<xsl:text>","CANTIDAD":"</xsl:text>
		<xsl:value-of select="PRODUCTOLICITACION/ULTIMACOMPRA/CANTIDAD"/>
		<xsl:text>"},"CompraMedia":{"NUMERO_PEDIDOS":"</xsl:text>
		<xsl:value-of select="PRODUCTOLICITACION/COMPRAMEDIA/NUMERO_PEDIDOS"/>
		<xsl:text>","CANTIDAD_TOTAL":"</xsl:text>
		<xsl:value-of select="PRODUCTOLICITACION/COMPRAMEDIA/CANTIDAD_TOTAL"/>
		<xsl:text>","PRECIO_MIN":"</xsl:text>
		<xsl:value-of select="PRODUCTOLICITACION/COMPRAMEDIA/PRECIO_MIN"/>
		<xsl:text>","PRECIO_MAX":"</xsl:text>
		<xsl:value-of select="PRODUCTOLICITACION/COMPRAMEDIA/PRECIO_MAX"/>
		<xsl:text>","PRECIO_MEDIO":"</xsl:text>
		<xsl:value-of select="PRODUCTOLICITACION/COMPRAMEDIA/PRECIO_MEDIO"/>
