...
function globalEvents(){
	...
	jQuery("#DIAGNOSTICO_NO_APTO").change(function(){
        ...
        if (document.forms['EvaluacionProducto'].elements['REF_PROV'] && document.forms['EvaluacionProducto'].elements['REF_PROV'].value != ''){
...
function RecuperarDatosProductoID(){
    ...
    if(idemp != '' && (idprod != '' || idProdEstandar != '') ){
             jQuery.ajax({
		url: 'http://www.newco.dev.br/Gestion/Comercial/RecuperaDatosProducto.xsql',
		data: "ID_EMP="+idemp+"&ID_PROD="+idprod+"&ID_PROD_ESTANDAR="+idProdEstandar,
                type: "GET",
                contentType: "application/xhtml+xml",
                beforeSend: function(){
                    null;
                ...
                success: function(objeto){
                    ...
                    form.elements['REF_PROV'].value = data[1].RefProdProv;
                    form.elements['DESCR_PROV'].value = data[1].DescrProv;
                    if (form.elements['ID_PROD'].value == ''){ form.elements['ID_PROD'].value = data[1].ProdIDProv; }
...
function errorCheck(form){
    ...
    if (estado == ''){
        ...
        if (form.elements['INSTRUCCIONES'] && form.elements['INSTRUCCIONES'].value == ''){
        ...
        //USUARIO EVALUADOR
        if (document.getElementById("usuarioEvaluador").style.display != 'none'){
        ...
        if (msg == ''){ GuardarNuevaEvaluacion(form); }
        else{ alert(msg); }
    ...
    if (estado == 'P'){
        ...
        if (form.elements['DIAGNOSTICO'].value == 'NO-APTO'){
