...
//	Ultima revisión ET 16dic21 16:00 lic_proveedor_161221.js
...
function PreparaLineaProducto(numProd, contLinea)
{
	...
	//			thisCell += '<strong>' + arrProductos[ColumnaOrdenadaProds[numProd]].Nombre + '</strong>&nbsp;';
		thisCell += '<strong>' + NombreProductoConEstilo(numProd) + ' ['+arrProductos[ColumnaOrdenadaProds[numProd]].Marcas+ ']</strong>&nbsp;';
		
		if ((arrProductos[ColumnaOrdenadaProds[numProd]].Marcas!='')||(arrProductos[ColumnaOrdenadaProds[numProd]].PrincActivo!=''))
			thisCell += '<img src="http://www.newco.dev.br/images/2017/info.png" title="'+strPrincActivo+': '+arrProductos[ColumnaOrdenadaProds[numProd]].PrincActivo+'" class="static"/>'
