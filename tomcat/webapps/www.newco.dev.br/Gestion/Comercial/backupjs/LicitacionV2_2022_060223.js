...
//	Ultima revisión ET 06feb23 09:30 LicitacionV2_2022_060223.js
		...
		success: function(objeto){
			...
			if(data.OfertasProductoLic.posicion && data.OfertasProductoLic.posicion!= ''){
				...
				for (var i=0; i<data.OfertasProductoLic.ofertas.length; ++i)
				{
					...
					Oferta["ORDEN"]=data.OfertasProductoLic.ofertas[i].LIC_OFE_ORDEN;											//17ene23 Para multiopcion
					Oferta["CODEXPEDIENTE"]=data.OfertasProductoLic.ofertas[i].LIC_OFE_CODEXPEDIENTE;							//06feb23 Nuevo campo OHSJD
					Oferta["CODCUM"]=data.OfertasProductoLic.ofertas[i].LIC_OFE_CODCUM;											//06feb23 Nuevo campo OHSJD
					Oferta["CODIUM"]=data.OfertasProductoLic.ofertas[i].LIC_OFE_CODIUM;											//06feb23 Nuevo campo OHSJD
					Oferta["CODINVIMA"]=data.OfertasProductoLic.ofertas[i].LIC_OFE_CODINVIMA;									//06feb23 Nuevo campo OHSJD
					Oferta["FECHACADINVIMA"]=data.OfertasProductoLic.ofertas[i].LIC_OFE_FECHACADINVIMA;							//06feb23 Nuevo campo OHSJD
					Oferta["CLASRIESGO"]=data.OfertasProductoLic.ofertas[i].LIC_OFE_CLASIFICACIONRIESGO;						//06feb23 Nuevo campo OHSJD

					//solodebug	
					if (Oferta["CODEXPEDIENTE"]!='')
						debug('CargaOfertas:'+Pos+'. Oferta:'+data.OfertasProductoLic.ofertas[i].contador+' Prov:'+data.OfertasProductoLic.ofertas[i].PROVEEDOR+' Ref:'+data.OfertasProductoLic.ofertas[i].LIC_OFE_REFERENCIA
							+' CODEXPEDIENTE:'+data.OfertasProductoLic.ofertas[i].LIC_OFE_CODEXPEDIENTE+' CODCUM:'+data.OfertasProductoLic.ofertas[i].LIC_OFE_CODCUM+' CODIUM:'+data.OfertasProductoLic.ofertas[i].LIC_OFE_CODIUM);
					...
					Oferta["FS_ID"]=data.OfertasProductoLic.ofertas[i].FS_ID;
					Oferta["FS_URL"]=data.OfertasProductoLic.ofertas[i].FS_URL;
