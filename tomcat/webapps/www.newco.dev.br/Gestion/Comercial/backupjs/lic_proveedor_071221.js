...
//	Ultima revisión ET 7dic21 11:00 lic_proveedor_071221.js
...
function VerDocumentoOferta(tipo, Pos)
{
	...
	if (IDDoc!='-1')
	{
		...
		if (Pos!=-1)
		{
			//solodebug debug('VerDocumento. Tipo:'+tipo+' Pos:'+Pos+' IDDoc:'+IDDoc+' AbrirDoc('+k+'):'+arrDocs[k].URL);	
...
function IDDocumentoSeleccionado(tipo, Pos)
{
	...
	{
		IDDoc=jQuery('#REGSAN_'+Pos).val();
	}
	else if (tipo=='CE')
	{
		IDDoc=jQuery('#CERTEXP_'+Pos).val();
	}
...
function ArrayDocumentos(tipo)
{
	...
	//solodebug	debug("ArrayDocumentos. tipo:"+tipo+" arrDocs:"+arrDocs.name);
