...
//	Ultima revisión ET 8jul22 12:25 LicV2Prods_2022_300922.js
...
/*	var thisPosArr, thisOfertaID, PrecioHist, Cantidad, 
	...
	// Informamos la posición del array arrProveedores que contiene la oferta del proveedor en la que se ha hecho el click.
	...
	if(wasChecked){
		...
		// Informamos la posición del array arrProveedores que estaba seleccionado previamente
		...
		if(thisPosArrProv !== oldPosArrProv){
			...
			//29may19 arrProveedores[thisPosArrProv].OfertasAdjAux++;
			//29may19 arrProveedores[oldPosArrProv].OfertasAdjAux--;
			arrProveedores[thisPosArrProv].OfertasAdj++;
			arrProveedores[oldPosArrProv].OfertasAdj--;
