...
//	Ultima revisión ET 23mar22 15:05 lic_proveedor_230322.js
	...
	if(arrProductos.length > 0)
	{
		...
		for(var i=0; i<arrProductos.length; i++)
		{
			...
			thisRow = StringtoCSV(arrProductos[ColumnaOrdenadaProds[i]].RefCliente)	// Ref.Cliente 
				...
				+ StringtoCSV(arrProductos[ColumnaOrdenadaProds[i]].Oferta.Cantidad);		// Oferta:Cantidad
					
			debug('listadoExcelProv: thisRow:'+thisRow);
