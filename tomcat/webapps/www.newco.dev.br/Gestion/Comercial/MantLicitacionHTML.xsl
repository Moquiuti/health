...
<!--
	...
	Actualizacion javascript lic_241221.js lic_proveedor_111022.js
	Ultima revisión ET 23mar22 12:15
-->
...
<xsl:import href="http://www.newco.dev.br/Gestion/Comercial/LicProveedoresTemplates.xsl"/>
<xsl:import href="http://www.newco.dev.br/Gestion/Comercial/LicCentrosTemplates.xsl"/>
...
<head>
    ...
    <xsl:choose>
		...
		<xsl:for-each select="/Mantenimiento/LICITACION/PRODUCTOSLICITACION/PRODUCTO">
			...
			items['Oferta']['Marca']	= '<xsl:value-of select="LIC_OFE_MARCA"/>';				//	14mar22 Recuperamos LIC_OFE_MARCA, no LIC_OFE_MARCA_JS
...
-->			
	...
	<xsl:if test="/Mantenimiento/LICITACION/ROL = 'VENDEDOR'">
		<script type="text/javascript" src="http://www.newco.dev.br/Gestion/Comercial/lic_proveedor_111022.js"></script>
	</xsl:if>
	<script type="text/javascript" src="http://www.newco.dev.br/Gestion/Comercial/lic_241221.js"></script>	<!--lic_171117multipedido.js-->
	...
	<xsl:otherwise>
		...
		<div class="ZonaTituloPagina">
			...
			<xsl:when test="not(/Mantenimiento/NUEVALICITACION)">
				<p class="Path"><xsl:value-of select="document($doc)/translation/texts/item[@name='Inicio']/node()"/>&nbsp;/&nbsp;<xsl:value-of select="document($doc)/translation/texts/item[@name='licitacion']/node()"/>&nbsp;/&nbsp;<span class="FinPath"><xsl:value-of select="substring(/Mantenimiento/LICITACION/TITULO,1,70)"/></span>
					<span class="CompletarTitulo" style="width:600px;">
						<!--	 Texto precio con/sin IVA, solo para España)	-->
						<xsl:choose>
						<xsl:when test="/Mantenimiento/LICITACION/IDPAIS = '34' and not(/Mantenimiento/LICITACION/MOSTRAR_PRECIO_IVA)">
							<span style="font-size:11px;margin:5px 0px;"> (<xsl:value-of select="document($doc)/translation/texts/item[@name='precios_sin_iva']/node()"/>)</span>
						</xsl:when>
						<xsl:when test="/Mantenimiento/LICITACION/IDPAIS = '34' and /Mantenimiento/LICITACION/MOSTRAR_PRECIO_IVA">
							<span style="font-size:11px;margin:5px 0px;"> (<xsl:value-of select="document($doc)/translation/texts/item[@name='precios_con_iva']/node()"/>)</span>
						</xsl:when>
						<xsl:otherwise>
						<!--<xsl:value-of select="/Mantenimiento/LICITACION/EMPRESALICITACION/NOMBRE"/>:&nbsp;<xsl:value-of select="/Mantenimiento/LICITACION/LIC_CODIGO"/>-->
						<!--:&nbsp;<xsl:value-of select="substring(/Mantenimiento/LICITACION/LIC_TITULO,1,70)"/>-->
						</xsl:otherwise>
						</xsl:choose>
					</span>
				</p>
				<p class="TituloPagina">
					<!--<xsl:value-of select="/Mantenimiento/LICITACION/LIC_CODIGO"/>:&nbsp;-->
					...
					<span class="CompletarTitulo" style="width:924px;">
						...
						<a class="btnNormal" style="text-decoration:none;">
							<xsl:choose>
							<xsl:when test="/Mantenimiento/LICITACION/ROL='VENDEDOR'">
								<!--23mar22 <xsl:attribute name="href">javascript:listadoExcel(<xsl:value-of select="/Mantenimiento/LICITACION/PRODUCTOSLICITACION/LIC_PROV_ID"/>);</xsl:attribute>-->
								<xsl:attribute name="href">javascript:listadoExcelProv();</xsl:attribute>
							</xsl:when>
						...
						&nbsp;
						<!-- PS 20170802 -->
						<!--<xsl:if test="/Mantenimiento/LICITACION/ROL='COMPRADOR' and /Mantenimiento/LICITACION/LIC_IDESTADO != 'EST'  and /Mantenimiento/LICITACION/LIC_IDESTADO != 'COMP' and /Mantenimiento/LICITACION/LIC_CONSUMOADJUDICADO > '0'">-->	
						<xsl:if test="/Mantenimiento/LICITACION/ROL='COMPRADOR' and /Mantenimiento/LICITACION/LIC_IDESTADO != 'EST' and /Mantenimiento/LICITACION/LIC_IDESTADO != 'COMP'">	
							<a class="btnNormal" id="botonVencedores" href="javascript:MostrarPagPersonalizada('http://www.newco.dev.br/Gestion/Comercial/licOfertasSeleccionadas.xsql?LIC_ID={/Mantenimiento/LICITACION/LIC_ID}',10,90,90,10);"><xsl:value-of select="document($doc)/translation/texts/item[@name='Vencedores']/node()"/></a>
							&nbsp;
						</xsl:if>
						<xsl:if test="/Mantenimiento/LICITACION/ROL='COMPRADOR' and /Mantenimiento/LICITACION/LIC_IDESTADO != 'EST' and /Mantenimiento/LICITACION/LIC_IDESTADO != 'COMP' and /Mantenimiento/LICITACION/LIC_IDESTADO != 'CONT' and /Mantenimiento/LICITACION/LIC_IDESTADO != 'CAD'">	
							<a class="btnNormal" id="botonProveedores" href="javascript:MostrarPagPersonalizada('http://www.newco.dev.br/Gestion/Comercial/licResumenProveedores.xsql?LIC_ID={//LIC_ID}',10,90,30,30);"><xsl:value-of select="document($doc)/translation/texts/item[@name='Proveedores']/node()"/></a>
							&nbsp;
						</xsl:if>
						...
						<!-- 13jul16 Descarga el fichero con la OC de la licitacion. 8ago16 Desactivo: descargaremos desde la integración
						<xsl:if test="/Mantenimiento/LICITACION/BOTON_DESCARGAR_OC">
							<div class="botonLargoVerdadNara clear" id="botonDescargarOC">
								<a href="javascript:DescargarOC();">
									<xsl:value-of select="document($doc)/translation/texts/item[@name='boton_descargarOC']/node()"/>
                    			</a>
							</div>
						</xsl:if>
						-->
						...
						<!--	El botón de conversaciones con proveedores lo mostramos en el formulario
			...
			<xsl:otherwise>
				...
				<p class="TituloPagina">
					...
					<span class="CompletarTitulo">
						<a class="btnNormal" href="http://www.newco.dev.br/Gestion/Comercial/Licitaciones.xsql" title="Volver a las licitaciones">
		...
		<xsl:if test="not(/Mantenimiento/NUEVALICITACION)">
			...
			<xsl:if test="/Mantenimiento/LICITACION/ROL = 'COMPRADOR' and /Mantenimiento/LICITACION/LIC_IDESTADO != 'EST' and /Mantenimiento/LICITACION/LIC_MESESDURACION = 0">
				...
				<form name="infoPedido" id="infoPedido" method="POST" action="http://www.newco.dev.br/Gestion/Comercial/MantLicitacion.xsql">
				...
				<tbody>
					...
					<tr>
						...
						<td class="cuarenta datosLeft borderGris" style="padding:15px 10px;">
						<xsl:choose>
...
-->
			...
			<table class="buscador tablaUsuarios" id="lUsuariosForm" style="display:none;">
				<tr class="sinLinea"><td colspan="4">&nbsp;</td></tr>

				<tr class="sinLinea">
					<td class="trenta">&nbsp;</td>
					<td class="labelRight quince grisMed"><xsl:value-of select="document($doc)/translation/texts/item[@name='usuarios']/node()"/>:</td>
			...
			<!--<table class="infoTable divLeft tablaInforme incidencias" id="lInforme" style="display:none;border-top:1px solid #999;" cellspacing="5">-->
			<table class="buscador" id="lResumen" style="display:none;margin-top: 40px;">
			<tbody>
				<!--
				<tr style="height:5px;"><td colspan="3">&nbsp;</td></tr>
				-->
				...
				<tr class="sinLinea">
					...
					<td class="datosLeft"><xsl:value-of select="/Mantenimiento/LICITACION/PRODUCTOSADJUDICADOS"/>/<xsl:value-of select="/Mantenimiento/LICITACION/LIC_NUMEROLINEAS"/></td>
				</tr>
				<tr class="sinLinea">
					<td class="labelRight"><xsl:value-of select="document($doc)/translation/texts/item[@name='Proveedores']/node()"/>:&nbsp;</td>
					<td class="datosLeft"><xsl:value-of select="/Mantenimiento/LICITACION/LIC_PROVEEDORESADJUDICADOS"/>/<xsl:value-of select="/Mantenimiento/LICITACION/LIC_NUMEROPROVEEDORES"/></td>
				</tr>
				<tr class="sinLinea">
					<td class="labelRight"><xsl:value-of select="document($doc)/translation/texts/item[@name='Total_adjudicado']/node()"/>:&nbsp;</td>
					<td class="datosLeft"><xsl:value-of select="/Mantenimiento/LICITACION/LIC_CONSUMOADJUDICADO"/><!--/<xsl:value-of select="/Mantenimiento/LICITACION/LIC_CONSUMOHISTADJUDICADO"/>--></td>
				</tr>
				<tr class="sinLinea">
					<td class="labelRight"><xsl:value-of select="document($doc)/translation/texts/item[@name='Ahorro']/node()"/>:&nbsp;</td>
					<td class="datosLeft"><xsl:value-of select="/Mantenimiento/LICITACION/LIC_AHORROADJUDICADO"/></td>
				</tr>
			...
			<!-- PESTANA INFORMES -->
			<table class="buscador" id="lInformes" style="display:none;margin-top: 40px;">
			<tbody>
				<tr class="sinLinea">
					<td class="datosLeft" style="width:100px">&nbsp;</td>
					<td class="datosLeft">
						<strong><a href="javascript:MostrarPagPersonalizada('http://www.newco.dev.br/Gestion/Comercial/licAvanceOfertas.xsql?LIC_ID={/Mantenimiento/LIC_ID}','Informe Licitacion',70,70,0,0);"><xsl:value-of select="document($doc)/translation/texts/item[@name='AvanceOfertas']/node()"/></a></strong>
					</td>
				</tr>
				<tr class="sinLinea">
					<td class="datosLeft" style="width:100px">&nbsp;</td>
					<td class="datosLeft">
						<strong><a href="javascript:MostrarPagPersonalizada('http://www.newco.dev.br/Gestion/Comercial/licOfertasSeleccionadas.xsql?LIC_ID={/Mantenimiento/LIC_ID}','Informe Licitacion',70,70,0,0);"><xsl:value-of select="document($doc)/translation/texts/item[@name='Vencedores']/node()"/></a></strong>
					</td>
				</tr>
				<tr class="sinLinea">
					<td class="datosLeft" style="width:100px">&nbsp;</td>
					<td class="datosLeft">
						<strong><a href="javascript:MostrarPagPersonalizada('http://www.newco.dev.br/Gestion/Comercial/VencedoresYAlternativas.xsql?LIC_ID={/Mantenimiento/LIC_ID}&amp;OFERTAS=2','Informe vencedores y 2 alternativas de la licitacion',70,70,0,0);"><xsl:value-of select="document($doc)/translation/texts/item[@name='VencedoresY2Alternativas']/node()"/></a></strong>
					</td>
				</tr>
				<tr class="sinLinea">
					<td class="datosLeft" style="width:100px">&nbsp;</td>
					<td class="datosLeft">
						<strong><a href="javascript:MostrarPagPersonalizada('http://www.newco.dev.br/Gestion/Comercial/VencedoresYAlternativas.xsql?LIC_ID={/Mantenimiento/LIC_ID}&amp;OFERTAS=4','Informe vencedores y 4 alternativas de la licitacion',70,70,0,0);"><xsl:value-of select="document($doc)/translation/texts/item[@name='VencedoresY4Alternativas']/node()"/></a></strong>
					</td>
				</tr>
				<tr class="sinLinea">
					<td class="datosLeft" style="width:100px">&nbsp;</td>
					<td class="datosLeft">
						<strong><a href="javascript:MostrarPagPersonalizada('http://www.newco.dev.br/Gestion/Comercial/licInformePorProveedor.xsql?LIC_ID={/Mantenimiento/LIC_ID}','Informe productos adjudicados de la licitacion',70,70,0,0);"><xsl:value-of select="document($doc)/translation/texts/item[@name='Productos_adjudicados_por_proveedor']/node()"/></a></strong>
					</td>
				</tr>
				<tr class="sinLinea">
					<td class="datosLeft" style="width:100px">&nbsp;</td>
					<td class="datosLeft">
						<strong><a href="javascript:MostrarPagPersonalizada('http://www.newco.dev.br/Gestion/Comercial/licInformeProveedoresYOfertas.xsql?LIC_ID={/Mantenimiento/LIC_ID}','Informe proveedores y ofertas de la licitacion',70,70,0,0);"><xsl:value-of select="document($doc)/translation/texts/item[@name='Proveedores_y_ofertas']/node()"/></a></strong>
					</td>
				</tr>
				<tr class="sinLinea">
					<td class="datosLeft" style="width:100px">&nbsp;</td>
					<td class="datosLeft">
						<strong><a href="javascript:MostrarPagPersonalizada('http://www.newco.dev.br/Gestion/Comercial/licInformeResumen.xsql?LIC_ID={/Mantenimiento/LIC_ID}','Informe resumen de la licitacion',70,70,0,0);"><xsl:value-of select="document($doc)/translation/texts/item[@name='Informe_resumen_licitacion']/node()"/></a></strong>
					</td>
				</tr>
				...
				<tr class="sinLinea">
					<td class="datosLeft" style="width:100px">&nbsp;</td>
					<td class="datosLeft">
						<strong><a href="javascript:MostrarPagPersonalizada('http://www.newco.dev.br/Gestion/Comercial/licInformePedidos.xsql?LIC_ID={/Mantenimiento/LIC_ID}','Informe pedidos de la licitacion',70,70,0,0);"><xsl:value-of select="document($doc)/translation/texts/item[@name='Informe_pedidos_licitacion']/node()"/></a></strong>
					</td>
				</tr>
				</xsl:if>
			</tbody>
