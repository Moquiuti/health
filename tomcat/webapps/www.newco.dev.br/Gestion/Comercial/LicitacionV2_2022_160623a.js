...
//	Ultima revisión ET 16jun23 15:25 LicitacionV2_2022_160623a.js
...
function AbrirProducto(Pos, Foco)
{
	...
	var linTablaOfertas='<tr id="OFE_[LIC_OFE_ID]" class="filaOferta conhover">'
					...
					+'<td class="textLeft">[CUMPLE_PED_MIN]<a href="javascript:FichaEmpresa([IDPROVEEDOR],\'DOCUMENTOS\');">[NOTAPROV][PROVEEDOR]</a>'
	...
	else 
	{
		...
		for (var i=0; i<arrProductos[Pos].Ofertas.length;++i)
		{
			...
			Linea=Linea.replaceAll('[SPANCONSUMO]','<span class="'+Color+'">'+Consumo+'</span>');		//19set22 CUidado, antes FormatoNumero(arrProductos[Pos].Ofertas[i].CONSUMO
