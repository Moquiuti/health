...
<!-- 
	Template para la pestaña de productos de la licitación. Disenno 2022
	ultima revision: ET 27abr23 10:40
-->
...
<div id="lProductos" class="marginTop80" style="display:none;">
	...
	<div id="topPesProds">
		...
		<div id="pagAnterior" class="divLeft floatLeft w120px textLeft marginLeft20 lineHeight30">&nbsp;</div>
		<!-- Desplegable para numProductos en pagina, leyenda paginacion y desplegable tipo vista -->
		<div id="pagTamanyo" class="divLeft floatLeft w800px textLeft marginLeft20 lineHeight30 fuentePeq">
			...
			<!-- Leyenda paginacion -->
			<span id="paginacion marginLeft20"></span>
			...
			<span id="vistaTabla" class="marginLeft20">
		...
		<div id="pagSiguiente" class="divLeft floatLeft w120px textLeft marginLeft20 lineHeight30 fondoGris">&nbsp;</div>
	</div>
	...
	<div>
			<a class="btnDestacadoPeq" id="botonAdjudicarSelec" href="javascript:AdjudicarOfertas();">
	...
	<xsl:if test="/Mantenimiento/LICITACION/AUTOR and /Mantenimiento/LICITACION/LIC_PORPRODUCTO = 'S' and (/Mantenimiento/LICITACION/LIC_IDESTADO = 'INF' or /Mantenimiento/LICITACION/LIC_IDESTADO = 'CURS')">
		...
		<xsl:if test="/Mantenimiento/LICITACION/LIC_IDESTADO != 'CONT'">
			<a class="btnDestacadoPeq" id="botonActualizar2" href="javascript:ValidarFormulario(document.forms['ActualizarProductos'],'actualizarProductos', 1);">
		...
		<xsl:if test="/Mantenimiento/LICITACION/LIC_MULTIOPCION!='S'">
			<a class="btnDestacadoPeq" id="botonSelecMejPrecios" href="javascript:SeleccionarMejoresPrecios();">
				<xsl:value-of select="document($doc)/translation/texts/item[@name='seleccionar_mejores_precios']/node()"/>
			</a>&nbsp;
			<a class="btnDestacadoPeq" id="botonGuardarSelec" href="javascript:GuardarSeleccion();"><xsl:value-of select="document($doc)/translation/texts/item[@name='guardar_seleccion']/node()"/></a>
		</xsl:if>
		</span>
	</xsl:if>

	<div class="tabela">
	<table id="lProductos_OFE" width="100%">
	<thead class="cabecalho_tabela">
		<tr class="subTituloTabla">
			<!-- Info Productos por parte del Cliente -->
			<th rowspan="2" class="textLeft">
				...
				<span class="w20px floatLeft h1px">&nbsp;</span><!--sirve para fijar el ancho minimo de la columna-->
			</th>
			<th rowspan="2" class="textLeft w100px">
				...
				<span class="w100px floatLeft h1px">&nbsp;</span>
			</th>
			<th rowspan="2" class="textLeft">
				<!-- Permitimos ordenacion -->
				...
				<input type="text" name="filtroProductos" id="filtroProductos" class="campopesquisa w100px" />&nbsp;
				<a href="javascript:filtrarProductosBeforeAjax();" class="btnDiscreto"><xsl:value-of select="document($doc)/translation/texts/item[@name='buscar']/node()"/></a>
				<span class="w250px floatLeft h1px">&nbsp;</span>
			</th>
			<th rowspan="2" class="w1px">&nbsp;</th><!-- iconos para los campos avanzados -->
			<th rowspan="2" class="textLeft">
				<!-- Permitimos ordenacion -->
				...
				<span class="w30px floatLeft h1px">&nbsp;</span>
			</th>
			<th rowspan="2" class="textLeft">&nbsp;<xsl:value-of select="document($doc)/translation/texts/item[@name='unidad_basica_abr']/node()"/>&nbsp;</th>
			...
			<th rowspan="2" class="textLeft">
				...
				<span class="w70px floatLeft h1px">&nbsp;</span>
			</th>
<!--
		<xsl:choose>
		<xsl:when test="not(/Mantenimiento/LICITACION/MOSTRAR_PRECIO_IVA)">
			<th rowspan="2" class="textLeft">&nbsp;<xsl:copy-of select="document($doc)/translation/texts/item[@name='precio_historico_sIVA_abr_2line']/node()"/>&nbsp;</th>
			<th rowspan="2" class="textLeft">&nbsp;<xsl:copy-of select="document($doc)/translation/texts/item[@name='precio_objetivo_sIVA_abr_2line']/node()"/>&nbsp;</th>
		</xsl:when>
		<xsl:otherwise>
			<th rowspan="2" class="textLeft">&nbsp;<xsl:copy-of select="document($doc)/translation/texts/item[@name='precio_historico_cIVA_abr_2line']/node()"/>&nbsp;</th>
			<th rowspan="2" class="textLeft">&nbsp;<xsl:copy-of select="document($doc)/translation/texts/item[@name='precio_objetivo_cIVA_abr_2line']/node()"/>&nbsp;</th>
		</xsl:otherwise>
		</xsl:choose>
-->
			<th rowspan="2" class="textLeft">&nbsp;<xsl:value-of select="document($doc)/translation/texts/item[@name='cantidad']/node()"/>&nbsp;</th>
		...
		<xsl:when test="/Mantenimiento/LICITACION/IDPAIS != '55'">
			<th rowspan="2" class="textLeft">
                <xsl:attribute name="class"><xsl:if test="/Mantenimiento/LICITACION/IDPAIS != '55'">textLeft</xsl:if></xsl:attribute>
                &nbsp;<xsl:copy-of select="document($doc)/translation/texts/item[@name='iva']/node()"/>&nbsp;
            </th>
		</xsl:when>
		<xsl:otherwise>
			<th rowspan="2" class="textLeft">&nbsp;</th>
		</xsl:otherwise>
		</xsl:choose>
		...
		<xsl:for-each select="/Mantenimiento/LICITACION/PRODUCTOSLICITACION/PROVEEDORESLICITACION/PROVEEDOR">
			<xsl:if test="TIENE_OFERTAS">	<!--	solo proveedores con ofertas		-->
				<th class="colNomProv textCenter bordeIzqGris w120px" colspan="4">
				<xsl:choose>
				<xsl:when test="/Mantenimiento/LICITACION/AUTOR and /Mantenimiento/LICITACION/LIC_PORPRODUCTO = 'S' and (/Mantenimiento/LICITACION/LIC_IDESTADO = 'CURS' or /Mantenimiento/LICITACION/LIC_IDESTADO = 'INF')">
					<a href="javascript:seleccionarPreciosProveedor({COLUMNA});">
		...
		<xsl:for-each select="/Mantenimiento/LICITACION/PRODUCTOSLICITACION/PROVEEDORESLICITACION/PROVEEDOR">
			<xsl:if test="TIENE_OFERTAS">	<!--	9set16	solo proveedores con ofertas		-->
				...
				<th class="zerouno bordeIzqGris">&nbsp;</th>
				<xsl:choose>
				<xsl:when test="not(/Mantenimiento/LICITACION/MOSTRAR_PRECIO_IVA)">
				...
				<!-- Columna para la imagen de la evaluacion de la oferta -->
				<th class="colEval" style="display:none;"><xsl:copy-of select="document($doc)/translation/texts/item[@name='evaluacion_abr']/node()"/></th>
				<!-- Columna para la imagen si existe ficha tecnica y imagenes si existen campos avanzados -->
				<th class="colInfo" style="display:none;">&nbsp;</th>
			</xsl:if>
		</xsl:for-each>
	...
	<tbody class="corpo_tabela_oculto"></tbody>
	...
	<xsl:if test="/Mantenimiento/LICITACION/AUTOR"><!-- 1set16	No para licitaciones agregadas	-->
		<div style="margin-top: 20px;"><!--Boton actualizar bajo la tabla	-->
			<a class="btnDestacadoPeq" id="botonActualizar" href="javascript:ValidarFormulario(document.forms['ActualizarProductos'],'actualizarProductos', 1);">
				<xsl:attribute name="style">
					<xsl:choose>
					<xsl:when test="/Mantenimiento/LICITACION/LIC_IDESTADO = 'CONT'">margin:10px 0 0 200px;display:none;</xsl:when>
					<xsl:otherwise>margin:10px 0 0 200px;</xsl:otherwise>
					</xsl:choose>
				</xsl:attribute>
				<xsl:value-of select="document($doc)/translation/texts/item[@name='actualizar_datos']/node()"/>
			</a>&nbsp;
			<xsl:if test="(/Mantenimiento/LICITACION/LIC_IDESTADO = 'EST') or (/Mantenimiento/LICITACION/LIC_IDESTADO = 'COMP')">
				<a class="btnDestacadoPeq" id="botonBorrarProductos" href="javascript:BorrarTodosProductos();">
			...
			<tfoot>
				<tr>
					...
					<td colspan="2">
						...
						<!--<div class="boton">-->
							<a class="btnDestacadoPeq" href="javascript:guardarCamposAvanzadosProd();">
		...
		<div class="divLeft" style="margin-top:20px">
			<table class="infoTable">
				<tr>
					...
					<td class="cinco">&nbsp;</td>
					<td class="quince">
							<a class="btnDestacadoPeq" id="botonAdjudicarSelec" ref="javascript:AdjudicarOfertas();">
								<xsl:if test="/Mantenimiento/LICITACION/PRODUCTOSLICITACION/PRODUCTOS_OLVIDADOS">
									<xsl:attribute name="class">grey</xsl:attribute>
								</xsl:if>
								<xsl:value-of select="document($doc)/translation/texts/item[@name='adjudicar']/node()"/>
...
<!--								<xsl:sort select="number(translate(listItem,'%',''))"/>-->
				...
				<tr>
					...
					<td>
						<!--<div class="boton">-->
							<a class="btnDestacadoPeq" href="javascript:ValidarFormulario(document.forms['CatPrivProductos'],'productos_2');">
		...
		<tr id="TblRefProductos"><td colspan="4">
			...
			<form id="RefProductos" name="RefProductos" method="post">
				...
				<tr>
					...
					<td class="datosLeft">
						<a class="btnNormal" href="javascript:MostrarPagPersonalizada('http://www.newco.dev.br/Administracion/Mantenimiento/Productos/CatalogoPrivadoProductoEmpresa2022.xsql?IDEMPRESA={/Mantenimiento/LICITACION/IDEMPRESACATALOGO}&amp;ORIGEN=LICITACION','Catálogo Privado',50,80,90,20);">
...
<div id="lProductos" class="marginTop80" style="display:none;">
	...
	<div id="topPesProds" class="posCabTablaProd">
		<!-- Link a pagina anterior -->
		<div id="pagAnterior" class="floatLeft w100px" >&nbsp;</div>
		<!-- Desplegable para numProductos en pagina, leyenda paginacion y desplegable tipo vista -->
		<div id="pagTamanyo" class="floatLeft w800px">
			<xsl:value-of select="document($doc)/translation/texts/item[@name='tamanyo_pagina']/node()"/>:&nbsp;
			<select name="numRegistros" id="numRegistros" style="font-size:11px;">
				<option value="10">10 <xsl:value-of select="document($doc)/translation/texts/item[@name='productos']/node()"/></option>
	...
	<thead>
		<tr class="subTituloTabla">
			...
			<td class="w1px">&nbsp;</td><!-- iconos para los campos avanzados -->
...
<!--								<xsl:sort select="number(translate(listItem,'%',''))"/>-->
		...
		<tr id="TblRefProductos"><td colspan="4">
			...
			<form id="RefProductos" name="RefProductos" method="post">
				<tr>
					<td class="veinte">&nbsp;</td>
					<td colspan="3" class="datosLeft fuentePeq"><xsl:value-of select="document($doc)/translation/texts/item[@name='leyenda_nuevo_poducto_X_ref_licitaciones']/node()"/>:&nbsp;
				...
				<tr>
					...
					<td class="datosLeft" style="padding-left:5px;">
						<a class="btnNormal" href="javascript:MostrarPagPersonalizada('http://www.newco.dev.br/Administracion/Mantenimiento/Productos/CatalogoPrivadoProductoEmpresa2022.xsql?IDEMPRESA={/Mantenimiento/LICITACION/IDEMPRESACATALOGO}&amp;ORIGEN=LICITACION','Catálogo Privado',50,80,90,20);">
							<xsl:value-of select="document($doc)/translation/texts/item[@name='abrir_catalogo']/node()"/>
						<!--<xsl:choose>
						<xsl:when test="Mantenimiento/LICITACION/IDPAIS = '34'">
...
<div id="lProductos" class="marginTop80" style="display:none;">
	...
	<xsl:when test="/Mantenimiento/LICITACION/PRODUCTOSLICITACION/PRODUCTO and /Mantenimiento/LICITACION/PERMITIR_EDICION">
		...
		<table class="divLeft" id="lPedidoMinimo"  cellspacing="6px" cellpadding="6px">
		...
		<thead>
			<tr>
				<td colspan="2">
					<div class="marginLeft20 w90 textCenter">
						<div class="expliProvLic">
			...
			<tr class="sinLinea">
				...
				<td class="datosLeft">
					<xsl:call-template name="desplegable">
						...
						<xsl:with-param name="class">w100px</xsl:with-param>
					</xsl:call-template>
				</td>
			</tr>
			<tr class="sinLinea">
				...
				<td class="datosLeft">
					<input type="text" class="campopesquisa w100px" name="LIC_PROV_PEDIDOMINIMO" id="pedido_minimo" value="{Mantenimiento/LICITACION/PRODUCTOSLICITACION/LIC_PROV_PEDIDOMINIMO}"/>
				</td>
			</tr>
			...
			<tr class="sinLinea">
				...
				<td class="datosLeft">
                	...
                	<span class="cargado fuentePeq"><xsl:value-of select="document($doc)/translation/texts/item[@name='documento_cargado']/node()"/>!</span>
            		</div>
				</td>
			</tr>
		...
		<xsl:when test="/Mantenimiento/LICITACION/LIC_PORPRODUCTO = 'S'">
			<div class="divLeft">
				<div class="destacado">
					<xsl:value-of select="document($doc)/translation/texts/item[@name='productos_sin_ofertar_expli']/node()"/><br/>
					<xsl:value-of select="document($doc)/translation/texts/item[@name='informar_precio_cero_expli']/node()"/>
				</div>
			</div>
		</xsl:when>
		<xsl:otherwise>
			<div class="divLeft">
				<div class="destacado">
					<xsl:value-of select="document($doc)/translation/texts/item[@name='informar_precio_cero_expli']/node()"/><br/>
				</div>
			</div>
		</xsl:otherwise>
		</xsl:choose>
		
		<xsl:if test="/Mantenimiento/LICITACION/PRODUCTOSLICITACION/INCLUYE_PROGRAMACION">
			<div class="divCenter w800px">
				<div class="urgente">
					<xsl:value-of select="document($doc)/translation/texts/item[@name='Licitacion_incluye_programacion']/node()"/><br/>
				</div>
				<br/>
			</div>
		</xsl:if>
		...
		<table class="buscador" id="lProductos_PROVE" cellspacing="6px" cellpadding="6px">
		<thead>
			<tr class="subTituloTabla">
				<td class="w1px">
					<!-- Permitimos ordenacion por productos no informados-->
				...
				<td class="w50px"><xsl:value-of select="document($doc)/translation/texts/item[@name='ref_cliente']/node()"/></td>
				<td class="w1px">&nbsp;</td>
				<td class="w1px">&nbsp;</td><!-- columna iconos campos avanzados producto informados -->
				<td class="textLeft">
					<!-- Permitimos ordenacion -->
					<a href="javascript:OrdenarProdsPorColumna('NombreNorm');" style="text-decoration:none;" id="anchorNombre">
						<xsl:value-of select="document($doc)/translation/texts/item[@name='nombre']/node()"/>
				...
				<xsl:otherwise>
					<td class="w50px"><xsl:value-of select="document($doc)/translation/texts/item[@name='ref_proveedor']/node()"/></td>
				</xsl:otherwise>
				</xsl:choose>
				<!--Quitamos el registro sanitario de la fila  principal, lo dejamos junto al resto de nuevos campos	-->
				<!--20feb23 <xsl:choose>
				<xsl:when test="/Mantenimiento/LICITACION/LIC_INCLUIR_REGSANITARIO='S'">
					<td class="w50px"><xsl:value-of select="document($doc)/translation/texts/item[@name='reg_sanitario']/node()"/></td>
				</xsl:when>
				<xsl:otherwise>
					<td class="w1px">&nbsp;</td>
				</xsl:otherwise>
				...
				<td class="w50px"><xsl:value-of select="document($doc)/translation/texts/item[@name='lic_marca']/node()"/></td>
				<td class="w60px"><xsl:value-of select="document($doc)/translation/texts/item[@name='unidad_basica']/node()"/></td>
				<td class="w70px"><xsl:value-of select="document($doc)/translation/texts/item[@name='Cant_']/node()"/></td>
				<td class="w50px"><xsl:copy-of select="document($doc)/translation/texts/item[@name='ud_por_lote_2line']/node()"/></td>
				<xsl:if test="/Mantenimiento/LICITACION/PRODUCTOSLICITACION/MOSTRAR_PRECIO_OBJETIVO">
					<td class="w50px"><xsl:copy-of select="document($doc)/translation/texts/item[@name='precio_objetivo_sIVA_2line']/node()"/></td>
				</xsl:if>
				<td class="w50px"><xsl:copy-of select="document($doc)/translation/texts/item[@name='precio_2line']/node()"/></td>
				<td>&nbsp;</td>					<!-- Celda para el boton de datos ampliados -->
				<xsl:choose>
				<xsl:when test="/Mantenimiento/LICITACION/IDPAIS != '55'">
					<td class="w30px"><xsl:value-of select="document($doc)/translation/texts/item[@name='tipo_iva']/node()"/></td>
				</xsl:when>
				<xsl:otherwise>
					<td class="w1px">&nbsp;</td>
				</xsl:otherwise>
				</xsl:choose>
				<td class="w130px">&nbsp;</td>	<!-- Botones Guardar / + / borrar -->
				<td class="w1px">&nbsp;</td>	<!-- Celda para mostrar la imagen con el resultado de la operacion de la celda anterior -->
			</tr>
		</thead>
		...
		<tfoot>
			...
			<tr class="sinLinea">
				...
				<td colspan="14">
					...
					<span class="fuentePeq"><xsl:value-of select="document($doc)/translation/texts/item[@name='expli_completaroferta']/node()"/></span>
					<br/><br/>
				</td>
			</tr>
			<tr class="sinLinea">
				<td colspan="16">&nbsp;</td>
				<td colspan="2">
					<a class="btnDestacadoPeq"  id="idGuardarTodasOfertas" style="display:none;" href="javascript:guardarTodasOfertasAjax(0);">
			...
			<tr class="sinLinea">
				<td colspan="18">
					<span class="fuentePeq"><xsl:value-of select="document($doc)/translation/texts/item[@name='Enviar_referencias_para_proveedor']/node()"/> 
					<xsl:if test="/Mantenimiento/LICITACION/IDPAIS!='55'">[:<xsl:value-of select="document($doc)/translation/texts/item[@name='tipo_iva']/node()"/></xsl:if>
					<xsl:if test="/Mantenimiento/LICITACION/LIC_INCLUIR_REGSANITARIO='S'">[:<xsl:value-of select="document($doc)/translation/texts/item[@name='reg_sanitario']/node()"/>:<xsl:value-of select="document($doc)/translation/texts/item[@name='Cod_Expediente']/node()"/>:<xsl:value-of select="document($doc)/translation/texts/item[@name='Cod_CUM']/node()"/>:<xsl:value-of select="document($doc)/translation/texts/item[@name='Cod_IUM']/node()"/><!--20feb23 :<xsl:value-of select="document($doc)/translation/texts/item[@name='Cod_Invima']/node()"/>-->:<xsl:value-of select="document($doc)/translation/texts/item[@name='Fecha_Limite']/node()"/>:<xsl:value-of select="document($doc)/translation/texts/item[@name='Clas_Riesgo']/node()"/>]]
					</xsl:if>
					</span>
					<br/>
...
-->
	...
	<xsl:when test="/Mantenimiento/LICITACION/PRODUCTOSLICITACION/PRODUCTO">
		<table class="buscador" id="lPedidoMinimo"  cellspacing="6px" cellpadding="6px">
			...
			<tfoot>
				<tr>
					...
					<td colspan="2">
						<input type="hidden" name="posArray" id="posArray"/>
						<!--<div class="boton">-->
							<a href="javascript:guardarCamposAvanzadosOfe();" class="btnDestacadoPeq">
								<xsl:value-of select="document($doc)/translation/texts/item[@name='guardar']/node()"/>
							</a>
							<!--&nbsp;<a href="javascript:showTabla(false);" class="btnNormal"><xsl:value-of select="document($doc)/translation/texts/item[@name='cerrar']/node()"/></a>-->
							&nbsp;<a href="javascript:cerrarCamposAvanzados();" class="btnNormal"><xsl:value-of select="document($doc)/translation/texts/item[@name='cerrar']/node()"/></a>
...
<!--	<xsl:when test="/Mantenimiento/LICITACION/PRODUCTOSLICITACION/PRODUCTO and (/Mantenimiento/LICITACION/LIC_IDESTADO = 'CURS' or /Mantenimiento/LICITACION/LIC_IDESTADO = 'INF') and (/Mantenimiento/LICITACION/PRODUCTOSLICITACION/LIC_PROV_IDESTADO = 'CURS' or /Mantenimiento/LICITACION/PRODUCTOSLICITACION/LIC_PROV_IDESTADO = 'INF')">-->
	...
	<form name="PublicarCompras" id="PublicarCompras" method="post">
		...
		<xsl:when test="/Mantenimiento/LICITACION/LIC_PORPRODUCTO = 'S'">
			<div class="divLeft">
				<div class="destacado">
					<strong><xsl:value-of select="document($doc)/translation/texts/item[@name='productos_sin_ofertar_expli']/node()"/></strong><br/>
		...
		<xsl:otherwise>
			<div class="divLeft">
				<div class="destacado">
					<strong><xsl:value-of select="document($doc)/translation/texts/item[@name='informar_precio_cero_expli']/node()"/></strong><br/>
				</div>
			</div>
		</xsl:otherwise>
		</xsl:choose>
		...
		<tr id="TblRefProductosCant"><td colspan="4">
			...
			<form id="RefProductosCant" name="RefProductosCant" method="post">
				<tr>
					...
					<td class="veinte">
						<a class="btnDestacadoPeq"  id="idGuardarTodasCantidades" style="display:none;" href="javascript:guardarTodosDatosCompraAjax(0);">
							<xsl:value-of select="document($doc)/translation/texts/item[@name='todos']/node()"/>
						</a>
					</td>
				</tr>
				...
				<tr>
					<td colspan="2">&nbsp;</td>
					<td>
						<a id="EnviarProductosCantPorRef" class="btnDestacadoPeq" href="javascript:ValidarFormulario(document.forms['RefProductosCant'],'productosCant');">
							<xsl:value-of select="document($doc)/translation/texts/item[@name='enviar_referencia']/node()"/>
						</a>
						<div id="idEstadoEnvio" style="display:none;"/>
					</td>
