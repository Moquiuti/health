...
//	Ultima revision ET 29set21 22:00 FichaProductoLicitacion_290921.js
...
function GuardarProductoSel(IDProdLic, Accion){
	...
	else if (OfertasSeleccionadas()>1)
	{
		...
		//solodebug	console.log('OfertasSeleccionadas. multOfertas:'+multOfertas+ 'cantAdjud:'+cantAdjud+'CantidadTotal:'+CantidadTotal);
...
function CompruebaCantidadCentrosProv()
{
	...
	//solodebug	debug('CompruebaCantidadCentrosProv.');
