...
//	Busca ID, asigna acción y envía formulario
function ComprobarSinonimo()
{
	document.forms[0].elements["ACCION"].value='COMPROBAR';
	document.forms[0].elements["PARAMETROS"].value=document.forms[0].elements["COMPROBAR"].value;
	
	if (document.forms[0].elements["COMPROBAR"].value!='') Enviar()
	else alert('Falta informar los sinónimos.');
}
