			...
			success: function(objeto){
				...
				if (data.DatosProducto.PRO_NOMBRE!='')		//	28oct16	Control errores
				{
                	...
                	txtHTML = "<td>"+" "+"</td>" + 
                            ...
                            "<td class='textLeft'><input type='text' class='campopesquisa w50px' name='NEWLINE_CANTIDAD' id='NEWLINE_CANTIDAD' size='10' value='" + data.DatosProducto.UN_LOTE+"'/></td>" +
