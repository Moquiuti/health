...
function DescargarExcel()
{
	...
	var modifProv='',rechazados='',docPendiente='',esPack='',enPack='',sinPrivados='',sinEmplantillar='',sinPrecioMVM='',sinOfertaMVM='',sinOfertaFNCP='',sinOfertaRecol='';
	...
	var param="IDCLIENTE="+idcliente+"&IDPROVEEDOR="+idproveedor+"&PRODUCTO="+producto+"&MODIFICADOSPROV="+modifProv+"&RECHAZADOS="+rechazados+"&DOC_PENDIENTE="+docPendiente
