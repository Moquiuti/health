...
<!--
	...
	ultima revision: ET 21abr22 10:30 MantenProductos_210422.js
-->
...
<head>
	...
	<script type="text/javascript" src="http://www.newco.dev.br/Administracion/Mantenimiento/Productos/MantenProductos_210422.js"></script>
	...
	var ncCentroCoste= '<xsl:value-of select="document($doc)/translation/texts/item[@name='Cod_cen_consumo']/node()"/>';
