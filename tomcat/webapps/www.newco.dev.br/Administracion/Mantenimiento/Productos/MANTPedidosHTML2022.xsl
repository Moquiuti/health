...
<!--
	...
	Ultima revision: ET 02ago22 12:15 MANTPedidos2022_040822.js
-->
...
<head>
	...
	<script type="text/javascript" src="http://www.newco.dev.br/Administracion/Mantenimiento/Pedidos/MANTPedidos2022_040822.js"></script>
		...
		<th class="uno">&nbsp;</th>
			...
			<xsl:for-each select="MantenimientoPedidos/MANTENIMIENTO/LISTAEMPRESAS/PEDIDO/LINEASPEDIDO/LINEAPEDIDO">
				<tr>
					...
					<td class="textLeft"><input type="text" class="campopesquisa" name="CANTIDAD_{LMO_ID}" size="4" value="{CANTIDAD}"/></td>
					<td class="textLeft">
						<xsl:choose>
						<xsl:when test="/MantenimientoPedidos/MANTENIMIENTO/LISTAEMPRESAS/MANTENIMIENTO_AVANZADO='S'">
