...
<!--
	...
	Ultima revision: ET 22feb22 11:15 EMPInfoCom2022_220222.js
-->
...
<head>
	...
	<script type="text/javascript" src="http://www.newco.dev.br/Administracion/Mantenimiento/Empresas/EMPInfoCom2022_220222.js"></script>
		...
		<p class="TituloPagina">
			...
			<xsl:if test="/InfoCom/EMPRESA/MVM or /InfoCom/EMPRESA/MVMB">
				<a class="btnNormal" style="text-decoration:none;">
					<xsl:attribute name="href">javascript:AbrirManten(<xsl:value-of select="EMP_ID"/>);</xsl:attribute>
...
<xsl:template name="condComercialProveedor">
  ...
  <!-- solo se muestra la tabla resumen (como pop-up) para fichas de proveedores (acceso para usuarios MVM y MVMB) -->
	...
	<div class="divCenter w1200px">
		<div class="indicadores">
			<div class="titulo_indicadores">&nbsp;<xsl:value-of select="document($doc)/translation/texts/item[@name='pedidos_90d']/node()"/>&nbsp;</div>
			<div class="meio_indicadores positivo"><xsl:value-of select="/InfoCom/EMPRESA/RESUMENPROVEEDORES/PROVEEDOR/EIS_PROV_NUMEROPEDIDOS"/></div>
			<div class="rodape_indicadores positivo"><xsl:value-of select="/InfoCom/EMPRESA/DIVISA/PREFIJO"/><xsl:value-of select="/InfoCom/EMPRESA/RESUMENPROVEEDORES/PROVEEDOR/EIS_PROV_IMPORTEPEDIDOS"/><xsl:value-of select="/InfoCom/EMPRESA/DIVISA/SUFIJO"/></div>
		</div>
		<div class="indicadores">
			<div class="titulo_indicadores">&nbsp;<xsl:value-of select="document($doc)/translation/texts/item[@name='pedidos_retr_90d']/node()"/>&nbsp;</div>
			<div class="meio_indicadores negativo"><xsl:value-of select="/InfoCom/EMPRESA/RESUMENPROVEEDORES/PROVEEDOR/EIS_PROV_NUMPEDIDOSRETRASADOS"/></div>
			<div class="rodape_indicadores negativo"><xsl:value-of select="/InfoCom/EMPRESA/RESUMENPROVEEDORES/PROVEEDOR/EIS_PROV_PORCPEDIDOSRETRASADOS"/>%</div>
		</div>
		<div class="indicadores">
			<div class="titulo_indicadores">&nbsp;<xsl:value-of select="document($doc)/translation/texts/item[@name='pedidos_parc_90d']/node()"/>&nbsp;</div>
			<div class="meio_indicadores negativo"><xsl:value-of select="/InfoCom/EMPRESA/RESUMENPROVEEDORES/PROVEEDOR/EIS_PROV_NUMPEDIDOSPARCIALES"/></div>
			<div class="rodape_indicadores negativo"><xsl:value-of select="/InfoCom/EMPRESA/RESUMENPROVEEDORES/PROVEEDOR/EIS_PROV_PORCPEDIDOSPARCIALES"/>%</div>
		</div>
		<div class="indicadores">
			<div class="titulo_indicadores">&nbsp;<xsl:value-of select="document($doc)/translation/texts/item[@name='retraso_medio_90d']/node()"/>&nbsp;</div>
			<div class="meio_indicadores negativo"><xsl:value-of select="/InfoCom/EMPRESA/RESUMENPROVEEDORES/PROVEEDOR/EIS_PROV_RETRASOMEDIO"/></div>
			<div class="rodape_indicadores negativo"><xsl:value-of select="/InfoCom/EMPRESA/RESUMENPROVEEDORES/PROVEEDOR/EIS_PROV_RETRASODIAS"/></div>
		</div>
		<div class="indicadores">
			<div class="titulo_indicadores">&nbsp;<xsl:value-of select="document($doc)/translation/texts/item[@name='licitaciones_90d']/node()"/>&nbsp;</div>
			<div class="meio_indicadores positivo"><xsl:value-of select="/InfoCom/EMPRESA/RESUMENPROVEEDORES/PROVEEDOR/EIS_PROV_LICITACIONES"/></div>
			<div class="rodape_indicadores positivo">&nbsp;</div>
		</div>
		<div class="indicadores">
			<div class="titulo_indicadores">&nbsp;<xsl:value-of select="document($doc)/translation/texts/item[@name='lic_ofertadas_90d']/node()"/>&nbsp;</div>
			<div class="meio_indicadores positivo"><xsl:value-of select="/InfoCom/EMPRESA/RESUMENPROVEEDORES/PROVEEDOR/EIS_PROV_LICITACIONESRESP"/></div>
			<div class="rodape_indicadores positivo"><xsl:value-of select="/InfoCom/EMPRESA/RESUMENPROVEEDORES/PROVEEDOR/EIS_PROV_LIC_RATIORESPTOT"/>%</div>
		</div>
		<div class="indicadores">
			<div class="titulo_indicadores">&nbsp;<xsl:value-of select="document($doc)/translation/texts/item[@name='lic_ganadas_90d']/node()"/>&nbsp;</div>
			<div class="meio_indicadores positivo"><xsl:value-of select="/InfoCom/EMPRESA/RESUMENPROVEEDORES/PROVEEDOR/EIS_PROV_LICITACIONESGANADAS"/></div>
			<div class="rodape_indicadores positivo"><xsl:value-of select="/InfoCom/EMPRESA/RESUMENPROVEEDORES/PROVEEDOR/EIS_PROV_LIC_RATIOGANRESP"/>%</div>
		</div>
	</div>
...
<!--	
  ...
  <div class="divLeft tablas70" id="pestanaCondicParticDiv" style="margin-top:30px;">
		...
		<tr class="sinLinea">
			<td class="uno">&nbsp;</td>
			<td class="x150px labelRight"><xsl:value-of select="document($doc)/translation/texts/item[@name='codigo']/node()"/>:&nbsp;</td>
			<td class="datosLeft" colspan="3">
				<xsl:choose>
				<xsl:when test="/InfoCom/EMPRESA/EDITAR_INFO_COMERCIAL">
					<input type="text" class="campopesquisa w100px" name="COP_CODIGO" id="COP_CODIGO" value="{/InfoCom/EMPRESA/CONDICIONES/COP_CODIGO}"/>
				</xsl:when>
				<xsl:otherwise>
		...
		<xsl:when test="/InfoCom/EMPRESA/EMP_IDPAIS=55">
			<tr class="sinLinea">
				...
				<xsl:choose>
				<xsl:when test="/InfoCom/EMPRESA/EDITAR_INFO_COMERCIAL">
						<input type="text" class="campopesquisa w300px" name="COP_NOMBREBANCO" id="COP_NOMBREBANCO" size="20" value="{/InfoCom/EMPRESA/CONDICIONES/COP_NOMBREBANCO}"/>
				</xsl:when>
				<xsl:otherwise>
				...
				<xsl:choose>
				<xsl:when test="/InfoCom/EMPRESA/EDITAR_INFO_COMERCIAL">
						<input type="text" class="campopesquisa w100px" name="COP_CODBANCO" id="COP_CODBANCO" size="6" value="{/InfoCom/EMPRESA/CONDICIONES/COP_CODBANCO}"/>
				</xsl:when>
				<xsl:otherwise>
				...
				<xsl:choose>
				<xsl:when test="/InfoCom/EMPRESA/EDITAR_INFO_COMERCIAL">
						<input type="text"  class="campopesquisa w100px" name="COP_CODOFICINA" id="COP_CODOFICINA" size="6" value="{/InfoCom/EMPRESA/CONDICIONES/COP_CODOFICINA}"/>
				</xsl:when>
				<xsl:otherwise>
				...
				<xsl:choose>
				<xsl:when test="/InfoCom/EMPRESA/EDITAR_INFO_COMERCIAL">
					<input type="text" class="campopesquisa w300px" name="COP_CODCUENTA" id="COP_CODCUENTA" size="15" value="{/InfoCom/EMPRESA/CONDICIONES/COP_CODCUENTA}"/>
				</xsl:when>
				<xsl:otherwise>
