...
<!--
 | ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 |
 | Fichero.......: ZonaEmpresaHTML.xsl
 | Autor.........: E.T.
 | Fecha.........: 14/2/2002
 | Descripcion...: Presenta la lista de empresas y permite el mantenimiento de las mismas
 | Funcionamiento: 
 |
 |Modificaciones:
  ...
  <xsl:template match="/">
    <html>
	 ...
	 <script type="text/javascript" src="http://www.newco.dev.br/General/basic_180608.js"></script>
		...
		{
		var IDUsuario = ]]></xsl:text><xsl:value-of select="ZonaEmpresa/US_ID"/>;<xsl:text disable-output-escaping="yes"><![CDATA[

     	   	parent.areaTrabajo.location.href='./EMPNueva.xsql?IDUSUARIO='+IDUsuario+']]></xsl:text><xsl:if test="//ZonaEmpresa/AREAEMPRESA/EMPRESAS/EDICION"><xsl:text disable-output-escaping="yes"><![CDATA[&]]></xsl:text>ADMINISTRADORMVM=ADMINISTRADORMVM</xsl:if><xsl:text disable-output-escaping="yes"><![CDATA[';
     	} 
	...
	{
   		parent.areaTrabajo.location.href='./ListadoEmpresas.xsql';
    } 
	
    function ListadoCentros() 
	{
   		parent.areaTrabajo.location.href='./BuscadorCentros.xsql';
    } 

    function ControlUsuarios() 
	{
   		parent.areaTrabajo.location.href='./ListaUsuariosControl.xsql';
    } 
      ...
      <form action="ZonaEmpresa.xsql" name="Centros" method="POST">
			...
			<input type="hidden" name="IDNUEVAEMPRESA">
		   		<xsl:attribute name="value"><xsl:value-of select="ZonaEmpresa/AREAEMPRESA/EMPRESAS/field/@current"/>
				</xsl:attribute>
			</input>
			
			<input type="hidden" name="IDNUEVOCENTRO">
		   		<xsl:attribute name="value"><xsl:value-of select="ZonaEmpresa/AREAEMPRESA/CENTROS/field/@current"/>
				</xsl:attribute>
			</input>
      ...
      <!--idioma fin-->
		...
		<table class="plantilla">
            ...
            <br/>
            <!--USUARIOS DEL CENTRO-->
            <table class="plantilla" border="0">
                <tr height="25px">
                	<th>&nbsp;</th>
                	<th colspan="3">
