...
<!--
	Ficha de centro
	9set16	Incluir pestañas para gestión de documentos
...
<tbody>
	<tr>
		...
		<td class="veinte label" rowspan="3">
			<img src="http://www.newco.dev.br/Documentos/{/Mantenimiento/form/CENTRO/URL_LOGOTIPO}" height="80px" width="160px" style="padding-left:10px"/>
		</td>
		<td class="label quince">
			<xsl:value-of select="document($doc)/translation/texts/item[@name='centro']/node()"/>&nbsp;<xsl:value-of select="document($doc)/translation/texts/item[@name='nif']/node()"/>:
		</td>
		<td>
	...
	<tr>
    	<td>&nbsp;</td>
		<td class="label"><xsl:value-of select="document($doc)/translation/texts/item[@name='direccion']/node()"/>:</td>
		<td>
    ...
    <tr>
        ...
        <td><xsl:value-of select="/Mantenimiento/form/CENTRO/CEN_TELEFONO" /></td>
    </tr>
	...
	<tr>
    	<td colspan="2">&nbsp;</td>
		<td class="label"><xsl:value-of select="document($doc)/translation/texts/item[@name='numero_de_camas']/node()"/>:</td>
		<td><xsl:value-of select="CEN_CAMAS"/><xsl:if test="CEN_CAMAS = ''">-</xsl:if></td>
    </tr>
    <tr>
    	<td colspan="2">&nbsp;</td>
		<td class="label"><xsl:value-of select="document($doc)/translation/texts/item[@name='quirofanos']/node()"/>:</td>
		<td><xsl:value-of select="CEN_QUIROFANOS"/><xsl:if test="CEN_QUIROFANOS = ''">-</xsl:if></td>
	</tr>
	</xsl:if>
	...
	<tr>
    	<td colspan="2">&nbsp;</td>
		<td class="label"> <xsl:value-of select="document($doc)/translation/texts/item[@name='empresa']/node()"/>:</td>
		<td>
