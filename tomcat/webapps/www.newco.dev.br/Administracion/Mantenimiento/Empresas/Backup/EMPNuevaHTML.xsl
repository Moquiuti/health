...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="/">  
    <html>
     ...
     <script type="text/javascript" src="http://www.newco.dev.br/Administracion/Mantenimiento/Empresas/EMPNueva100914.js"></script>
...
<!--idioma-->
 ...
 <div class="divLeft">
  <table class="infoTable">
	...
	<input type="text" size="50" maxlength="100" name="EMP_NOMBRE"/>
      </td>
      <td class="quince labelRight">
	...
	<input type="text" size="20" maxlength="20" name="EMP_NIF"/>
	<br/>
	...
	<xsl:call-template name="field_funcion">
      ...
      <td class="datosLeft">
	<input type="text" size="25" maxlength="200" name="EMP_POBLACION"/> 	     
      </td>
    </tr>	
    <tr>
       <td class="labelRight">
      ...
      <td class="datosLeft">
	<input type="text" size="25" maxlength="50" name="EMP_TELEFONO"/> 	     
      </td>
       <td class="labelRight">
         <xsl:value-of select="document($doc)/translation/texts/item[@name='fax']/node()"/>:
      </td>
      <td class="datosLeft">  
	 <input type="text" size="25" maxlength="50" name="EMP_FAX"/>
      </td>
    </tr> 
    <tr>
      <td class="labelRight">
      ...
      <td class="datosLeft">
       ...
       <td class="datosLeft" >
		<input type="text" size="25" maxlength="200" name="EMP_ZONACOMERCIAL" value="España"/>
      </td>
    </tr>
    <tr>
       <td class="labelRight">
...
<!--    <tr>
    ...
    <tr>
      ...
      <td colspan="3" class="datosLeft"> 
              <input type="checkbox" name="EMP_SERVICIOSCDC"/>
           	  <xsl:text>&nbsp;&nbsp;&nbsp;</xsl:text>
    ...
    <tr>
      ...
      <td colspan="3" class="datosLeft"> 
              <input type="checkbox" name="EMP_EXTERNA"/>
              <xsl:text>&nbsp;&nbsp;&nbsp;</xsl:text>
 ...
 <br/>
  ...
  <table class="infoTable">
    ...
    <tr>
      ...
      <td class="datosLeft">
        <input type="text" size="35" maxlength="200" name="DEP_NOMBRE"/>
      </td>
    </tr>
  </table>
  ...
  <table style="width:100%;">
    <tr>
      ...
      <td class="veinte">
      	<div class="boton">
        	<a href="javascript:EnviaNuevaEmpresa(document.forms['BuscaEmpresa'],'EMPNuevaSave.xsql?EMP_ID=0&amp;DESDE=Alta');">
...
<xsl:template name="GENERAL_TEXTBOX">
  ...
  <input type="text" name="{$nom}" size="{$size}" maxlength="{$maxlength}"/>     
</xsl:template>
...
<xsl:template name="GENERAL_TEXTBOX_COMPRAS">
  ...
  <xsl:param name="size">25</xsl:param>
  <xsl:param name="maxlength">100</xsl:param>
  <input type="text" name="{$nom}" size="{$size}" maxlength="{$maxlength}" onChange="this.value=toInteger(this.value)">     
  </input>
</xsl:template>
