...
function globalEvents(){
	...
	/*jQuery("#verParteProveedor").click (function() { jQuery('#soloCliente').hide(); 
													 jQuery('#soloProveedor').show(); 
													 jQuery('#tdParteProveedor').css("background","#becff4"); 
													 jQuery('#tdParteProveedor').css("border","2px solid #3b5998"); 
													 jQuery('#tdParteCliente').css("background","#e4e4e5"); 
													 jQuery('#tdParteCliente').css("border","0"); 
													});

	jQuery("#verParteCliente").click (function() { jQuery('#soloProveedor').hide(); 
												   jQuery('#soloCliente').show();
												   jQuery('#tdParteProveedor').css("background","#e4e4e5");
												    jQuery('#tdParteProveedor').css("border","0"); 
												   jQuery('#tdParteCliente').css("background","#becff4");
												    jQuery('#tdParteCliente').css("border","2px solid #3b5998"); 
												  });
*/
}//fin de globalEvents
...
function privilegiosUsuario(){
        	  var esAdministrador;
                  ...
                  if(document.forms[0].elements['US_USUARIOGERENTE'] && document.forms[0].elements['US_USUARIOGERENTE'].checked === true){
                        ...
                        //28-10-14 si admin no enseño derechos de compras de otros centros
	...
	form.target = target;
			...
			jQuery.ajax({
						...
						success:function(data){
							...
							jQuery('#confirmBoxCopiarDer').css("color", "#FF0000");
			...
			jQuery.ajax({
						...
						success:function(data){
							...
							if (doc.Estado == 'OK'){
                                                            ...
                                                            alert(document.forms['MensajeJS'].elements['ERROR_USUARIO_CAMBIADO'].value);
                                                        }
