...
//	Ultima revisión: ET 25ene23 15:55 USManten2022_250123.js
...
function DerechosCARPyPL(propietario, usuario){
  ...
  if(usuario>0){
    MostrarPag('http://www.newco.dev.br/Administracion/Mantenimiento/Empresas/CARPyPLManten2022.xsql'+opciones,'carpYpl');
  }
  else{
...
function DerechosMenus(usuario, empresa){
  ...
  if(usuario>0){
    MostrarPag('http://www.newco.dev.br/Administracion/Mantenimiento/Empresas/MenusManten2022.xsql'+opciones,'MenusManten');
  }
  else{
...
function verLogs(){
	var IDUsuario=document.forms[0].elements['ID_USUARIO'].value;
	document.location="http://www.newco.dev.br/Administracion/Mantenimiento/Empresas/LogsUsuario2022.xsql?US_ID="+IDUsuario;
}
