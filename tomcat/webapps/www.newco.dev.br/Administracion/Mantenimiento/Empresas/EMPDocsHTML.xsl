...
<!--
    Mostrar documentos de la empresa.
 	ultima revision: ET 25may22 19:01 EMPDocs_250522.js
 +-->
...
<head>
	...
	<script type="text/javascript" src="http://www.newco.dev.br/Administracion/Mantenimiento/Empresas/EMPDocs_250522.js"></script>
</head>
...
<xsl:template match="EMPRESA">
	...
	<div class="ZonaTituloPagina">
		...
		<p class="TituloPagina">
			<xsl:choose>
			<!--<xsl:when test="/Docs/EMPRESA/MVM and /Docs/FICHAEMPRESA!='S'">-->
			<xsl:when test="/Docs/EMPRESA/FIDEMPRESA/field and /Docs/FICHAEMPRESA!='S'">
				...
				<xsl:call-template name="desplegable">
					...
					<xsl:with-param name="style">height:25px;font-size:20px;width:800px;</xsl:with-param>
    ...
    <xsl:if test="/Docs/EMPRESA/SUBIR_DOCUMENTOS">
     ...
     <!-- <table class="infoTableAma documentos" border="0">-->
      ...
      <form name="SubirDocumentos" method="post">
        ...
        <tr class="sinLinea">
          <!--documentos-->
          <td class="tres"><!--<strong><xsl:value-of select="document($doc)/translation/texts/item[@name='se_permite_cargar_documentos']/node()"/>.</strong>-->&nbsp;</td>
	...
	<br/>
		...
		<form name="frmDocumentos" action="http://www.newco.dev.br/Administracion/Mantenimiento/Empresas/EMPDocs.xsql" method="post">
			...
			<tr class="filtros"><!--class="select" height="50px"-->
				<th class="uno">&nbsp;</th>
				<!--
				<xsl:choose>
				<xsl:when test="/Docs/EMPRESA/MVM">
				...
				<th width="180px" style="text-align:left">
					...
					<input type="text" name="FTEXTO" size="30" style="width:170px;">
			...
			<xsl:if test="/Docs/EMPRESA/DOCUMENTOS[@tipo='OF']">	<!--	2nov20	OFERTAS COMERCIALES	-->
				<xsl:call-template name="tabla_documentos">
