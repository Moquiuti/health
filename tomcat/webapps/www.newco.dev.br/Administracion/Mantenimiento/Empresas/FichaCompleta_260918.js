/*
	...
	UltimaRevisión: ET 26set18 12:24
*/
...
function onloadEvents(){
	...
	//	inicializamos los campos de descuento en función de la forma de pago
	console.log('Cond.financieras: PlazoPago:'+jQuery('#PLAZO_PAGO').val()+' Desc30dias:'+jQuery('#DESC_PAGO_30DIAS').val()+' Desc60dias:'+jQuery('#DESC_PAGO_60DIAS').val()
