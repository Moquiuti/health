...
//	Ultima revision: ET 18nov21 11:45 EquivalenciasERP_18nov21.js
...
function DescargarExcel()
{
	...
	cadenaCSV=strCodigo+sepCSV+strDescripcion+sepCSV+strID+strForma+sepCSV+strForma+sepCSV+strID+strPlazo+sepCSV+strPlazo+saltoLineaCSV;
	
	//	Recorremos el array de plazos de pago
	for (var i=0; i<arrEquiv.length; i++)
	{
	
		cadenaCSV+=arrEquiv[i].Codigo+sepCSV+arrEquiv[i].Descripcion+sepCSV+arrEquiv[i].IDForma+sepCSV+arrEquiv[i].Forma+arrEquiv[i].IDPlazo+sepCSV+arrEquiv[i].Plazo+saltoLineaCSV;
	}
