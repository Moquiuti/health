...
//	Ultima revision: ET 10abr20 09:18 MANTPedidos_100420.js
...
function onLoad()
{
	//solodebug debug('onLoad derManten:'+derManten+' derPrecios:'+derPrecios);
	//	Si el usuario solo tiene derechos para mantenimiento de productos, no de precios, desactiva los campos de precio
	if ((derManten=='S')&&(derPrecios=='N'))
	{
		//solodebug debug('onLoad derManten:'+derManten+' derPrecios:'+derPrecios+' Bloqueando mantemimiento de precios');
		jQuery(".clPrecio").attr("readonly", true).css("background-color","#E0E0E0");
		jQuery(".clPrecioRef").attr("readonly", true).css("background-color","#E0E0E0");
	}
}
