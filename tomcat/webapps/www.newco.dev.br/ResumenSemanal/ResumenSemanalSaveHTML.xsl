...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="/">
    <html>
      <head>
        <title>Mantenimiento de Resumenes Semanales</title>
...
<body bgColor="#eeffff" leftMargin="0" topMargin="0" marginheight="0" marginwidth="0">
  ...
  <table width="70%" border="0" align="center">
    <tr>
      <td>
        <p align="center">Los datos del resumen semanal han sido actualizados correctamente en
		MedicalVM.<BR/>
		Un mensaje de ejemplo ha sido enviado a la dirección medicalvm@medicalvm.com</p>
      </td>
    </tr>
    <tr align="center">
      <td>
    ...
    <tr align="center">
      <td>
        <xsl:apply-templates select="ResumenSemanal/jumpTo"/>
      </td>
    </tr>
  </table>
</body>
