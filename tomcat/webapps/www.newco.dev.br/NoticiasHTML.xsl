       ...
       <!--idioma fin-->
        ...
        <div class="todo">
            ...
            <xsl:call-template name="menuPublic"><!--en general.xsl-->
                <xsl:with-param name="select">noticias</xsl:with-param>
            </xsl:call-template>
            ...
            <div class="todoInside">
                ...
                <div class="zonaPublicaBox">
                    <p>&nbsp;</p>
                    <xsl:for-each select="document('http://www.newco.dev.br/XML/noticias.xml')/NOTICIAS/NOTICIA">
                        <p class="grisNoticias"><img src="http://www.newco.dev.br/images/list.gif" />&nbsp;<a href='{ENLACE}' class="linkNoticias" target="_blank"><xsl:copy-of select="TITULO"/></a></p>
                        <p class="textNoticias"><xsl:value-of select="TEXT"/></p>
                        <p class="fechaNoticias"><xsl:value-of select="FECHA"/></p>
                        <p class="lineNoticias">&nbsp;</p>
                    </xsl:for-each>
                </div>
