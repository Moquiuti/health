...
<xsl:template match="LISTAPROCESOS">        
  ...
  <xsl:template match="Sorry">
    <p class="tituloCamp"><xsl:value-of select="document('http://www.newco.dev.br/General/messages.xml')/messages/msg[@id='WF-0000' and @lang=$lang]" disable-output-escaping="yes"/></p>
  </xsl:template>
