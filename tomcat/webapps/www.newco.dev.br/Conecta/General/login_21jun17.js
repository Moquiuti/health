...
function CompruebaHTTP(URLSegura)
 {
 	console.log('location.href: '+window.location.href+' location.href.include:'+window.location.href.includes(""));
...
//alert ("login-3");
	//if(window.location.protocol=='http:') 
	//var	urlMedical="http://www.newco.dev.br/Login.xsql"; 
	//else
	var urlMedical="http://www.newco.dev.br/Login.xsql";
