...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="/">
	...
	//	Pulsación de un día en el calendario
	function PulsarDia(Dia)
	{
		AbrirPagina('AgendaDiaria.xsql?');
	}
	
	//	Pulsación de una semana en el calendario
...
<td>
	...
	<tr class="blanco">
	<td>
	<a 	onMouseOver="window.status='Seleccionar fechas de Vacaciones y otros días no hábiles';return true;" 
		onMouseOut="window.status='';return true;" 
