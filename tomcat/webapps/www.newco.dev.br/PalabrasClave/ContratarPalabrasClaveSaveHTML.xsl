...
<body bgColor="#ffffff" leftMargin="0" topMargin="0" marginheight="0" marginwidth="0">
  ...
  <table width="70%" border="0" align="center">
    <tr>
      <td>
        <p align="center">Su solicitud de contratación de palabras clave ha sido actualizada
		correctamente en MedicalVM.<br/> En breve recibirá la confirmación de la reserva.</p>
      </td>
    </tr>
    <tr align="center">
      <td>
    ...
    <tr align="center">
      <td>
        <!--<xsl:apply-templates select="ActualizarPalabrasClave/button"/>-->
        <xsl:call-template name="boton">
 	  <xsl:with-param name="path" select="ActualizarPalabrasClave/button"/>
 	</xsl:call-template>
      </td>
    </tr>
  </table>
