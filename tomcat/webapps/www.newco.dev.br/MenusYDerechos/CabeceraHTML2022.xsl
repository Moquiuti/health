...
<!--
	...
	Ultima revisión: ET 26may23 13:15 Cabecera2022_121222.js
-->
...
<html>
<head>
	<!--	Quitar estilos cuando ya esten actualizados los CSS	-->
	<style type="text/css">
	/*	5dic22 Nuevo logo personalizable	*/
	.logoPers {
		float: left;
		width: 350px;
		height: 60px;
    ...
    <script type="text/javascript" src="http://www.newco.dev.br/MenusYDerechos/Cabecera2022_121222.js"></script>
	<script type="text/javascript">
		var Accion='<xsl:value-of select="/Cabecera/ACCION"/>';
	</script>
	<meta Http-Equiv="Cache-Control" content="max-age=86400"/><!--24abr23-->
</head>
...
<body onload="bodyLoad();">
	...
	<div class="header">
		<!--5dic22<a target="mainFrame" class="logo"></a>-->
		<a target="mainFrame"><img class="logoPers" src="http://www.newco.dev.br/{Cabecera/USUARIO/PORTAL/PMVM_URLLOGOPRINCIPAL}"/></a>
		<div class="header-right">
			<div class="key" onclick="CambiarClave();"></div>
			<div class="usuario">
				<p><xsl:value-of select="substring(Cabecera/USUARIO/NOMBRECENTRO,0,50)"/> | <xsl:value-of select="substring(Cabecera/USUARIO/NOMBREUSUARIO,0,25)"/></p>
			</div>
	...
	<div class="menu">
		<a class="w60px" id="MENU_0" style="background-image:initial;transition:initial;" href="http://www.newco.dev.br/General/CargaPagina.html?TARGET=http://www.newco.dev.br/Personal/BandejaTrabajo/WFStatus2022.xsql" target="mainFrame">
			...
			<xsl:if test="ID!=1"><!--30may22	Quitamos el menu de INICIO	-->
    			<a class="itens_menu principal" id="MENU_{ID}">
        			...
        			<xsl:when test="name_location!=''">
                		<xsl:attribute name="href">http://www.newco.dev.br/General/CargaPagina.html?TARGET=http://www.newco.dev.br/<xsl:value-of select="ENLACE_2022"/></xsl:attribute>
