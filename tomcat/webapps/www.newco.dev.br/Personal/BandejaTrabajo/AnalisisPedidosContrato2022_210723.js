...
//	ultima revisión: ET 21jul23 09:30 AnalisisPedidosContrato2022_210723.js
...
/*	19set22 Para 6 meses
	...
	{
		alert(strInformeMesesMaximo.replace('[MAXMESES]',plazoMaximo));
		return 'ERROR';
	}
...
function AplicarFiltro(){
	...
	jQuery("#waitBuscar").show();

	var form=document.forms[0];
	form.action='AnalisisPedidosContrato2022.xsql';
...
// alert('fec entr '+utilFechaEntrega);
	...
	jQuery.ajax({
		...
		data: "IDEMPRESA="+IDEmpresa+"&IDCENTRO="+IDCentro+"&IDPROVEEDOR="+IDProveedor+"&PRODUCTO="+producto
					...
					+"&IDCENTROCONSUMO="+IDCentroConsumo+"&IDLICITACION="+IDLicitacion+"&IDLICITACION="+IDLicitacion+"&MODO=CON_CONTRATO"
					+"&_="+d.getTime(),
        type: "GET",
