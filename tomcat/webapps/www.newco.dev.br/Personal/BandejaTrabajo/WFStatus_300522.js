// JS Página de Inicio
// Ultima revisión ET: 20ene22 15:00 WFStatus_300522.js
...
//30may22 Presenta un alert con las noticias (guardadas en campos hidden)
function AlertNoticias()
{
	var txtNoticias='';
	for (var i=0;i<Noticias.length;++i)
	{
		txtNoticias+=Noticias[i].Titulo+':'+Noticias[i].Cuerpo+'\n\r\n\r';
	}
	alert (txtNoticias);
}
