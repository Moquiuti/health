...
<!--
	...
	Ultima revision ET 21jul23 09:15 AnalisisPedidosContrato2022_210723.js
-->
...
<head>
    ...
    <title><xsl:value-of select="document($doc)/translation/texts/item[@name='Analisis_pedidos_contrato']/node()"/>:&nbsp;<xsl:value-of select="/AnalisisPedidos/LINEASPEDIDOS/COMPRADOR/TITULO" /></title>
	<!--style-->
	...
	<script type="text/javascript" src="http://www.newco.dev.br/Personal/BandejaTrabajo/AnalisisPedidosContrato2022_210723.js"></script>
...
<body>
	...
	<form  method="post" name="Form1" action="AnalisisPedidosContrato2022.xsql">
...
<xsl:template name="ANALISIS">
	...
	<div class="ZonaTituloPagina">
		<p class="TituloPagina">
			<xsl:value-of select="document($doc)/translation/texts/item[@name='Analisis_pedidos_contrato']/node()"/>:&nbsp;<xsl:value-of select="/AnalisisPedidos/LINEASPEDIDOS/COMPRADOR/TITULO" />&nbsp;
	...
	<thead class="cabecalho_tabela">
		<tr class="subTituloTabla">
			...
			<xsl:if test="/AnalisisPedidos/LINEASPEDIDOS/COMPRADOR/MOSTRAR_PRECIO_FABRICA">
				<th class="w100px">
                	<xsl:value-of select="document($doc)/translation/texts/item[@name='Precio_fabrica']/node()"/>
            	</th>
				<th class="w100px">
                	<xsl:value-of select="document($doc)/translation/texts/item[@name='Descuento']/node()"/>
            	</th>
			</xsl:if>
			<th class="w100px">
            ...
            <xsl:choose>
                <xsl:when test="not(/AnalisisPedidos/LINEASPEDIDOS/COMPRADOR/MOSTRAR_PRECIO_FABRICA)">
					<th class="w50px">
			...
			<xsl:for-each select="LINEAPEDIDO">
				<tr class="conhover">
                   ...
                   <!--ref cliente o ref estandar-->
                    ...
                    <!--precio de fabrica	-->
                    <xsl:if test="/AnalisisPedidos/LINEASPEDIDOS/COMPRADOR/MOSTRAR_PRECIO_FABRICA">
						<td class="textRight"><xsl:value-of select="PRECIOFABRICA"/></td>
						<td class="textRight"><xsl:value-of select="DESCPRECIOFABRICA"/></td>
					</xsl:if>
                    <!--precio-->
	...
	<table>
		<tr>
			...
			<td class="w100px">
     		...
     		<td class="w80px">
				<a id="btnBuscar" href="javascript:AplicarFiltro();" title="Buscar" class="btnDestacado">
					<xsl:value-of select="document($doc)/translation/texts/item[@name='buscar']/node()"/>
				</a>
				<span id="waitBuscar" style="display:none;" class="clear"><img src="http://www.newco.dev.br/images/loading.gif"/></span>
			</td>
