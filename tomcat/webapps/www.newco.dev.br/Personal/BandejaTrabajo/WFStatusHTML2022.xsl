...
<!--
	Página de inicio
	Ultima revisión ET: 21jun23 10:37 WFStatus2022_210623.js EISConsultas2022_240522.js cargaDocAlbaran_251019.js-> deberia ser opcional, mantenemos durante un tiempo
-->
...
<head>
	...
	<script type="text/javascript">
		...
		var EsVendedor='<xsl:choose><xsl:when test="/WorkFlowPendientes/INICIO/LICITACIONES/VENDEDOR">S</xsl:when><xsl:otherwise>N</xsl:otherwise></xsl:choose>';
	...
	<xsl:for-each select="/WorkFlowPendientes/INICIO/RESUMENES_MENSUALES/RESUMEN_MENSUAL[@IncluirGrafico='S']">
 	...
 	<script type="text/javascript" src="http://www.newco.dev.br/Personal/BandejaTrabajo/WFStatus2022_210623.js"></script>
...
<xsl:template name="ADMIN">
    ...
    <xsl:apply-templates select="INICIO/BANDEJA/COMPRAS/PEDIDOSRECHAZADOS/BANDEJA"/><!--8nov22 Pedidos rechazados	-->
	...
	<xsl:if test="INICIO/INICIO_GRAFICO">
     	<div id="actividadMensualBox" class="eisBox w1000px tableCenter marginTop50 conScroll">
			...
			<br/>
			<br/>
			<br/><!--18nov22 Incluimos algunas filas mas-->
			<br/>
			<br/>
			<br/>
			<br/>
	...
	<div class="tabela tabela_redonda">
		...
		<xsl:for-each select="INICIO/PEDIDOSPROBLEMATICOS/COMPRADOR/PEDIDO">
			...
			<td align="center" valign="middle">
				<xsl:if test="DOCUMENTOS_VENDEDOR/DOCUMENTO">
					<a href="javascript:DocumentosPedido({MO_ID});)"><img class="valignM" src="http://www.newco.dev.br/images/clipIconO.gif"/></a>
				</xsl:if>
				<xsl:choose>
        	...
        	<td>
        	  ...
        	  <!--situacion-->
				...
				<xsl:when test="SITUACION != ''">
					...
					<xsl:when test="SITUACION='1'">
						<img src="../../images/Situacion{SITUACION}de3.gif"><!--5ago22 <xsl:apply-templates select="SITUACION"/>-->
          ...
          <!--control-->
					<td>
						...
						<xsl:when test="SITUACION!='' and SITUACION != '-1'">
							<img src="../../images/Situacion{SITUACION}de3.gif"><!--5ago22 <xsl:apply-templates select="SITUACION"/>--><xsl:attribute name="title"><xsl:apply-templates select="SITUACION"/></xsl:attribute></img>
						</xsl:when>
						<xsl:otherwise>
	...
	<xsl:when test="INICIO/BANDEJA/CDC and not(INICIO/MINIMALISTA)">
		<div class="divLeft20">
			...
			<div class="botonLargo">
				<a href="http://www.newco.dev.br/Compras/PedidosProgramados/PedidosProgramados2022.xsql">
...
<xsl:template match="VENDEDOR">
  ...
  <xsl:otherwise>
	...
	-->
    <xsl:apply-templates select="/WorkFlowPendientes/INICIO/BANDEJA/COMPRAS/PEDIDOSRECHAZADOS/BANDEJA"/><!--8nov22 Pedidos rechazados	-->
  ...
  <div class="divleft">
	...
	<div class="divLeft">
		...
		<div class="textLeft marginTop40">
			<xsl:if test="/WorkFlowPendientes/INICIO/IDPAIS=55">
				<p class="marginLeft50 urgente w500px"><a target="_blank" href="http://www.newco.dev.br/Personal/BandejaTrabajo/MVMB_InstrucionesFornecedor_17mar23.pdf">&nbsp;<xsl:value-of select="document($doc)/translation/texts/item[@name='sea_un_proveedor_de_calidad']/node()"/></a></p>
				<br/>
				<br/>
			</xsl:if>
			...
			<table cellspacing="6px" cellpadding="6px">
				...
				<xsl:otherwise>
					...
					<tr class="conhover">
                		...
                		<td class="textLeft">
							&nbsp;<a class="btnDiscreto" href="javascript:DocumentosPedido('{MO_ID}')"><xsl:value-of select="document($doc)/translation/texts/item[@name='documentos']/node()"/></a>&nbsp;
                		</td>
...
<xsl:when test="/WorkFlowPendientes/INICIO/INCIDENCIASPRODUCTOS/INCIDENCIA and not(/WorkFlowPendientes/INICIO/INCIDENCIASPRODUCTOS/MVM)">
	<div class="textLeft marginTop40">
	  <table class="tableCenter w1000px">
    	 <tr class="tituloTabla">
        	<td><xsl:value-of select="document($doc)/translation/texts/item[@name='incidencias']/node()"/></td>
    	 </tr>
	  </table>
	</div>	
	<div class="tabela tabela_redonda">
	<table cellspacing="6px" cellpadding="6px">
		<thead class="cabecalho_tabela">
			<tr>
				...
				<th class="textLeft">&nbsp;<xsl:value-of select="document($doc)/translation/texts/item[@name='ref_cliente']/node()"/></th>
				<th class="textLeft">&nbsp;<xsl:value-of select="document($doc)/translation/texts/item[@name='producto']/node()"/></th>
				<th class="textLeft"><xsl:value-of select="document($doc)/translation/texts/item[@name='res']/node()"/></th>
		...
		<xsl:for-each select="/WorkFlowPendientes/INICIO/INCIDENCIASPRODUCTOS/INCIDENCIA">
			<tr class="conhover">
				...
				<td class="textLeft">&nbsp;
					<a href="javascript:MostrarPagPersonalizada('http://www.newco.dev.br/Administracion/Mantenimiento/Productos/Incidencia2022.xsql?ID_INC={PROD_INC_ID}&amp;PRO_ID={PROD_INC_IDPRODUCTO}&amp;LIC_OFE_ID={PROD_INC_IDOFERTA_LIC}','incidencia',100,80,0,-10);">
                		<!--15jun18     -->
                		<xsl:choose>
...
<xsl:when test="/WorkFlowPendientes/INICIO/EVALUACIONESPRODUCTOS/EVALUACION">
	<div class="textLeft marginTop40">
	  <table class="tableCenter w1000px">
    	 <tr class="tituloTabla">
        	<td><xsl:value-of select="document($doc)/translation/texts/item[@name='evaluacion_productos']/node()"/></td>
    	 </tr>
	  </table>
	</div>	
	<div class="tabela tabela_redonda">
	<table cellspacing="6px" cellpadding="6px">
		<thead class="cabecalho_tabela">
			<tr>
				...
				<th class="textLeft">&nbsp;<xsl:value-of select="document($doc)/translation/texts/item[@name='producto']/node()"/></th>
        		<th class="textLeft"><xsl:value-of select="document($doc)/translation/texts/item[@name='proveedor']/node()"/></th>
				<th class="textLeft"><xsl:value-of select="document($doc)/translation/texts/item[@name='autor']/node()"/></th>
				<th class="textLeft"><xsl:value-of select="document($doc)/translation/texts/item[@name='centro_evaluacion']/node()"/></th>
		...
		<xsl:for-each select="/WorkFlowPendientes/INICIO/EVALUACIONESPRODUCTOS/EVALUACION">
			<tr class="conhover" style="border-bottom:1px solid #C3D2E9;">
				...
				<td class="textLeft">&nbsp;
					<a href="javascript:MostrarPagPersonalizada('http://www.newco.dev.br/Gestion/Comercial/EvaluacionProducto2022.xsql?ID_EVAL={PROD_EV_ID}','Evaluaci?n producto',100,80,0,-10);">
				...
				<td class="textLeft"><xsl:value-of select="AUTOR"/></td>
				<td class="textLeft">
...
<xsl:when test="/WorkFlowPendientes/INICIO/LICITACIONES/LICITACION and not(/WorkFlowPendientes/INICIO/LICITACIONES/MVM)">
	<div class="textLeft marginTop40">
	  <table class="tableCenter w1000px">
    	 <tr class="tituloTabla">
        	<td><xsl:value-of select="document($doc)/translation/texts/item[@name='LICITACIONES']/node()"/>&nbsp;<a href="http://www.newco.dev.br/Gestion/Comercial/Licitaciones2022.xsql">[<xsl:value-of select="document($doc)/translation/texts/item[@name='Busqueda_avanzada']/node()"/>]</a>
        	</td>
    	 </tr>
	  </table>
	</div>	
	...
	<table cellspacing="6px" cellpadding="6px">
		<thead class="cabecalho_tabela">
			<tr>
				...
				<th class="w170px textLeft"><xsl:value-of select="document($doc)/translation/texts/item[@name='estado']/node()"/></th>
				...
				<th class="w100px textLeft"><xsl:value-of select="document($doc)/translation/texts/item[@name='Productos']/node()"/></th>
				<th class="w50px">&nbsp;<xsl:value-of select="document($doc)/translation/texts/item[@name='fecha_alta_abbr']/node()"/></th>
				<th class="w50px">&nbsp;<xsl:value-of select="document($doc)/translation/texts/item[@name='fecha_decision_abbr']/node()"/></th>
		...
		<xsl:for-each select="/WorkFlowPendientes/INICIO/LICITACIONES/LICITACION">
			...
			<td class="textLeft">
				...
				<xsl:when test="/WorkFlowPendientes/INICIO/LICITACIONES/INCLUIR_CENTRO_PEDIDO">
					<a href="javascript:FichaCentro({CENTROPEDIDO/ID});">
						<xsl:value-of select="CENTROPEDIDO/NOMBRE"/>
					</a>
				</xsl:when>
				<xsl:otherwise>
					<a href="javascript:FichaEmpresa({IDEMPRESA});">
			...
			<td class="textLeft"><xsl:value-of select="ESTADO"/>
			...
			<td class="textLeft"><xsl:value-of select="LINEASOFERTADAS"/>&nbsp;/&nbsp;<xsl:value-of select="LIC_NUMEROLINEAS"/></td>
			<td class="fuentePeq"><xsl:value-of select="LIC_FECHAALTA"/></td>
			<td class="fuentePeq"><xsl:value-of select="LIC_FECHADECISIONPREVISTA"/></td>
			<td class="fuentePeq">
				<xsl:attribute name="style">
					<xsl:choose>
					<xsl:when test="SEMAFORO='AMBAR'">color:red;</xsl:when>
					<xsl:otherwise></xsl:otherwise>
					</xsl:choose>
				</xsl:attribute>
...
<xsl:when test="/WorkFlowPendientes/INICIO/SOLICITUDESCATALOGACION/SOLICITUD and not(/WorkFlowPendientes/INICIO/SOLICITUDESCATALOGACION/MVM)">
	<div class="textLeft marginTop40">
	  <table class="tableCenter w1000px">
    	 <tr class="tituloTabla">
        	<td><xsl:value-of select="document($doc)/translation/texts/item[@name='solicitudes_catalogacion']/node()"/></td>
    	 </tr>
	  </table>
	</div>	
	<div class="tabela tabela_redonda">
	<table cellspacing="6px" cellpadding="6px">
		...
		<xsl:for-each select="/WorkFlowPendientes/INICIO/SOLICITUDESCATALOGACION/SOLICITUD">
			<tr class="conhover" id="SOLIC_{SC_ID}" style="border-bottom:1px solid #C3D2E9;">
				...
				<td style="text-align:left;">&nbsp;
					<strong>
            			<a href="javascript:MostrarPagPersonalizada('http://www.newco.dev.br/Gestion/Comercial/SolicitudCatalogacion2022.xsql?SC_ID={SC_ID}','solicitud catalogacion',100,80,0,-10)">
...
<xsl:if test="/WorkFlowPendientes/INICIO/SOLICITUDCATALOGACION or /WorkFlowPendientes/INICIO/CONTROLPRECIOS">
	...
	<a class="btnDestacado" href="http://www.newco.dev.br/Gestion/Comercial/NuevaSolicitudCatalogacion2022.xsql" target="_self">
...
<xsl:when test="/WorkFlowPendientes/INICIO/SOLICITUDESOFERTA/SOLICITUD and not(/WorkFlowPendientes/INICIO/SOLICITUDESOFERTA/MVM)">
	<div class="textLeft marginTop40">
	  <table class="tableCenter w1000px">
    	 <tr class="tituloTabla">
        	<td><xsl:value-of select="document($doc)/translation/texts/item[@name='solicitudes_oferta']/node()"/></td>
    	 </tr>
	  </table>
	</div>	
	<div class="tabela tabela_redonda">
	<table cellspacing="6px" cellpadding="6px">
		...
		<xsl:for-each select="/WorkFlowPendientes/INICIO/SOLICITUDESOFERTA/SOLICITUD">
			<tr class="conhover" id="SOLIC_{SO_ID}" style="border-bottom:1px solid #C3D2E9;">
				<td class="color_status">&nbsp;</td>
				<td>
            		<a href="javascript:MostrarPagPersonalizada('http://www.newco.dev.br/Gestion/Comercial/SolicitudOferta2022.xsql?SO_ID={SO_ID}','solicitud oferta',100,80,0,-10)">
...
<xsl:template match="GESTIONCOMERCIAL">
	...
	<div class="textLeft marginTop40">
	  <table class="tableCenter w1000px">
    	 <tr class="tituloTabla">
        	<td><xsl:value-of select="document($doc)/translation/texts/item[@name='tareas_pendientes']/node()"/>
				<xsl:if test="INICIO/GESTIONCOMERCIAL/GESTION[position() &gt; 6]">
					<a href="http://www.newco.dev.br/Gestion/Comercial/Tareas2022.xsql">
	...
	<table cellspacing="6px" cellpadding="6px">
		<thead class="cabecalho_tabela">
			<tr>
				<th class="w1px">&nbsp;</th>
				<th class="w60px"><xsl:value-of select="document($doc)/translation/texts/item[@name='fecha']/node()"/></th>
				<th class="w100px textLeft"><xsl:value-of select="document($doc)/translation/texts/item[@name='autor']/node()"/></th>
				<th class="w150px textLeft"><xsl:value-of select="document($doc)/translation/texts/item[@name='responsable']/node()"/></th>
				<th class="w150px textLeft"><xsl:value-of select="document($doc)/translation/texts/item[@name='empresa']/node()"/></th>
				<th class="textLeft"><xsl:value-of select="document($doc)/translation/texts/item[@name='descripcion_tarea']/node()"/></th>
				<th class="w60px"><xsl:value-of select="document($doc)/translation/texts/item[@name='fecha_limite']/node()"/></th>
				<th class="w60px textLeft"><xsl:value-of select="document($doc)/translation/texts/item[@name='estado']/node()"/></th>
				<th class="w60px textLeft"><xsl:value-of select="document($doc)/translation/texts/item[@name='prioridad']/node()"/></th>
				<th>&nbsp;</th>
				<th>&nbsp;</th>
			</tr>
		</thead>
    	  ...
    	  <xsl:if test="ID = IDPADRE"><!-- si id = idpadre significa que es la tarea no tearea hijo-->
			<tr class="conhover" style="border-bottom:1px solid #C3D2E9;">
				<td class="color_status">&nbsp;</td>
					...
					<td style="text-align:left;">
				    	<a href="javascript:FichaEmpresa{IDEMPRESA/field/dropDownList/listElem[ID = ../../@current]/ID});">
							<xsl:value-of select="IDEMPRESA/field/dropDownList/listElem[ID = ../../@current]/listItem"/>
		       			</a>
					</td>
					<td class="textLeft">
		        		<strong><a href="http://www.newco.dev.br/Gestion/Comercial/Tareas2022.xsql"><xsl:value-of select="TEXTO"/></a></strong>
		      		</td>
		...
		<div class="divLeft textCenter" style="margin-bottom:20px;">
			...
			<div class="tabela tabela_redonda">
				...
				<tr>
         			<!-- pos -->
					<th class="w1px">&nbsp;</th>
					<th class="w1px">&nbsp;</th>	<!--	icono urgente		-->
         			 <!-- numero -->
					<th class="w50px textLeft"><xsl:value-of select="document($doc)/translation/texts/item[@name='numero']/node()"/></th>
					...
					<xsl:if test="/WorkFlowPendientes/INICIO/BANDEJA/MULTICENTROS or /WorkFlowPendientes/INICIO/BANDEJA/DERECHOS_ADMIN='EMPRESA'">
						<th class="w150px textLeft">&nbsp;<xsl:value-of select="document($doc)/translation/texts/item[@name='centro']/node()"/></th>
					</xsl:if>
					<!-- fecha -->
					<th class="w40px">&nbsp;<xsl:value-of select="document($doc)/translation/texts/item[@name='fecha']/node()"/></th>
					<!-- empresa -->
					<th class="textLeft">&nbsp;<xsl:value-of select="LISTATAREAS/TITULOEMPRESA"/></th>
					<!-- Estado -->
					<th class="textLeft">&nbsp;<xsl:value-of select="document($doc)/translation/texts/item[@name='estado']/node()"/></th>

					<xsl:if test="INCLUIR_RESPONSABLE">
						<th class="w1px textLeft"></th>
						<th class="w150px textLeft"><xsl:value-of select="document($doc)/translation/texts/item[@name='responsable']/node()"/></th>
					</xsl:if>
					...
					<xsl:when test="../../ROL[.='C']">
						<!-- plantilla -->
						<th class="textLeft">&nbsp;<xsl:value-of select="document($doc)/translation/texts/item[@name='plantilla']/node()"/></th>
					</xsl:when>
					</xsl:choose>
						<!-- Fecha decision o entrega -->
						<th class="w40px"><xsl:value-of select="document($doc)/translation/texts/item[@name='fecha_entrega']/node()"/></th>
					<!-- Importe -->
					<xsl:choose>
					...
					<xsl:for-each select="LISTATAREAS/TAREA">
						...
						<tr class="conhover">
							...
							<xsl:if test="/WorkFlowPendientes/INICIO/BANDEJA/MULTICENTROS or /WorkFlowPendientes/INICIO/BANDEJA/DERECHOS_ADMIN='EMPRESA'">
								<td class="textLeft">
									<!-- centro (para usuarios admin o multicentro -->
									<a href="javascript:FichaCentro({CEN_ID});"><xsl:value-of select="CENTRO"/></a>
								</td>
							</xsl:if>
							...
							<xsl:if test="../../INCLUIR_RESPONSABLE">
								...
								<td class="fuentePeq textLeft">
									<xsl:value-of select="USUARIOAPROBADOR"/>
								</td>
							</xsl:if>
						<xsl:choose>
...
<xsl:template name="buscadorInicioAdmin">
	...
	<table cellspacing="6px" cellpadding="6px">
		...
		<xsl:choose>
		<xsl:when test="INICIO/PEDIDOSPROBLEMATICOS/COMPRADOR/FILTROS/IDLUGARENTREGA">
			<th class="w150px textLeft">
				<label><xsl:value-of select="document($doc)/translation/texts/item[@name='lugar_entrega']/node()"/>:</label><br/>				
				<xsl:call-template name="desplegable">
					<xsl:with-param name="path" select="INICIO/PEDIDOSPROBLEMATICOS/COMPRADOR/FILTROS/IDLUGARENTREGA/field"/>
					<xsl:with-param name="claSel">w150px</xsl:with-param>
				</xsl:call-template>
			</th>
		</xsl:when>
		<xsl:otherwise>
				<input type="hidden" name="IDLUGARENTREGA" value="" />
		</xsl:otherwise>
		</xsl:choose>
	...
	<tr>
	<td colspan="15" border="1" class="buscadorAvanzado" style="display:none"> 
		<table class="tbBuscAvanzado tableCenter w1400px">
...
<xsl:template match="EMPRESA2">
	<a>
    <xsl:attribute name="href">javascript:FichaEmpresa(<xsl:value-of select="../EMP_ID2"/>)</xsl:attribute>
		<xsl:attribute name="class">
 			<xsl:if test="../IDINCIDENCIA!=''">alerta</xsl:if>
  		</xsl:attribute>
		<xsl:value-of select="."/>
...
<xsl:template match="CENTRO2">
	<a>
		<xsl:attribute name="href">javascript:FichaCentro(<xsl:value-of select="../CEN_ID2"/>)</xsl:attribute>
		<xsl:attribute name="class">
 			<xsl:if test="../IDINCIDENCIA!=''">alerta</xsl:if>
  	</xsl:attribute>
		<xsl:value-of select="."/>
