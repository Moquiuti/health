...
//	Ultima revision: ET 05ene22 19:00
...
function CompruebaHTTP(URLSegura)
{
 	...
 	if((window.location.protocol=='http:')&&(!window.location.href.includes("mvmnucleo")&&(!window.location.href.includes("demo.purchasingvm"))))
	{
...
function loginDirecto()
{
	...
	//solodebug	console.log('loginDirecto. urlMedical:'+urlMedical+' location:'+window.location+'-->'+window.location.indexOf('demo.purchasing'));		
	//solodebug	alert('loginDirecto. urlMedical:'+urlMedical+' location:'+window.location+'-->'+window.location.indexOf('demo.purchasing'));
	...
	jQuery.ajax({
		...
		type: "GET",
		//Las 2 lineas siguientes funcionan si se devuelve directamente JSON
		//dataType: "json",
		...
		success:function(data){
			...
			else
			{
				...
				document.location.href="http://www.newco.dev.br/MenusYDerechos/Main2022.xsql";
			}
		}
