//	JS Login MVM
//	Ultima revision: ET 5may22 11:00. COrrecciones en ContactoSave. Limpiar cookie de STYLE. No cambiar a https en DEMO. Incluir SameSite en SetCookie y DeleteCookie.
...
function loginDirecto()
{
	...
	if(window.location.protocol=='http:')
		urlMedical="http:"+"//www.mvmnucleo.com/Login.xsql";		//acceso no seguro
	else		
		urlMedical="http://www.newco.dev.br/Login.xsql";			//acceso seguro
		
	//solodebug	
	console.log('loginDirecto. urlMedical:'+urlMedical);		
	...
	jQuery.ajax({
		...
		success:function(data){
			//5ene21 var res=eval("(" + data + ")");
			
			//solodebug	
			console.log('loginDirecto. urlMedical:'+urlMedical+' data:'+JSON.stringify(data));		
