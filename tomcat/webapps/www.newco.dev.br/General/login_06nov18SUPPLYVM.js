...
function CompruebaHTTPSUPPLYVM(URLSeguraSUPPLYVM)
 {
 	//
...
//			window.location.href=URLSeguraOHSJD;
		...
		window.location.href='http://www.supplyvm.com.br/index.html';
 }
...
//				jQuery('#textoKO').hide();			//	Podía estar el texto activo de un intento de login anterior
    			...
    			if (tipo=='POPUP')
				{
					...
					// 2020 document.location.href="http://www.newco.dev.br/MenusYDerechos/Main2017.xsql";
					window.open('http://www.newco.dev.br/MenusYDerechos/Main2017.xsql');
					// 2020 alert("NO POPUP");
				}
			// 2020 alert("NO POPUP");
...
{ 
	...
	// 2020document.cookie = sName + "=" + escape(sValue) + ";host="+dominio+";path=/";+"SameSite=None;secure";	
