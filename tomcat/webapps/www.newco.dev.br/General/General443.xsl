...
<!--
  template que funciona como una funcion.
  para llamarlo
  
      <xsl:call-template name="desplegable">
        <xsl:with-param name="path" select="ruta absoluta hasta la marca de field">
          ruta absoluta hasta la marca de field
          
          ejemplo:  blabla/blabla/field
