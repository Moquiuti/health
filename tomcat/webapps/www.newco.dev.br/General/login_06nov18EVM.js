...
function login(tipo)
{
	...
	jQuery.ajax({
		...
		success:function(data){
			...
			if (res.sesion=="-1")
			{
				alert("Acceso denegado, por favor revise usuario y clave");
				jQuery('#textoKO').show();
			}
			else
			{
//				jQuery('#textoKO').hide();			//	Podía estar el texto activo de un intento de login anterior
    			...
    			if (tipo=='POPUP')
				{
					...
					//2020 window.location.replace('http://www.newco.dev.br/MenusYDerechos/Main2017.xsql');
					alert("POPUP SI");
				}else {
					
					window.open('http://www.newco.dev.br/MenusYDerechos/Main2017.xsql');
					//document.location.href="http://www.newco.dev.br/MenusYDerechos/Main2017.xsql";
					//window.location.replace('http://www.newco.dev.br/MenusYDerechos/Main2017.xsql');
					//2020 $(location).attr('href','http://www.newco.dev.br/MenusYDerechos/Main2017.xsql')
					//2020 $(window).attr('location','http://www.newco.dev.br/MenusYDerechos/Main2017.xsql')
					//2020 $(location).prop('href', 'http://www.newco.dev.br/MenusYDerechos/Main2017.xsql')
...
{ 
	...
	document.cookie = sName + "=" + escape(sValue) + ";host='+dominio+';path=/";	
        // 2020 document.cookie = sName + "=" + escape(sValue) + ";host="+dominio+";path=/;"+"SameSite=None;Secure";
        // 2020 document.cookie = sName + "=" + escape(sValue) + ";host="+dominio+";path=/;SameSite=None;Secure";
        // 2020 document.cookie = sName + "=" + escape(sValue) + ";host="+v_Dominio+";path=/;sameSite=Lax";
        // 2020 alert(document.cookie);
}
