// JavaScript Document
//	ET	16dic16
//	Ultima revision: 22jun17 11:37


//	Comprobar si estamos en https
function CompruebaHTTP(URLSegura)
 {
 	//console.log('location.href: '+window.location.href+' location.href.includes:
//alert("URL secure: "+URLSegura + " location: "+window.location.href);
	//'+window.location.href.includes(""));
 	if((window.location.protocol=='http:')&&( window.location.href.includes("")))
			window.location.href=URLSegura;
 }


function CompruebaHTTPOHSJD(URLSeguraOHSJD)
 {
 	//
//console.log('location.href: '+window.location.href+'potocol: '+window.location.protocol+' location.href.includes:'+window.location.href.includes(""));
// 	if((window.location.protocol=='http:')&&( window.location.href.includes("")))
//			window.location.href=URLSeguraOHSJD;
        if(window.location.protocol=='http:')
		window.location.href='http://www.plataforma.centraldecompras.com.co/index.html';
 }


function CompruebaHTTPEVM(URLSeguraEVM)
 {
 	//
//console.log('location.href: '+window.location.href+'potocol: '+window.location.protocol+' location.href.includes:'+window.location.href.includes(""));
// 	if((window.location.protocol=='http:')&&( window.location.href.includes("")))
//			window.location.href=URLSeguraEVM;
        if(window.location.protocol=='http:')
		window.location.href='http://www.educationalvm.com.br/index.html';
 }

function CompruebaHTTPcentralcg(URLSeguracentralcg)
 {
 	//
//console.log('location.href: '+window.location.href+'potocol: '+window.location.protocol+' location.href.includes:'+window.location.href.includes(""));
// 	if((window.location.protocol=='http:')&&( window.location.href.includes("")))
//			window.location.href=URLSeguraOHSJD;
        if(window.location.protocol=='http:')
		window.location.href='http://www.newco.dev.br/centralcg/index.html';
 }

function CompruebaHTTPImbanaco(URLSeguraImbanaco)
 {
//console.log('location.href: '+window.location.href+'potocol: '+window.location.protocol+' location.href.includes:'+window.location.href.includes(""));
        if(window.location.protocol=='http:')
                window.location.href='http://www.newco.dev.br/Imbanaco/index.html';
 }
...
//alert("textoKO");
			...
			{
				jQuery('#textoKO').hide();			//	Podía estar el texto activo de un intento de login anterior
				jQuery('#textoOK').show();
    			SetCookie('SES_ID', res.sesion);
    			if (tipo=='POPUP')
					window.open('http://www.newco.dev.br/MenusYDerechos/Main2017.xsql');
				else
					document.location.href="http://www.newco.dev.br/MenusYDerechos/Main2017.xsql";


// PS 20170713
//				 SetCookie('SES_ID', res.sesion);
//    			if (document.domain!='www.mvmnucleo.com')
//					window.open('http://www.newco.dev.br/MenusYDerechos/Main2017.xsql');
//				else
//					document.location.href="http://www.newco.dev.br/MenusYDerechos/Main2017.xsql";
...
//req.open('GET', '//www.mvmnucleo.com/MenusYDerechos/Main2017.xsql', false); 
//req.send(null);
				//jQuery.get('http://www.newco.dev.br/MenusYDerechos/Main2017.xsql');				
				//document.location.href="http://www.newco.dev.br/MenusYDerechos/Main2017.xsql";
				//relative link:document.location.href="www.mvmnucleo.com/MenusYDerechos/Main2017.xsql";
			}
		}
...
{ 
	...
	var dominio=document.forms['frmLogin'].elements['DOMINIO'].value;
	//var dominio='www.mvmnucleo.com';
	document.cookie = sName + "=" + escape(sValue) + ";host='+dominio+';path=/";	
        //document.cookie = sName + "=" + escape(sValue) + ";host='+dominio+';path=/" +";SameSite=None"+";Secure";
        //document.cookie = sName + "=" + escape(sValue) + "; host="+v_Dominio+"; path=/"+"; SameSite=None"+"; secure";
        //document.cookie = sName + "=" + escape(sValue) + "; host="+v_Dominio+"; path=/"+"; SameSite=Lax";
        
        //var varCookie = 'sName + "=" + escape(sValue) + ";host='+dominio+';path=/"'
        //document.cookie = 'varCookie; SameSite=None; Secure';
       
        //document.cookie = 'varCookie = "sName + "=" + escape(sValue) + ";host='+dominio+';path=/"' + "; SameSite=None"+"; Secure";
}
...
function EnviaContacto(formu){
	...
	if (msg == ''){
		...
		var portal	= codificacionAjax(formu.elements['PORTAL'].value);

		jQuery.ajax({
			url:"ContactoSave.xsql",
			data: "CONTACTO_MAIL="+mail+"&CONTACTO_NOMBRE="+nombre+"&CONTACTO_CARGO="+cargo+"&CONTACTO_TIPO_EMP="+tipo+"&CONTACTO_EMPRESA="+empresa+"&CONTACTO_TEL="+tel+"&CONTACTO_TEXT="+text+"&PAIS="+pais+"&PORTAL="+portal,
			type: "GET",
			contentType: "application/xhtml+xml",
			beforeSend:function(){
				var dominio=document.forms['frmLogin'].elements['DOMINIO'].value;
...
function MostrarPagPersonalizada(pag,titulo,p_ancho,p_alto,p_desfaseLeft,p_desfaseTop){  
	//alert('alert MostrarPagPersonalizada');
	if(titulo==null) 
