...
<!--
	Mantenimiento de Modelo de Contrato
	Ultima revisión:ET 26feb20 08:51
-->
...
<head>
	...
	<script type="text/javascript" src="http://www.newco.dev.br/ProcesosCdC/Contratos/ModeloContrato_5set18.js"></script>
</head>
<body>
<xsl:choose>
...
<xsl:otherwise>
	...
	<xsl:otherwise>
		...
		<div class="ZonaTituloPagina">
			<p class="Path"><xsl:value-of select="document($doc)/translation/texts/item[@name='Inicio']/node()"/>&nbsp;/&nbsp;<span class="FinPath"><xsl:value-of select="document($doc)/translation/texts/item[@name='Modelo_contrato']/node()"/></span></p>
			<p class="TituloPagina">
				...
				<span class="CompletarTitulo" style="width:350px;">
					...
					<xsl:if test="MODELO/LINEAS/LINEA">
						<a class="btnNormal" href="javascript:MostrarPagPersonalizada('http://www.newco.dev.br/ProcesosCdC/Contratos/VerModeloContrato.xsql?CON_MOD_ID={MODELO/CON_MOD_ID}','Nuevo modelo contrato',100,100,0,0);"> 
        	...
        	<ul style="width:1000px;">
				...
				<li>
        			...
        			<xsl:choose>
        			  ...
        			  <xsl:otherwise>
        				<input type="text" name="CON_MOD_CODIGO" class="form-control" data-parsley-trigger="change" required="" maxlength="50" value="{MODELO/CON_MOD_CODIGO}"/>
        			  </xsl:otherwise>
        			</xsl:choose>
				</li>
				<li>
        			...
        			<xsl:choose>
        			  ...
        			  <xsl:otherwise>
        				<input type="text" name="CON_MOD_NOMBRE" class="form-control grande" data-parsley-trigger="change" required="" maxlength="50" value="{MODELO/CON_MOD_NOMBRE}"/>
        			  </xsl:otherwise>
        			</xsl:choose>
				</li>
				<li>
        			...
        			<xsl:choose>
        			  ...
        			  <xsl:otherwise>
        				<input type="text" name="CON_MOD_DESCRIPCION" class="form-control" style="width:700px;" data-parsley-trigger="change" maxlength="1000" value="{MODELO/CON_MOD_DESCRIPCION}"/>
        			  </xsl:otherwise>
        			</xsl:choose>
				</li>
