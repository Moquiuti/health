...
<!--
	...
	Ultima revision: ET 8nov21 17:40
-->
...
<head>
	...
	<script type="text/javascript" src="http://www.newco.dev.br/ProcesosCdC/MantenimientoReducido/mantenimientoReducido.040917.js"></script>
...
<body>
	...
	<form name="form1">
		...
		<div class="ZonaTituloPagina">
			<p class="Path"><xsl:value-of select="document($doc)/translation/texts/item[@name='Inicio']/node()"/>&nbsp;/&nbsp;<xsl:value-of select="document($doc)/translation/texts/item[@name='catalogo_privado']/node()"/>&nbsp;/&nbsp;
				<span class="FinPath">
					...
					<xsl:when test="/Mantenimiento/MANTENIMIENTO/MVM or /Mantenimiento/MANTENIMIENTO/MVMB">
						<xsl:call-template name="desplegable">
							...
							<xsl:with-param name="style">height:25px;width:450px;font-size:15px;</xsl:with-param>
						</xsl:call-template>
					</xsl:when>
					<xsl:otherwise>
			...
			<p class="TituloPagina">
				...
				<span class="CompletarTitulo">
					...
					<xsl:if test="/Mantenimiento/MANTENIMIENTO/PRO_ID_ANTERIOR != ''">
						<a class="btnNormal" href="http://www.newco.dev.br/ProcesosCdC/MantenimientoReducido/MantenimientoReducido.xsql?PRO_ID={/Mantenimiento/MANTENIMIENTO/PRO_ID_ANTERIOR}&amp;EMP_ID={/Mantenimiento/MANTENIMIENTO/CLIENTE/IDEMPRESA}" title="Anterior producto" target="_self">
					...
					<xsl:if test="/Mantenimiento/MANTENIMIENTO/PRO_ID_SIGUIENTE != ''">
						<a class="btnNormal" href="http://www.newco.dev.br/ProcesosCdC/MantenimientoReducido/MantenimientoReducido.xsql?PRO_ID={/Mantenimiento/MANTENIMIENTO/PRO_ID_SIGUIENTE}&amp;EMP_ID={/Mantenimiento/MANTENIMIENTO/CLIENTE/IDEMPRESA}" title="Siguiente producto" target="_self">
      ...
      <div class="divLeft">
		...
		<tr class="sinLinea">
			...
			<td class="datosLeft">
				...
				<!--DATOS PRODUCTO MVM-->
				<div class="divLeft50nopa">
					<!--15dic16	<table class="infoTable" cellspacing="5" style="border-collapse:separate;">-->
					<table class="buscador">
					<tbody>
						<tr class="sinLinea">
							<!--<td class="cinquenta" colspan="2" style="font-weight:bold; background:#e3e1e2; padding:3px 0;">-->
        			  ...
        			  <xsl:if test="/Mantenimiento/MANTENIMIENTO/CDC and /Mantenimiento/MANTENIMIENTO/CLIENTE/IDPRODUCTO != ''">
						...
						<tr class="sinLinea">
							...
							<td class="datosLeft">
								<input type="text" size="12" maxlength="12" name="PRECIOCONMARGENPORDEFECTO" class="noinput peq" disabled="disabled"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Euros&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						...
						<tr class="sinLinea" style="display:none;">
							<td class="cinquenta" colspan="2" >
								<!-- precio -->
						...
						<tr class="sinLinea">
							...
							<td class="datosLeft">
								<input type="text" size="12" maxlength="12" name="PRECIO" class="peq" value="{/Mantenimiento/MANTENIMIENTO/CLIENTE/TARIFA/PRECIO}" onChange="ValidarNumero(this,4);" onBlur="calcularTodosAhorros(document.forms['form1']);" disabled="disabled"/>
						...
						<tr class="sinLinea">
							...
							<td class="datosLeft">
								...
								<input type="text" size="5" maxlength="12" name="AHORRO_{/Mantenimiento/MANTENIMIENTO/CLIENTE/IDEMPRESA}" class="noinput peq" style="text-align:right; margin-top:-3px;" onFocus="this.blur();"/>%
						...
						<tr class="sinLinea">
							...
							<td class="datosLeft">
								<input type="text" class="peq" size="12" maxlength="12" name="PRECIOFINAL_{/Mantenimiento/MANTENIMIENTO/CLIENTE/IDEMPRESA}" value="{/Mantenimiento/MANTENIMIENTO/CLIENTE/TARIFA_TOTAL_SINFORMATO}" onChange="ValidarNumero(this,4);">
									<!--si viejo modelo no hace nada el onblur, si nuevo modelo si-->
									<xsl:attribute name="onBlur">
										<xsl:choose>
										<xsl:when test="/Mantenimiento/MANTENIMIENTO/NUEVOMODELO">
								...
								<input type="text" size="5" maxlength="5" name="MARGENBRUTO_{/Mantenimiento/MANTENIMIENTO/CLIENTE/IDEMPRESA}" style="text-align:right; margin-top:-3px;" class="noinput peq" onFocus="this.blur();"/>%
							</td>
						</tr>
						<tr class="sinLinea">
							<td>&nbsp;</td>
					...
					<tbody>
						<tr class="sinLinea">
							...
							<td class="datosLeft">
								...
								<xsl:otherwise>
									<input type="text" size="12" maxlength="9" name="REFERENCIACLIENTE"/>
        			  ...
        			  <xsl:when test="/Mantenimiento/MANTENIMIENTO/CLIENTE/PLANTILLAS/PLANTILLA">
            			...
            			<tr class="sinLinea">
            			  ...
            			  <td class="datosLeft">
                			...
                			<xsl:otherwise>
                			  <input type="text" name="FECHA_LIMITE" id="FECHA_LIMITE" value="{/Mantenimiento/MANTENIMIENTO/CLIENTE/FECHALIMITEOFERTA}" class="noinput peq" size="10"/>
                			  <input type="hidden" name="CLIENTE_ID" id="CLIENTE_ID" value="{/Mantenimiento/MANTENIMIENTO/CLIENTE/IDEMPRESA}"/>
            			...
            			<tr class="sinLinea">
							...
							<xsl:if test="/Mantenimiento/MANTENIMIENTO/CLIENTE/PLANTILLAS/PLANTILLA"><!--30may11 Si no está emplantillado no mostramos botón de ocultar -->
								<a class="btnDestacado" href="javascript:DerechosPlantillas(document.forms['form1']);">
		...
		<!--	Botones traspasados a la tabla
        ...
        <table class="menuGestion" style="width:100%;">
          <tr>
		...
		<table id="pedidosBox" class="buscador" style="display:;">
          ...
          <xsl:for-each select="/Mantenimiento/MANTENIMIENTO/CLIENTE/PEDIDOS/LINEAPEDIDO">
            <tr>
              <td>&nbsp;</td>
              <td><a href="javascript:MostrarPagPersonalizada('http://www.newco.dev.br/Compras/Multioferta/MultiofertaFrame.xsql?MO_ID={MO_ID}','Multioferta',100,100,0,0)"><xsl:value-of select="CODIGO"/></a></td>
        ...
        <div class="divLeft">
		<table id="todosPreciosBox" class="buscador" style="display:none;">
        ...
        <div class="divLeft">
		<table id="roturasBox" class="buscador" style="display:none;">
        ...
        <div class="divLeft">
			<table id="historicoCentrosBox" class="buscador" style="display:none;">
		...
		<div class="divLeft">
			<!--<table id="preciosBox" class="grandeInicio" style="display:none;">
				<tr class="tituloTabla">-->
			<table id="preciosBox" class="buscador" style="display:none;">
				<tr class="subTituloTabla">
              ...
              <th>&nbsp;</th>
				...
				<div class="divLeft">
					<!--<table id="preciosReferenciaBox" style="display:none;" class="grandeInicio">
						<tr class="tituloTabla">-->
					<table id="preciosReferenciaBox" style="display:none;" class="buscador">
						<tr class="subTituloTabla">
			...
			<xsl:if test="/Mantenimiento/MANTENIMIENTO/ADMIN or /Mantenimiento/MANTENIMIENTO/MVM">
				<div class="divLeft">
					<!--<table id="precioConsumoClinicasBox" style="display:none;" class="grandeInicio">
						<tr class="tituloTabla">-->
					<table id="precioConsumoClinicasBox" style="display:none;" class="buscador">
						<tr class="subTituloTabla">
              				<th class="tres">&nbsp;</th>
				...
				<div class="divLeft">
					<!--<table id="infoProveedorBox" style="display:none;" class="grandeInicio" border="0">
						<tr class="tituloTabla">-->
					<table id="infoProveedorBox" style="display:none;" class="buscador">
						<tr class="subTituloTabla">
			...
			<xsl:if test="/Mantenimiento/MANTENIMIENTO/ADMIN or /Mantenimiento/MANTENIMIENTO/MVM or /Mantenimiento/MANTENIMIENTO/CDC">
				...
				<div class="divLeft">
					<!--<table id="consumoCentrosBox" style="display:none;" class="grandeInicio">
						<tr class="titulotabla">-->
					<table id="consumoCentrosBox" style="display:none;" class="buscador">
						<tr class="subTitulotabla">
