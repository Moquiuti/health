...
function ValidarFormulario(form){
	...
	//solodebug
	console.log('ValidarFormulario. Ref1:'+form.elements['CATPRIV_REFERENCIA_STRING1'].value+' Ref2:'+form.elements['CATPRIV_REFERENCIA_STRING2'].value);
	...
	if((!errores) && form.elements['CATPRIV_REFERENCIA_STRING2'] && (esNulo(form.elements['CATPRIV_REFERENCIA_STRING2'].value))){
		...
		//solodebug
		console.log('ValidarFormulario. Err1. Ref1:'+form.elements['CATPRIV_REFERENCIA_STRING1'].value+' Ref2:'+form.elements['CATPRIV_REFERENCIA_STRING2'].value);
		...
		//solodebug
		console.log('ValidarFormulario. Err2. Ref1:'+form.elements['CATPRIV_REFERENCIA_STRING1'].value+' Ref2:'+form.elements['CATPRIV_REFERENCIA_STRING2'].value);
		...
		//solodebug
		console.log('ValidarFormulario. Err3. Ref1:'+form.elements['CATPRIV_REFERENCIA_STRING1'].value+' Ref2:'+form.elements['CATPRIV_REFERENCIA_STRING2'].value);
