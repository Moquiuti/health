											...
											<xsl:choose>
												<xsl:when test="/Mantenimiento/SUBFAMILIA/ID='0'">
													<xsl:if test="/Mantenimiento/SUBFAMILIA/CODIFICACIONNIVELES[@MostrarCategoria='S']">
														<input type="text" name="CATPRIV_REFERENCIA_TXT" id="CATPRIV_REFERENCIA_TXT" disabled="disabled" class="noinput muypeq" size="3"/>
													</xsl:if>
													<input type="hidden" name="CATPRIV_REFERENCIA_STRING1" id="CATPRIV_REFERENCIA_STRING1"/>
													<input type="text" class="peq" id="CATPRIV_REF" name="CATPRIV_REFERENCIA_STRING2" size="3">
														<xsl:choose>
														<xsl:when test="/Mantenimiento/SUBFAMILIA/CODIFICACIONNIVELES[@MostrarCategoria='S']">
						...
						<td class="datosLeft">
							<xsl:choose>
								<xsl:when test="Mantenimiento/TIPO='CONSULTA' or Mantenimiento/SUBFAMILIA/BLOQUEADO">
									...
									<input type="hidden" class="muygrande" name="CATPRIV_NOMBRE" value="{Mantenimiento/SUBFAMILIA/NOMBRE}"/>
								</xsl:when>
								<xsl:otherwise>
									<input type="text" class="muygrande" name="CATPRIV_NOMBRE" value="{Mantenimiento/SUBFAMILIA/NOMBRE}" size="70" maxlength="300"/>
								</xsl:otherwise>
							</xsl:choose>
						</td>
					</tr>
