...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <table class="grandeInicio">
   <tr class="tituloTabla">
		...
		<th><xsl:value-of select="document($doc)/translation/texts/item[@name='catalogo_privado_listado']/node()"/><br />
...
<xsl:template name="modoD">
  <!--idioma-->
   ...
   <thead>
      ...
      <!--idioma fin--></xsl:template><!--fin de modoD-->
<!--modoADJ Adjudicados-->
...
<!--modoMULT Multiples Tipo de informe = Multiples-->
...
<!--modoP tipo de informe: precios y ahorro-->
...
<table class="grandeInicio">
   <thead>
  		<tr class="titulos">
                ...
                <td class="dies"> <xsl:copy-of select="document($doc)/translation/texts/item[@name='tipo_iva_2line']/node()"/></td>
                
                <td class="dies"><xsl:value-of select="document($doc)/translation/texts/item[@name='precio_historico_iva_incl_2line']/node()"/></td>
                
                <td class="dies"><xsl:copy-of select="document($doc)/translation/texts/item[@name='precio_actual_iva_incl_2line']/node()"/></td>
                
                <td class="dies"> <xsl:copy-of select="document($doc)/translation/texts/item[@name='comision_mvm_16iva_2line']/node()"/></td>
  ...
  <thead>
  		<tr class="titulos">
            ...
            <tr class="subTituloTabla">
                ...
                <td>&nbsp;<xsl:value-of select="document($doc)/translation/texts/item[@name='ahorro']/node()"/>&nbsp;</td>
 ...
 <table class="grandeInicio">
  <thead>
  		<tr class="titulos">
                 ...
                 <td class="dies"><xsl:value-of select="document($doc)/translation/texts/item[@name='ud_por_lote_2line']/node()"/></td>
                 <td class="dies"><xsl:value-of select="document($doc)/translation/texts/item[@name='precio_euros_2line']/node()"/></td>
		</tr>
   </thead>
   </table>
