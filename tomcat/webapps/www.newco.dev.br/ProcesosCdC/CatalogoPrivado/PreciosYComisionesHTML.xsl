...
<!--
	...
	ultima revision	ET 11may22 17:00
-->
		...
		<xsl:otherwise>
			...
			<div id="pruebaDescarga">
				...
				<!--<tr class="titulos">-->
					...
					<!--<td class="cinco">&nbsp;&nbsp;<xsl:value-of select="document($doc)/translation/texts/item[@name='marca']/node()"/>&nbsp;&nbsp;</td>--><!--10may22 marca de proveedor en lugar de marcas autorizadas-->
					<td class="uno"></td>
					...
					<th class="cinco">&nbsp;&nbsp;<xsl:value-of select="document($doc)/translation/texts/item[@name='marca']/node()"/>&nbsp;&nbsp;</th>
					<td>
