...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
                      ...
                      <xsl:when test="MO_STATUS &lt; 11"><!- - si es mas peq de 11, (Status=OFERTA) - ->-->
                        <tr class="blanco">
                          ...
                          <td align="center" width="8%">
          					<b>
                  			<a>
                  			<xsl:attribute name="href">javascript:MostrarPag('http://www.newco.dev.br/ProcesosCdC/CatalogoPrivado/NoConformidadProducto.xsql?IDINFORME=<xsl:value-of select="ID"/>','NoConformidadProducto');</xsl:attribute>
                  			<xsl:attribute name="onMouseOver">window.status='Abrir informe.';return true;</xsl:attribute>
  ...
  <xsl:template match="ERW_DESCRIPCION_BANDEJA">
	    <a>
	     <xsl:attribute name="href">http://www.newco.dev.br/ProcesosCdC/CatalogoPrivado/NoConformidadProducto.xsql?IDINFORME=<xsl:value-of select="../ID"/></xsl:attribute>
	     <xsl:attribute name="onMouseOver">window.status='Abrir informe.';return true;</xsl:attribute>
	     <xsl:attribute name="onMouseOut">window.status='';return true;</xsl:attribute>
