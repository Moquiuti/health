...
<!--
	Información de un producto estándar y producto adjudicado para el margen izquierdo de la pagina del catálogo privado
	ultima revision	ET 07mar22 16:25
-->
...
//alert('ZonaProducto-6');				
	...
	function recargarPagina(){
		document.location.href='ZonaProductos2022.xsql?IDPRODUCTOESTANDAR='+document.forms[0].elements['CATPRIV_IDPRODUCTOESTANDAR'].value+'&IDSUBFAMILIA='+document.forms[0].elements['CATPRIV_IDSUBFAMILIA'].value+'&TIPOVENTANA='+document.forms[0].elements['TIPOVENTANA'].value+'&IDFAMILIA='+document.forms[0].elements['CATPRIV_IDFAMILIA'].value;
	}
...
<xsl:otherwise>
	...
	<form name="form1" action="" method="post">
        ...
        <table class="fuentePeq" id="table_padre">
			<tr>
				...
				<xsl:for-each select="/ZonaCatalogo/AREACATALOGOS/PROVEEDORES/PROVEEDOR">
					...
					<tr height="20px;">
                        ...
                        <td>
							...
							<xsl:otherwise>
								<a href="javascript:MostrarPagPersonalizada('http://www.newco.dev.br/Administracion/Mantenimiento/Empresas/EMPDetalleFrame2022.xsql?EMP_ID={IDPROVEEDOR}&amp;VENTANA=NUEVA','empresa',100,58,0,-50)" class="suave">
									<xsl:value-of select="NOMBREPROVEEDOR"/>
								</a>
