/*
	Librería JS para la gestión del catálogo privado. Nuevo disenno.
	ultima revision ET 28feb22 (incluir path absoluto en las llamadas) ZonaCatalogo2022_280222.js
*/
...
function CambioEmpresaActual(idEmpresa, accion){
	...
	parent.areaTrabajo.Cabecera.document.location.href=Path+'Buscador2022.xsql?IDEMPRESA='+idEmpresa;
	//}

	document.location.href=Path+'ZonaCatalogo2022.xsql?IDEMPRESA='+idEmpresa+'&ACCION='+accion+'&TIPOVENTANA='+document.forms[0].elements['TIPOVENTANA'].value;
}

function CambioCategoriaActual(idEmpresa, idCategoria, accion){
	document.location.href=Path+'ZonaCatalogo2022.xsql?IDEMPRESA='+idEmpresa+'&IDNUEVACATEGORIA='+idCategoria+'&ACCION='+accion+'&TIPOVENTANA='+document.forms[0].elements['TIPOVENTANA'].value;
}

function CambioFamiliaActual(idEmpresa, idFamilia, accion){
	document.location.href=Path+'ZonaCatalogo2022.xsql?IDEMPRESA='+idEmpresa+'&IDNUEVAFAMILIA='+idFamilia+'&ACCION='+accion+'&TIPOVENTANA='+document.forms[0].elements['TIPOVENTANA'].value;
}
...
function CambioSubfamiliaActual(idEmpresa, idSubfamilia, accion){
	...
	document.location.href=Path+'ZonaCatalogo2022.xsql?IDEMPRESA='+idEmpresa+'&IDNUEVASUBFAMILIA='+idSubfamilia+'&ACCION='+accion+'&TIPOVENTANA='+document.forms[0].elements['TIPOVENTANA'].value;
}

function CambioGrupoActual(idEmpresa, idGrupo, accion){
	document.location.href=Path+'ZonaCatalogo2022.xsql?IDEMPRESA='+idEmpresa+'&IDNUEVOGRUPO='+idGrupo+'&ACCION='+accion+'&TIPOVENTANA='+document.forms[0].elements['TIPOVENTANA'].value; 
}

//		añadimos una nueva categoria -- dc 07/01/13
function NuevaCategoria(idCategoria){
	var idEmpresa=document.forms[0].elements['CATPRIV_IDEMPRESA'].value;
	//var objFrame=new Object();

	parent.areaTrabajo.Resultados.location.href=Path+'MantCategorias2022.xsql?CATPRIV_IDCATEGORIA='+idCategoria+'&CATPRIV_IDEMPRESA='+idEmpresa;
}
...
//				nuevo trozo para que se enseñe tb buscador siempre
		parent.areaTrabajo.Resultados.location.href=Path+'MantCategorias2022.xsql?CATPRIV_IDCATEGORIA='+idCategoria+'&CATPRIV_IDEMPRESA='+idEmpresa+tipoModificacion;
	}else{
...
function NuevaFamilia(idFamilia,idCategoria){
	var idEmpresa=document.forms[0].elements['CATPRIV_IDEMPRESA'].value;

	parent.areaTrabajo.Resultados.location.href=Path+'MantFamilias2022.xsql?CATPRIV_IDCATEGORIA='+idCategoria+'&CATPRIV_IDFAMILIA='+idFamilia+'&CATPRIV_IDEMPRESA='+idEmpresa;
}

//		funcion para modificar la ref y el nombre de la familia
function ModificarFamilia(idFamilia,idCategoria){
	var tipoModificacion='';
	if(document.forms[0].elements['CATPRIV_IDFAMILIA'].value>''){
		...
		parent.areaTrabajo.Resultados.location.href=Path+'MantFamilias2022.xsql?CATPRIV_IDCATEGORIA='+idCategoria+'&CATPRIV_IDFAMILIA='+idFamilia+'&CATPRIV_IDEMPRESA='+idEmpresa+tipoModificacion;
	...
	if(IDFamilia>''){
		if(!tieneHijos(IDFamilia,arrayFamilias)){
			if(confirm(msgBorrar.replace('[[NIVEL]]', Nivel2).replace('[[NOMBRE]]', Familia)	/*borrar_nivel2*/)){
				document.location.href=Path+'ZonaCatalogo2022.xsql?IDEMPRESA='+idEmpresa+'&IDNUEVACATEGORIA='+idCategoria+'&IDNUEVAFAMILIA='+idFamilia+'&ACCION='+accion+'&TIPOVENTANA='+document.forms[0].elements['TIPOVENTANA'].value;
				var objFrame=new Object();
				parent.areaTrabajo.location.href=Path+'BuscadorFrame2022.xsql';
			}
		}else{
...
//		añadimos una nueva familia
function NuevaSubfamilia(idSubfamilia,idFamilia){
	if(document.forms[0].elements['CATPRIV_IDFAMILIA'].value>''){
		var idEmpresa=document.forms[0].elements['CATPRIV_IDEMPRESA'].value;
		var objFrame=new Object();

//				nuevo trozo para que se enseñe tb buscador siempre
		parent.areaTrabajo.Resultados.location.href=Path+'MantSubfamilias2022.xsql?CATPRIV_IDSUBFAMILIA='+idSubfamilia+'&CATPRIV_IDFAMILIA='+idFamilia+'&CATPRIV_IDEMPRESA='+idEmpresa;
	}else{
...
//		funcion para modificar la ref y el nombre de la familia
function ModificarSubfamilia(idSubfamilia,idFamilia){
	var tipoModificacion='';
	if(document.forms[0].elements['CATPRIV_IDSUBFAMILIA'].value>''){
		...
		parent.areaTrabajo.Resultados.location.href=Path+'MantSubfamilias2022.xsql?CATPRIV_IDSUBFAMILIA='+idSubfamilia+'&CATPRIV_IDFAMILIA='+idFamilia+'&CATPRIV_IDEMPRESA='+idEmpresa+tipoModificacion;
	}else{
	...
	if(IDSubfamilia>''){
		if(!tieneHijos(IDSubfamilia,arraySubfamilias)){
			if(confirm(msgBorrar.replace('[[NIVEL]]', Nivel3).replace('[[NOMBRE]]', Subfamilia)	/*borrar_nivel3*/)){
				document.location.href=Path+'ZonaCatalogo2022.xsql?IDEMPRESA='+idEmpresa+'&IDNUEVACATEGORIA='+idCategoria+'&IDNUEVAFAMILIA='+idFamilia+'&IDNUEVASUBFAMILIA='+idSubfamilia+'&ACCION='+accion+'&TIPOVENTANA='+document.forms[0].elements['TIPOVENTANA'].value;
				var objFrame=new Object();
				parent.areaTrabajo.location.href=Path+'BuscadorFrame2022.xsql';
			}
		}else{
...
function NuevoGrupo(idGrupo,idSubfamilia){
	if(document.forms[0].elements['CATPRIV_IDSUBFAMILIA'].value>''){
		var idEmpresa=document.forms[0].elements['CATPRIV_IDEMPRESA'].value;
		parent.areaTrabajo.Resultados.location.href=Path+'MantGrupos2022.xsql?CATPRIV_IDGRUPO='+idGrupo+'&CATPRIV_IDSUBFAMILIA='+idSubfamilia+'&CATPRIV_IDEMPRESA='+idEmpresa;
//				objFrame.location.href='MantGrupos2022.xsql?CATPRIV_IDGRUPO='+idGrupo+'&CATPRIV_IDSUBFAMILIA='+idSubfamilia+'&CATPRIV_IDEMPRESA='+idEmpresa+'&ACCION='+accion;
	}else{
		alert(msgSinNivelSuperior.replace('[[NIVEL]]', Nivel4).replace('[[NIVELSUP]]', Nivel3) /*sin_nivel3+para_nivel4*/);
	}
}

function ModificarGrupo(idGrupo,idSubfamilia){
	var tipoModificacion='';
	if(document.forms[0].elements['CATPRIV_IDGRUPO'].value>''){
		...
		parent.areaTrabajo.Resultados.location.href=Path+'MantGrupos2022.xsql?CATPRIV_IDGRUPO='+idGrupo+'&CATPRIV_IDSUBFAMILIA='+idSubfamilia+'&CATPRIV_IDEMPRESA='+idEmpresa+tipoModificacion;
	}else{
	...
	if(IDGrupo>''){
		...
		if(!tieneHijos(IDGrupo,arrayGrupos)){
			...
			if(confirm(/*borrar_nivel4*/msgBorrar.replace('[[NIVEL]]', Nivel4).replace('[[NOMBRE]]', Grupo))){
				document.location.href=Path+'ZonaCatalogo2022.xsql?IDEMPRESA='+idEmpresa+'&IDNUEVACATEGORIA='+idCategoria+'&IDNUEVAFAMILIA='+idFamilia+'&IDNUEVASUBFAMILIA='+idSubfamilia+'&IDNUEVOGRUPO='+idGrupo+'&ACCION='+accion+'&TIPOVENTANA='+document.forms[0].elements['TIPOVENTANA'].value;
				var objFrame=new Object();
				parent.areaTrabajo.location.href=Path+'BuscadorFrame2022.xsql';
			}
		}else{
...
function NuevoProductoEstandar(idProducto,idGrupo,idSubfamilia){
	if(document.forms[0].elements['CATPRIV_IDSUBFAMILIA'].value>''){
		var idEmpresa=document.forms[0].elements['CATPRIV_IDEMPRESA'].value;
		parent.areaTrabajo.Resultados.location.href=Path+'MantProductosEstandar2022.xsql?CATPRIV_IDPRODUCTOESTANDAR='+idProducto+'&CATPRIV_IDGRUPO='+idGrupo+'&CATPRIV_IDSUBFAMILIA='+idSubfamilia+'&CATPRIV_IDEMPRESA='+idEmpresa;
	}else{
		if(document.getElementById('td_grupos')){
...
function CambioProductoEstandarActual(idEmpresa, idProductoEstandar, accion){
	...
	document.location.href=Path+'ZonaCatalogo2022.xsql?IDEMPRESA='+idEmpresa+'&IDNUEVOPRODUCTOESTANDAR='+idProductoEstandar+'&IDNUEVASUBFAMILIA='+idSubfamilia+'&ACCION='+accion+'&TIPOVENTANA='+document.forms[0].elements['TIPOVENTANA'].value;
}

function ModificarProductoEstandar(idProducto,idGrupo,idSubfamilia,idFamilia,idCategoria){
	var tipoModificacion='';
	if(document.forms[0].elements['CATPRIV_IDPRODUCTOESTANDAR'].value>''){
		...
		//if(accion=='CONSULTARPRODUCTOESTANDAR'){
			tipoModificacion='&TIPO=CONSULTA';
		//}
		parent.areaTrabajo.Resultados.location.href=Path+'MantProductosEstandar2022.xsql?CATPRIV_IDPRODUCTOESTANDAR='+idProducto+'&CATPRIV_IDGRUPO='+idGrupo+'&CATPRIV_IDSUBFAMILIA='+idSubfamilia+'&CATPRIV_IDCATEGORIA='+idCategoria+'&CATPRIV_IDFAMILIA='+idFamilia+'&CATPRIV_IDEMPRESA='+idEmpresa+tipoModificacion;
	}else{
	...
	if(IDProdEstandar!=''){
		if(buscarHijos(IDProdEstandar,arrayProductosEstandar,3)==0){
			if(confirm(msgBorrar.replace('[[NIVEL]]', Nivel4).replace('[[NOMBRE]]', Grupo)/*borrar_prod_estandar*/)){
				document.location.href=Path+'ZonaCatalogo2022.xsql?IDEMPRESA='+idEmpresa+'&IDNUEVACATEGORIA='+idCategoria+'&IDNUEVAFAMILIA='+idFamilia+'&IDNUEVASUBFAMILIA='+idSubfamilia+'&IDNUEVOGRUPO='+idGrupo+'&IDNUEVOPRODUCTOESTANDAR='+idProductoEstandar+'&ACCION='+accion+'&TIPOVENTANA='+document.forms[0].elements['TIPOVENTANA'].value;
				var objFrame=new Object();
				parent.areaTrabajo.location.href=Path+'BuscadorFrame2022.xsql';
			}
		}else{
...
function recargarPagina(propagar){
	...
	objFrame.location.href='about:blank';
	document.location.href=Path+'ZonaCatalogo2022.xsql?IDNUEVOPRODUCTOESTANDAR='+document.forms[0].elements['CATPRIV_IDPRODUCTOESTANDAR'].value+'&IDNUEVAFAMILIA='+document.forms[0].elements['CATPRIV_IDFAMILIA'].value+'&ACCION=CAMBIOPRODUCTOESTANDAR'+'&TIPOVENTANA='+document.forms[0].elements['TIPOVENTANA'].value+'&PROPAGAR='+propagar;
}
...
//alert('idPE: '+idProductoEstandar+' , idG: '+idGrupo+' , idSF: '+idSubfamilia+' , idF: '+idFamilia+' , idC: '+idCategoria);
		...
		parent.zonaProducto.location.href=Path+'ZonaProductos2022.xsql?IDPRODUCTOESTANDAR='+idProductoEstandar+'&IDGRUPO='+idGrupo+'&IDSUBFAMILIA='+idSubfamilia+'&IDFAMILIA='+idFamilia+'&IDCATEGORIA='+idCategoria;
	}else{
//				CargarProductoEstandarEnBlanco();
	}

	if(!parent.areaTrabajo.location.href.match('BuscadorFrame2022.xsql'))
		if(propagar!='NOPROPAGAR')
			parent.areaTrabajo.location.href='BuscadorFrame2022.xsql';
}

function CargarProductoEstandarEnBlanco(){
	var idSubfamilia=document.forms['form1'].elements['CATPRIV_IDSUBFAMILIA'].value;
	var idFamilia=document.forms[0].elements['CATPRIV_IDFAMILIA'].value;
	parent.zonaProducto.location.href=Path+'ZonaProductos2022.xsql?IDPRODUCTOESTANDAR=-1&IDFAMILIA='+idFamilia+'&IDSUBFAMILIA='+idSubfamilia;
}
			...
			if(data.consumo == 'No'){
				...
				if(buscarHijos(IDProdEstandar,arrayProductosEstandar,3)==0){
					if(confirm(borrar_prod_estandar)){
						document.location.href=Path+'ZonaCatalogo2022.xsql?IDEMPRESA='+IDEmpresa+'&IDNUEVACATEGORIA='+IDCategoria+'&IDNUEVAFAMILIA='+IDFamilia+'&IDNUEVASUBFAMILIA='+IDSubfamilia+'&IDNUEVOGRUPO='+IDGrupo+'&IDNUEVOPRODUCTOESTANDAR='+IDProdEstandar+'&ACCION=BORRARPRODUCTOESTANDAR';
						var objFrame=new Object();
						parent.areaTrabajo.location.href=Path+'BuscadorFrame2022.xsql';
					}
				}else{
