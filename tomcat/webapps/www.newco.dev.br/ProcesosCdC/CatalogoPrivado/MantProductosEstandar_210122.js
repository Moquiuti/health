...
//	Ultima revisión: 8set21 09:30 MantProductosEstandar_210122.js

jQuery(document).ready(onloadEvents);

function onloadEvents(){
	debug("onloadEvents. Inicio.");
	...
	if(jQuery('#CATPRIV_IDGRUPO').length){
		debug("onloadEvents. UltimaRefProductoPorGrupo");
		UltimaRefProductoPorGrupo();
	// Recuperamos la ultima ref.utilizada segun la subfamilia por defecto (caso 3 niveles)
		...
		debug("onloadEvents. UltimaRefProductoPorSF");
		UltimaRefProductoPorSF();
	}
...
function UltimaRefProductoPorGrupo(){
	...
	//solodebug	
	debug('UltimaRefProductoPorGrupo IDEmpresa:'+IDEmpresa+' IDGrupo:'+IDGrupo);
