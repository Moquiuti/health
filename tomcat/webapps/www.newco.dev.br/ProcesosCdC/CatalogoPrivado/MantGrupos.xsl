...
<!--
	Ultima revisión ET 28nov18 11:21
-->
...
<!-- DC - 18/07/14 - Deshabilitamos los primeros caracteres de la ref.grupo que dependen de los niveles inferiores
													<input type="text" name="CATPRIV_REFERENCIA" value="{Mantenimiento/GRUPO/REFERENCIA}" size="8" maxlength="{string-length(Mantenimiento/GRUPO/CODIFICACIONNIVELES/NIVEL4)}"/>
													&nbsp;<span id="ley_ref_grupo">&nbsp;</span>
-->
