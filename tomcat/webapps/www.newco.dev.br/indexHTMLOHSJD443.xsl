...
<head>
	...
	<script type="text/javascript" src="http://www.newco.dev.br/General/login_06nov18OHSJD.js"></script>
...
<body onload="CompruebaHTTPOHSJD('{document($doc)/translation/texts/item[@name='URLSeguraOHSJD']/node()}');CompruebaCookie();">
<!--20180416<body>-->
