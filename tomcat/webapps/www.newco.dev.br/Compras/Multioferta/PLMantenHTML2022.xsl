...
<!--
	...
	ultima revision: ET 18feb22 09:30 PLManten2022_180222.js
 -->
...
<head>
	...
	<title>
		<xsl:value-of select="document($doc)/translation/texts/item[@name='plantilla']/node()"/>:&nbsp;<xsl:value-of select="/Mantenimiento/PLANTILLA/NOMBRE"/>
	</title>
	<script src="http://www.newco.dev.br/General/jquery-3.6.0.js"></script>	
	<script type="text/javascript" src="http://www.newco.dev.br/General/basic2022_010822.js"></script>
	<!--<script type="text/javascript" src="http://www.newco.dev.br/General/jquery.js"></script>
	<script type="text/javascript" src="http://www.newco.dev.br/General/basic_180608.js"></script>	-->
	<script type="text/javascript" src="http://www.newco.dev.br/Compras/Multioferta/PLManten2022_180222.js"></script>
...
<xsl:template name="MantenimientoEdicion">
  ...
  <form>
    ...
    <xsl:attribute name="action">PLManten2022.xsql</xsl:attribute>
...
+-->
    ...
    <table cellspacing="6px" cellpadding="6px">
      ...
      <tr class="sinLinea">
        <td class="labelRight w300px"><label><xsl:value-of select="document($doc)/translation/texts/item[@name='Productos']/node()"/>:&nbsp;</label></td>
...
<xsl:template name="DESCRIPCION">
  <input type="text" class="campopesquisa w400px" size="50" name="DESCRIPCION" maxlength="300">
