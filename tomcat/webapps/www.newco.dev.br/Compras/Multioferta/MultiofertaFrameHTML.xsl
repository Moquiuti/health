...
<!--
	...
	Ultima revisión ET 2set21 10:00
-->
      ...
      <head> 	       
        <title>  
            ...
            <xsl:when test="contains(/Multioferta/MULTIOFERTA/DERECHOS,'25_RW')">
            	<script type="text/javascript" src="http://www.newco.dev.br/Compras/Multioferta/MOFJS/MOF_25_RW_JS_070121.js"></script>
            </xsl:when>
...
-->     
   ...
   <!--DATOS PEDIDO--> 
	...
	<xsl:if test="/Multioferta/MULTIOFERTA/USUARIOGESTOR">
		<p style="text-align:center;width:100%;" class="rojo"><xsl:value-of select="document($doc)/translation/texts/item[@name='En_caso_contactar']/node()"/>&nbsp;<xsl:value-of select="/Multioferta/MULTIOFERTA/COMPRADOR" />.&nbsp;
