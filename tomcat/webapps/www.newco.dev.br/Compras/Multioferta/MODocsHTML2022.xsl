...
<!--
	...
	ultima revision: ET 16dic22 11:05 MODocs2022_260123.js 
-->
...
<head>
	...
	<title><xsl:value-of select="/Docs/MULTIOFERTA/CODIGO"/>&nbsp;<xsl:value-of select="/Docs/MULTIOFERTA/CENTROCLIENTE" disable-output-escaping="yes"/>:&nbsp;<xsl:value-of select="document($doc)/translation/texts/item[@name='documentos']/node()"/></title>
	...
	<script type="text/javascript">
		...
		var alrtTipoDocObligatorio='<xsl:value-of select="document($doc)/translation/texts/item[@name='Tipo_doc_obligatorio']/node()"/>';
	</script>
	<script src="http://www.newco.dev.br/General/jquery-3.6.0.js"></script>	
	<script type="text/javascript" src="http://www.newco.dev.br/General/basic2022_010822.js"></script>
	<script type="text/javascript" src="http://www.newco.dev.br/General/descargas_151117.js"></script>
	<script type="text/javascript" src="http://www.newco.dev.br/Compras/Multioferta/MODocs2022_260123.js"></script>
</head>
...
<xsl:template match="MULTIOFERTA">
	...
	<div class="ZonaTituloPagina">
		<p class="TituloPagina">
			<xsl:if test="/Docs/MULTIOFERTA/CODIGO"><xsl:value-of select="/Docs/MULTIOFERTA/CODIGO" disable-output-escaping="yes"/></xsl:if>:&nbsp;<xsl:value-of select="/Docs/MULTIOFERTA/CENTROCLIENTE" disable-output-escaping="yes"/>
			...
			<span class="CompletarTitulo">
				...
				<!--16dic22 Salir devuelve al pedido	<a class="btnNormal" href="javascript:window.close();" style="text-decoration:none;">-->
				<a class="btnNormal" href="javascript:chFichaPedido({/Docs/MULTIOFERTA/MO_ID});" style="text-decoration:none;">
		  ...
		  <tr>
   	    ...
   	    <tbody class="corpo_tabela">
   			<xsl:for-each select="$path/DOCUMENTO">
				...
				<tr class="conhover">
					<td id="doc_{ID}" class="color_status">
