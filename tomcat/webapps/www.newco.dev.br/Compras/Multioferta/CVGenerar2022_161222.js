...
//	Ultima revision: ET 16dic22 11:00 CVGenerar2022_161222.js
...
function EnviarPedidos(formPrincipal, linka, formPedido){
	...
	for(var i=0; i<formPrincipal.length; i++){
		...
		if(nom.indexOf("COMENTARIO_") != -1){
			...
			coments	+=	sepComentario + formPrincipal.elements['COMENTARIO_'+mo_id].value.replace(/#/g,'').replace(/|/g,'') + "#" + formPrincipal.elements['NUMERO_OFERT_PED_'+mo_id].value + "#";
