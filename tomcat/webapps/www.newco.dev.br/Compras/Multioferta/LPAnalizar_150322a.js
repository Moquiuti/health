...
function aplicarFiltro(filtroTxt, IDCategoria, IDTipoNeg){
	...
	//solodebug	debug('aplicarFiltro:'+filtroTxt+' IDCategoria:'+IDCategoria+' IDTipoNeg:'+IDTipoNeg);
...
function aplicarFiltroCompleto()
{
	...
	//solodebug	
	debug('aplicarFiltroCompleto filtro:'+filtroTXT+' IDCategoria:'+IDCategoria+' IDTipoNeg:'+IDTipoNeg);
