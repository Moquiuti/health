...
//	ultima revision: ET 26ene23 16:50 MODocs2022_260123.js
...
function ActualizarPadre()
{
	...
	if (Origen=='CONTROL')
	{
		w.location='http://www.newco.dev.br/Personal/BandejaTrabajo/ControlPedidos2022.xsql?IDPEDIDO='+IDPedido;
	}
	else if (Origen=='MANTEN')
	{
		w.location='http://www.newco.dev.br/Administracion/Mantenimiento/Pedidos/MANTPedidosSave2022.xsql?MO_ID='+IDMultioferta+'&IDCLIENTE='+IDCliente+'&IDPROVEEDOR='+IDProveedor+'&ACCION=COMPROBAR';
	}
	else
	{
		
		if (MOStatus<11)
			w.location='http://www.newco.dev.br/Compras/Multioferta/CVGenerar_MO2022.xsql?LP_ID='+LP_ID;
		else
			w.location='http://www.newco.dev.br/Compras/Multioferta/MultiofertaFrame2022.xsql?MO_ID='+IDMultioferta;
	}
}
