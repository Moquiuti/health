//	JS de MOF_14_RW. 
//	Ultima revision: ET 25oct21 11:00
...
//    No pedimos confirmacion cuando el proveedor rechaza un pedido.
...
//	25oct21 Avisamos al proveedor que esto es un abono
function AvisarAbono(){
	var msgAvisoAbono='';

	msgAvisoAbono+= document.forms['MensajeJS'].elements['MENS_AVISOABONO'].value+'\n';
	msgAvisoAbono+= document.forms['MensajeJS'].elements['MENS_AVISOABONO1'].value+'\n';
