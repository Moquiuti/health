...
<head>
	...
	<![CDATA[ 
                ...
                document.location.href='http://www.newco.dev.br/Compras/Multioferta/MultiofertaFrame2022.xsql?MO_ID='+mo_id;
			...
			function Evento_OnLoad(){
				...
				if (Incidencia!=''){
					GenerarIncidencia('http://www.newco.dev.br/Compras/Incidencias/Incidencia2022.xsql?INC_ID='+Incidencia+'&amp;RELOAD=N','Incidencia');
				}else if(URL!=''){
