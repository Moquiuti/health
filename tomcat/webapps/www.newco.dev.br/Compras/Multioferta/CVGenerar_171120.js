...
//	ultima revision: ET 17nov20 13:00 CVGenerar_171120.js
...
function globalEvents(){
	...
	ComentarioPorDefecto=ComentarioPorDefecto.replace('<COMENTARIO>','').replace('</COMENTARIO>','').replace(/\<br\>/g,'\n')
...
function actualizarImagen(idMultioferta, estado){
	var imgOK	= Dominio+'/images/Botones/AceptarMO.gif';
	var imgKO	= Dominio+'/images/Botones/CancelarMO.gif';
	var imgConsultar= Dominio+'/images/Botones/ConsultarMO.gif';
