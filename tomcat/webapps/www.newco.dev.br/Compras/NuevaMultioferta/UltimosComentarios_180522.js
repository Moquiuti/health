...
//	Ultima revision ET 11oct21 13:00 UltimosComentarios_071021.js
...
function copiarComentarios(IDComentario){
	...
	if (objFrameTop.name=='areaTrabajo')
	{
		...
		console.log('copiarComentarios. Opener:'+objFrameTop.name+'. Objeto:'+objeto+ '. Texto:'+texto);
...
function GuardarComentario(form, accion)
{
	...
	//solodebug
	console.log('GuardarComentario: CLAUSULALEGAL:'+document.forms['form1'].elements['CLAUSULALEGAL'].value);
...
function GuardarDefecto(form){
    //11oct21	form.action='/Compras/NuevaMultioferta/ComentarioDefectoSave.xsql';
...
function ClausulaLegalChange()
{
	...
	//document.forms['form1'].elements['CLAUSULALEGAL'].value=(document.forms['form1'].elements['chkCLAUSULALEGAL'].checked)?'S':'N';
}
...
function IncluirSiempreChange()
{
	...
	//document.forms['form1'].elements['INCLUIRSIEMPRE'].value=(document.forms['form1'].elements['chkINCLUIRSIEMPRE'].checked)?'S':'N';
}
