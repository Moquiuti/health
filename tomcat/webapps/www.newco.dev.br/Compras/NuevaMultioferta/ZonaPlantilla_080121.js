...
//	Ultima revision: ET 8ene21	18:00 ZonaPlantilla_080121.js
...
function PrepararOfertaPedido(tipo)
{
	...
	if (pl_id==-1)
		...
		var objFrame=new Object();
		objFrame=obtenerFrame(window.parent.frames[2],'areaTrabajo');
		objFrame.location.href='../Multioferta/LPAnalizarFrame.xsql?PL_ID='+pl_id+'&ACCION='+tipo+'&HOJADEGASTOS='+HojaDeGastos+'&NOMBREPACIENTE='+NombrePaciente+'&NUMCEDULA='+NumCedula+'&HABITACION='+Habitacion;
	
/*	
	4ago20 Este código no parece tener sentido
	if(tipo=='EDICION'){
			var objFrame=new Object();
			objFrame=obtenerFrame(window.parent.frames[2],'areaTrabajo');
