...
//	Ultima revision: ET 8ene21	18:00 ZonaPlantilla_210221.js
...
function PrepararOfertaPedido(tipo)
{
	...
	if (pl_id==-1)
		...
		console.log('../Multioferta/LPAnalizarFrame.xsql?PL_ID='+pl_id+'&ACCION='+tipo+'&HOJADEGASTOS='+encodeURIComponent(HojaDeGastos)+'&NOMBREPACIENTE='+encodeURIComponent(NombrePaciente)+'&NUMCEDULA='+encodeURIComponent(NumCedula)+'&HABITACION='+encodeURIComponent(Habitacion));
		
		objFrame.location.href='../Multioferta/LPAnalizarFrame.xsql?PL_ID='+pl_id+'&ACCION='+tipo+'&HOJADEGASTOS='+encodeURIComponent(HojaDeGastos)+'&NOMBREPACIENTE='+encodeURIComponent(NombrePaciente)+'&NUMCEDULA='+encodeURIComponent(NumCedula)+'&HABITACION='+encodeURIComponent(Habitacion);
