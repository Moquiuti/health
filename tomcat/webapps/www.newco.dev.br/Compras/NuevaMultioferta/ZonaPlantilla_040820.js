...
//	Ultima revision: ET 20nov19	13:50 ZonaPlantilla_040820.js
...
function PrepararOfertaPedido(tipo)
{
	...
	if (pl_id==-1)
		...
		var objFrame=new Object();
		objFrame=obtenerFrame(window.parent.frames[2],'areaTrabajo');
		objFrame.location.href='../Multioferta/LPAnalizarFrame.xsql?PL_ID='+pl_id+'&ACCION='+tipo+'&HOJADEGASTOS='+HojaDeGastos;
