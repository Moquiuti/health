...
//	Ultima revision: ET 12oct20	16:30 ZonaPlantilla_121020.js
...
function PrepararOfertaPedido(tipo)
{
	...
	if (pl_id==-1)
		...
		var objFrame=new Object();
		objFrame=obtenerFrame(window.parent.frames[2],'areaTrabajo');
		objFrame.location.href='../Multioferta/LPAnalizarFrame.xsql?PL_ID='+pl_id+'&ACCION='+tipo+'&HOJADEGASTOS='+HojaDeGastos+'&NOMBREPACIENTE='+NombrePaciente+'&NUMCEDULA='+NumCedula;
