...
function Pedido()
{
	...
	*/
	var Url='http://www.newco.dev.br/Compras/Multioferta/LPAnalizarFrame.xsql?IDEMPRESA='+document.forms['Busqueda'].elements['IDEMPRESA'].value
				+'&IDPROVEEDOR='+document.forms['Busqueda'].elements['IDPROVEEDOR'].value
				+'&SELECCIONADOS='+document.forms['Busqueda'].elements['SELECCIONADOS'].value
				+'&HOJADEGASTOS='+document.forms['Busqueda'].elements['HOJADEGASTOS'].value
				+'&NUMCEDULA='+document.forms['Busqueda'].elements['NUMCEDULA'].value
				+'&NOMBREPACIENTE='+document.forms['Busqueda'].elements['NOMBREPACIENTE'].value
				+'&HABITACION='+document.forms['Busqueda'].elements['HABITACION'].value;
