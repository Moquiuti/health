//	funciones JS para "ZonaPlantilla" en "EnviarPedidos". Nueva maquetacion 2022.
//	Ultima revision: ET 29may23	11:20 ZonaPlantilla2022_290523.js
...
function montarDesplegable(arrayDatos, obj, defecto)
{
	...
	for(var n=0;n<arrayDatos.length;n++){
		if(defecto==arrayDatos[n][0]){
			...
			//29may23 var decoded	= jQuery("<div/>").html('['+arrayDatos[n][1]+']').text();
...
function EditarPlantilla(){
	...
	if (pl_id==-1)
		...
		var objFrame=new Object();
		objFrame=obtenerFrame(window.parent.frames[2],'areaTrabajo');
		objFrame.location.href='../Multioferta/PLManten2022.xsql?PL_ID='+pl_id;
...
/*		console.log('EditarPlantilla.Frame:'+objFrame.name);
		...
		objFrame.location.href='http://www.newco.dev.br/Compras/NuevaMultioferta/AreaTrabajo2022.html';
		...
		setTimeout(function(){
			...
			objFrameHijo.location.href='../Multioferta/PLManten2022.xsql?PL_ID='+pl_id;
		},100);
*/
	}
...
function MostrarPlantilla(){
	...
	if (pl_id==-1)
		...
		objFrame=obtenerFrame(window.parent.frames[2],'areaTrabajo');
		objFrame.location.href='http://www.newco.dev.br/Compras/Multioferta/LPLista2022.xsql?PL_ID='+pl_id;		//20nov19	+'&SES_ID='+document.forms[0].elements['SES_ID'].value;
		/*
...
//	Primer paso del pedido en la pagina central
function PrepararOfertaPedido(tipo)
{
	...
	if (pl_id==-1)
		...
		console.log('../Multioferta/LPAnalizarFrame2022.xsql?PL_ID='+pl_id+'&ACCION='+tipo+'&HOJADEGASTOS='+encodeURIComponent(HojaDeGastos)+'&NOMBREPACIENTE='+encodeURIComponent(NombrePaciente)+'&NUMCEDULA='+encodeURIComponent(NumCedula)+'&HABITACION='+encodeURIComponent(Habitacion));
		
		objFrame.location.href='../Multioferta/LPAnalizarFrame2022.xsql?PL_ID='+pl_id+'&ACCION='+tipo+'&HOJADEGASTOS='+encodeURIComponent(HojaDeGastos)+'&NOMBREPACIENTE='+encodeURIComponent(NombrePaciente)+'&NUMCEDULA='+encodeURIComponent(NumCedula)+'&HABITACION='+encodeURIComponent(Habitacion);
...
function CargarListaProductos(idCarpeta, idPlantilla, idProducto, accion){
	var objFrame=new Object();
	objFrame=obtenerFrame(window.parent.frames[1],'zonaProducto');
	objFrame.location.href='http://www.newco.dev.br/Compras/NuevaMultioferta/ZonaProducto2022.xsql?IDCARPETA='+idCarpeta+'&IDPLANTILLA='+idPlantilla+'&IDPRODUCTO='+idProducto+'&ACCION='+accion;
}
