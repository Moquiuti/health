...
<head>
	...
	<script type="text/javascript" src="http://www.newco.dev.br/Compras/Multioferta/LPAnalizar_040220.js"></script>
		...
		<p class="TituloPagina">
			...
			<span class="CompletarTitulo" style="width:300px;">
				...
				<xsl:when test="/Analizar/ANALISIS/PEDIDO_MINIMO/IMPORTE != '0' and /Analizar/ANALISIS/PEDIDO_MINIMO/IMPORTE != ''">
					<a class="btnDestacado" href="javascript:controlPedido(document.forms['formBot'],document.forms,'LPAnalizarSave.xsql',{/Analizar/ANALISIS/PEDIDO_MINIMO/IMPORTE});" title="Continuar" id="botonContinuar"><xsl:value-of select="document($doc)/translation/texts/item[@name='continuar']/node()"/></a>
				</xsl:when>
				<xsl:otherwise>
		...
		<table class="buscador" border="0">
			<form name="formBot" method="POST">
				...
				<tr class="sinLinea">
					...
					<!--  pedido minimo -->
					<xsl:choose>
					<xsl:when test="/Analizar/ANALISIS/PEDIDO_MINIMO/ACTIVO!='N' and /Analizar/ANALISIS/PEDIDO_MINIMO/IMPORTE>0">
	...
	<thead>
		...
		<tr class="subTituloTabla">
			...
			<th align="left">
				...
				<span style="padding-left:5px;"><input type="text" name="strFiltro" id="strFiltro" size="30"/></span>
...
<!- - DC - Hacemos limpieza de la funcion controlPedido
					<a href="javascript:controlPedido(document.forms['formBot'],document.forms,'LPAnalizarSave.xsql',{/Analizar/ANALISIS/PEDIDO_MINIMO/IMPORTE});" title="Continuar" id="botonContinuar"><xsl:value-of select="document($doc)/translation/texts/item[@name='continuar']/node()"/></a>
- ->
