//	JS de MOF_25_RW
//	Ultima revisión ET 4set18 09:21
...
function UnidadesALotesRecibidas(unidades,unidadesporlote,cantidadTotal,objeto){
	...
	console.log('UnidadesALotesRecibidas. unidades:'+unidades+ ' unidadesporlote:'+unidadesporlote+' cantidadTotal:' +cantidadTotal)
		...
		{	
		  if ((incluyePacks=='N')&&(parseInt(unidades) > parseInt(cantidadTotal)))
		  {
	    	...
	    	if(document.forms['form1'].elements['CHKRECIBIDO_'+identificador].checked==true && parseInt(unidades) < parseInt(cantidadTotal)){
	    	  ...
	    	  //}
	        	...
	        	document.forms['form1'].elements['CantidadEntregada_'+identificador].value=nuevasUnidades;	          
			  	...
			  	console.log('UnidadesALotesRecibidas. checked=true. unidades:'+unidades+ ' nuevasUnidades:'+nuevasUnidades+' < cantidadTotal:' +cantidadTotal)
			...
			{	  	
			  ...
			  console.log('UnidadesALotesRecibidas. NOT checked=true. unidades:'+unidades+ ' nuevasUnidades:'+nuevasUnidades+' < cantidadTotal:' +cantidadTotal)
		...
		{	
		  if ((incluyePacks=='N')&&(parseInt(unidades) > parseInt(cantidadTotal)))
		  {
	    	...
	    	//if(parseInt(unidades) <= parseInt(cantidadTotal)){
				...
				console.log('UnidadesALotesRecibidasImagen. Revisando cantidad. unidades:'+unidades+ ' unidadesporlote:'+unidadesporlote+' nuevasUnidades:'+nuevasUnidades+' cantidadTotal:' +cantidadTotal)
