...
function inicializarDesplegableCentros(centroSeleccionado){
	...
	if (centroSeleccionado!=-1)	mostrarDesplegableLugarDeEntrega(centroSeleccionado, IDLugarEntrega);
}
...
function mostrarDesplegableLugarDeEntrega(centroSeleccionado, IDLugarEntregaActual){
	...
	console.log('mostrarDesplegableLugarDeEntrega centroSeleccionado:'+centroSeleccionado+' IDLugarEntregaActual:'+IDLugarEntregaActual);
