...
//	ultima revision ET 18ene22 10:00 MantenProductos_180122.js
...
function MostrarEstructuraDatos()
{
	...
	{
		titulo=ncNifProveedor+sepCampos+ncRefProveedor+sepCampos+ncPrecio+'['+sepCampos+ncNombre+']';
	}
...
//
//	Actualizar tarifas (catálogo de proveedores)
//
...
function ProcesarActualizarTarifasTXT(CadenaCambios)
{
	...
	for (i=0;i<=numRefs;++i)
	{
		var CodProveedor,Referencia,Precio,Nombre;
		var Producto= Piece(CadenaCambios, '·',i);
		...
		//solodebug		
		console.log('MantenProductosTXT. Linea ('+i+'). CodProveedor:'+CodProveedor+'. Ref:'+Referencia+'. Prod:'+Nombre+'. Precio:'+Precio	);
