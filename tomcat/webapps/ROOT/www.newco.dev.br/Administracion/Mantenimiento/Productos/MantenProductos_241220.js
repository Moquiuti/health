...
//	ultima revision ET 21dic20 11:00 MantenProductos_241220.js
...
function MostrarEstructuraDatos()
{
	...
	else if (opcion=='PRODEST')
	{
		...
		titulo+=sepCampos+ncPrincipioActivo+']';
	}
...
function ProcesarProdEstandarTXT(CadenaCambios)
{
	...
	for (i=0;i<=numRefs;++i)
	{
		var RefEstandar, RefCliente, Nombre, Marcas, PrecioRef, TipoIVA=0, Regulado='N', CurvaABC='', Orden='1', Registro='', FechaCadRegistro='', Oncologico='N', PrincipioActivo='';
