...
// Ultima revisión: ET 28jun23 PROManten2022_280623.js
...
function globalEvents(){
	...
	jQuery("#IDPROVEEDOR").change(function(){
		...
		//6abr23 SeleccionaFichas(IDProveedor,'IDFICHA','-1','lista');
...
function CompruebaCambios(formu, accion){
	...
	//	6abr23 Faltaba controlar algunos campos
	if	((formu.elements['ANT_PRO_NOMBRE'].value != formu.elements['PRO_NOMBRE'].value)
		||(formu.elements['ANT_PRO_MARCA'].value != formu.elements['PRO_MARCA'].value)
		||(formu.elements['ANT_PRO_CODEXPEDIENTE'].value != formu.elements['PRO_CODEXPEDIENTE'].value)
		||(formu.elements['ANT_PRO_CODCUM'].value != formu.elements['PRO_CODCUM'].value)
		||(formu.elements['ANT_PRO_CODIUM'].value != formu.elements['PRO_CODIUM'].value)
		||(formu.elements['ANT_PRO_CODINVIMA'].value != formu.elements['PRO_CODINVIMA'].value)
		||(formu.elements['ANT_PRO_FECHACADINVIMA'].value != formu.elements['PRO_FECHACADINVIMA'].value)
		||(formu.elements['ANT_PRO_CLASIFICACIONRIESGO'].value != formu.elements['PRO_CLASIFICACIONRIESGO'].value))
	{	
		todoIgual = 'NO';
    }
	...
	*/
	...
	if ((Rol=='VENDEDOR')&&(jQuery('#EXPLICACIONCAMBIOS').val==''))
	{
		alert(alrtFaltaExplicarCambio);
		return;
	}
