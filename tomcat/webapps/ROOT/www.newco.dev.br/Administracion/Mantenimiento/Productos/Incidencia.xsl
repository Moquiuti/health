...
<!--
	...
	Ultima revisión: ET 7jun17 08:48
-->
...
<xsl:otherwise>
	...
	<div style="float:left;"><!-- Bloque de pestañas solo si mvm o mvmb -->
	<xsl:choose>
		...
		<div class="ZonaTituloPagina">
			...
			<p class="TituloPagina">
				...
				<span class="CompletarTitulo" width="700px">
                    ...
                    <!--cdc puede cerrar la incidencia si esta en propuesta de solución pedido de alf 5-6-15-->
        	...
        	<ul style="width:1000px;">
             	<li>
					...
					<xsl:when test="/Incidencia/LANG = 'spanish'">
    					<xsl:choose>
        					<xsl:when test="/Incidencia/INCIDENCIA/PROD_INC_IDESTADO = 'INC'">
            					<img src="http://www.newco.dev.br/images/step2inc.gif" alt="Diagnóstico" />
        					</xsl:when>
        					<xsl:when test="/Incidencia/INCIDENCIA/PROD_INC_IDESTADO = 'DIAG'">
            					<img src="http://www.newco.dev.br/images/step3inc.gif" alt="Propuesta de solución" />
        					</xsl:when>
					...
					<xsl:otherwise>
    					<xsl:choose>
        					<xsl:when test="/Incidencia/INCIDENCIA/PROD_INC_IDESTADO = 'INC'">
            					<img src="http://www.newco.dev.br/images/step2inc-BR.gif" alt="Diagnóstico" />
        					</xsl:when>
        					<xsl:when test="/Incidencia/INCIDENCIA/PROD_INC_IDESTADO = 'DIAG'">
            					<img src="http://www.newco.dev.br/images/step3inc-BR.gif" alt="Solução proposta" />
        					</xsl:when>
        					<xsl:when test="/Incidencia/INCIDENCIA/PROD_INC_IDESTADO = 'P'">
