...
<!--  
	...
	Ultima revisión: ET 20oct21 17:45  EMPManten_141221a.js
--> 
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="/">
	...
	<script type="text/javascript" src="http://www.newco.dev.br/Administracion/Mantenimiento/Empresas/EMPManten_141221a.js"></script>
...
<xsl:template match="EMPRESA">
  ...
  <input type="hidden" name="EMP_IDUSUARIORECLAMACIONES" />
	...
	<div class="ZonaTituloPagina">
		<p class="Path"><xsl:value-of select="document($doc)/translation/texts/item[@name='Inicio']/node()"/>&nbsp;/&nbsp;<xsl:value-of select="document($doc)/translation/texts/item[@name='empresa']/node()"/>&nbsp;/&nbsp;<span class="FinPath"><xsl:value-of select="substring(/MantenimientoEmpresas/form/EMPRESA/EMP_NOMBRE,0,60)" /></span>
			<span class="CompletarTitulo">
				<span class="amarillo">EMP_ID=<xsl:value-of select="EMP_ID"/></span>&nbsp;&nbsp;
				<xsl:value-of select="document($doc)/translation/texts/item[@name='fecha_modificacion']/node()"/>:&nbsp;<xsl:value-of select="/MantenimientoEmpresas/form/EMPRESA/EMP_FECHAULTIMOCAMBIO" />
			</span>
		</p>
		<p class="TituloPagina">
        	<xsl:value-of select="substring(/MantenimientoEmpresas/form/EMPRESA/EMP_NOMBRECORTOPUBLICO,0,60)" />
...
<table class="buscador">
    <xsl:choose>
        <xsl:when test="/MantenimientoEmpresas/form/EMPRESA/ROL='VENDEDOR' and /MantenimientoEmpresas/form/EMPRESA/EMP_ENVIARPDF = 'S'">
             <tr class="sinLinea"><td colspan="5">
	...
	<tr class="sinLinea">
		<td colspan="5"><span class="rojo amarillo"><xsl:value-of select="document($doc)/translation/texts/item[@name='Documentacion_obligatoria_pendiente']/node()"/></span></td>
	</tr>
	</xsl:if>
...
<!--
    ...
    <table class="buscador">
		...
		<tr class="sinLinea">
			...
			<td class="datosLeft" colspan="2">
				&nbsp;&nbsp;<input type="text" class="peq" name="EMP_SEPFICCARGAPEDIDOS" value="{EMP_SEPFICCARGAPEDIDOS}"/>&nbsp;
		...
		<td class="labelRight">
			...
			<td class="datosLeft" colspan="2">
				&nbsp;&nbsp;<input type="text" class="grande" name="EMP_CABFICCARGAPEDIDOS" value="{EMP_CABFICCARGAPEDIDOS}"/>&nbsp;
		...
		<tr class="sinLinea">
			...
			<td class="datosLeft" colspan="2">
		  		&nbsp;&nbsp;<input type="text" class="grande" name="EMP_MODELOFICCARGAPEDIDOS" value="{EMP_MODELOFICCARGAPEDIDOS}"/>&nbsp;
        ...
        <thead>
          ...
          <tbody>
              <xsl:choose>
               ...
               <tr class="sinLinea">
                   <td class="labelRight"><xsl:value-of select="document($doc)/translation/texts/item[@name='usuario']/node()"/>:<span class="camposObligatorios">*</span></td>
                   <td>&nbsp;</td>
                    <td class="datosLeft">
                            <xsl:choose>
                                    <xsl:when test="NOEDICION">
              ...
              <tr class="sinLinea">
				...
				<td>&nbsp;</td>
                <td class="datosLeft" colspan="3"><input type="text" name="EMP_LIC_TITULO" value="{EMP_LIC_TITULO}" size="63"/></td>
                <!--<td>&nbsp;</td>-->
              </tr>
              <tr class="sinLinea">
                <!--<td>&nbsp;</td>-->
             ...
             <tr class="sinLinea">
				...
				<td>&nbsp;</td>
                <td class="datosLeft" colspan="3"><input type="text" name="EMP_LIC_FORZARCAJAS" value="{EMP_LIC_FORZARCAJAS}" size="100"/>&nbsp;
       			<xsl:value-of select="document($doc)/translation/texts/item[@name='Forzar_cajas_expli']/node()"/></td>
             </tr>
    		 <tr class="sinLinea">
        		   <td class="labelRight">
	...
	<tr class="sinLinea">
		...
		&nbsp;
		&nbsp;
		<xsl:if test="VENDEDORES_PARTICULARES"><a href="http://www.newco.dev.br/Administracion/Mantenimiento/Empresas/AsignarComerciales.xsql?IDEMPRESA={EMP_ID}"><xsl:value-of select="document($doc)/translation/texts/item[@name='Vendedores_particulares']/node()"/></a>
		</xsl:if>
	</td>
        </tr>
        <tr class="sinLinea">
...
<!--
   ...
   <!--
	...
	<tr class="sinLinea" style="background:#F3F781;">
    	<td class="labelRight">
         ...
         <tr class="sinLinea"><td colspan="3">&nbsp;</td></tr>
          ...
          <table class="buscador" border="0">
            <tr class="subTituloTabla">
                ...
                <td class="dies">&nbsp;<xsl:value-of select="document($doc)/translation/texts/item[@name='plazo_entrega']/node()"/></td>
                <td class="dies">&nbsp;<xsl:value-of select="document($doc)/translation/texts/item[@name='plazo_envio']/node()"/></td>
