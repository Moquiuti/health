...
function onloadEvents(){
	...
	jQuery("#pes_CondicPartic").click(function(){
		...
		ActivarMenu("pes_CondicPartic", "pestanaCondicParticDiv")

	});
	jQuery("#pes_Evaluaciones").click(function(){
	
		//console.log('jQuery("#pes_Evaluaciones").click(function()');
		ActivarMenu("pes_Evaluaciones", "pestanaEvaluacionesDiv")

	});
	jQuery("#pes_Incidencias").click(function(){
	
		//console.log('jQuery("#pes_Incidencias").click(function()');
		ActivarMenu("pes_Incidencias", "pestanaIncidenciasDiv")

	});
	jQuery("#pes_Roturas").click(function(){
	
		//console.log('jQuery("#pes_Roturas").click(function()');
		ActivarMenu("pes_Roturas", "pestanaRoturasDiv")
	});

	jQuery("#pes_Reclamaciones").click(function(){
	
		//console.log('jQuery("#pes_Reclamaciones").click(function()');
		ActivarMenu("pes_Reclamaciones", "pestanaReclamacionesDiv")
	});
	
}


//	30mar21 Extraemos la funcion de activacion de menu
function ActivarMenu(Menu, Pestana)
{
	//	16oct17	Marcamos la pestaña seleccionada
	jQuery("a.MenuLic").css('background','#E6E6E6');
	jQuery("a.MenuLic").css('color','#555555');
	jQuery("#"+Menu).css('background','#3b569b');
	jQuery("#"+Menu).css('color','#D6D6D6');
...
//	Abre el EIS con los filtros correspondientes
...
//	22feb22 Abre la pagina de mantenimiento de empresa
function AbrirManten(IDEmpresa)
{
	MostrarPagPersonalizada('http://www.newco.dev.br/Administracion/Mantenimiento/Empresas/EMPManten.xsql?ID='+IDEmpresa+'&amp;ADMINISTRADORMVM=ADMINISTRADORMVM','Mantenimiento empresa',100,80,0,0);
}
