		...
		<xsl:apply-templates select="EMP_ID"/>
			...
			<tr>
				<td class="quince" rowspan="3">
					<img src="http://www.newco.dev.br/Documentos/{/Mantenimiento/form/CENTRO/URL_LOGOTIPO}" height="80px" width="160px"/>
				</td>
			...
			<tr>
        		...
        		<xsl:choose>
        		<xsl:when test="/Mantenimiento/form/CENTRO/EMP_IDPAIS=34">
