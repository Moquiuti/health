...
//	Ultima revision: ET 17may22 11:20 ZonaEmpresa2022_210322.js
...
function NuevaEmpresa() 
{
    ...
    parent.areaTrabajo.location.href='http://www.newco.dev.br/Administracion/Mantenimiento/Empresas/EMPNueva2022.xsql?EMP_IDPAIS='+IDPais+'&IDUSUARIO='+IDUsuario+'&ADMINISTRADORMVM=ADMINISTRADORMVM';
} 
...
function EditarEmpresa(){
	...
	if(emp_id==-1)
		...
		parent.areaTrabajo.location.href='http://www.newco.dev.br/Administracion/Mantenimiento/Empresas/EMPManten2022.xsql?IDEMPRESA='+emp_id+'&ADMINISTRADORMVM=ADMINISTRADORMVM';
}
...
function EditarCentro()
{
  ...
  var emp_id = document.forms[0].elements['IDEMPRESA'].value;
	...
	{
     	parent.areaTrabajo.location.href='http://www.newco.dev.br/Administracion/Mantenimiento/Empresas/CENManten2022.xsql?CEN_ID='+cen_id;
	}
} 
...
function NuevoCentro() 
{
	if(document.forms[0].elements['IDEMPRESA'].value>0){
      parent.areaTrabajo.location.href='http://www.newco.dev.br/Administracion/Mantenimiento/Empresas/CENManten2022.xsql?EMP_ID='+document.forms[0].elements['IDEMPRESA'].value+'&amp;CEN_ID=';
    }
    else{
      alert(msgSinEmpresa);
    }
...
function NuevoUsuario()
{
  if(document.forms[0].elements['IDCENTRO'].value>0){
	  parent.areaTrabajo.location.href='http://www.newco.dev.br/Administracion/Mantenimiento/Empresas/USManten2022.xsql?EMP_ID='+document.forms[0].elements['IDEMPRESA'].value+'&ID_USUARIO=0&CEN_ID='+document.forms[0].elements['IDCENTRO'].value+'&GERENTECENTRO='+usuarioGerente;
  }
  else{
	alert(msgSinCentro);
  }
...
function EditarUsuario(IDUsuario){
	...
	parent.areaTrabajo.location.href='http://www.newco.dev.br/Administracion/Mantenimiento/Empresas/USManten2022.xsql?EMP_ID='+document.forms[0].elements['IDEMPRESA'].value+'&ID_USUARIO='+IDUsuario+'&CEN_ID='+document.forms[0].elements['IDCENTRO'].value+'&GERENTECENTRO='+usuarioGerente;
...
function ListaCarpetasYPlantillasPorUsuario(idCentro)
{
  if(document.forms[0].elements['IDCENTRO'].value>0)
  {
	  parent.areaTrabajo.location.href='http://www.newco.dev.br/Administracion/Mantenimiento/Empresas/ListadoUsuariosYPlantillas2022.xsql?CEN_ID='+idCentro;
  }
}
...
function AsignarComerciales()
{
  ...
  {
	  parent.areaTrabajo.location.href='http://www.newco.dev.br/Administracion/Mantenimiento/Empresas/AsignarComerciales2022.xsql?IDEMPRESA='+document.forms[0].elements['IDNUEVAEMPRESA'].value;
  }
}  
...
function Perfiles()
{
  if(document.forms[0].elements['IDNUEVAEMPRESA'].value>0)
  {
	  parent.areaTrabajo.location.href='http://www.newco.dev.br/Administracion/Mantenimiento/Empresas/PerfilesUsuarios2022.xsql?IDEMPRESA='+document.forms[0].elements['IDNUEVAEMPRESA'].value;
  }
}  

function ListadoEmpresas() 
{
   	parent.areaTrabajo.location.href='http://www.newco.dev.br/Administracion/Mantenimiento/Empresas/ListadoEmpresas2022.xsql?IDPAIS='+document.forms[0].elements['IDPAIS'].value;
} 

function ListadoCentros() 
{
   	parent.areaTrabajo.location.href='http://www.newco.dev.br/Administracion/Mantenimiento/Empresas/BuscadorCentros2022.xsql?IDPAIS='+document.forms[0].elements['IDPAIS'].value;
} 

function ListaTodosUsuarios()
{
	parent.areaTrabajo.location.href='http://www.newco.dev.br/Administracion/Mantenimiento/Empresas/BuscadorUsuarios2022.xsql?IDPAIS='+document.forms[0].elements['IDPAIS'].value;
}

function ControlUsuarios() 
{
   	parent.areaTrabajo.location.href='http://www.newco.dev.br/Administracion/Mantenimiento/Empresas/ListaUsuariosControl2022.xsql?IDPAIS='+document.forms[0].elements['IDPAIS'].value;
} 

function FacturacionEspecial()	
{
   	parent.areaTrabajo.location.href='http://www.newco.dev.br/Administracion/Mantenimiento/Empresas/FacturacionEspecial2022.xsql?IDEMPRESA='+document.forms[0].elements['IDNUEVAEMPRESA'].value;
} 


function Comentarios()	
{
	parent.areaTrabajo.location.href='http://www.newco.dev.br/Compras/NuevaMultioferta/UltimosComentarios2022.xsql?IDEMPRESA='+document.forms[0].elements['IDEMPRESA'].value+'&IDCENTRO='+document.forms[0].elements['IDCENTRO'].value;
} 

function Circuitos()	
{
	parent.areaTrabajo.location.href='http://www.newco.dev.br/Administracion/Mantenimiento/Empresas/CircuitosAprobacion2022.xsql?IDEMPRESA='+document.forms[0].elements['IDEMPRESA'].value;
} 

function LugaresEntrega()	
{
	parent.areaTrabajo.location.href='http://www.newco.dev.br/Administracion/Mantenimiento/Empresas/LugaresEntrega2022.xsql?IDEMPRESA='+document.forms[0].elements['IDEMPRESA'].value;
} 

//	25nov19 Mantenimiento de logotipos por centro
function Logotipos()	
{
	parent.areaTrabajo.location.href='http://www.newco.dev.br/Administracion/Mantenimiento/Empresas/Logotipos2022.xsql?IDEMPRESA='+document.forms[0].elements['IDEMPRESA'].value;
} 

//	27nov19 Mantenimiento de integración por centro
function Integracion()	
{
	parent.areaTrabajo.location.href='http://www.newco.dev.br/Administracion/Mantenimiento/Empresas/CentrosIntegracion2022.xsql?IDEMPRESA='+document.forms[0].elements['IDEMPRESA'].value;
} 

//	Selecciones
function Selecciones()	
{
	parent.areaTrabajo.location.href='http://www.newco.dev.br/Gestion/EIS/EISSelecciones2022.xsql?IDEMPRESALISTA='+document.forms[0].elements['IDEMPRESA'].value;
} 

//	Abre el mantenimiento seleccionado en el desplegable
function abrirManten()
{
	var opc=jQuery("#ABRIR_MANT").val();
	
	if (opc=='Lugares_entrega')
		LugaresEntrega()
	else if (opc=='Logotipos')
		Logotipos();
	else if (opc=='plantillas')	
		ListaCarpetasYPlantillasPorUsuario(centroActual);
	else if (opc=='perfiles')
		Perfiles();
	else if (opc=='Circuitos')
		Circuitos();
	else if (opc=='vendedores')
		AsignarComerciales();
	else if (opc=='comentarios')
		Comentarios();
	else if (opc=='integracion')
		Integracion();
	else if (opc=='selecciones')
		Selecciones();
}
