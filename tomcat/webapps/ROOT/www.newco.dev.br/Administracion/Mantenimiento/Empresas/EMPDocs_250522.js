...
//	ultima revision: ET 21set21 16:20 EMPDocs_210921.js. Cuidado, en caso de cambios actualizar tambien EMPNuevaSimpleHTML
...
function DibujaTabla(Categoria)
{
	...
	for (var i=0;i<Categoria.Documentos.length;++i)
	{
		...
		linea=linea.replace(/\[ID\]/g,Categoria.Documentos[i].ID).replace(/\[CONTADOR\]/g,Categoria.Documentos[i].Cont).replace(/\[URL\]/g,Categoria.Documentos[i].Url).replace(/\[NOMBRE\]/g,Categoria.Documentos[i].NombreTipo+':'+Categoria.Documentos[i].Nombre);
