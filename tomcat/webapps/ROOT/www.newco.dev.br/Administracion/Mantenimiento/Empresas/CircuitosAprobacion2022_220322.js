...
//	Ultima revision: ET 27jul22 15:00 CircuitosAprobacion2022_220322.js
...
function LimpiarCircuito()
{
	...
	document.forms['frmCirc'].elements['LISTACONDICIONES'].value='IMPORTE';
	document.forms['frmCirc'].elements['CONVENIO'].value='T';
...
function EditarCircuito(id)
{
	...
	document.forms['frmCirc'].elements['CONVENIO'].value=document.forms['frmCirc'].elements['CONVENIO_'+id].value;
...
function CambiaCentro()
{
	...
	else
	{
		...
		//solodebug 
		console.log("CambiaCentro:"+Centro);
