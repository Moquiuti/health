...
<head>
	...
	<script type="text/javascript" src="http://www.newco.dev.br/Administracion/Mantenimiento/Empresas/CENManten_301118.js"></script>
	...
	<div class="ZonaTituloPagina">
		<p class="Path"><xsl:value-of select="document($doc)/translation/texts/item[@name='Inicio']/node()"/>&nbsp;/&nbsp;
			...
			<xsl:when test="CEN_ID !=''">
				<xsl:value-of select="document($doc)/translation/texts/item[@name='centro']/node()"/>&nbsp;/&nbsp;<span class="FinPath"><xsl:value-of select="substring(/Mantenimiento/form/CENTRO/CEN_NOMBRE,0,80)"/></span>
			</xsl:when>
			<xsl:otherwise>
				<span class="FinPath"><xsl:value-of select="document($doc)/translation/texts/item[@name='centro']/node()"/></span>
			</xsl:otherwise>
			</xsl:choose>
            <xsl:if test="CEN_ID !=''">
			<span class="CompletarTitulo">
				<span style="font-weight:bold;" class="amarillo">CEN_ID=<xsl:value-of select="CEN_ID"/></span>
				&nbsp;&nbsp;&nbsp;<xsl:value-of select="document($doc)/translation/texts/item[@name='fecha_modificacion']/node()"/>:&nbsp;<xsl:value-of select="/Mantenimiento/form/CENTRO/CEN_FECHAULTIMOCAMBIO" />
			</span>
        	</xsl:if>
		</p>
	...
	<div class="divLeft">
		...
		<input type="hidden" name="EMP_ID" value="{EMP_ID}"/>
			...
			<tr class="sinLinea">
				...
				<xsl:otherwise>
					...
					<td class="datosLeft">
						...
						<xsl:otherwise>
							<input type="text" name="CEN_BARRIO" maxlength="50" size="24" value="{CEN_BARRIO}"/>
						</xsl:otherwise>
						</xsl:choose>
					</td>
				</xsl:otherwise>
			...
			<tr class="sinLinea">
				...
				<td class="datosLeft">
					<xsl:call-template name="desplegable"><xsl:with-param name="path" select="PROVINCIAS/PROVINCIA/field"/></xsl:call-template>
				</td>
				...
				<td class="datosLeft">
					<input type="text" name="CEN_EMAILPUBLICO" maxlength="100" value="{CEN_EMAILPUBLICO}" size="50"/>
				</td>
			</tr>
		...
		<div id="soloCliente">
			...
			<table class="buscador">
                ...
                <tr class="sinLinea">
                    ...
                    <td colspan="3" class="datosLeft">
                        <input type="text" name="CEN_CODIGO" id="CEN_CODIGO" maxlength="50" size="25" value="{CEN_CODIGO}"/>
                ...
                <tr class="sinLinea">
                    ...
                    <td colspan="3" class="datosLeft">
                        <input type="text" name="CEN_CODIFICACIONPEDIDOS" id="CEN_CODIFICACIONPEDIDOS" maxlength="50" size="25" value="{CEN_CODIFICACIONPEDIDOS}"/>
                        &nbsp;<xsl:value-of select="document($doc)/translation/texts/item[@name='codificacion_pedidos_expli']/node()"/>
                    </td>
                </tr>
                ...
                <tr class="sinLinea">
                    ...
                    <td colspan="3" class="datosLeft">
                        ...
                        <input type="text" name="CEN_ULTIMOPEDIDOANNO" id="CEN_ULTIMOPEDIDOANNO" maxlength="6" size="6" class="peq" value=""/>
                    </td>
                </tr>
			...
			<xsl:if test="/Mantenimiento/form/CENTRO/ROL='COMPRADOR'">
                <tr class="tituloTabla">
					<th colspan="4"><xsl:value-of select="document($doc)/translation/texts/item[@name='integracion']/node()"/></th>
				</tr>
                ...
                <tr class="sinLinea">
                    ...
                    <td colspan="3" class="datosLeft">
                        <input type="text" name="CEN_NOMBREERP" id="CEN_NOMBREERP" maxlength="100" size="25" value="{CEN_NOMBREERP}"/>
                ...
                <tr class="sinLinea">
                    ...
                    <td colspan="3" class="datosLeft">
                        <input type="text" class="muygrande" name="CEN_URLWEBSERVICE" id="CEN_URLWEBSERVICE" maxlength="100" size="25" value="{CEN_URLWEBSERVICE}"/>
                ...
                <tr class="sinLinea">
                    ...
                    <td colspan="3" class="datosLeft">
                        <input type="text" name="CEN_REFERENCIAINTEGRACION" id="CEN_REFERENCIAINTEGRACION" maxlength="50" size="25" value="{CEN_REFERENCIAINTEGRACION}"/>
                ...
                <tr class="sinLinea">
    			 ...
    			 <tr class="sinLinea">
					...
					<td class="datosLeft" colspan="2">
						&nbsp;&nbsp;<input type="text" class="peq" name="CEN_SEPFICCARGAPEDIDOS" value="{CEN_SEPFICCARGAPEDIDOS}"/>&nbsp;
						<xsl:value-of select="document($doc)/translation/texts/item[@name='sep_fich_carga_pedidos_expli']/node()"/>
					</td>
    			 </tr>
    			 <tr class="sinLinea">
					<td class="labelRight">
					...
					<td class="datosLeft" colspan="2">
					  &nbsp;&nbsp;<input type="text" class="grande" name="CEN_CABFICCARGAPEDIDOS" value="{CEN_CABFICCARGAPEDIDOS}"/>&nbsp;
						<xsl:value-of select="document($doc)/translation/texts/item[@name='cabec_fich_carga_pedidos_expli']/node()"/>
					</td>
    			 </tr>
    			 <tr class="sinLinea">
					<td class="labelRight">
					...
					<td class="datosLeft" colspan="2">
					  &nbsp;&nbsp;<input type="text" class="grande" name="CEN_MODELOFICCARGAPEDIDOS" value="{CEN_MODELOFICCARGAPEDIDOS}"/>&nbsp;
                ...
                <tr class="sinLinea">
                    ...
                    <td colspan="3" class="datosLeft">
                        <!--<input type="text" name="CEN_IDCATEGORIAPROVISIONAL" id="CEN_IDCATEGORIAPROVISIONAL" maxlength="50" size="25" value="{CEN_IDCATEGORIAPROVISIONAL}"/>-->
                        <xsl:call-template name="desplegable">
        	...
        	<thead>
        	  ...
        	  <tbody>
            	  ...
            	  <xsl:when test="/Mantenimiento/form/CENTRO/ROL='VENDEDOR'">
                	  <input type="text" name="CEN_IDUSUARIOLICITACIONESAUT" id="CEN_IDUSUARIOLICITACIONESAUT" value="" />
            	  </xsl:when>
            	  </xsl:choose>
            	  <tr class="sinLinea">
                	<td>&nbsp;</td>
                	<td class="labelRight"><xsl:value-of select="document($doc)/translation/texts/item[@name='titulo']/node()"/>:</td>
                	<td class="datosLeft"><input type="text" name="CEN_LIC_TITULO" value="{CEN_LIC_TITULO}" size="63"/></td>
                	<td>&nbsp;</td>
            	  </tr>
            	   <tr class="sinLinea">
                	<td>&nbsp;</td>
			...
			<tr class="sinLinea">
				...
				<td class="veinte">
                    ...
                    <xsl:choose>
                        ...
                        <xsl:otherwise><!- -si es nuevo centro envio a otra página para recargar bien- ->
                            <a href="javascript:ActualizarNuevoCentro(document.forms['frmManten']);">
								<xsl:value-of select="document($doc)/translation/texts/item[@name='guardar']/node()"/>
                            </a>
                        </xsl:otherwise>
                    </xsl:choose>
