//	JS correspondiente a Nueva empresa
...
function CrearEmpresa(formu,accion){
    //alert('mi');
    //alert(validarFormulario(formu));
	formu=document.forms['BuscaEmpresa'];
	if (validarFormulario(formu))
	{
		AsignarAccion(formu,'EMPNuevaSave2022.xsql');
		SubmitForm(formu);
	}
}
...
function validarFormulario(form){
	...
	if((!errores) && (esNulo(document.forms[0].elements['EMP_CPOSTAL'].value))){
		...
		if(!checkRegEx(document.forms[0].elements['EMP_CPOSTAL'].value, regex_cpostal)){
			errores=1;
			alert(document.forms['MensajeJS'].elements['EL_CAMPO'].value+" " + document.forms['MensajeJS'].elements['FORMATO_COD_POSTAL'].value+ " "+ document.forms['MensajeJS'].elements['SOLO_NUM_GUIONES_PAR'].value);
			form.elements['EMP_CPOSTAL'].focus();
			return false;
		}
	}
	*/
	...
	if((!errores) && (esNulo(document.forms[0].elements['EMP_TELEFONO'].value))){
		...
		if((!errores) && (!checkRegEx(document.forms[0].elements['EMP_TELEFONO'].value, regex_tlfn))){
			errores=1;
			alert(document.forms['MensajeJS'].elements['EL_CAMPO'].value+" " + document.forms['MensajeJS'].elements['FORMATO_TELEFONO'].value+ " "+ document.forms['MensajeJS'].elements['SOLO_NUM_GUIONES_PAR'].value);
			form.elements['EMP_TELEFONO'].focus();
			return false;
		}
	}
	...
	if((!errores) && (!checkRegEx(document.forms[0].elements['EMP_FAX'].value, regex_fax)) && (!esNulo(document.forms[0].elements['EMP_FAX'].value))){
		errores=1;
		alert(document.forms['MensajeJS'].elements['EL_CAMPO'].value+" " + document.forms['MensajeJS'].elements['FORMATO_FAX'].value+ " "+ document.forms['MensajeJS'].elements['SOLO_NUM_GUIONES_PAR'].value);
...
*/
	...
	if((!errores) && (esNulo(document.forms[0].elements['US_TF_FIJO'].value))){
		...
		if((!errores) && (!checkRegEx(document.forms[0].elements['US_TF_FIJO'].value, regex_tlfn_fijo))){
			errores=1;
                            alert(document.forms['MensajeJS'].elements['EL_CAMPO'].value+" " + document.forms['MensajeJS'].elements['FORMATO_TELEFONO_FIJO'].value+ " "+ document.forms['MensajeJS'].elements['SOLO_NUM_GUIONES_PAR'].value);
			form.elements['US_TF_FIJO'].focus();
			return false;
		}
	}
