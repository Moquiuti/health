...
<!--  
	...
	ultima revision: ET 27set18 08:32
--> 
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="/">
	...
	<script type="text/javascript" src="http://www.newco.dev.br/Administracion/Mantenimiento/Empresas/FichaCompleta_161018.js"></script>
...
<xsl:template match="EMPRESA">
	...
	<div class="ZonaTituloPagina">
		<p class="Path"><xsl:value-of select="document($doc)/translation/texts/item[@name='Inicio']/node()"/>&nbsp;/&nbsp;<xsl:value-of select="document($doc)/translation/texts/item[@name='empresa']/node()"/>&nbsp;/&nbsp;<span class="FinPath"><xsl:value-of select="substring(/FichaEmpresa/EMPRESA/EMP_NOMBRECORTO,0,60)" /></span>
			<span class="CompletarTitulo">
				<!--<span class="amarillo">EMP_ID=<xsl:value-of select="/FichaEmpresa/EMPRESA/EMP_ID"/></span>&nbsp;&nbsp;-->
				<xsl:value-of select="document($doc)/translation/texts/item[@name='fecha_modificacion']/node()"/>:&nbsp;<xsl:value-of select="/FichaEmpresa/EMPRESA/EMP_ULTIMOCAMBIO" />
			</span>
		</p>
		<p class="TituloPagina">
			<xsl:choose>
			<xsl:when test="BOTONES_APROBARACTUALIZAR">
				<xsl:value-of select="document($doc)/translation/texts/item[@name='Proveedor_solicita_actualizar_datos_ficha']/node()"/>
			</xsl:when>
			<xsl:otherwise>
        		<xsl:value-of select="document($doc)/translation/texts/item[@name='Ficha_completa_proveedor']/node()"/>
			</xsl:otherwise>
			</xsl:choose>
			&nbsp;&nbsp;
			<span class="CompletarTitulo">
	...
	<br/>
 	<div class="divLeft">
		<ul class="pestannas">
			<li>
				<a id="pes_FichaBasica" class="MenuLic">
            	<xsl:choose>
			...
			<li>
				<a id="pes_UsRepresentante" class="MenuLic">
            	<xsl:choose>
			...
			<li>
				<a id="pes_UsGerente" class="MenuLic">
            	<xsl:choose>
			...
			<li>
				<a id="pes_DirFinanciero" class="MenuLic">
            	<xsl:choose>
			...
			<li>
				<a id="pes_EncCartera" class="MenuLic">
            	<xsl:choose>
			...
			<li>
				<a id="pes_ServCliente" class="MenuLic">
            	<xsl:choose>
			...
			<li>
				<a id="pes_DirComercial" class="MenuLic">
            	<xsl:choose>
			...
			<li>
				<a id="pes_UsRepDirecto" class="MenuLic">
            	<xsl:choose>
			...
			<li>
				<a id="pes_DatosFin" class="MenuLic">
            	<xsl:choose>
			...
			<li>
				<a id="pes_Cuenta1" class="MenuLic">
            	<xsl:choose>
			...
			<li>
				<a id="pes_Cuenta2" class="MenuLic">
            	<xsl:choose>
			...
			<li>
				<a id="pes_DatosPago" class="MenuLic">
            	<xsl:choose>
			...
			<li>
				<a id="pes_DatosEntrega" class="MenuLic">
            	<xsl:choose>
	...
	<form id="frmFicha" name="frmFicha" data-parsley-validate="" method="post" action="EMPFichaCompleta.xsql">
...
<form id="frmDatosFin" name="frmDatosFin" data-parsley-validate="" method="post" action="EMPDatosFinancieros.xsql">
<input type="hidden" name="EMP_ID" id="EMP_ID" value="{EMP_ID}"/>
<table class="buscador">
...
<xsl:template name="frmUsuario">
	...
	<form id="{$nombreForm}" name="{$nombreForm}" data-parsley-validate="" method="post" action="EMPUsuario.xsql">
...
<xsl:template name="frmCuenta">
	...
	<div class="divLeft divForm" id="div_pes_{$nombreForm}">
	<form id="{$nombreForm}" name="{$nombreForm}" data-parsley-validate="" method="post" action="EMPCuentaBancaria.xsql">
	<input type="hidden" name="EMP_ID" id="EMP_ID" value="{$path/EMP_ID}"/>&nbsp;&nbsp;
...
<form id="frmDatosPago" name="frmDatosPago" data-parsley-validate="" method="post" action="EMPDatosPago.xsql">
<input type="hidden" name="EMP_ID" id="EMP_ID" value="{EMP_ID}"/>
<table class="buscador">
	...
	<tr class="sinLinea">
		...
		<td class="datosLeft" style="width:50%;">
		<xsl:choose>
		<xsl:when test="NOEDICION">
	...
	<tr class="sinLinea">
		<td colspan="2" ><strong><xsl:value-of select="document($doc)/translation/texts/item[@name='Medicamentos_regulados']/node()"/></strong></td>
	</tr>
...
<form id="frmDatosEntrega" name="frmDatosEntrega" data-parsley-validate="" method="post" action="EMPDatosEntrega.xsql">
<input type="hidden" name="EMP_ID" id="EMP_ID" value="{EMP_ID}"/>
<table class="buscador">
