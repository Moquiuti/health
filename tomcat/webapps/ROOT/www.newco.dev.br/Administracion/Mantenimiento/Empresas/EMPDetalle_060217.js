//	Funciones javascript para EMPDetalleHTML
//	ultima revision: ET 9oct17 09:04
      ...
      for(var i = 0; i < resp.documentos.length; i++){
        if(resp.documentos[i].error && resp.documentos[i].error != ''){
          ...
          if(resp.documentos[i].size){
            // En lugar del elemento nombre del form cojo el nombre del fichero diretamente, si hay espacios el sistema pone guion bajo, entonces cuento cuantos ghiones son, divido al penultimo y a�ado la ultima palabra, si la ultima palabra esta vac�a implica que hay 2 ghiones bajos, entonces divido a los 2 ghiones bajos y cojo la primera parte.
