...
<xsl:otherwise>
  ...
  <form name="formValoracion" action="EMPValoracionProv.xsql" method="post">
	...
	<div class="ZonaTituloPagina">
		<p class="Path"><xsl:value-of select="document($doc)/translation/texts/item[@name='Inicio']/node()"/>&nbsp;/&nbsp;<xsl:value-of select="document($doc)/translation/texts/item[@name='empresa']/node()"/>&nbsp;/&nbsp;<span class="FinPath"><xsl:value-of select="document($doc)/translation/texts/item[@name='valoracion_proveedor']/node()"/>&nbsp;</span>
		<span class="CompletarTitulo">
			<xsl:if test="ENTRADAS_SEGUIMIENTO/MVM or ENTRADAS_SEGUIMIENTO/MVMB or ENTRADAS_SEGUIMIENTO/ADMIN">&nbsp;&nbsp;&nbsp;&nbsp;<span class="amarillo">EMP_ID:&nbsp;<xsl:value-of select="ENTRADAS_SEGUIMIENTO/TITULOS/IDEMPRESA"/></span></xsl:if>
		</span>
		</p>
	...
	-->
			...
			<!--
				...
				<table class="buscador" id="NuevaValoracion" style="width:100%;">
				<thead>
					<th colspan="4">&nbsp;</th>
				</thead>
				...
				<tbody>
				<tr>
		            <td style="width:200px;"><label><xsl:value-of select="document($doc)/translation/texts/item[@name='visibilidad']/node()"/>:&nbsp;</label></td>
				...
				<tr class="sinLinea">
		            ...
		            <td colspan="3" style="text-align:left; padding-left:3px;">
						<textarea name="NV_COMENTARIO" id="NV_COMENTARIO" cols="60" rows="5" style="float:left;margin-right:10px;"/>&nbsp;
					</td>
		        </tr>
				</tbody>
	...
	<table id="ListaValoraciones" class="buscador">
      <xsl:choose>
...
-->
      ...
      <xsl:otherwise>
        <tr><td colspan="6" align="center"><strong><xsl:value-of select="document($doc)/translation/texts/item[@name='valoraciones_sin_resultados']/node()"/></strong></td></tr>
      </xsl:otherwise>
      </xsl:choose>
    	</table>
