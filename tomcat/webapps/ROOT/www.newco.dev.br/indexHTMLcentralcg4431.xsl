...
<!-- Fin OHSJD -->
					...
					<p><xsl:value-of select="document($doc)/translation/texts/item[@name='AP_Procedimientos']/node()"/></p>
...
<!-- PS 20180312 20190227 CENTRALCG --><div class="servicios">
    		...
    		<div class="zonacuatro">
    			<div class="contacto">
 				<h3 class="textoOscuro"><span class="textoDestacado"><xsl:value-of select="document($doc)/translation/texts/item[@name='AP_Contacte']/node()"/></span>&#160;<xsl:value-of select="document($doc)/translation/texts/item[@name='AP_PresentacionCENTRALCG']/node()"/>:</h3>
...
-->
    		...
    		<div class="pie">
				...
				<xsl:value-of select="document($doc)/translation/texts/item[@name='AP_Pie2']/node()"/>
				</a>
				</p>
				<xsl:if test="$reducido != 'S'">
