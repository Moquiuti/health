...
function EliminaCookies(){
    ...
    /*if (document.cookie != "") {
            ...
            fecha_fin.setDate(fecha_fin.getDate()-1)
                ...
                //document.cookie = mi_cookie + "=;expires=Thu, 01 Jan 1970 00:00:01 GMT;" + location.hostname + ';';
                document.cookie = mi_cookie + "='';expires=Thu, 01 Jan 1970 00:00:01 GMT;" + location.hostname + ';';
    */
            ...
            if(getCookie2('PARAMETRO')!='')
                    document.cookie = 'PARAMETRO=; path=/; host=' + location.hostname + ';expires=Thu, 01 Jan 1970 00:00:01 GMT';
