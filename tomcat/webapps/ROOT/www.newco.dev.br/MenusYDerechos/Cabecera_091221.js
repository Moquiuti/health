//	JS para la cabecera
//	Ultima revisión: 9dic21 11:00 Cabecera_091221.js
...
{
	console.log('globalEvents. Accion:'+Accion);
	...
	if (Accion=='NUEVOPEDIDO')
		...
		jQuery("#MENU_6998 a").attr('class', 'MenuActivo');	//cuidado 6998 para proveedores
	else
