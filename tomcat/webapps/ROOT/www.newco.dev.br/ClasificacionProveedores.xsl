    ...
    <!--proveedores-->
        ...
        <div class="todo">
            ...
            <xsl:call-template name="menuPublic"><!--en general.xsl-->
                <xsl:with-param name="select">proveedores</xsl:with-param>
            </xsl:call-template>
            ...
            <div class="todoInside">
               ...
               <div class="zonaPublicaBox">
                ...
                <xsl:copy-of select="document($doc)/translation/texts/item[@name='proveedores_text_pagina']/node()"/>
                
               <!-- <table class="clasificacion gris">
                    <tr class="subTitulo">
                    	<td class="dies">&nbsp;</td>
                        <td><xsl:value-of select="document($doc)/translation/texts/item[@name='pos']/node()"/></td>
                        <td><xsl:value-of select="document($doc)/translation/texts/item[@name='proveedor']/node()"/></td>
                        <td><xsl:value-of select="document($doc)/translation/texts/item[@name='valoracion']/node()"/></td>
                        <td><xsl:value-of select="document($doc)/translation/texts/item[@name='evolucion']/node()"/></td>
                        <td>&nbsp;</td>
                    </tr>
                    <xsl:for-each select="/ClasificacionProveedores/RESUMENPROVEEDORES/PROVEEDOR">
                     <tr class="body">
                        ...
                        <td><img src="http://www.newco.dev.br/images/star{NOTA}.gif" alt="{NOTA}"/></td>
                        <td class="textCenter">
