...
function validarForm(){
	...
	// Validamos input nombre producto
	if((!errores) && (esNulo(oForm.elements['NOMBRE'].value))){
		errores++;
		alert(val_faltaNombre);
		oForm.elements['NOMBRE'].focus();
	}
	...
	// Validamos input udsLote
	valAux	= jQuery('#UDSLOTE').val().replace(",",".");
	if((!errores) && (esNulo(valAux))){
		errores++;
		alert(val_faltaUdsLote);
