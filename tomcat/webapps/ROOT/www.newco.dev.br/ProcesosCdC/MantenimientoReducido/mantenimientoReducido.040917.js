//	Ultima revision: ET 4set17 10:36
...
function DerechosPlantillas(form)
{
	...
	else
	{
    	...
    	var idProdEstandar=form.elements['IDPRODUCTOESTANDAR'].value;
    	var idEmpresa=form.elements['IDEMPRESA'].value;

    	MostrarPagPersonalizada('http://www.newco.dev.br/ProcesosCdC/MantenimientoReducido/MantenimientoReducidoDerechos.xsql?IDEMPRESA='+idEmpresa+'&IDPRODUCTO='+idProducto+'&IDPRODESTANDAR='+idProdEstandar+'&LISTA_PLANTILLAS='+lista,'DerechoALasPlantillas',80,50,0,-50);
	}
}
