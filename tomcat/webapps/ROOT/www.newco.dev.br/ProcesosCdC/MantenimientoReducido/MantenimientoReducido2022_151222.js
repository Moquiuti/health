...
function cambiaFecha(){
  ...
  form.elements[fechaLimite].setAttribute('class','campopesquisa w100px');	//15dic22
...
function DerechosPlantillas(form){
	form.method = 'post';
	// si todavia no hemos adjudicado, no mostramos los derechos
	if(form.elements['IDPRODUCTOESTANDAR'].value==''){
	    alert(document.forms['MensajeJS'].elements['GUARDAR_CAMBIOS_CATALOGACION'].value);
	}
	else
...
//	25may22 Mantenimiento de producto estandar, 28set22 acortamos la URL
function MantProductoEstandar(IDEmpresa, IDProdEstandar)
{
	MostrarPagPersonalizada("http://www.newco.dev.br/ProcesosCdC/CatalogoPrivado/MantProductosEstandar2022.xsql?CATPRIV_IDPRODUCTOESTANDAR="+IDProdEstandar,'Mant.prod.est.',100,80,0,0);
}
