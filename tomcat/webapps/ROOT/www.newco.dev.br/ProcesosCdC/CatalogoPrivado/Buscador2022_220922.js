...
//	Ultima revision: ET 22set22 09:45 Buscador2022_220922.js
...
//	var idcentro = jQuery('#IDCENTRO').val();
	...
	debug('DescargarExcel. REG. length:'+ jQuery('#REGULADOS').length+' check:'+jQuery('#REGULADOS').is(':checked')+' res:'+Regulados);
