...
<!--
	...
	Ultima revisión: ET 9dic22 15:45 MantProductosEstandar2022_141022.js
-->
...
<head>
	...
	<script language="javascript">
		...
		var alrt_PrecioIncorrecto	= '<xsl:value-of select="document($doc)/translation/texts/item[@name='introducido_valor_incorrecto']/node()"/>';
		var str_Precio	= '<xsl:value-of select="document($doc)/translation/texts/item[@name='precio']/node()"/>';
	</script>

	<script type="text/javascript" src="http://www.newco.dev.br/ProcesosCdC/CatalogoPrivado/MantProductosEstandar2022_141022.js"></script>
</head>
...
<xsl:otherwise>
	...
	<form name="form1" action="http://www.newco.dev.br/ProcesosCdC/CatalogoPrivado/MantProductosEstandar2022.xsql" method="post">
		<!--idioma-->
		<xsl:variable name="lang">
			<xsl:choose>
			<xsl:when test="/Mantenimiento/LANG"><xsl:value-of select="/Mantenimiento/LANG"/></xsl:when>
		...
		<div class="ZonaTituloPagina">
			<p>
				...
				<xsl:if test="/Mantenimiento/PRODUCTOESTANDAR/ID != 0 and (/Mantenimiento/PRODUCTOESTANDAR/MASTER or /Mantenimiento/PRODUCTOESTANDAR/MASTER_UNICO) and /Mantenimiento/ACCION = 'MODIFICARPRODUCTOESTANDAR'">
				...
				<span class="CompletarTitulo" style="width:600px;font-size:13px;">
					...
					&nbsp;
					-->
					<xsl:if test="/Mantenimiento/PRODUCTOESTANDAR/CDC">
                    	<xsl:choose>
                    	...
                    	<xsl:when test="(Mantenimiento/ACCION='MODIFICAR' or Mantenimiento/ACCION='MOVER' or Mantenimiento/ACCION='MODIFICARPRODUCTOESTANDAR' or Mantenimiento/ACCION= 'COPIARPRODUCTOESTANDAR') and not (Mantenimiento/PRODUCTOESTANDAR/TRASPASADO)">
							...
							<input type="text" name="REFCLIENTETRASPASO" id="REFCLIENTETRASPASO" class="campopesquisa w100px" value="" maxlength="20" style="display:none" onInput="javascript:CambiadaReferencia();"/>&nbsp;
						...
						&nbsp;
						<a class="btnNormal" id="btnAdjudicar" href="http://www.newco.dev.br/ProcesosCdC/CatalogoPrivado/CatalogacionRapida2022.xsql?IDPRODESTANDAR={/Mantenimiento/PRODUCTOESTANDAR/ID}">
        ...
        <div class="divLeft">
		<div class="tabela tabela_redonda" id="ResumenCatalogo" style="display:none;">
		<table cellspacing="6px" cellpadding="6px" class="w1000px tableCenter" >
			<thead class="cabecalho_tabela">
				<tr class="sinLinea">
					<th class="w1px">&nbsp;</th>
					<th class="w50px" style="text-align:right;"><xsl:value-of select="document($doc)/translation/texts/item[@name='nombre_nivel']/node()"/></th>
					<th class="w50px" style="text-align:right;"><xsl:value-of select="document($doc)/translation/texts/item[@name='total']/node()"/></th>
					<th class="w50px" style="text-align:right;"><xsl:value-of select="document($doc)/translation/texts/item[@name='ref_cliente']/node()"/></th>
					<th class="w50px" style="text-align:right;"><xsl:value-of select="document($doc)/translation/texts/item[@name='ref_mvm']/node()"/></th>
					<th class="w10px">&nbsp;</th>
				</tr>
			</thead>
			...
			<tbody class="corpo_tabela">
				...
				<tr id="Nivel_1">
					...
					<td class="total textRight">&nbsp;</td>
					<td class="ref_cliente textRight">&nbsp;</td>
					<td class="ref_mvm textRight">&nbsp;</td>
					<td>&nbsp;</td>
				</tr>
				</xsl:if>
		...
		<xsl:when test="Mantenimiento/PRODUCTOESTANDAR/CATEGORIAS">
			<tr class="sinLinea">
				...
				<xsl:choose>
				<!- - SOLO CONSULTA - ->
				<xsl:when test="not(Mantenimiento/PRODUCTOESTANDAR/CDC) or Mantenimiento/PRODUCTOESTANDAR/TRASPASADO or Mantenimiento/PRODUCTOESTANDAR/BLOQUEADO">
		...
		<xsl:otherwise>
				...
				<xsl:otherwise>
					...
					<xsl:when test="Mantenimiento/PRODUCTOESTANDAR/MASTER or Mantenimiento/PRODUCTOESTANDAR/MASTER_UNICO">
						...
						<xsl:when test="Mantenimiento/PRODUCTOESTANDAR/ID='0' and Mantenimiento/PRODUCTOESTANDAR/REFPROPUESTA!='ERROR' and not(Mantenimiento/PRODUCTOESTANDAR/FORZAR_CODIGOS)">
							<td class="textLeft">
								...
								<input type="text" class="campopesquisa w50px" id="CATPRIV_REF" name="CATPRIV_REFERENCIA_STRING2" maxlength="3" value="{Mantenimiento/PRODUCTOESTANDAR/REFPROPUESTA}"/>&nbsp;
								<input type="hidden" name="CATPRIV_REFERENCIA_AUX"/>
								<input type="hidden" name="CATPRIV_REFERENCIA"/>&nbsp;
								<a class="btnDiscreto" href="javascript:ValidarRefProdEstandar(document.forms[0]);"><xsl:value-of select="document($doc)/translation/texts/item[@name='comprobar']/node()"/>
									<!--<xsl:choose>
						...
						<xsl:otherwise>
							...
							<xsl:otherwise>
								<td class="textLeft">
									...
									<input type="text" class="campopesquisa w50px" id="CATPRIV_REF" name="CATPRIV_REFERENCIA_STRING2" value="{substring(Mantenimiento/PRODUCTOESTANDAR/REFERENCIA,7)}" maxlength="3" />
					...
					<xsl:otherwise>
						<td class="sesanta textLeft">
							...
							<xsl:if test="Mantenimiento/PRODUCTOESTANDAR/CATALOGO_PADRE!=''">
			...
			<tr class="sinLinea">
				...
				<!-- edicion -->
				<xsl:otherwise>
					<input type="text" class="campopesquisa w400px" id="CATPRIV_NOMBRE" name="CATPRIV_NOMBRE" value="{Mantenimiento/PRODUCTOESTANDAR/NOMBRE}" maxlength="500"/>
			...
			<tr class="sinLinea">
				...
				<xsl:choose>
				<!-- consulta -->
				<xsl:when test="not(Mantenimiento/PRODUCTOESTANDAR/CDC) or Mantenimiento/PRODUCTOESTANDAR/TRASPASADO">
					<xsl:value-of select="Mantenimiento/PRODUCTOESTANDAR/NOMBRE_PRIVADO"/>
				</xsl:when>
				<!-- edicion -->
				<xsl:otherwise>
					<input type="text" class="campopesquisa w400px" name="CATPRIV_NOMBRE_PRIVADO" value="{Mantenimiento/PRODUCTOESTANDAR/NOMBRE_PRIVADO}" size="70" maxlength="300"/>
				</xsl:otherwise>
				</xsl:choose>
					&nbsp;<label>(<xsl:value-of select="document($doc)/translation/texts/item[@name='particular']/node()"/>)</label>
				</td>
				<td>&nbsp;</td>
			</tr>
			<tr class="sinLinea">
				...
				<!-- edicion -->
				<xsl:otherwise>
					<input type="text" class="campopesquisa w400px" name="CP_PRO_PRINCIPIOACTIVO" value="{Mantenimiento/PRODUCTOESTANDAR/CP_PRO_PRINCIPIOACTIVO}" size="70" maxlength="100"/>
				</xsl:otherwise>
				</xsl:choose>
				</td>
				<td>&nbsp;</td>
				...
				<tr class="sinLinea">
					...
					<td class="textLeft">
                    	<xsl:call-template name="desplegable">
							...
							<xsl:if test="not(Mantenimiento/PRODUCTOESTANDAR/CDC) or Mantenimiento/PRODUCTOESTANDAR/TRASPASADO">
			...
			<tr class="sinLinea">
				...
				<!-- edicion -->
				<xsl:otherwise>
					<input type="text" class="campopesquisa w400px" name="CATPRIV_DESCRIPCION" value="{Mantenimiento/PRODUCTOESTANDAR/DESCRIPCION}" size="70" maxlength="1000"/>
				</xsl:otherwise>
				</xsl:choose>
				</td>
				<td>&nbsp;</td>
            ...
            <tr class="sinLinea">
				...
				<td class="textLeft">
					...
					<!-- edicion -->
					<xsl:otherwise>
						<input type="text" class="campopesquisa w400px" name="MARCAS" id="MARCAS" value="{Mantenimiento/PRODUCTOESTANDAR/MARCASACEPTABLES}" size="70" maxlength="300"/>
					</xsl:otherwise>
					</xsl:choose>
				</td>
				<td>&nbsp;</td>
            ...
            <tr class="sinLinea">
				...
				<td class="textLeft">
					...
					<!-- edicion -->
					<xsl:otherwise>
						<input type="text" class="campopesquisa" name="CATPRIV_UNIDADBASICA" id="CATPRIV_UNIDADBASICA" value="{Mantenimiento/PRODUCTOESTANDAR/UNIDADBASICA}" maxlength="300"/>
					</xsl:otherwise>
					</xsl:choose>
				</td>
				<td>&nbsp;</td>
            ...
            <tr class="sinLinea">
				<td>&nbsp;</td>
				<td class="labelRight"><xsl:value-of select="document($doc)/translation/texts/item[@name='iva']/node()"/>:</td>
                <!--12oct22 <td class="textLeft"><xsl:value-of select="Mantenimiento/PRODUCTOESTANDAR/IVA/field/dropDownList/listElem[ID = /Mantenimiento/PRODUCTOESTANDAR/IDTIPOIVA]/listItem" />-->
                <td class="textLeft"><bold><xsl:value-of select="Mantenimiento/PRODUCTOESTANDAR/TIPOIVA" />%</bold>
            ...
            <tr class="sinLinea">
				...
				<td class="textLeft">
                    ...
                    <xsl:otherwise>
                        ...
                        <input type="text"  class="campopesquisa w150px" name="CATPRIV_PRECIOREFERENCIA" value="{Mantenimiento/PRODUCTOESTANDAR/PRECIOREFERENCIA_FORMATO}" maxlength="20"/>
                    </xsl:otherwise>
				</xsl:choose>&nbsp;<label><xsl:value-of select="Mantenimiento/PRODUCTOESTANDAR/DIV_SUFIJO"/></label>
				</td>
				<td>&nbsp;</td>
			</tr>
            ...
            <tr class="sinLinea">
				...
				<td class="textLeft">
                    ...
                    <xsl:when test="not(Mantenimiento/PRODUCTOESTANDAR/CDC) or Mantenimiento/PRODUCTOESTANDAR/TRASPASADO">
                        <xsl:choose>
                   		 <!-- consulta -->
                    	<xsl:when test="Mantenimiento/PRODUCTOESTANDAR/PRECIOMAXIMO_FORMATO != ''"><xsl:value-of select="Mantenimiento/PRODUCTOESTANDAR/PRECIOMAXIMO_FORMATO" /></xsl:when>
						<xsl:otherwise>&nbsp;-&nbsp;</xsl:otherwise>
						</xsl:choose>
                    </xsl:when>
                    <!-- edicion -->
                    <xsl:otherwise>
                        <input type="hidden" name="CATPRIV_PRECIOMAXIMO_OLD" value="{Mantenimiento/PRODUCTOESTANDAR/PRECIOMAXIMO_FORMATO}" size="10" maxlength="20"/>
                        <input type="text"  class="campopesquisa w150px" name="CATPRIV_PRECIOMAXIMO" value="{Mantenimiento/PRODUCTOESTANDAR/PRECIOMAXIMO_FORMATO}" maxlength="20"/>
                    </xsl:otherwise>
				</xsl:choose>&nbsp;<label><xsl:value-of select="Mantenimiento/PRODUCTOESTANDAR/DIV_SUFIJO"/></label>
				</td>
				<td>&nbsp;</td>
            ...
            <tr class="sinLinea">
                ...
                <td class="textLeft">
					<input class="muypeq" type="checkbox" name="CHK_REGULADO">
						<xsl:if test="not(Mantenimiento/PRODUCTOESTANDAR/CDC)">
					...
					<xsl:choose>
					<xsl:when test="not(Mantenimiento/PRODUCTOESTANDAR/CDC)">
						<xsl:value-of select="Mantenimiento/PRODUCTOESTANDAR/COMENTARIOSREGULADO"/>
					</xsl:when>
					<xsl:otherwise>
						<input type="text"  class="campopesquisa w400px" name="COMENTARIOSREGULADO" value="{Mantenimiento/PRODUCTOESTANDAR/COMENTARIOSREGULADO}" maxlength="200"/>
					</xsl:otherwise>
					</xsl:choose>
			...
			<tr class="sinLinea">
				...
				<td class="textLeft">
					...
					<xsl:otherwise>
						...
						<input type="text"  class="campopesquisa" name="CATPRIV_REFCLIENTE" id="CATPRIV_REFCLIENTE" value="{Mantenimiento/PRODUCTOESTANDAR/REFCLIENTE}" maxlength="20"/>&nbsp;
						<a href="javascript:ValidarRefCliente(document.forms[0],'PRODUCTOESTANDAR');" class="btnDiscreto">
							<xsl:value-of select="document($doc)/translation/texts/item[@name='comprobar']/node()"/>
							<!--<xsl:choose>
							<xsl:when test="/Mantenimiento/LANG = 'portugues'">
								<img src="http://www.newco.dev.br/images/comprobar-BR.gif" alt="Verificar"/>
			...
			<tr class="sinLinea">
				...
				<td class="textLeft">
					...
					<xsl:otherwise>
						<input type="text" class="campopesquisa" name="CATPRIV_REFCLIENTE2" id="CATPRIV_REFCLIENTE2" value="{Mantenimiento/PRODUCTOESTANDAR/REFCLIENTE2}" maxlength="20"/>&nbsp;
					</xsl:otherwise>
					</xsl:choose>
				</td>
				<td>&nbsp;</td>
			...
			<tr class="sinLinea">
				...
				<td class="textLeft">
					...
					<xsl:otherwise>
						<input type="text" class="campopesquisa" name="CATPRIV_REFCLIENTE3" id="CATPRIV_REFCLIENTE3" value="{Mantenimiento/PRODUCTOESTANDAR/REFCLIENTE3}" size="10" maxlength="20"/>&nbsp;
					</xsl:otherwise>
					</xsl:choose>
				</td>
				<td>&nbsp;</td>
			...
			<tr class="sinLinea">
				...
				<td class="textLeft">
					...
					<xsl:otherwise>
						<input type="text" class="campopesquisa" name="CATPRIV_REFCLIENTE4" id="CATPRIV_REFCLIENTE4" value="{Mantenimiento/PRODUCTOESTANDAR/REFCLIENTE4}" size="10" maxlength="20"/>&nbsp;
					</xsl:otherwise>
					</xsl:choose>
				</td>
				<td>&nbsp;</td>
			...
			<tr class="sinLinea">
				...
				<td class="textLeft">
					...
					<xsl:otherwise>
						<input type="text" class="campopesquisa" name="UNIDADMEDIABASE" id="UNIDADMEDIABASE" value="{Mantenimiento/PRODUCTOESTANDAR/UNIDADMEDIABASE}" size="10" maxlength="20"/>&nbsp;
					</xsl:otherwise>
					</xsl:choose>
				</td>
				<td>&nbsp;</td>
			...
			<tr class="sinLinea">
				...
				<td class="textLeft">
					...
					<xsl:otherwise>
						<input type="text" class="campopesquisa" name="UNIDADPEDIDO" id="UNIDADPEDIDO" value="{Mantenimiento/PRODUCTOESTANDAR/UNIDADPEDIDO}" size="10" maxlength="20"/>&nbsp;
					</xsl:otherwise>
					</xsl:choose>
				</td>
				<td>&nbsp;</td>
			...
			<tr class="sinLinea">
				...
				<td class="textLeft">
					...
					<xsl:otherwise>
						<input type="text" class="campopesquisa" name="RELACIONBASEPEDIDO" id="RELACIONBASEPEDIDO" value="{Mantenimiento/PRODUCTOESTANDAR/RELACIONBASEPEDIDO}" size="10" maxlength="20"/>&nbsp;
					</xsl:otherwise>
					</xsl:choose>
				</td>
				<td>&nbsp;</td>
			...
			<tr class="sinLinea">
				...
				<td class="textLeft">
					...
					<xsl:otherwise>
						<input type="text" class="campopesquisa" name="STOCKMINIMO" id="STOCKMINIMO" value="{Mantenimiento/PRODUCTOESTANDAR/STOCKMINIMO}" size="10" maxlength="20"/>&nbsp;
					</xsl:otherwise>
					</xsl:choose>
				</td>
				<td>&nbsp;</td>
			...
			<tr class="sinLinea">
				...
				<td class="textLeft">
					...
					<xsl:otherwise>
						<input type="text" class="campopesquisa" name="STOCKMAXIMO" id="STOCKMAXIMO" value="{Mantenimiento/PRODUCTOESTANDAR/STOCKMAXIMO}" size="10" maxlength="20"/>&nbsp;
					</xsl:otherwise>
					</xsl:choose>
				</td>
				<td>&nbsp;</td>
			...
			<tr class="sinLinea">
				...
				<td class="textLeft">
					...
					<xsl:otherwise>
						<input type="text" class="campopesquisa" name="TIPOPRODUCTO" id="TIPOPRODUCTO" value="{Mantenimiento/PRODUCTOESTANDAR/TIPOPRODUCTO}" size="10" maxlength="20"/>&nbsp;
					</xsl:otherwise>
					</xsl:choose>
				</td>
				<td>&nbsp;</td>
			...
			<tr class="sinLinea">
				...
				<td class="textLeft">
					...
					<xsl:otherwise>
						<input type="text" class="campopesquisa" name="CP_PRO_ORDEN" id="CP_PRO_ORDEN" value="{Mantenimiento/PRODUCTOESTANDAR/CP_PRO_ORDEN}" size="3" maxlength="3"/>&nbsp;
					</xsl:otherwise>
					</xsl:choose>
				</td>
				<td>&nbsp;</td>
			...
			<xsl:variable name="lnHomologacion">
				<xsl:choose>
				<xsl:when test="REF_CENTRO!=''">javascript:MostrarPagPersonalizada('http://www.newco.dev.br/ProcesosCdC/CatalogoPrivado/Homologacion2022.xsql?IDEMPRESA=<xsl:value-of select="/Mantenimiento/CATPRIV_IDEMPRESA"/>&amp;IDCENTRO=<xsl:value-of select="CEN_ID"/>&amp;REFERENCIA=<xsl:value-of select="REF_CENTRO"/>','DetalleCentro',100,45,0,-50);</xsl:when>
				<xsl:otherwise>javascript:MostrarPagPersonalizada('http://www.newco.dev.br/ProcesosCdC/CatalogoPrivado/Homologacion2022.xsql?IDEMPRESA=<xsl:value-of select="/Mantenimiento/CATPRIV_IDEMPRESA"/>&amp;IDCENTRO=<xsl:value-of select="CEN_ID"/>&amp;REFERENCIA=<xsl:value-of select="/Mantenimiento/PRODUCTOESTANDAR/REFERENCIA"/>','DetalleCentro',100,45,0,-50);</xsl:otherwise>
				</xsl:choose>
			</xsl:variable>
			<tr class="sinLinea">
				<td>&nbsp;</td>
				...
				<td class="textLeft">
					...
					&nbsp;
					Ref:&nbsp;
					<input type="text" class="campopesquisa w120px" name="REFCENTRO_{CEN_ID}" id="REFCENTRO_{CEN_ID}" value="{REF_CENTRO}" maxlength="30">
					<xsl:if test="not(/Mantenimiento/PRODUCTOESTANDAR/CDC) or /Mantenimiento/PRODUCTOESTANDAR/TRASPASADO">
						<xsl:attribute name="disabled" value="disabled"/>
					</xsl:if>
					</input>
					&nbsp;<a href="{$lnHomologacion}"><xsl:value-of select="document($doc)/translation/texts/item[@name='Orden']/node()"/></a>:&nbsp;
					<input type="text" class="campopesquisa w40px" name="ORDEN_{CEN_ID}" id="ORDEN_{CEN_ID}" value="{ORDEN}" size="2" maxlength="2">
					<xsl:if test="not(/Mantenimiento/PRODUCTOESTANDAR/CDC) or /Mantenimiento/PRODUCTOESTANDAR/TRASPASADO">
						<xsl:attribute name="disabled" value="disabled"/>
					</xsl:if>
					</input>
					...
					<input type="text" class="campopesquisa w120px" name="PRECIOREF_{CEN_ID}" id="PRECIOREF_{CEN_ID}" value="{PRECIOREFERENCIA}" size="16" maxlength="16">
					<xsl:if test="not(/Mantenimiento/PRODUCTOESTANDAR/CDC) or /Mantenimiento/PRODUCTOESTANDAR/TRASPASADO">
						<xsl:attribute name="disabled" value="disabled"/>
					</xsl:if>
					</input>
					...
					<input type="text" class="campopesquisa w120px" name="UDBASICA_{CEN_ID}" id="UDBASICA_{CEN_ID}" value="{UNIDADBASICA}" size="16" maxlength="16">
					<xsl:if test="not(/Mantenimiento/PRODUCTOESTANDAR/CDC) or /Mantenimiento/PRODUCTOESTANDAR/TRASPASADO">
						<xsl:attribute name="disabled" value="disabled"/>
					</xsl:if>
					</input>
					&nbsp;
					<label><xsl:value-of select="document($doc)/translation/texts/item[@name='marcas']/node()"/>:</label>&nbsp;
					<input type="text"  class="campopesquisa w120px" name="MARCAS_{CEN_ID}" id="MARCAS_{CEN_ID}" value="{MARCASACEPTABLES}" maxlength="1000">
					<xsl:if test="not(/Mantenimiento/PRODUCTOESTANDAR/CDC) or /Mantenimiento/PRODUCTOESTANDAR/TRASPASADO">
						<xsl:attribute name="disabled" value="disabled"/>
					</xsl:if>
					</input>
			...
			<tr class="sinLinea">
				...
				<td class="textLeft">
					...
					<xsl:otherwise>
						<input type="text" name="CURVA_ABC" id="CURVA_ABC" class="campopesquisa w30px" value="{Mantenimiento/PRODUCTOESTANDAR/CURVA_ABC}" size="1" maxlength="1"/>
					</xsl:otherwise>
					</xsl:choose>
				</td>
				<td>&nbsp;</td>
        	...
        	<tr class="sinLinea">
                ...
                <td class="textLeft">
					...
					<xsl:otherwise>
						<input type="text" class="campopesquisa w300px" name="CP_PRO_REGISTRO" id="CP_PRO_REGISTRO" value="{Mantenimiento/PRODUCTOESTANDAR/CP_PRO_REGISTRO}" maxlength="100"/>
					</xsl:otherwise>
					</xsl:choose>
                </td>
				<td>&nbsp;</td>
        	...
        	<tr class="sinLinea">
                ...
                <td class="textLeft">
					...
					<xsl:otherwise>
						<input type="text" class="campopesquisa w100px" name="CP_PRO_FECHACADREGISTRO" id="CP_PRO_FECHACADREGISTRO" value="{Mantenimiento/PRODUCTOESTANDAR/CP_PRO_FECHACADREGISTRO}" maxlength="20"/>
					</xsl:otherwise>
					</xsl:choose>
                </td>
				<td>&nbsp;</td>
            ...
            <tr class="sinLinea">
                ...
                <td class="textLeft">
                    <strong>
                        <xsl:choose>
                        <xsl:when test="/Mantenimiento/PRODUCTOESTANDAR/LICITACION != ''">
                            <xsl:value-of select="/Mantenimiento/PRODUCTOESTANDAR/LICITACION"/>
                        </xsl:when>
                        <xsl:otherwise>
                    ...
                    <input type="hidden" name="CP_PRO_IDTEXTOLICITACION" id="CP_PRO_IDTEXTOLICITACION"  value="{Mantenimiento/PRODUCTOESTANDAR/LICITACION}"/>
        ...
        <xsl:if test="Mantenimiento/PRODUCTOESTANDAR/LICITACIONES != ''">
			...
			<table class="buscador">
            	...
            	<td class="textLeft">
                	...
                	<a class="btnDestacado" href="javascript:InsertarProdLici(document.forms['form1']);">
