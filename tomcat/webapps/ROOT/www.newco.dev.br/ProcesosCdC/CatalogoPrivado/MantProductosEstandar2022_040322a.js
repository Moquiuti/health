...
//	Ultima revisión:ET 04mar22 11:55 MantProductosEstandar2022_040322a.js
...
function ValidarFormulario(form){
	...
	var nuevaReferencia=form.elements['CATPRIV_REFERENCIA'].value.toUpperCase().trim();
	var ReferenciaOriginal=form.elements['REFERENCIAORIGINAL'].value.toUpperCase().trim();
	var nuevoNombre=form.elements['CATPRIV_NOMBRE'].value.toUpperCase().trim();
