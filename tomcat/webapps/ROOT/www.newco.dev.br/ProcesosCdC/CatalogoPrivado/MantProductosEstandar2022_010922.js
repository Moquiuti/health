...
//	Ultima revisión: ET 01set22 09:20 MantProductosEstandar2022_010922.js
...
function ValidarFormulario(form){
	...
	if (isNaN(form.elements['CATPRIV_PRECIOREFERENCIA'].value))
	{
	...
	//	COmprobar que el contenido de PrecioReferencia es numerico
	if (isNaN(form.elements['CATPRIV_PRECIOMAXIMO'].value))
	{
