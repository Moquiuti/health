...
<body onload="CompruebaHTTP('');CompruebaCookie();">
    <div class="todo">
    	...
    	<div class="cabecera">
			...
			<xsl:otherwise>
				&nbsp;<a class="textoMarketplace" href="http://www.newco.dev.br/Administracion/Mantenimiento/Empresas/EMPNuevaSimple2022.xsql?IDPAIS={/AreaPublica/IDPAIS}&amp;PORTAL={/AreaPublica/PORTAL}&amp;INDEXLANG={$lang}"><xsl:value-of select="document($doc)/translation/texts/item[@name='AP_NuevoProveedor']/node()"/></a>
			</xsl:otherwise>
			</xsl:choose>
	</div>
