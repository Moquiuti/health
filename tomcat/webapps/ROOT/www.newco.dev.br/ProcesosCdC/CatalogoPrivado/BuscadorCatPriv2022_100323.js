...
//	Ultima revision: ET 10mar23 11:00 BuscadorCatPriv2022_100323.js
...
//	10mar23 Pagina de homologacion
function Homologacion(IDCliente, Referencia)
{
	document.location="http://www.newco.dev.br/ProcesosCdC/CatalogoPrivado/Homologacion2022.xsql?IDEMPRESA="+IDCliente+"&IDCENTRO=&REFERENCIA="+Referencia;
}

//	10mar23 Pagina de catalogacion rapida
function CatalogacionRapida(IDProdEstandar)
{
	document.location="http://www.newco.dev.br/ProcesosCdC/CatalogoPrivado/CatalogacionRapida2022.xsql?IDPRODESTANDAR="+IDProdEstandar;
}

//	10mar23 Pagina de catalogacion rapida
function CambioGrupoActual(IDEmpresa, IDProdEstandar)
{
	EjecutarFuncionDelFrame('zonaCatalogo','CambioGrupoActual('+IDEmpresa+','+IDProdEstandar+',\'CAMBIOGRUPO\');');
}

//	10mar23 Cambio Grupo Actual en frame izquierdo
function CambioGrupoActual(IDEmpresa, IDGrupo)
{
	EjecutarFuncionDelFrame('zonaCatalogo','CambioGrupoActual('+IDEmpresa+','+IDGrupo+',\'CAMBIOGRUPO\');');
}

//	10mar23 Cambio Subfamilia Actual en frame izquierdo
function CambioSubfamiliaActual(IDEmpresa, IDSubfamilia)
{
	EjecutarFuncionDelFrame('zonaCatalogo','CambioSubfamiliaActual('+IDEmpresa+','+IDSubfamilia+',\'CAMBIOSUBFAMILIA\');');
}

//	10mar23 Cambio Familia Actual en frame izquierdo
function CambioFamiliaActual(IDEmpresa, IDFamilia)
{
	EjecutarFuncionDelFrame('zonaCatalogo','CambioFamiliaActual('+IDEmpresa+','+IDFamilia+',\'CAMBIOFAMILIA\');');
}

//	10mar23 Cambio Categoria Actual en frame izquierdo
function CambioCategoriaActual(IDEmpresa, IDCategoria)
{
	EjecutarFuncionDelFrame('zonaCatalogo','CambioCategoriaActual('+IDEmpresa+','+IDCategoria+',\'CAMBIOCATEGORIA\');');
}
