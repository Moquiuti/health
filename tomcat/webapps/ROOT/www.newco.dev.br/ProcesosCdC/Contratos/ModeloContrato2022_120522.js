//	JS para manten. Modelo Contrato
//	Ultima revision: ET 1jul22 15:00 ModeloContrato2022_120522.js
	...
	else
	{
		...
		jQuery.ajax({
			...
			error: function(objeto, quepaso, otroobj){
				...
				console.log('enviarLineaFichero [ERROR1]: lineaActual:'+lineaActual+ ' total:'+totalLineas+ ' => ERROR enviando:'+objeto+':'+quepaso+':'+otroobj);
				return 'ERROR';
			},
			success: function(objeto){
				...
				//	debug	console.log('enviarProdEstandar: res:'||data.EnviarLinea.estado);

				//	Procesar error
				if (data.EnviarLinea.estado!='OK')
				{
					console.log('EnviarTodasLineasFichero: ERROR:'+nombreFichero+' '+texto);
...
//	12may22 Abre el documento con el modelo completo
function VerModelo(IDModelo)
{
	MostrarPagPersonalizada('http://www.newco.dev.br/ProcesosCdC/Contratos/VerModeloContrato.xsql?CON_MOD_ID='+IDModelo,'Nuevo modelo contrato',100,100,0,0);
}

//	12may22 vuelve al buscador de modelos
function ModelosContrato()
{
	document.location="http://www.newco.dev.br/ProcesosCdC/Contratos/ModelosContrato.xsql";
}
