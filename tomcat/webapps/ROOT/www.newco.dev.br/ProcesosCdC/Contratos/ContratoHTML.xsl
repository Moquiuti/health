...
<!--
	...
	Ultima revisión: ET 28may20 12:05 Contrato_260220.js
-->
...
<head>
	...
	<script type="text/javascript" src="http://www.newco.dev.br/ProcesosCdC/Contratos/Contrato_260220.js"></script>
...
<xsl:otherwise>
	...
	<xsl:otherwise>
		...
		<div class="ZonaTituloPagina">
			<p class="Path"><xsl:value-of select="document($doc)/translation/texts/item[@name='Inicio']/node()"/>&nbsp;/&nbsp;<span class="FinPath"><xsl:value-of select="document($doc)/translation/texts/item[@name='Contrato']/node()"/></span></p>
			<p class="TituloPagina">
				...
				<span class="CompletarTitulo" style="width:400px;">
					...
					<xsl:otherwise>
						<!--<a class="btnNormal" href="javascript:MostrarPagPersonalizada('http://www.newco.dev.br/ProcesosCdC/Contratos/ProcesarContrato.xsql?CON_ID={CONTRATO/CON_ID}','{CONTRATO/CON_TITULO}',100,100,0,0);">-->
    	...
    	<div>
			...
			<form class="formEstandar" name="Contrato" id="Contrato" method="post" action="Contrato.xsql">
				...
				<li>
					...
					<xsl:when test="NOEDICION">
						...
						<xsl:with-param name="claSel">form-control grande</xsl:with-param>
				...
				<li>
        			...
        			<xsl:choose>
        			  ...
        			  <xsl:otherwise>
        				<input type="text" name="CON_CODIGO" class="form-control" data-parsley-trigger="change" required="" maxlength="50" value="{CONTRATO/CON_CODIGO}"/>
        			  </xsl:otherwise>
        			</xsl:choose>
				</li>
				<li>
        			...
        			<xsl:choose>
        			  ...
        			  <xsl:otherwise>
        				<input type="text" name="CON_TITULO" class="form-control grande" data-parsley-trigger="change" required="" maxlength="50" value="{CONTRATO/CON_TITULO}"/>
        			  </xsl:otherwise>
        			</xsl:choose>
				</li>
				<li>
					...
					<xsl:when test="NOEDICION">
						...
						<xsl:with-param name="claSel">form-control muygrande</xsl:with-param>
						<xsl:with-param name="required">required</xsl:with-param>
						<xsl:with-param name="deshabilitado">disabled</xsl:with-param>
						</xsl:call-template>
					</xsl:when>
				...
				<li>
        			...
        			<xsl:choose>
        			  ...
        			  <xsl:otherwise>
        				<input type="text" name="CON_FECHAFIRMA" class="form-control" placeholder="DD/MM/YY" style="width:100px;" data-parsley-trigger="change" required="" maxlength="10" value="{CONTRATO/CON_FECHAFIRMA}"/>&nbsp;(dd/mm/aa)
        			  </xsl:otherwise>
        			</xsl:choose>
				</li>
				<li>
        			...
        			<xsl:choose>
        			  ...
        			  <xsl:otherwise>
        				<input type="text" name="CON_FECHAINICIO" class="form-control" placeholder="DD/MM/YY" style="width:100px;" data-parsley-trigger="change" required="" maxlength="10" value="{CONTRATO/CON_FECHAINICIO}"/>&nbsp;(dd/mm/aa)
        			  </xsl:otherwise>
        			</xsl:choose>
				</li>
				<li>
        			...
        			<xsl:choose>
        			  ...
        			  <xsl:otherwise>
        				<input type="text" name="CON_FECHAFINAL" class="form-control" placeholder="DD/MM/YY" style="width:100px;" data-parsley-trigger="change" required="" maxlength="10" value="{CONTRATO/CON_FECHAFINAL}"/>&nbsp;(dd/mm/aa)
        			  </xsl:otherwise>
        			</xsl:choose>
				</li>
				<li>
        			...
        			<xsl:choose>
        			  ...
        			  <xsl:otherwise>
        				<input type="text" name="CON_DURACIONCONTRATO" class="form-control grande" data-parsley-trigger="change" required="" maxlength="50" value="{CONTRATO/CON_DURACIONCONTRATO}"/>
        			  </xsl:otherwise>
        			</xsl:choose>
				</li>
				<li>
        			...
        			<xsl:choose>
        			  ...
        			  <xsl:otherwise>
        				<input type="text" name="CON_DESCRIPCION" class="form-control" style="width:500px;" data-parsley-trigger="change" maxlength="50" value="{CONTRATO/CON_DESCRIPCION}"/>
        			  </xsl:otherwise>
        			</xsl:choose>
				</li>
				</form>
