...
<!--
	...
	Ultima revisión:ET 12set18 11:33
-->
...
<head>
	...
	<title><xsl:value-of select="document($doc)/translation/texts/item[@name='Modelo_contrato']/node()"/>:&nbsp;<xsl:value-of select="/ModeloContrato/MODELOCONTRATO/TITULO"/></title>
	...
	<script type="text/javascript">
		...
		<xsl:for-each select="/ModeloContrato/MODELOCONTRATO/LINEA">
		...
		{
			console.log('MostrarModelo. Lineas:'+lineas.length);
			
			var documento='';
			for (i=0;i<lineas.length;++i)
			{
				//solodebug	console.log('MostrarModelo. Linea['+i+']:'+lineas[i]);
...
<body onLoad="javascript:MostrarModelo();">
<xsl:choose>
