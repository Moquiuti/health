...
<head>
	...
	<script type="text/javascript" src="http://www.newco.dev.br/General/login_18ene17.js"></script>
    		...
    		<div class="login">
    			<div class="loginBox">
					...
					<form name="frmLogin">
						...
						<br/>
						<a id="btnLoginDirecto" class="btnClaro" href="javascript:loginDirecto();">Entrar</a>
						<br/>
						<br/>
						<div id="textoOK" class="loginOK" style="display:none;"><xsl:value-of select="document($doc)/translation/texts/item[@name='LoginOK']/node()"/>Acceso correcto, entrando en el sistema</div>
						<div id="textoKO" class="loginKO" style="display:none;"><xsl:value-of select="document($doc)/translation/texts/item[@name='LoginKO']/node()"/>Acceso denegado, por favor revise usuario y contraseña</div>
					</form>
					<br />
