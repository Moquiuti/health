// JS Página de Inicio
// Ultima revisión ET: 17feb23 08:11 WFStatus2022_170223.js. CUidado: aplicar los cambios tambien a ResumenPedidosActivosHTML2022.xsl
  ...
  if(form.elements.PLAZOCONSULTA) plazoConsulta = form.elements.PLAZOCONSULTA.value;
	...
	jQuery.ajax({
		...
		data: "IDEMPRESA="+IDEmpresa+"&IDCENTRO="+IDCentro+"&IDPROVEEDOR="+IDProveedor+"&IDFILTROMOTIVO="+IDFiltroMotivo+"&IDFILTRORESPONSABLE="+IDFiltroResponsable
					...
					+"&FIDAREAGEOGRAFICA="+IDAreaGeo+"&FTEXTO="+fTexto+"&PLAZOCONSULTA="+plazoConsulta+"&IDFILTROVENDEDOR="+IDFiltroVendedor
					+"&_="+d.getTime(),
    type: "GET",
    contentType: "application/xhtml+xml",
    error: function(objeto, quepaso, otroobj){
