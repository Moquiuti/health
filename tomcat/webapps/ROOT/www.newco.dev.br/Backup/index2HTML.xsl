    ...
    <div class="todo">
		...
		<div class="avisoCookie" id="avisoCookieBox" style="display:none;">
			<div class="avisoCookieBox">
					...
					<!--Al acceder al área privada de MedicalVM.com se crearán únicamente las "cookies" necesarias para navegar en nuestra 
plataforma con seguridad, guardando la identificación de la sesión y algunos datos de configuración del usuario.--></p>
                    <p class="textoCookie"><xsl:value-of select="document($doc)/translation/texts/item[@name='AP_MVM_textocookie2']/node()"/>
					<!--Además, nuestro analizador de tráfico del site utiliza "cookies" y seguimientos de IPs que nos permiten recoger datos a
 efectos estadísticos: fecha de la primera visita, número de veces que se ha visitado, fecha de la última visita, URL y dominio de la que 
proviene, explorador utilizado y resolución de la pantalla. No obstante,  el usuario si lo desea puede desactivar y/o eliminar estas cookies 
siguiendo las instrucciones de su navegador de Internet.--></p>
					...
					<!--Si continúas navegando en la página entenderemos que aceptas nuestra <a href="javascript:MostrarPagPersonalizada('http://www.newco.dev.br/PoliticaCookies.html','Politica%20Cookies',60,60,20,20);">política de cookies</a>&nbsp;-->
