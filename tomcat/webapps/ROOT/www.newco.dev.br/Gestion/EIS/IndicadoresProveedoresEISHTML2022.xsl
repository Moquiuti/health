...
<!--
	...
	Ultima revision: ET 22feb22 10:20 IndicadoresProveedoresEIS2022_220222.js
-->
  ...
  <xsl:template match="/">
    ...
    <html>
      ...
      <!--idioma-->
		...
		<script type="text/javascript" src="http://www.newco.dev.br/Gestion/EIS/IndicadoresProveedoresEIS2022_220222.js"></script>
	...
	<body onload="javascript:inicio();">	
      ...
      <!--idioma fin-->
        ...
        <div class="divLeft">
		<form name="frmFiltro" id="frmFiltro" method="post" action="http://www.newco.dev.br/Gestion/EIS/IndicadoresProveedoresEIS2022.xsql">        
        <table id="PestanasInicio" class="w1100px" border="0" cellspacing="6px" cellpadding="6px">
            <tr>
				<xsl:choose>
				<xsl:when test="/IndicadoresProveedores/INDICADORES/CLIENTE/field">
					<th class="labelRight w150px">
						<xsl:value-of select="document($doc)/translation/texts/item[@name='cliente']/node()"/>:&nbsp;
					</th>
					<th class="w600px textLeft">
            ...
            <tr>
				...
				<xsl:when test="not (/IndicadoresProveedores/INDICADORES/SIN_CABECERA='S')">
					...
					<th class="w600px textLeft">
						...
						<xsl:if test="/IndicadoresProveedores/INDICADORES/IDPROVEEDOR!=-1">
							<a href="javascript:FichaEmpresa({/IndicadoresProveedores/INDICADORES/IDPROVEEDOR})"><xsl:value-of select="document($doc)/translation/texts/item[@name='ver']/node()"/></a>
						</xsl:if>
						&nbsp;&nbsp;&nbsp;
					</th>
				</xsl:when>
				...
				<th class="labelRight w150px">
					<xsl:value-of select="document($doc)/translation/texts/item[@name='periodo']/node()"/>:&nbsp;
				</th>
				<th class="w150px">
					<xsl:call-template name="desplegable">
				...
				<th class="w400px textLeft">
					<span class="avanzadas">
					<xsl:if test="/IndicadoresProveedores/INDICADORES/PERIODO!='OTROS'">
						<xsl:attribute name="style">display:none</xsl:attribute>
					</xsl:if>
					<label><xsl:value-of select="document($doc)/translation/texts/item[@name='de']/node()"/>:</label>&nbsp;
					<input type="text" name="FECHA_INICIO" id="FECHA_INICIO" class="w100px" value="{/IndicadoresProveedores/INDICADORES/FECHA_INICIO}"/>
					&nbsp;&nbsp;&nbsp;
					<label><xsl:value-of select="document($doc)/translation/texts/item[@name='a']/node()"/>:</label>&nbsp;
					<input type="text" name="FECHA_FINAL" id="FECHA_FINAL" class="w100px" value="{/IndicadoresProveedores/INDICADORES/FECHA_FINAL}"/>
					&nbsp;&nbsp;&nbsp;
