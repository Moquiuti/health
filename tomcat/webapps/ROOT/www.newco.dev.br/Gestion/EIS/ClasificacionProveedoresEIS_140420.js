...
//	ultima revision: ET 13ene20 09:50 ClasificacionProveedoresEIS_140420.js
...
{
	window.location="http://www.newco.dev.br/Gestion/Comercial/CondicionesProveedores.xsql?IDCLIENTE="+document.forms["formProv"].elements["IDCLIENTE"].value;
}
...
{
	window.location="http://www.newco.dev.br/Gestion/EIS/IndicadoresProveedoresEIS.xsql?IDCLIENTE="+document.forms["formProv"].elements["IDCLIENTE"].value+"&IDPROVEEDOR="+IDProv;
}
