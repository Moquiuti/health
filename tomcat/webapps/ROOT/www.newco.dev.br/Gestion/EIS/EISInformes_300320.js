...
//	ultima revisión: ET 30mar20 17:40 EISInformes_300320.js
...
function globalEvents(){
	...
	jQuery('#IDCENTROCLIENTE').change(function(){
		...
		location.href = 'http://www.newco.dev.br/Gestion/EIS/EISInformes.xsql?IDEMPRESA=' + IDEmpresa + '&IDINFORME=' + IDInforme + '&IDCENTRO=' + this.value;
	});

	jQuery('#IDEMPRESA').change(function(){
		var IDEmpresa = document.forms[0].elements["IDEMPRESA"].value;
		//solodebug	alert('IDEmpresa:'+IDEmpresa);
		location.href = 'http://www.newco.dev.br/Gestion/EIS/EISInformes.xsql?IDEMPRESA=' + IDEmpresa + '&IDINFORME=' + IDInforme;
	});
}
