...
-->
	...
	<script type="text/javascript" src="http://www.newco.dev.br/Gestion/EIS/EISMatriz_230118.js"></script>
		...
		<form method="post" action="EISMatriz.xsql" name="formEISMatriz">
			...
			<div class="ZonaTituloPagina">
				...
				<p class="TituloPagina">
					...
					<!--<span class="fuentePequenna">(<xsl:value-of select="document($doc)/translation/texts/item[@name='actualizado']/node()"/>: <xsl:value-of select="/EIS_XML/RESULTADOS/ACTUALIZACION"/>)</span>-->
			...
			<xsl:otherwise>
				...
				<xsl:otherwise>
					...
					<xsl:choose>
					<xsl:when test="/EIS_XML/RESULTADOS/DERECHOS = 'MVM' or /EIS_XML/RESULTADOS/DERECHOS = 'MVMB' or /EIS_XML/RESULTADOS/PRECALCULADA">
