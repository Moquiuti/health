...
<body class="gris">
	...
	<xsl:otherwise>
		<!-- Titulo -->
		<h1 class="titlePage">Palabras más buscadas en el Catálogo Público de www.MedicalVM.com por Empresa - Últimos 30 días. No incluye MVM.</h1>
		...
		<div class="divLeft">
			...
			<thead>
				<tr class="titulos">
					...
					<td class="cinquenta">Búsqueda</td>
