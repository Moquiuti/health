// JavaScript Document
//	Ultima revision ET 27feb20 10:40 EISMatriz_270220.js
...
//if(k == (NumCabeceraH-1)) total = total + ' - ' + FormatNumber(ColumnaTotales[NumLineas],4,',','.');
			...
			cadenaHtml=cadenaHtml+cellStart+'<a class="numeric celdanormal">'+total+'</a>'+'&nbsp;'+ linkToEIS +cellEnd;		//	23ene18
...
function NumbertoCSV(Number) {return (sepTextoCSV+Number.toString().replace('.',',')+sepTextoCSV+sepCSV);}
