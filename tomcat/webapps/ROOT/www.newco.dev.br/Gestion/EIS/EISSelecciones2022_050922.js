...
//	Ultima revisión: ET 1abr22 18:11 EISSelecciones2022_010422.js
...
{
	window.location="http://www.newco.dev.br/Gestion/EIS/EISSeleccion2022.xsql?IDSELECCION="+idSeleccion;	
}

//	Abre la página de mantenimiento de la selección correspondiente
function NuevaSeleccion()
{
	window.location="http://www.newco.dev.br/Gestion/EIS/EISSeleccion2022.xsql";	
}
...
function DescargarExcel(){
	...
	if ((document.forms['Selecciones'].elements['ADMINMVM'])&&(document.forms['Selecciones'].elements['ADMINMVM'].value=='S'))
	{
