	...
	//--->
      ...
      <xsl:choose>
		...
		<div class="ZonaTituloPagina">
			<p class="Path"><xsl:value-of select="document($doc)/translation/texts/item[@name='Inicio']/node()"/>&nbsp;/&nbsp;<xsl:value-of select="document($doc)/translation/texts/item[@name='eis']/node()"/>&nbsp;/&nbsp;<span class="FinPath"><xsl:value-of select="document($doc)/translation/texts/item[@name='listado_de_datos']/node()"/></span>
		...
		<tr>
			...
			<td class="labelRight dies">&nbsp;Año:</td>
	    ...
	    <tr class="subTituloTabla">	      
	    	...
	    	<td>AQUI<xsl:value-of select="document($doc)/translation/texts/item[@name='numero']/node()"/> </td>
