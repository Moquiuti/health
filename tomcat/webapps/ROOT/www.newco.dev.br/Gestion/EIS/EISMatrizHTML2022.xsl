...
<!--
	...
	Ultima revisión: ET 9ago22 16:26 EISMatriz2022_090822.js
+-->
...
-->
	...
	<script type="text/javascript" src="http://www.newco.dev.br/Gestion/EIS/EISMatriz2022_090822.js"></script>
			...
			<xsl:otherwise>
				...
				<xsl:otherwise>
					...
					<tr class="sinLinea">
						...
						<td colspan="4">&nbsp;</td>
						<td>
							<a class="btnDestacado btn150px textCenter" id="MostrarCuadro" href="javascript:TablaEISMatrizAjax();"><xsl:value-of select="document($doc)/translation/texts/item[@name='mostrar']/node()"/></a>
				...
				<xsl:if test="not(/EIS_XML/RESULTADOS/PRECALCULADA)">
					<!-- Linea de menu -->
		 			<div class="divLeft marginTop20 h20px">
						<ul class="pestannas w100">
							<li>
								<a class="Menu" id="pes_Acumulado"><xsl:value-of select="document($doc)/translation/texts/item[@name='Acumulado']/node()"/></a>
							</li>
							<li>
								<a class="Menu" id="pes_PorcH"><xsl:value-of select="document($doc)/translation/texts/item[@name='Porcentaje_horizontal']/node()"/></a>
							</li>
							<li>
								<a class="Menu" id="pes_PorcV"><xsl:value-of select="document($doc)/translation/texts/item[@name='Porcentaje_vertical']/node()"/></a>
							</li>
							<li>
					...
					<xsl:if test="/EIS_XML/RESULTADOS/DERECHOS = 'MVM' or /EIS_XML/RESULTADOS/DERECHOS = 'MVMB'">
						...
						<div class="divLeft marginLeft100 marginTop20">
					...
					<!-- 16mar22 No parece tener apenas uso y complica la pagina: Link 'Periodo Anterior'
				...
				<div class="tabela tabela_redonda marginTop120">
...
<tr class="sinLinea">
	...
	<td class="datosLeft veinte">
		<xsl:call-template name="desplegable">
			...
			<xsl:with-param name="claSel">w110px</xsl:with-param>
		</xsl:call-template>&nbsp;
		<xsl:call-template name="desplegable">
	...
	<td class="datosLeft">
		<xsl:call-template name="desplegable">
			...
			<xsl:if test="/EIS_XML/RESULTADOS/FILTROS/field[@name='IDCATEGORIA']/@disabled = 'disabled'"><xsl:with-param name="deshabilitado">disabled</xsl:with-param></xsl:if>
			<xsl:with-param name="claSel">w300px</xsl:with-param>
		</xsl:call-template>
	</td>
	<td class="cinco">&nbsp;</td>
...
<tr class="sinLinea">
	...
	<td class="datosLeft">
		<xsl:call-template name="desplegable">
			...
			<xsl:if test="/EIS_XML/RESULTADOS/FILTROS/field[@name='IDFAMILIA']/@disabled = 'disabled'"><xsl:with-param name="deshabilitado">disabled</xsl:with-param></xsl:if>
			<xsl:with-param name="claSel">w300px</xsl:with-param>
		</xsl:call-template>
	</td>
	<td class="cinco">&nbsp;</td>
...
<tr class="sinLinea">
	...
	<td class="datosLeft"><select id="IDCENTRO" name="IDCENTRO" disabled="disabled" class="seleccion w300px"/></td>
	<td>&nbsp;</td>
	...
	<td class="datosLeft">
		<xsl:call-template name="desplegable">
			...
			<xsl:if test="/EIS_XML/RESULTADOS/FILTROS/field[@name='IDSUBFAMILIA']/@disabled = 'disabled'"><xsl:with-param name="deshabilitado">disabled</xsl:with-param></xsl:if>
			<xsl:with-param name="claSel">w300px</xsl:with-param>
		</xsl:call-template>
	</td>
	<td class="cinco">&nbsp;</td>
...
<tr class="sinLinea">
	...
	<td class="datosLeft">
		<input type="text" class="campopesquisa w300px" name="TEXTO" id="TEXTO">
...
<tr class="sinLinea">
	...
	<xsl:when test="not(/EIS_XML/RESULTADOS/FILTROS/field/@name='IDCATEGORIA') and /EIS_XML/RESULTADOS/FILTROS/field/@name='IDPRODUCTOESTANDAR'">
		...
		<td class="datosLeft">
			<xsl:call-template name="desplegable">
				<xsl:with-param name="path" select="/EIS_XML/RESULTADOS/FILTROS/field[@name='IDPRODUCTOESTANDAR']/."/>
				<xsl:if test="/EIS_XML/RESULTADOS/FILTROS/field[@name='IDPRODUCTOESTANDAR']/@disabled = 'disabled'"><xsl:with-param name="deshabilitado">disabled</xsl:with-param></xsl:if>
				<xsl:with-param name="claSel">w300px</xsl:with-param>
			</xsl:call-template>
		</td>
		<td>&nbsp;</td>	
...
<tr class="sinLinea">
	...
	<xsl:when test="/EIS_XML/RESULTADOS/FILTROS/field/@name='IDCATEGORIA' and /EIS_XML/RESULTADOS/FILTROS/field/@name='IDGRUPO'">
		...
		<td class="datosLeft">
			<xsl:call-template name="desplegable">
				<xsl:with-param name="path" select="/EIS_XML/RESULTADOS/FILTROS/field[@name='IDGRUPO']/."/>
				<xsl:if test="/EIS_XML/RESULTADOS/FILTROS/field[@name='IDGRUPO']/@disabled = 'disabled'"><xsl:with-param name="deshabilitado">disabled</xsl:with-param></xsl:if>
				<xsl:with-param name="claSel">w300px</xsl:with-param>
			</xsl:call-template>
		</td>
		<td>&nbsp;</td>
