...
<!--
	...
	Ultima revision: ET 3jun22 11:00 EISResumen2022_030622.js
+-->
...
<head>
	...
	<script type="text/javascript" src="http://www.newco.dev.br/Gestion/EIS/EISResumen2022_030622.js"></script>
	...
	<xsl:param name="doc"/>
		<div id="pestanas">
			<ul class="pestannas w100">
				...
				<li>
					<a id="tablaDatos" class="MenuLic"><xsl:value-of select="document($doc)/translation/texts/item[@name='Tabla_datos']/node()"/></a>
				</li>
			</ul>
		</div>
		...
		<div class="divLeft marginTop50">
        	...
        	<div id="actividadMensualBox" class="eisBox w1000px divCenter">
				...
				<canvas id="actMensual" width="1000px" height="600px"></canvas>
        	</div><!--fin de actividadMensualBox-->

        	<div id="actividadDiariaBox" class="eisBox w1000px divCenter" style="display:none;">
				...
				<canvas id="actDiaria" width="1000px" height="600px"></canvas>
        	</div><!--fin de actividadDiariaBox-->

        	<div id="alarmasBox" class="eisBox w1000px divCenter" style="display:none;">
            	<xsl:call-template name="ALARMAS_ADMIN"/>
        	</div><!--fin de alarmasBox-->
			<!--
        	<div id="tablaDatosBox" class="eisBox w1000px divCenter" style="display:none;">
			...
			<table cellspacing="6px" cellpadding="6px">
				<thead class="cabecalho_tabela">
					<tr>
						<th class="w1x"></th>
						<th>&nbsp;</th>
						<xsl:for-each select="/EIS_CONSULTAS/CUADROPRINCIPALEIS/RESUMENES_MENSUALES/RESUMEN_MENSUAL[1]/COLUMNA">
...
<!-- Pagina principal REDUCIDA (para PROVEEDORES)	-->
