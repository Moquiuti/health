...
<!-- PS 5dic16 añadido para volver al codigo antiguo antes de cambiar diseño -->
...
<!-- PS 5dic16 comentado para volver al codigo antiguo antes de cambiar diseño -->
	<!-- <script type="text/javascript">
...
<xsl:otherwise>
	...
	<!--<h1 class="titlePage"><xsl:value-of select="document($doc)/translation/texts/item[@name='sistema_info_direccion_12_meses']/node()"/></h1>-->
        ...
        <!--si es cuadro principal enseño el nuevo eis-->
        <xsl:choose>
