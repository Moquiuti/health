...
//	Ultima revisión ET 29ene20 EISConsultas_290120.js
...
*/
function preparaTablaDiaria(Datasets, Labels) {
	...
	myChart.borderColor="#00FF00";
}

function preparaTablaMensual(Datasets, Labels) {
...
*/
    preparaTablaMensual(DatasetsMensual, NombresMeses);
    preparaTablaDiaria(DatasetsDiario, NombresDias);
}
