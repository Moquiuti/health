...
<!--
	...
	Ultima revisión: ET 9ene23 12:00 ClasificacionProveedoresEIS2022_090123.js
-->
  ...
  <xsl:template match="/">
    ...
    <html>
      ...
      <!--idioma-->
		...
		<script type="text/javascript" src="http://www.newco.dev.br/Gestion/EIS/ClasificacionProveedoresEIS2022_090123.js"></script>
    ...
    <!--proveedores-->
		...
		<form name="formProv" id="formProv" method="post" action="http://www.newco.dev.br/Gestion/EIS/ClasificacionProveedoresEIS2022.xsql">
		...
		<table cellspacing="6px" cellpadding="6px">
			...
			<tr>
                ...
                <th class="textCenter w140px"><xsl:value-of select="document($doc)/translation/texts/item[@name='licitaciones']/node()"/><br/>
                ...
                <th class="textCenter w50px"><xsl:value-of select="document($doc)/translation/texts/item[@name='incidencias_pedidos']/node()"/></th>
                <th class="textCenter w50px"><xsl:value-of select="document($doc)/translation/texts/item[@name='incidencias_productos']/node()"/></th>
                <!--	PENDIENTE
				...
				-->
                <th class="textCenter w50px"><xsl:value-of select="document($doc)/translation/texts/item[@name='Eval']/node()"/></th>
                <th class="textCenter">
					&nbsp;
				</th>
			</tr>
    		...
    		<xsl:for-each select="/ClasificacionProveedores/RESUMENPROVEEDORES/PROVEEDOR">
            	<tr class="conhover">
                	...
                	<td class="textLeft"><a href="javascript:FichaEmpresa('{ID}');"><xsl:value-of select="NOMBRE"/></a></td>
					<xsl:if test="/ClasificacionProveedores/RESUMENPROVEEDORES/IDPAIS=57">
                	<td class="textCenter">
                    	<xsl:choose>
                    	<xsl:when test="/ClasificacionProveedores/RESUMENPROVEEDORES/MOSTRAR_COLORES_DOCUMENTACION">
							...
							<xsl:if test="not(IDESTADOFICHA='SIN_FICHA' or IDESTADOFICHA='CURS')">
                   				<a href="javascript:FichaCompleta('{ID}');"><img src="http://www.newco.dev.br/images/2017/info.png"/></a>
							</xsl:if>
                    	</xsl:when>
                    	<xsl:otherwise>
							<xsl:if test="not(IDESTADOFICHA='SIN_FICHA' or IDESTADOFICHA='CURS')">
			...
			<tfoot class="rodape_tabela">
				<tr class="subTituloTabla">
                	<td colspan="6"></td>
                	<td colspan="3" class="textRight"><xsl:value-of select="document($doc)/translation/texts/item[@name='total']/node()"/>:</td>
					<xsl:if test="/ClasificacionProveedores/RESUMENPROVEEDORES/IDPAIS=57">
                		<td colspan="2"></td>
					</xsl:if>
                	<td colspan="2"></td>
					...
					<td><xsl:value-of select="/ClasificacionProveedores/RESUMENPROVEEDORES/TOTALEVALUACIONES"/></td>
                	<td colspan="2"></td>
				</tr>
			</tfoot>
		</table>
