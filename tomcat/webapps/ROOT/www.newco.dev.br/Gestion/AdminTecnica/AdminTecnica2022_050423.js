...
function onLoadBody()
{
	...
	if (document.forms[0].elements["PERIODO"])
	{
...
//	5abr23 Guarda la diferencia horaria de Brasil y COlombia
function DiferenciaHoraria()
{
	var DifHorBrasil=document.forms[0].elements["DIF_HOR_BRASIL"].value,
		DifHorColombia=document.forms[0].elements["DIF_HOR_COLOMBIA"].value;
	
	document.forms[0].elements["ACCION"].value='DIFHORARIA';
	document.forms[0].elements["PARAMETROS"].value=DifHorBrasil+'|'+DifHorColombia;
