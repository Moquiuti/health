...
//	Ultima revision ET 5abr23 15:52 LicProveedor2022_050423.js
...
function dibujaSubirDocOferta(Tipo, ID){
	...
	innerHTML = '<div class="w200px floatLeft"><a id="a_'+Tipo+'_'+ID+'" href="'+strJS+'" class="btnNormal">'+str_SubirFicha+'</a></div>';
