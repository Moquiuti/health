...
//	ET	28jul16	Recarga de la página
//	ET 28jul16	12:27


var int=self.setInterval("refresh()",20000);	//recarga cada 20s
function refresh()
{
	//Solo recargamos si no hay ningún fichero seleccionado para subir
	if (document.forms['SubirDocumentos'].elements['inputFileDoc'].value=='')
	{
