...
//	ultima revision ET 23ene20 09:22 AltaLicitacionesAjax_141119.js
...
function prepararEnvio(nombreFichero, ficRequisicao, ficTituloPdc, ficDataVencimento, ficHoraVencimento, ficMoeda, ficObservacao, ficUrgencia)
{
	...
	var datosFichero='Titulo_Pdc#'+encodeURIComponent(ScapeHTMLString(ficTituloPdc))+'|'				
				+'Data_Vencimento#'+ficDataVencimento+'|'
				+'Hora_Vencimento#'+ficHoraVencimento+'|'
				+'Moeda#'+ficMoeda+'|'
				+'Observacao#'+encodeURIComponent(ScapeHTMLString(ficObservacao))+'|'
