...
//	ultima revision ET 21mar19 09_19
...
function ProcesarCadenaPedidoTXT(ListaProductos)
{
	...
	for (i=0;i<=numRefs;++i)
	{
		var Centro,Ref,Cantidad,LugarEntrega,CentroCoste,Descripcion,Precio;
		...
		if (usMulticentros=='S')
		{
			...
			LugarEntrega= Piece(Producto, ':', 3);
			CentroCoste	= Piece(Producto, ':', 4);
			Descripcion	= Piece(Producto, ':', 5);
			Precio		= Piece(Producto, ':', 6);

			//solodebug		
			console.log('ProcesarCadenaTXT. Oferta ('+i+'). Centro:'+Centro+'. Ref:'+Ref+'. Cant:'+Cantidad+'. Entr:'+LugarEntrega+'. CenCoste:'+CentroCoste+'. Desc:'+Descripcion+'. Precio:'+Precio);
		...
		else
		{
			...
			LugarEntrega= Piece(Producto, ':', 2);
			CentroCoste	= Piece(Producto, ':', 3);
			Descripcion	= Piece(Producto, ':', 4);
			Precio		= Piece(Producto, ':', 5);

			//solodebug		
			console.log('ProcesarCadenaTXT. Oferta ('+i+'). Ref:'+Ref+'. Cant:'+Cantidad+'. Entr:'+LugarEntrega+'. CenCoste:'+CentroCoste+'. Desc:'+Descripcion+'. Precio:'+Precio);
		}
