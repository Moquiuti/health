...
//	ultima revision ET 16oct19 10:30
...
function ProcesarCadenaPedidoTXT(ListaProductos)
{
	...
	for (i=0;i<=numRefs;++i)
	{
		...
		else
		{
			...
			if (posIDSolicitud>=0) IDSolicitud= Piece(Producto, '|', posIDSolicitud);			//	16oct19 
			...
			if ((Ref!='')||((Cantidad!='')&&(Cantidad!='0')))		//	15dic17	Eliminamos líneas sin ref ni cantidad
			{
				var items		= [];
				items['CodPed']	= CodPed;
