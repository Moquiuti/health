...
for (my $i = 0; $fnames[$i]; $i++) {
	print '{"file":"'.$fhandles[$i].'","num" : "'.$i.'","nombre" : "'.$fnames[$i].$fsuf_orig.'","orig" : "'.$fnames[$i].$fsuf_orig.'","big" : "'.$fnames[$i].$fsuf_big.'", "small" : "'.$fnames[$i].$fsuf_small.'", "mime" : "'.$fmimes[$i].'", "size" : "'.$fsizes[$i].'", "width" : "'.$ancho[$i].'","error" : "'.$errors[$i].'"}';
	if ($i < $flength - 1) {
		print ', ';
	}
}
...
for (my $i = 0; $fnames_planos[$i]; $i++) {
        print '{"file":"'.$fhandles_planos[$i].'","num" : "'.$i.'","nombre" : "'.$fnames_planos[$i].$fsuf_orig.'","orig" : "'.$fnames_planos[$i].$fsuf_orig.'","big" : "'.$fnames_planos[$i].$fsuf_big.'", "small" : "'.$fnames_planos[$i].$fsuf_small.'", "mime" : "'.$fmimes_planos[$i].'", "size" : "'.$fsizes_planos[$i].'", "width" : "'.$ancho[$i].'","error" : "'.$errors_planos[$i].'"}';
