...
//	ultima revision ET 20mar20 09:22 AltaLicitacionesAjax_200320.js
		...
		if(data.estado == 'ok')
		{
			...
			if (window.File && window.FileReader && window.FileList && window.Blob) {
				...
				jQuery.get(urlfichero, function(fileContent) {
					...
					console.log('DescargarOC:'+strdataurl);
					...
					if (ieversion>=11) {
						console.log('DescargarOC: ieversion:'+ieversion);
						//alert('IE11');
						//alert('strdataurl:'+strdataurl);
						//alert('fileContent:'+fileContent);
    				...
    				if (document.createEvent) {
						console.log('DescargarOC: createEvent');
				...
				// Para IE < 11: muestra ventana con toolbar y menú PS 29ago16
						console.log('DescargarOC: MostrarXML');
