...
//	Ultima revisión ET 225ene22 09:00 lic_proveedor_250122.js
...
function dibujaTablaProductosPROVE(){
	...
	//solodebug	
	debug('dibujaTablaProductosPROVE totalProductos:'+totalProductos);
	...
	if(totalProductos > 0){
		...
		//solodebug	
		debug('dibujaTablaProductosPROVE firstProduct:'+firstProduct+' lastProduct:'+lastProduct+' numProductos:'+numProductos+' pagsProdTotal:'+pagsProdTotal+' totalProductos:'+totalProductos);
