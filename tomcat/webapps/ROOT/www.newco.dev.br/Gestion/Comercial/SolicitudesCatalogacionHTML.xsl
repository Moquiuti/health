...
<!--
	Ultima revision: ET 11nov20 18:34 SolicitudCatalogacion_280617.js
-->
...
<head>
	...
	<script type="text/javascript" src="http://www.newco.dev.br/Gestion/Comercial/SolicitudCatalogacion_280617.js"></script>
</head>
<body>
<!--idioma-->
<xsl:variable name="lang">
...
<xsl:choose>
	...
	<div class="ZonaTituloPagina">
		<p class="Path"><xsl:value-of select="document($doc)/translation/texts/item[@name='Inicio']/node()"/>&nbsp;/&nbsp;<span class="FinPath"><xsl:value-of select="document($doc)/translation/texts/item[@name='solicitudes_catalogacion']/node()"/></span></p>
		<p class="TituloPagina">
			...
			<span class="CompletarTitulo">
				...
				<a class="btnDestacado" href="javascript:MostrarPagPersonalizada('http://www.newco.dev.br/Gestion/Comercial/NuevaSolicitudCatalogacion.xsql','Nueva solicitud',100,100,0,0);"> 
		...
		<table class="buscador">
			...
			<tr class="filtros" height="50px">
				...
				<th width="140px" style="text-align:left;">
					...
					<xsl:call-template name="desplegable"><xsl:with-param name="path" select="SOLICITUDESCATALOGACION/FPLAZO/field"/></xsl:call-template>
				</th>

				<th width="140px" style="text-align:left">
                    <!--<div class="botonLargo">
					<strong>-->
						<a class="btnDestacadoPeq" href="javascript:BuscarSolicitudesCatalogacion(document.forms['Buscador']);">
			...
			<xsl:for-each select="SOLICITUDESCATALOGACION/SOLICITUD">
				...
				<tr id="SOLIC_{SC_ID}" style="border-bottom:1px solid #A7A8A9;">
					...
					<xsl:if test="$usuario = 'CDC'">
						<a href="javascript:BorrarSolicitudCatalogacion('{SC_ID}');"><img src="http://www.newco.dev.br/images/2017/trash.png"/></a>
					</xsl:if>
					</td>
				</tr>
			</xsl:for-each>
