...
function IncluirProveedores()
{
	...
	for (var i=0;i</*23set22 arrProveedores.*/arrProveedores.length;++i)
		//23set22	jQuery('#IDPROVEEDOR').append("<option value='"+arrProveedores[i].ID+"' >"+arrProveedores[i].NombreCorto+"</option>")
...
{		
	...
	for (var i=0;i<arrProductos[Pos].OfertasBack.length;++i)
	{
		if (arrProductos[Pos].OfertasBack[i].OfertaAdjud=='S')
		{
			...
			//solodebug debug('ActualizaTotales [1]. Prov:'+arrProveedores[PosProveedor].NombreCorto+' ofertas:'+arrProveedores[PosProveedor].OfertasAdj+' cons.Ant.:'+arrProveedores[PosProveedor].ConsumoAdj);
			...
			//23set22	arrProveedores[PosProveedor].ConsumoAdj=formateaDivisa(arrProveedores[PosProveedor].ConsumoAdj_Float);
	...
	for (var i=0;i<arrProductos[Pos].Ofertas.length;++i)
	{
		if (arrProductos[Pos].Ofertas[i].OfertaAdjud=='S')
		{
			...
			//solodebug debug('ActualizaTotales [2]. Prov:'+arrProveedores[PosProveedor].NombreCorto+' ofertas:'+arrProveedores[PosProveedor].OfertasAdj+' cons.Ant.:'+arrProveedores[PosProveedor].ConsumoAdj);
