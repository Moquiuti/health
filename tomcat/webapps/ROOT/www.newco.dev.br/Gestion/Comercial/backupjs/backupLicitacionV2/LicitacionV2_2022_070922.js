...
//	Ultima revisión ET 9set22 11:00 LicitacionV2_2022_090922.js
...
function ActualizarProducto(Pos){
	...
	if (arrProductos[Pos].Cantidad!=nuevaCant)
	{
		...
		if (IDOfeAdj!='')
		{
			...
			var Consumo=(CantAdjud*desformateaDivisa(arrProductos[Pos].Ofertas[PosOfeAdj].PRECIO).toFixed(2));
			
			//solodebug	
			console.log('ActualizarProducto. Asignando cantidad a oferta IDOfeAdj:'+IDOfeAdj+' CantAdjud:'+CantAdjud+' Precio:'+arrProductos[Pos].Ofertas[PosOfeAdj].PRECIO+' Consumo:'+Consumo);
			
			arrProductos[Pos].Ofertas[PosOfeAdj].CONSUMO=Consumo;

			var Color=CompruebaColorOferta(Pos, PosOfeAdj);
			jQuery('#Consumo_'+IDOfeAdj).html('<span class="'+Color+'">'+formateaDivisa(Consumo)+'</span>');
