...
//	Ultima revision ET 6feb23 16:30 LicProveedor2022_060223.js
...
function ActualizarOfertas(Referencias)
{
	...
	{
		var Ref,RefProv,RefProv2,Nombre,Marca,UdsXLote,Precio,RegSan,CodExpediente,CodCum,CodIum,CodInvima,FechaCadInvima,ClasRiesgo;
		...
		else
		{
			...
			CodExpediente	= Piece(Producto, ':', 7);
			CodCum		= Piece(Producto, ':', 8);
			CodIum		= Piece(Producto, ':', 9);
			CodInvima	= Piece(Producto, ':', 10);
			FechaCadInvima	= Piece(Producto, ':', 11);
			ClasRiesgo	= Piece(Producto, ':', 12);
		}
