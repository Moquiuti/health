...
//	Ultima revision ET 1feb23 09:00 LicProveedor2022_300123.js
...
function PreparaLineaProducto(numProd, contLinea)
{
	...
	//27may22		thisCell += '<img src="http://www.newco.dev.br/images/2017/info.png" title="'+strPrincActivo+': '+arrProductos[ColumnaOrdenadaProds[numProd]].PrincActivo+'" class="static"/>'
		...
		if (incluirFS=='S')
		{
			...
			thisCell += divEnd;
			thisCell += dibujaSubirDocOferta('FS', Indice);
			thisCell += cellEnd;
			thisRow += thisCell;
			thisRow += rowEnd;
		}
...
{
	//solodebug	console.log('DesplegableTipoIva. NumeroLinea:'+NumeroLinea+' TipoIva:'+TipoIva);
...
function guardarOfertaFila(thisPosArr, tipo, recal)
{
	...
	if(tipo!='BORRAR')	//26ene23 No realizar estas comprobaciones si se va a borrar el registro
	{
		...
		{
			errores++;
			msgErrores+=alrt_faltaFSObligatorio+'\n'
		}
