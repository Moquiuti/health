...
//	Ultima revisión ET 8mar23 11:45 LicitacionV2_2022_080323.js
...
function ActualizarProducto(Pos, AvisarCambioCantidad){
	...
	//solodebug	
	console.log('ActualizarProducto '+Pos+' Cant:'+arrProductos[Pos].Cantidad+' nuevaCant:'+nuevaCant);
	...
	//solodebug	
	console.log('ActualizarProducto '+Pos+' listaProductos:'+listaProductos);
	...
	if (arrProductos[Pos].Cantidad!=nuevaCant)
	{
		...
		//solodebug	
		console.log('ActualizarProducto '+Pos+' hay cambio en cantidad');
		...
		if (AvisarCambioCantidad=='S')
		{
			...
			//solodebug	
			console.log('ActualizarProducto '+Pos+' QuitarSeleccionesProducto');
	...
	//solodebug	
	console.log('ActualizarProducto '+Pos+'.AJAX:ActualizarProductos.xsql listaProductos:'+listaProductos);
	...
	jQuery.ajax({
		...
		success: function(objeto){
			...
			if(data.ProductosActualizados.estado == 'OK'){
				...
				//solodebug	
				console.log('ActualizarProducto '+Pos+'. AJAX OK, AbrirProducto');
				...
				//solodebug	
				console.log('ActualizarProducto '+Pos+'. AJAX KO, alert + return');
