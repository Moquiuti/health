/*
	...
	Ultima revisión: ET 8jun22 15:40 LicAnalisisLineas2022_190322.js
*/
...
function DescargarExcel(){
	...
	//alert("DescargarExcel. IDEMPRESA="+IDEmpresa+"&IDCENTRO="+IDCentro+"&IDPROVEEDOR="+IDProveedor+"&PRODUCTO="+producto+"&MARCA="+marca+"&FECHA_INICIO="+fechaInicio+"&FECHA_FINAL="+fechaFinal+"&CODIGOLICITACION="+licitacion+"&INCLUIROFERTAS="+incluirOfertas+"&UTILFECHAENTREGA="+utilFechaEntrega);
