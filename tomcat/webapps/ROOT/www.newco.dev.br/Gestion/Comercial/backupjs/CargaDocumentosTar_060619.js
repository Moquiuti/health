//	Carga documentos JS
//	copiado desde CargaDocumentosSeg_030619.js para su uso en la gestión comercial
//	Ultima revision 6jun19 11:35
...
function addDocFile(){
	var remove = document.forms['Admin'].elements['DOCUMENTOS_BORRADOS'].value;
...
function periodicUpdateDoc(form){
	...
	if(uploadFrameDoc && uploadFrameDoc.document && uploadFrameDoc.document.getElementsByTagName("p")[0]) 
	{
		...
		tipoDoc = document.forms['Admin'].elements['TIPO_DOC'].value;
...
function handleFileRequestDoc(resp){
	...
	var usuario = document.forms['Admin'].elements['ID_USUARIO'].value;
	var borrados = document.forms['Admin'].elements['DOCUMENTOS_BORRADOS'].value;
	var borr_ante = document.forms['Admin'].elements['BORRAR_ANTERIORES'].value;
	var tipoDoc = document.forms['Admin'].elements['TIPO_DOC'].value;
	var prove = document.forms['Admin'].elements['IDEMPRESAUSUARIO'].value;
	...
	if(msg != ''){
		...
		jQuery.ajax({
			...
			success:function(data){
				...
				document.forms['Admin'].elements['inputFileDoc'].value = '';
				var tipo = document.forms['Admin'].elements['TIPO_DOC'].value;
				var IDEmpUsuario = document.forms['Admin'].elements['IDEMPRESAUSUARIO'].value;
				document.getElementById('confirmBox').style.display = 'none';
				jQuery("#carga").hide();
