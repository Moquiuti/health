		...
		<div class="ZonaTituloPagina">
			...
			<p class="TituloPagina">
				...
				<span class="CompletarTitulo">
					...
					<a class="btnDestacado" href="javascript:MostrarPagPersonalizada('http://www.newco.dev.br/Gestion/Comercial/EvaluacionProductoCopia.xsql?ID_EVAL={/EvaluacionProducto/EVALUACIONPRODUCTO/PROD_EV_ID}','evaluacion',100,80,0,0)" title="Cópia" style="text-decoration:none;">
					...
					<img src="http://www.newco.dev.br/images/imprimir.gif" style="margin-top:-5px;" alt="Imprimir" />
						...
						<xsl:choose>
                                    <xsl:when test="EvaluacionProducto/LANG != 'spanish'">
                                                <a href="javascript:MostrarPagPersonalizada('http://www.newco.dev.br/Gestion/Comercial/EvaluacionProductoCopia.xsql?ID_EVAL={/EvaluacionProducto/EVALUACIONPRODUCTO/PROD_EV_ID}','evaluacion',100,80,0,0)" title="Cópia" style="text-decoration:none;">
                                                    <img src="http://www.newco.dev.br/images/copiar-BR.gif" style="margin-top:-5px;" alt="Cópia" />
                                                </a>
                                    </xsl:when>
                                    <xsl:otherwise>
			...
			<input type="hidden" name="PROD_INC_IDDOCSOLUCION" id="DOC_SOL" value="{EvaluacionProducto/EVALUACIONPRODUCTO/DOCUMENTO_SOLUCION/ID}"/>
				...
				<tr>
					...
					<td class="datosLeft">
                                ...
                                <!- -si es cdc o usuario evaluador o us coordinador enseño fecha envio muestras o si es proveedor desp que guarda fecha envio muestras 24-08-15mc- ->
