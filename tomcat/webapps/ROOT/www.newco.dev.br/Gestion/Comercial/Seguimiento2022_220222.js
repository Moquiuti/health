...
// Ultima revision: 22feb22 18:08 Seguimiento2022_220222.js
...
function Inicio()
{
	...
	{
		//console.log('Inicio.'+window.parent.location+'.'+window.top.location+' -> Ocultar botón');
		jQuery('#btnTareas').hide();
	}
}
...
function Enviar()
{
	...
	document.forms.frmSeg.action="Seguimiento2022.xsql";
