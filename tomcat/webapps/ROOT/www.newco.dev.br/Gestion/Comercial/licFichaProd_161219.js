...
//	Ultima revision ET 6nov19 14:00 licFichaProd_161219.js
...
function SeleccionadaOferta (ID)
{
	...
	if ((LicMultiOpcion=='S')||(MesesDuracion==0))	//	16dic19 Faltaba incluir la opción de SPOT
	{
		if (jQuery("#ADJUD_"+ID).prop("checked"))
		{
...
function Pedido(IDOfertaLic)
{
	...
	if (LicAgregada=='S')
	{
		...
		//solodebug
		console.log('Pedido para centro: '+"("+IDCentroPedido+") "+CentroPedido+" Cantidad:"+Cantidad);
