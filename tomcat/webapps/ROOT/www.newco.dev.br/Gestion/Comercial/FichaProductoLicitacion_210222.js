...
//	Ultima revision ET 10feb22 20:40 FichaProductoLicitacion_210222.js
...
function GuardarProductoSel(IDProdLic, Accion){
	...
	alert('GuardarProductoSel. LicMultiOpcion:'+LicMultiOpcion+' OfertasSeleccionadas:'+OfertasSeleccionadas());
	...
	//solodebug	
	alert("IDLIC="+IDLicitacion+"&IDPRODUCTOLIC="+IDProdLic+"&IDOFERTA="+IDOfertaLic+"&IDMOTIVO="+IDMotivo+"&MOTIVO="+encodeURIComponent(Motivo));
