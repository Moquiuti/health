...
//	Ultima revisión ET 24set20 11:30 lic_240920.js
	...
	{	
		...
		jQuery.ajax({
			...
			success: function(objeto)
			{
				...
				//solodebug	
				debug('cargaDatosOfertasProveedoresAjax. objeto:'+objeto+' ListaProductosOfertas.length:'+data.ProductosLicitacion.ListaProductosOfertas.length);

				if(data.ProductosLicitacion.ListaProductosOfertas.length > 0)
				{
				
					//solodebug	
					debug('cargaDatosOfertasProveedoresAjax. length:'+data.ProductosLicitacion.ListaProductosOfertas.length+'>0');
				
					jQuery.each(data.ProductosLicitacion.ListaProductosOfertas, function(key, producto)
					{
						//solodebug	
						debug('cargaDatosOfertasProveedoresAjax. buscar producto:'+producto.LIC_PROD_ID);
					...
					//solodebug 
					debug('cargaDatosOfertasProveedoresAjax: PosProvActual:'+PosProvActual+ ' total:'+arrProveedores.length+ ' => llamada recursiva tras carga de datos');
