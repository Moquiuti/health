...
function ValidarFormulario(oForm, nombre, flag){
	...
	console.log('ValidarFormulario'+nombre+ 'ctrlCargaProv:'+ctrlCargaProv);
...
function GuardarSeleccion(){
	...
	jQuery('table#lProductos_OFE tbody tr').each(function(){
		...
		//solodebug console.log('ListaOfertas:'+ListaOfertas+' controlPaginacion:'+controlPaginacion+'/'+MaxPagina+' numPaginas:'+numPaginas);
...
function GuardarSeleccionAjax(ListaOfertas, numProdsLista, MaxPagina, loop, loops, error)
{
	...
	//solodebug	console.log('GuardarSeleccionAjax: '+ListaOfertas+ 'loop:'+loop+'loops:'+loop+' ListaOfertasPagina:'+ListaOfertasPagina);
...
function StringtoCSV(Cadena) {return (sepTextoCSV+Cadena+sepTextoCSV+sepCSV);}
