...
//	Ultima revisión ET 19set19 11:00
...
function ColocaFloatingBox()
{
	...
	//solodebug	debug('ColocaFloatingBox.top: '+(jQuery(window).scrollTop()+80)+' left:'+(jQuery(window).width()-500));
}
...
function ValidarFormulario(oForm, nombre, flag){
	...
	if(nombre == 'datosGenerales')
	{
		...
		else
		{
			...
			//solodebug	console.log('Comprobar fecha. Hoy:'+hoy+'...'+dd+'/'+mm+'/'+yyyy+' fecha dec.:'+oForm.elements['LIC_FECHADECISION'].value+' comparafechas:'+comparaFechas(oForm.elements['LIC_FECHADECISION'].value, dd+'/'+mm+'/'+yyyy));
			
			if(!errores && (oForm.elements['LIC_MESES'].value>0) && comparaFechas(oForm.elements['LIC_FECHADECISION'].value, dd+'/'+mm+'/'+yyyy) == '<')
			{
				errores++;
