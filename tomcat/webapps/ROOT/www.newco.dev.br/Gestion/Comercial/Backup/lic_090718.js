...
//	ultima revision: ET 9jul18 11:41
				...
				if(data.ProductosLicitacion.ListaProductosOfertas.length > 0){
					jQuery.each(data.ProductosLicitacion.ListaProductosOfertas, function(key, producto){
						...
						if (arrProductos[fila].Ofertas[PosProvActual].OfertaAdjud=='S'){	//	21set16 Informar producto con oferta adjudicada
							...
							//solodebug	alert('fila:'+fila+' PosProvActual:'+PosProvActual+arrProductos[fila].TieneSeleccion+ 'numProdsSeleccion:'+numProdsSeleccion);
...
{
	console.log('IDProducto:'+IDProducto+' ListaOfertas:'+ListaOfertas);
	...
	console.log('IDProducto:'+IDProducto+' en linea '+lineaProd);
	...
	for(j=0;j<PieceCount(ListaOfertas,'|');++j)
	{
		...
		console.log('IDProducto:'+IDProducto+' en linea '+lineaProd+ 'COmprobando IDOferta:'+IDOferta+' Orden:'+Orden);
...
{
	alert('Pendiente de implementar. Disculpe las molestias.');
}
