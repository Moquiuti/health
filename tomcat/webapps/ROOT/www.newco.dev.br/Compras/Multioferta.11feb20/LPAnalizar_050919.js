...
//	Última revisión: ET 05set19 10:15
...
function inicializarDesplegableCentros(IDCentro){
	...
	if (IDCentro==-1)	mostrarDesplegableLugarDeEntrega(IDCentroDefecto, IDLugarEntrega);
...
function mostrarDesplegableLugarDeEntrega(IDCentroActual, IDLugarEntregaActual){
	...
	//solodebug 
	console.log('mostrarDesplegableLugarDeEntrega IDCentroActual:'+IDCentroActual+' IDLugarEntregaActual:'+IDLugarEntregaActual);
...
function controlPedido(){
	...
	//solodebug	console.log('controlPedido. pedMinimoTipo:'+pedMinimoTipo+' pedidoMinimo:'+pedMinimo+' sumaTotal:'+parseFloat(document.forms['sumaTotal'].elements['sumaTotal'].value.replace(/\./g,'').replace(",","."))+'. errorPedido:'+errorPedido);

	if((errorPedido != '') && (errorPedido != 0) && (pedMinimoTipo == 'E'))	//	Solo validamos en caso de pedido mínimo estricto
	{
		//solodebug	console.log('controlPedido. pedidoMinimo. errorPedido:'+errorPedido);
		
		if (saltarPedMinimo=='N')
		{
			
			//solodebug	console.log('controlPedido. errorPedido:'+errorPedido+'. alert!');
		...
		else
		{
			...
			//solodebug	console.log('controlPedido. errorPedido:'+errorPedido+'. confirm!');
	...
	if (errorPedido !='')
	{
		//solodebug	console.log('controlPedido. errorPedido:'+errorPedido+'. show!');
		
		jQuery('#divContinuar').show();
	}
	else
	{
		//solodebug	console.log('controlPedido. errorPedido:'+errorPedido+'. Actua!');
...
function pedidoMinimo(pedMinimo, total){
	...
	console.log('pedidoMinimo('+pedMinimo+', '+total+')');
	...
	console.log('pedidoMinimo('+pedMinimo+', '+total+'):'+msg);
	return msg;
}//fin pedidoMinimo
