...
var cLimitePlantillaVisible=150;		//	Limite de plantilla máximo para el funcionamiento tradicional
...
function inicializarDesplegableCentros(IDCentro){
	...
	//solodebug 
	console.log('inicializarDesplegableCentros IDCentro:'+IDCentro);
	...
	//solodebug 
	console.log('inicializarDesplegableCentros centroSeleccionado:'+centroSeleccionado+' CentroExiste:'+CentroExiste+' IDPrimerCentro:'+IDPrimerCentro);
	...
	if (IDCentro==-1)	mostrarDesplegableLugarDeEntrega(IDPrimerCentro, IDLugarEntrega);
	else mostrarDesplegableLugarDeEntrega(centroSeleccionado, IDLugarEntrega);
}
