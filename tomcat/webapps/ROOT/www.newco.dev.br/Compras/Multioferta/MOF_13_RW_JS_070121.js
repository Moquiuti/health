//	JS de MOF_13_RW
//	Ultima revisión ET 2oct18 11:32 MOF_13_RW_JS_070121.js
...
function inicializarImportes(form){ 
	...
	/*29abr22
	//solodebug	
	console.log('inicializarImportes. MO_SUBTOTAL:'+form.elements['MO_SUBTOTAL'].value+' num:'+desformateaDivisa(form.elements['MO_SUBTOTAL'].value)+ ' redondeo:'+Round(desformateaDivisa(form.elements['MO_SUBTOTAL'].value),2));
	console.log('inicializarImportes. MO_IMPORTEIVA:'+form.elements['MO_IMPORTEIVA'].value+' num:'+desformateaDivisa(form.elements['MO_IMPORTEIVA'].value)+ ' redondeo:'+Round(desformateaDivisa(form.elements['MO_IMPORTEIVA'].value),2));
	console.log('inicializarImportes. IMPORTE_FINAL_PEDIDO:'+form.elements['IMPORTE_FINAL_PEDIDO'].value+' num:'+desformateaDivisa(form.elements['IMPORTE_FINAL_PEDIDO'].value)+ ' redondeo:'+Round(desformateaDivisa(form.elements['IMPORTE_FINAL_PEDIDO'].value),2));
	...
	*/
	...
	form.elements['MO_SUBTOTAL'].value=SubtotalTxt;
	form.elements['MO_IMPORTEIVA'].value=IVATxt;
	form.elements['COSTELOGISTICA'].value=CosteTransporteTxt;
	form.elements['COSTELOGISTICA_IVA'].value=CosteTransporteIVATxt;
	form.elements['IMPORTE_FINAL_PEDIDO'].value=TotalTxt;
	
	//solodebug console.log('inicializarImportes. MO_SUBTOTAL:'+form.elements['MO_SUBTOTAL'].value);
