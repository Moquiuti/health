...
<!--
	Ultima revision. ET 12may22 09:45
-->
...
<!--        <input type="hidden" name="xml-stylesheet" value="{../xml-stylesheet}"/>-->
	...
	<div class="ZonaTituloPagina">
		<p class="Path"><xsl:value-of select="document($doc)/translation/texts/item[@name='Inicio']/node()"/>&nbsp;/&nbsp;<xsl:value-of select="document($doc)/translation/texts/item[@name='pedidos']/node()"/>&nbsp;/&nbsp;<span class="FinPath"><xsl:value-of select="document($doc)/translation/texts/item[@name='buscador_catalogo_proveedores']/node()"/></span>
...
<xsl:template match="ROW">
	...
	<tr>
		...
		<td align="right">
			...
			<!--la tarifa devuelve ya los precios correctos para cada cliente, solo viamed usa la marca TARIFA_CONIVA_EUROS 8-4-14-->
			...
			<table name="TABLA_SIN_STOCK_{PRO_ID}" id="TABLA_SIN_STOCK_{PRO_ID}" style="display:none; height:1px; border:none;" class="buscador">
				...
				<tr class="sinLinea">
					<td style="text-align:left; width:600px;">
						...
						<input type="text" class="muygrande" name="SIN_STOCK_{PRO_ID}"  size="60" maxlength="200"/>&nbsp;
					</td>
				</tr>
				<tr class="sinLinea">
					<td style="text-align:left; width:600px;">
						...
						<input type="text" name="STOCKS_REF_ALT_{PRO_ID}"  size="12" maxlength="25"/><xsl:text>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</xsl:text>
						<label><xsl:value-of select="document($doc)/translation/texts/item[@name='Prod']/node()"/>.&nbsp;</label>
						<input type="text"  class="grande" name="STOCKS_PROD_ALT_{PRO_ID}"  size="40" maxlength="150"/>
