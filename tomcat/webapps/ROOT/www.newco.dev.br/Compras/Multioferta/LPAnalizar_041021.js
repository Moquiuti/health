...
//	Ultima revision: ET 4oct21 12:00 LPAnalizar_041021.js
					...
					else
					{
						...
						*/
						...
						else
						{
							...
							//	4oct21 Actualizamos la divisa
							if (IDDivisa!=arrayLineasProductos[ColumnaOrdenadaProds[j]].Productos[0].IDDivisa)
							{
								cambiaADivisaProducto(j);
							}
