//	JS Derechos de un usuario sobre los productos de una plantilla
//	ultima revisión: ET 20nov19 	LPLista_201119.js
...
function DerechosUsuarioPlantilla()
{
	...
	window.location.href="http://www.newco.dev.br/Compras/Multioferta/PLManten.xsql?PL_ID="+IDPlantilla;
}
...
function DerechosUsuarioProducto(IDProdEstandar,IDProducto)
{
	...
	MostrarPagPersonalizada('http://www.newco.dev.br/ProcesosCdC/MantenimientoReducido/MantenimientoReducidoDerechos.xsql?IDEMPRESA='+idEmpresa+'&IDPRODUCTO='+IDProducto+'&IDPRODESTANDAR='+IDProdEstandar,80,50,0,-50);
}
