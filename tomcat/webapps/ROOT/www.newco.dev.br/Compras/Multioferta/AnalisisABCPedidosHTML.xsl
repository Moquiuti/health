...
<!--
	...
	Ultima revision 1mar21 12:30 AnalisisABCPedidos_240221.js
-->
...
<head>
	...
	<script type="text/javascript" src="http://www.newco.dev.br/Gestion/EIS/AnalisisABCPedidos_240221.js"></script>
...
<xsl:template name="buscador">
	...
	<table class="buscador" border="0">
		...
		<th  width="140px" style="text-align:left;">
			...
			<xsl:call-template name="desplegable"><xsl:with-param name="path" select="FILTROS/LISTAFAMILIAS/field"/></xsl:call-template>
		</th>
		<th  width="140px" style="text-align:left;">
			<label><xsl:value-of select="document($doc)/translation/texts/item[@name='Grupo_stock']/node()"/>:</label><br />
			<xsl:call-template name="desplegable"><xsl:with-param name="path" select="FILTROS/GRUPODESTOCK/field"/></xsl:call-template>
		</th>
		...
		<th width="140px" style="text-align:left;background:#F0F0F0;">
			...
			<input type="text" name="FECHA_INICIO"  id="FECHA_INICIO" value="{FECHAINICIO}" size="9" style="background:#FFFF99;border:1px solid #ccc;" />
		</th>
		<th width="140px" style="text-align:left;background:#F0F0F0;">
			<!--fecha final-->
			...
			<input type="text" name="FECHA_FINAL" id="FECHA_FINAL" value="{FECHAFINAL}"  size="9"  />
		</th>
		<th  width="180px" style="text-align:right;">
			<label>A:</label>
			<select name="PORCENTAJE_A" id="PORCENTAJE_A" style="width:100px"><!-- onchange="AplicarFiltro();"-->
                <option value="5">
			...
			<br />
			<label>B:</label>
			<select name="PORCENTAJE_B" id="PORCENTAJE_B" style="width:100px"><!-- onchange="AplicarFiltro();"-->
                <option value="75">
