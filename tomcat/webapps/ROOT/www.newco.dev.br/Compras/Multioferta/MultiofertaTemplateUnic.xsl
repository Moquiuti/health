...
<!--
	...
	Ultima revisión ET 2set21 09:40
-->
...
<xsl:template name="NEGOCIACION">    
    ...
    <!--SI HAY COMENTARIOS
         ...
         <input type="hidden" name="NMU_COMENTARIOS" value=""/>
			...
			<p class="textLeft">
				<br/>
				<strong><a class="btnNormal" href="javascript:MostrarPagPersonalizada('http://www.newco.dev.br/Compras/Multioferta/MODocs.xsql?MO_ID={/Multioferta/MULTIOFERTA/MO_ID}');"><xsl:value-of select="document($doc)/translation/texts/item[@name='documentos']/node()"/></a></strong><br/><br/>
	...
	<!-- <table class="grandeInicio" border="1">-->
	 ...
	 <!-- pongo aqui la parte de comentarios y lo demas-->
    	...
    	&nbsp;</td>
    	  ...
    	  <td class="textRight">
            <input type="text" name="MO_SUBTOTAL" size="12" maxlength="12" style="text-align:right;width:170px;" value="{IMPORTE_TOTAL_FORMATO}" class="noinput" onFocus="this.blur();"/>&nbsp;<xsl:value-of select="/Multioferta/MULTIOFERTA/DIVISA/PREFIJO"/><xsl:value-of select="/Multioferta/MULTIOFERTA/DIVISA/SUFIJO"/>
      		<!--
			<xsl:choose>
        	<xsl:when test="contains($numMOF,'MOF_11_RO')">
            	<input type="text" name="MO_SUBTOTAL" size="12" maxlength="12" style="text-align:right;width:140px;" value="{IMPORTE_TOTAL_FORMATO}" class="noinput" onFocus="this.blur();"/>&nbsp;<xsl:value-of select="/Multioferta/MULTIOFERTA/DIVISA/PREFIJO"/><xsl:value-of select="/Multioferta/MULTIOFERTA/DIVISA/SUFIJO"/>
        	</xsl:when>
        	<xsl:otherwise>
        		<xsl:apply-templates select="IMPORTE_TOTAL_FORMATO"/>
        	</xsl:otherwise>
    	...
    	<tr class="sinLinea">
    	  <td class="label textRight"> 
			...
			<!--para multioferta-frame 28-->
				<input type="hidden" name="MO_DESCUENTOGENERAL" size="6" maxlength="6" style="text-align:right;font-weight:bold;" value="{MO_DESCUENTOGENERAL}" onFocus="this.blur();"/>
				<input type="text" name="MO_IMPORTEIVA" size="12" maxlength="12" onFocus="this.blur();" value="{MO_IMPORTEIVA_FORMATO}" class="noinput" style="text-align:right;width:170px;"/>&nbsp;<xsl:value-of select="/Multioferta/MULTIOFERTA/DIVISA/PREFIJO"/><xsl:value-of select="/Multioferta/MULTIOFERTA/DIVISA/SUFIJO"/>
			</td>
			</tr>
			...
			<tr class="sinLinea">
				...
				<td align="right">
        			<input type="text" name="COSTELOGISTICA" size="12" maxlength="12" onFocus="this.blur();" value="{MO_COSTELOGISTICA_FORMATO}" class="noinput" style="text-align:right;width:170px;"/>&nbsp;<xsl:value-of select="/Multioferta/MULTIOFERTA/DIVISA/PREFIJO"/><xsl:value-of select="/Multioferta/MULTIOFERTA/DIVISA/SUFIJO"/>
				</td>
			</tr>
			</xsl:if>
			<xsl:if test="MO_COSTELOGISTICA_IVA">
			<tr class="sinLinea">
				...
				<td align="right">
        			<input type="text" name="COSTELOGISTICA_IVA" size="12" maxlength="12" onFocus="this.blur();" value="{MO_COSTELOGISTICA_IVA_FORMATO}" class="noinput" style="text-align:right;width:170px;"/>&nbsp;<xsl:value-of select="/Multioferta/MULTIOFERTA/DIVISA/PREFIJO"/><xsl:value-of select="/Multioferta/MULTIOFERTA/DIVISA/SUFIJO"/>
				</td>
			</tr>
			</xsl:if>
			<tr class="sinLinea">
			...
			<td class="textRight">
				<input type="text" name="IMPORTE_FINAL_PEDIDO" size="12" maxlength="12" onFocus="this.blur();" value="{IMPORTE_FINAL_PEDIDO}" class="noinput" style="text-align:right;width:170px;"/>&nbsp;<xsl:value-of select="/Multioferta/MULTIOFERTA/DIVISA/PREFIJO"/><xsl:value-of select="/Multioferta/MULTIOFERTA/DIVISA/SUFIJO"/>
			</td>
			</tr>
