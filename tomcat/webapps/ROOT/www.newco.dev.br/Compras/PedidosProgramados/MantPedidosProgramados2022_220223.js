...
function GuardarCambios()
{
	...
	if(((form.elements['PEDP_ID'].value<=0 || form.elements['PEDP_ID'].value=='') && form.elements['IDFRECUENCIA'].value=='Z')||(form.elements['IDFRECUENCIA'].value=='Z' && form.elements['IDFRECUENCIA_ANTERIOR'].value!=form.elements['IDFRECUENCIA'].value)){
		...
		//solodebug	alert('GuardarCambios. fechaInicio:'+ form.elements['FECHA_INICIO'].value+' fechaEntrega:'+ form.elements['FECHANO_ENTREGA'].value+' fechaLanzamiento:'+form.elements['FECHANO_LANZAMIENTO'].value+' fechaFin:'+form.elements['FECHANO_FIN'].value+' Recalcular:'+form.elements['RECALCULAR'].value);
