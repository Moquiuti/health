...
//	Creado: ET 1mar17	10:41
//	Ultima revision: ET 1mar17	10:41
...
function MostrarPlantilla(){
	...
	if (pl_id==-1)
		...
		setTimeout(function(){
			...
			objFrameHijo.location.href='http://www.newco.dev.br/Compras/Multioferta/LPLista.xsql?PL_ID='+pl_id+'&SES_ID='+document.forms[0].elements['SES_ID'].value;
		},100);
