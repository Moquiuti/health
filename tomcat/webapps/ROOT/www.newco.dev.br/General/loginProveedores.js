...
function AbrirVentana(form){
	var user = form.elements['USER'].value;
        ...
        //alert(pass+' lenght '+pass.length);
            ...
            if(getCookie2('PORTAL')!='')
                    document.cookie = 'PORTAL=; path=/; host=' + location.hostname + ';expires=Thu, 01 Jan 1970 00:00:01 GMT';

            SetCookie('PARAMETRO', form.elements['PARAMETRO'].value);
            SetCookie('LANG', form.elements['LANG'].value);
            SetCookie('PORTAL', form.elements['PORTAL'].value);


            var host = 'http://clubviplimpieza.proveedores.com/hframe.php';
