...
//******************************************************************************
    ...
    document.writeln(
        '<style type="text/css">'                                       +
            ...
            '/* Calendar background */'                                 +
            'table.scw                  {background-color:  #91AA9D;}'  +
            '/* Drag Handle */'                                         +
            'td.scwDrag                 {background-color:  #9999CC;'   +
                                        'color:             #CCCCFF;}'  +
            '/* Week number heading */'                                 +
            'td.scwWeekNumberHead       {color:             #91AA9D;}'  +
            '/* Week day headings */'                                   +
            'td.scwWeek                 {color:             #EFEFEF;}'  +
            '/* Week numbers */'                                        +
            'td.scwWeekNo               {background-color:  #776677;'   +
                                        'color:             #EFEFEF;}'  +
            '/* Enabled Days */'                                        +
            '/* Week Day */'                                            +
            'td.scwCells                {background-color:  #EFEFEF;'   +
                                        'color:             #000000;}'  +
            '/* Day matching the input date */'                         +
            'td.scwInputDate            {background-color:  #CC9999;'   +
                                        'color:             #FF0000;}'  +
            '/* Weekend Day */'                                         +
            'td.scwCellsWeekend         {background-color:  #EFEFEF;'   +
                                        'color:             #AD0000;}'  +
            '/* Day outside the current month */'                       +
            'td.scwCellsExMonth         {background-color:  #EFEFEF;'   +
                                        'color:             #666666;}'  +
            '/* Today selector */'                                      +
            'td.scwNow                  {background-color:  #91AA9D;'   +
                                        'color:             #FFFFFF;}'  +
            '/* Clear Button */'                                        +
